...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.C_MASK 0xde7808f45dfc98 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xbfdd446cab8d6a5 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_10_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_11_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_13_slice_and_concat/slice_0]
