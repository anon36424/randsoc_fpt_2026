...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0xfffff CONFIG.C_DOUT_DEFAULT_2 0xfffff CONFIG.C_GPIO2_WIDTH 14 CONFIG.C_GPIO_WIDTH 20 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x64 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 148 CONFIG.C_SDA_INERTIAL_DELAY 108 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 154.6520099756872 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_0_cordic/aclken]
