...
set_property -dict "CONFIG.C_MASK 0x1b64dae8b520b8a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x86212f0f9407caa CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3a CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 252 CONFIG.C_SDA_INERTIAL_DELAY 60 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 943.3666715109763 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_3] [get_bd_pins ip_6_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_3] [get_bd_pins ip_6_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_1] [get_bd_pins ip_6_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_2] [get_bd_pins ip_6_xadc_wiz/alarm_out]
