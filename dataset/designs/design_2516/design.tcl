...
set_property -dict "CONFIG.C_MASK 0x13118ba3b2c03d CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x9cd5e51d04381f1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_11_axi/AXI_M1]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_7_xadc_wiz/ot_out]
