...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 47 CONFIG.aresetn 1 CONFIG.atuserwidth 143 CONFIG.bportwidth 50 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 29 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 29 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 24 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 47 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 22 -to 0 ip_8_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 23 -to 0 ip_9_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_4_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/CE]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/C_IN]
