...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x40 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 158 CONFIG.C_SDA_INERTIAL_DELAY 108 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 805.2875912851126 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_PORTS 7 " [get_bd_cells ip_9_slice_and_concat/concat]
...
create_bd_pin -dir I -from 17 -to 0 ip_9_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_9_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_9_slice_and_concat/slice_6]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_6] [get_bd_pins ip_9_slice_and_concat/slice_6/din]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/slice_6/dout] [get_bd_pins ip_9_slice_and_concat/concat/In6]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_1] [get_bd_pins ip_0_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_2] [get_bd_pins ip_0_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_4] [get_bd_pins ip_0_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_5] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_6] [get_bd_pins ip_2_dft/XK_RE]
