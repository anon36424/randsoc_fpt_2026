...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 3 CONFIG.C_TAVDV_PS_MEM_0 13581 CONFIG.C_TAVDV_PS_MEM_1 13825 CONFIG.C_TCEDV_PS_MEM_0 13913 CONFIG.C_TCEDV_PS_MEM_1 14400 CONFIG.C_THZCE_PS_MEM_0 7272 CONFIG.C_THZCE_PS_MEM_1 7663 CONFIG.C_THZOE_PS_MEM_0 7278 CONFIG.C_THZOE_PS_MEM_1 6669 CONFIG.C_TLZWE_PS_MEM_0 814 CONFIG.C_TLZWE_PS_MEM_1 7227 CONFIG.C_TWC_PS_MEM_0 15390 CONFIG.C_TWC_PS_MEM_1 15624 CONFIG.C_TWPH_PS_MEM_0 11451 CONFIG.C_TWPH_PS_MEM_1 11485 CONFIG.C_TWP_PS_MEM_0 11106 CONFIG.C_TWP_PS_MEM_1 12929 CONFIG.C_WR_REC_TIME_MEM_0 26395 CONFIG.C_WR_REC_TIME_MEM_1 25087 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 29 CONFIG.Iterations 8 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 27 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 48 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_4_cordic/cordic_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 39 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 48 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 23 CONFIG.aresetn 1 CONFIG.atuserwidth 131 CONFIG.bportwidth 8 CONFIG.btuserwidth 112 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 19 CONFIG.roundmode Truncate " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 237 CONFIG.convolution_code1 71 CONFIG.convolution_code2 129 CONFIG.convolution_code3 105 CONFIG.convolution_code4 127 CONFIG.convolution_code5 162 CONFIG.convolution_code6 64 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 9 CONFIG.output_rate 13 CONFIG.puncture_code0 101111110 CONFIG.puncture_code1 111100101 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_13_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir I -from 47 -to 0 ip_33_slice_and_concat/in_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_9
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_9]
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_33_slice_and_concat/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_2] [get_bd_pins ip_5_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_23_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_floating_point/S_AXIS_B] [get_bd_intf_pins ip_28_axis_dwidth_converter/M_AXIS]
