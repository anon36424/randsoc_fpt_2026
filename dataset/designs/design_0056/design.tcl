...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 8192 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 4 CONFIG.convolution_code0 1 CONFIG.convolution_code1 0 CONFIG.convolution_code2 3 CONFIG.convolution_code3 2 CONFIG.convolution_code4 6 CONFIG.convolution_code5 10 CONFIG.convolution_code6 12 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 8 CONFIG.output_rate 9 CONFIG.puncture_code0 11001101 CONFIG.puncture_code1 10100011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_4_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1395 CONFIG.C_DOUT_DEFAULT_2 0x1191 CONFIG.C_GPIO2_WIDTH 12 CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x11b6 CONFIG.C_TRI_DEFAULT_2 0x1fff " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MASK 0xfef8112c5b9713 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfcf3b9c0bb60d94 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 10 CONFIG.Iterations 45 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 38 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 39 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_9_cordic/cordic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 27 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 41 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_11_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6d CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 97 CONFIG.C_SDA_INERTIAL_DELAY 38 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 949.3847314845289 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_12_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 6 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 16 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 15 -to 0 ip_13_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 12 CONFIG.convolution_code1 9 CONFIG.convolution_code2 99 CONFIG.convolution_code3 81 CONFIG.convolution_code4 54 CONFIG.convolution_code5 36 CONFIG.convolution_code6 89 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 9 CONFIG.output_rate 12 CONFIG.puncture_code0 111100001 CONFIG.puncture_code1 111011110 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_16_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_BAUDRATE 4800 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Even " [get_bd_cells ip_17_uartlite/uart_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_23_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 43 -to 0 ip_31_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_31_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_3] [get_bd_pins ip_3_fft/event_frame_started]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_8] [get_bd_pins ip_17_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_21_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_uartlite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_gpio/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_uartlite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_3_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_conv_encoder/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_1] [get_bd_pins ip_13_accumulator/Q]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_2] [get_bd_pins ip_15_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_3] [get_bd_pins ip_15_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_4] [get_bd_pins ip_15_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_11_accumulator/ADD]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_15_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_13_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/C_IN]
