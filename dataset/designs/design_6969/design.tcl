...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3b CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 2 CONFIG.C_SDA_INERTIAL_DELAY 56 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 810.6024815340403 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.a_precision_type Custom CONFIG.a_tuser_width 6 CONFIG.add_sub_value Both CONFIG.axi_optimize_goal Performance CONFIG.c_a_exponent_width 5 CONFIG.c_a_fraction_width 7 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 0 CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 1 CONFIG.c_mult_usage No_Usage CONFIG.c_result_exponent_width 10 CONFIG.c_result_fraction_width 17 CONFIG.flow_control Blocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 1 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_type Float_to_float CONFIG.result_precision_type Custom " [get_bd_cells ip_4_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 1 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 8 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.C_MASK 0x58c2f1254046ce2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x658d9d9a1875c66 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 47 CONFIG.Iterations 29 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour OR_of_TLAST CONFIG.Out_TREADY 0 CONFIG.Output_Width 9 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 20 CONFIG.Round_Mode Truncate " [get_bd_cells ip_8_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8192 " [get_bd_cells ip_9_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 49 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_10_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x66 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 175 CONFIG.C_SDA_INERTIAL_DELAY 178 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 195.73165881230477 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_16_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xf0d7a2d5d1021a7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_17_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x7e3c9318f0e71d2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_17_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 36 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_31_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 27 -to 0 ip_37_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_9] [get_bd_pins ip_15_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_20_intc/irq_10] [get_bd_pins ip_16_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_microblaze/M_AXI_DP] [get_bd_intf_pins ip_22_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_22_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_emc/AXI] [get_bd_intf_pins ip_22_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_iic/AXI] [get_bd_intf_pins ip_22_axi/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_31_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_8_cordic/M_AXIS_DOUT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_fft/S_AXIS_DATA] [get_bd_intf_pins ip_31_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_1] [get_bd_pins ip_15_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_2] [get_bd_pins ip_15_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_3] [get_bd_pins ip_15_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_15_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/out0] [get_bd_pins ip_15_axi_timer/capturetrig1]
...
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_dwidth_converter/M_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_dwidth_converter/M_AXIS declared=288 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 352 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_33_axis_combiner/M_AXIS declared=352 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_33_axis_combiner/M_AXIS declared=352 actual=ERR $__err" }
if {[catch {
