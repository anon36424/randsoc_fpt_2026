...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 140 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 205 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 139 -to 0 ip_0_accumulator/B
connect_bd_net [get_bd_pins ip_0_accumulator/B] [get_bd_pins ip_0_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 204 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.C_DUPLEX 0 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_1_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 1024 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 38 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 40 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x1fffff CONFIG.C_GPIO_WIDTH 21 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.C_BAUDRATE 2400 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Even " [get_bd_cells ip_9_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0xcf44 CONFIG.C_DOUT_DEFAULT_2 0xffff CONFIG.C_GPIO2_WIDTH 26 CONFIG.C_GPIO_WIDTH 16 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 23 CONFIG.aresetn 0 CONFIG.bportwidth 20 CONFIG.ctrltuserwidth 13 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 34 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 38 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_11_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_13_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.AINIT_Value 1ffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 48 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 65 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_16_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 47 -to 0 ip_16_accumulator/B
connect_bd_net [get_bd_pins ip_16_accumulator/B] [get_bd_pins ip_16_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 64 -to 0 ip_16_accumulator/Q
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SPI_MEMORY 1 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_17_axi_quad_spi/axi_quad_spi_0]
...
create_bd_pin -dir I -from 204 -to 0 ip_43_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_43_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 187 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 204 CONFIG.DIN_TO 188 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_45_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 64 -to 0 ip_46_slice_and_concat/in_1
...
connect_bd_net [get_bd_pins ip_21_intc/irq_2] [get_bd_pins ip_7_gpio/irq]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_5] [get_bd_pins ip_13_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_21_intc/irq_6] [get_bd_pins ip_15_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_21_intc/irq_7] [get_bd_pins ip_17_axi_quad_spi/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_22_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_22_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_gpio/AXI] [get_bd_intf_pins ip_22_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_22_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_29_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_5_cordic/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_30_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_6_cordic/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_14_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/S_AXIS_DATA] [get_bd_intf_pins ip_26_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_40_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_4]
...
connect_bd_net [get_bd_pins ip_45_slice_and_concat/in_1] [get_bd_pins ip_4_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_1] [get_bd_pins ip_16_accumulator/Q]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_48_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/out0] [get_bd_pins ip_16_accumulator/ADD]
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_2_floating_point/aclken]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_5_cordic/aclken]
