...
set_property -dict "CONFIG.NUM_PORTS 8 " [get_bd_cells ip_10_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_10_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_5] [get_bd_pins ip_10_slice_and_concat/concat/In5]
create_bd_pin -dir I -from 0 -to 0 ip_10_slice_and_concat/in_6
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_6] [get_bd_pins ip_10_slice_and_concat/concat/In6]
create_bd_pin -dir I -from 12 -to 0 ip_10_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_10_slice_and_concat/slice_7]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_7] [get_bd_pins ip_10_slice_and_concat/slice_7/din]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/slice_7/dout] [get_bd_pins ip_10_slice_and_concat/concat/In7]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_11_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_6_clk_wiz/clk_out] [get_bd_pins ip_1_xadc_wiz/convstclk_in]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_9_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_intc/AXI] [get_bd_intf_pins ip_9_axi/AXI_S3]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_RE]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_4] [get_bd_pins ip_1_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_6] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_7] [get_bd_pins ip_2_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_4] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_5] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_0_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_3_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_2_dft/CE]
