...
create_bd_pin -dir O -from 16 -to 0 ip_3_accumulator/Q
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_12_slice_and_concat/slice_0]
