...
set_property -dict "CONFIG.AINIT_Value 1db5985fe00bab3e80c2c2b0508443681b704b30fc5764cb629e0a3ffd CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 229 CONFIG.Latency 15 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 229 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 228 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0xe91768a8991642b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x2bc3928724b94f9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 15901 CONFIG.C_TAVDV_PS_MEM_1 16192 CONFIG.C_TCEDV_PS_MEM_0 14692 CONFIG.C_TCEDV_PS_MEM_1 16330 CONFIG.C_THZCE_PS_MEM_0 7360 CONFIG.C_THZCE_PS_MEM_1 7280 CONFIG.C_THZOE_PS_MEM_0 6667 CONFIG.C_THZOE_PS_MEM_1 6817 CONFIG.C_TLZWE_PS_MEM_0 7548 CONFIG.C_TLZWE_PS_MEM_1 3051 CONFIG.C_TWC_PS_MEM_0 13691 CONFIG.C_TWC_PS_MEM_1 15480 CONFIG.C_TWPH_PS_MEM_0 10879 CONFIG.C_TWPH_PS_MEM_1 11337 CONFIG.C_TWP_PS_MEM_0 11640 CONFIG.C_TWP_PS_MEM_1 11411 CONFIG.C_WR_REC_TIME_MEM_0 28891 CONFIG.C_WR_REC_TIME_MEM_1 25297 " [get_bd_cells ip_8_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3f CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 35 CONFIG.C_SDA_INERTIAL_DELAY 92 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 195.80749720341421 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xd8bd11036de5eac CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x7bccefda118a9d2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 6 CONFIG.NUM_SI 2 " [get_bd_cells ip_17_axi/axi_0]
...
create_bd_pin -dir I -from 228 -to 0 ip_23_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 229 " [get_bd_cells ip_23_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 229 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 229 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 229 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 229 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 228 -to 0 ip_28_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 228 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 228 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 229 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 47 -to 0 ip_28_slice_and_concat/in_4
...
create_bd_pin -dir I -from 7 -to 0 ip_28_slice_and_concat/in_6
...
create_bd_pin -dir I -from 3 -to 0 ip_28_slice_and_concat/in_8
...
connect_bd_net [get_bd_pins ip_15_intc/irq_1] [get_bd_pins ip_7_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_15_intc/irq_2] [get_bd_pins ip_10_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_2] [get_bd_pins ip_10_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_timer/S_AXI] [get_bd_intf_pins ip_17_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_17_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_emc/AXI] [get_bd_intf_pins ip_17_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_iic/AXI] [get_bd_intf_pins ip_17_axi/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_DATA] [get_bd_intf_pins ip_4_cordic/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_1] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_2] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_3] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_4] [get_bd_pins ip_9_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_8] [get_bd_pins ip_12_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_9] [get_bd_pins ip_12_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_10] [get_bd_pins ip_12_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_0_xadc_wiz/convst_in]
...
if {[catch {
  ...
  set __s [expr {$__aw == 11 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_dwidth_converter/M_AXIS declared=11 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_dwidth_converter/M_AXIS declared=11 actual=ERR $__err" }
