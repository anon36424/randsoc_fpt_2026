...
set_property -dict "CONFIG.C_ADDR_WIDTH 47 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_6_fft/fft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 4 CONFIG.C_GPIO_WIDTH 32 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xffffffff CONFIG.C_TRI_DEFAULT_2 0xe46b63d6 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xffffffff CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 20 CONFIG.C_GPIO_WIDTH 32 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xffffffff CONFIG.C_TRI_DEFAULT_2 0xffffffff " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.C_BAUDRATE 300 CONFIG.C_DATA_BITS 7 CONFIG.PARITY No_Parity " [get_bd_cells ip_11_uartlite/uart_0]
...
set_property -dict "CONFIG.NUM_PORTS 13 " [get_bd_cells ip_15_intc/concat_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_15_intc/irq_11
connect_bd_net [get_bd_pins ip_15_intc/irq_11] [get_bd_pins ip_15_intc/concat_0/In11]
create_bd_pin -dir I -from 0 -to 0 ip_15_intc/irq_12
connect_bd_net [get_bd_pins ip_15_intc/irq_12] [get_bd_pins ip_15_intc/concat_0/In12]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 7 " [get_bd_cells ip_16_axi_legacy/axi_0]
...
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 ip_16_axi_legacy/AXI_M6
connect_bd_intf_net [get_bd_intf_pins ip_16_axi_legacy/AXI_M6] [get_bd_intf_pins ip_16_axi_legacy/axi_0/S06_AXI]
connect_bd_net [get_bd_pins ip_16_axi_legacy/clk] [get_bd_pins ip_16_axi_legacy/axi_0/S06_ACLK]
connect_bd_net [get_bd_pins ip_16_axi_legacy/reset] [get_bd_pins ip_16_axi_legacy/axi_0/S06_ARESETN]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_26_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_2] [get_bd_pins ip_2_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_3] [get_bd_pins ip_3_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_6] [get_bd_pins ip_7_gpio/irq]
connect_bd_net [get_bd_pins ip_15_intc/irq_7] [get_bd_pins ip_8_gpio/irq]
connect_bd_net [get_bd_pins ip_15_intc/irq_8] [get_bd_pins ip_9_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_9] [get_bd_pins ip_9_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_10] [get_bd_pins ip_10_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_11] [get_bd_pins ip_11_uartlite/irq]
connect_bd_net [get_bd_pins ip_15_intc/irq_12] [get_bd_pins ip_12_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_16_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_16_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI] [get_bd_intf_pins ip_16_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_16_axi_legacy/AXI_M5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_16_axi_legacy/AXI_M6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_uartlite/AXI] [get_bd_intf_pins ip_16_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_0] [get_bd_pins ip_12_xadc_wiz/vccaux_alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 35 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_24_axis_dwidth_converter/M_AXIS declared=35 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_axis_dwidth_converter/M_AXIS declared=35 actual=ERR $__err" }
