...
set_property -dict "CONFIG.C_MASK 0xa05f38c04f14d9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x23b633df5bf7cac CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_4_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MASK 0xb258686b0dc78b2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x42dccd0be26446e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0x97fb61a0fe710c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x79a92a806eb1e99 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 24 CONFIG.Iterations 0 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 38 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 41 CONFIG.Round_Mode Truncate " [get_bd_cells ip_11_cordic/cordic_0]
...
create_bd_pin -dir I -from 45 -to 0 ip_13_accumulator/B
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x1fffff CONFIG.C_DOUT_DEFAULT_2 0x1fffff CONFIG.C_GPIO2_WIDTH 24 CONFIG.C_GPIO_WIDTH 21 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_21_gpio/gpio_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_34_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_34_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 45 -to 0 ip_35_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_35_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_35_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_38_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_38_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_38_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_6] [get_bd_pins ip_16_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_7] [get_bd_pins ip_18_axi_quad_spi/irq]
...
connect_bd_net [get_bd_pins ip_25_intc/irq_6] [get_bd_pins ip_16_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_7] [get_bd_pins ip_18_axi_quad_spi/irq]
...
connect_bd_net [get_bd_pins ip_26_intc/irq_6] [get_bd_pins ip_16_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_26_intc/irq_7] [get_bd_pins ip_18_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axi_timer/S_AXI] [get_bd_intf_pins ip_27_axi/AXI_S9]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_5] [get_bd_pins ip_5_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_2] [get_bd_pins ip_6_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_3] [get_bd_pins ip_6_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_4] [get_bd_pins ip_6_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/out0] [get_bd_pins ip_20_dft/XN_RE]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_0] [get_bd_pins ip_13_accumulator/Q]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_1] [get_bd_pins ip_15_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_2] [get_bd_pins ip_15_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_3] [get_bd_pins ip_15_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_17_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_4] [get_bd_pins ip_20_dft/RFFD]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_5] [get_bd_pins ip_20_dft/XK_RE]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_0] [get_bd_pins ip_20_dft/XK_RE]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_1] [get_bd_pins ip_20_dft/XK_IM]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_4_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_0] [get_bd_pins ip_20_dft/XK_IM]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/out0] [get_bd_pins ip_20_dft/SIZE]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_0] [get_bd_pins ip_20_dft/XK_IM]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/out0] [get_bd_pins ip_6_dft/SIZE]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_0] [get_bd_pins ip_20_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_1] [get_bd_pins ip_20_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_2] [get_bd_pins ip_20_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_13_accumulator/CE]
