...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 10 CONFIG.C_TAVDV_PS_MEM_0 13780 CONFIG.C_TAVDV_PS_MEM_1 13746 CONFIG.C_TAVDV_PS_MEM_2 14471 CONFIG.C_TCEDV_PS_MEM_0 13675 CONFIG.C_TCEDV_PS_MEM_1 16329 CONFIG.C_TCEDV_PS_MEM_2 15123 CONFIG.C_THZCE_PS_MEM_0 7448 CONFIG.C_THZCE_PS_MEM_1 6841 CONFIG.C_THZCE_PS_MEM_2 6994 CONFIG.C_THZOE_PS_MEM_0 6412 CONFIG.C_THZOE_PS_MEM_1 7249 CONFIG.C_THZOE_PS_MEM_2 7013 CONFIG.C_TLZWE_PS_MEM_0 8949 CONFIG.C_TLZWE_PS_MEM_1 6015 CONFIG.C_TLZWE_PS_MEM_2 3861 CONFIG.C_TWC_PS_MEM_0 15097 CONFIG.C_TWC_PS_MEM_1 16447 CONFIG.C_TWC_PS_MEM_2 16247 CONFIG.C_TWPH_PS_MEM_0 12348 CONFIG.C_TWPH_PS_MEM_1 11311 CONFIG.C_TWPH_PS_MEM_2 12771 CONFIG.C_TWP_PS_MEM_0 11269 CONFIG.C_TWP_PS_MEM_1 12782 CONFIG.C_TWP_PS_MEM_2 11355 CONFIG.C_WR_REC_TIME_MEM_0 25390 CONFIG.C_WR_REC_TIME_MEM_1 27348 CONFIG.C_WR_REC_TIME_MEM_2 24516 " [get_bd_cells ip_1_emc/emc_0]
...
create_bd_pin -dir O -from 12 -to 0 ip_5_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_5_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 12 -to 0 ip_6_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_6_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_emc/AXI] [get_bd_intf_pins ip_4_axi/AXI_S0]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_RE]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_0] [get_bd_pins ip_0_dft/RFFD]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_1] [get_bd_pins ip_0_dft/XK_RE]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/out0] [get_bd_pins ip_0_dft/SIZE]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_RE]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_1] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_IM]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_1] [get_bd_pins ip_0_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_2] [get_bd_pins ip_0_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_0_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_8_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_0_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_0_dft/FD_IN]
