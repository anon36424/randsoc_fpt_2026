...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5e CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 182 CONFIG.C_SDA_INERTIAL_DELAY 250 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 788.9106853782725 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x8b43d4c16079585 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xc41616edf83b92c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 23 CONFIG.convolution_code1 90 CONFIG.convolution_code2 29 CONFIG.convolution_code3 65 CONFIG.convolution_code4 71 CONFIG.convolution_code5 74 CONFIG.convolution_code6 4 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 9 CONFIG.output_rate 16 CONFIG.puncture_code0 101111111 CONFIG.puncture_code1 111110111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_2_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x79 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 198 CONFIG.C_SDA_INERTIAL_DELAY 41 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 197.41072670265004 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x17a CONFIG.C_GPIO2_WIDTH 2 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_9_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MASK 0x30d1b76cd8413c8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xd2db8e4a18d13cc CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_gpio/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_20_slice_and_concat/in_5] [get_bd_pins ip_7_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_4_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_8_cordic/aclken]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_1] [get_bd_pins ip_7_xadc_wiz/alarm_out]
