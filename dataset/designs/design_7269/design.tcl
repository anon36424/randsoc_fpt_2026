...
set_property -dict "CONFIG.C_MASK 0x2b9d38343a915b2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xd6b78acc50e53cf CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 12 CONFIG.C_TAVDV_PS_MEM_0 16373 CONFIG.C_TCEDV_PS_MEM_0 13551 CONFIG.C_THZCE_PS_MEM_0 7401 CONFIG.C_THZOE_PS_MEM_0 7587 CONFIG.C_TLZWE_PS_MEM_0 3672 CONFIG.C_TWC_PS_MEM_0 16049 CONFIG.C_TWPH_PS_MEM_0 13187 CONFIG.C_TWP_PS_MEM_0 10939 CONFIG.C_WR_REC_TIME_MEM_0 26527 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 512 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x97c9e38862eab39 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfd8d47959092c7a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 241 CONFIG.Latency 14 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 245 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 240 -to 0 ip_6_accumulator/B
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x38 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 105 CONFIG.C_SDA_INERTIAL_DELAY 240 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 140.83435975789558 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_12_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 32 CONFIG.Iterations 23 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 41 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 46 CONFIG.Round_Mode Truncate " [get_bd_cells ip_13_cordic/cordic_0]
...
set_property -dict "CONFIG.NUM_MI 9 CONFIG.NUM_SI 6 " [get_bd_cells ip_19_axi_legacy/axi_0]
...
create_bd_pin -dir I -from 244 -to 0 ip_26_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 245 " [get_bd_cells ip_26_slice_and_concat/slice_6]
...
create_bd_pin -dir I -from 244 -to 0 ip_27_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 245 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 244 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 245 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 245 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 240 -to 0 ip_30_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 244 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 245 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 15 -to 0 ip_30_slice_and_concat/in_3
...
connect_bd_net [get_bd_pins ip_17_intc/irq_2] [get_bd_pins ip_7_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_6] [get_bd_pins ip_10_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_17_intc/irq_7] [get_bd_pins ip_11_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_19_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_19_axi_legacy/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_19_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_3] [get_bd_pins ip_3_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_4] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_5] [get_bd_pins ip_3_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_6] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_8_dft/RFFD]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_8_dft/XK_RE]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_3] [get_bd_pins ip_8_dft/XK_IM]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_4] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_5] [get_bd_pins ip_8_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_6] [get_bd_pins ip_8_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_32_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig1]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_8_dft/FD_IN]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_13_cordic/aclken]
