...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_4_fft/fft_0]
...
create_bd_pin -dir O -from 246 -to 0 ip_25_slice_and_concat/out0
...
create_bd_pin -dir I -from 255 -to 0 ip_25_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 240 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_25_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 255 CONFIG.DIN_TO 241 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_8] [get_bd_pins ip_9_uartlite/irq]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_6] [get_bd_pins ip_10_accumulator/Q]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_10_accumulator/Q]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_11_floating_point/aclken]
