...
set_property -dict "CONFIG.C_ADDR_WIDTH 46 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_6_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 28 CONFIG.aresetn 1 CONFIG.bportwidth 60 CONFIG.btuserwidth 56 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 86 CONFIG.roundmode Truncate " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 1 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_11_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MASK 0x6d43acf49f56a47 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfad72b375f93ba6 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DUPLEX 0 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_18_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 35 CONFIG.aresetn 1 CONFIG.atuserwidth 237 CONFIG.bportwidth 39 CONFIG.ctrltuserwidth 230 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 24 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 51 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_19_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 44 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_20_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_21_fft/fft_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_22_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.NUM_MI 15 CONFIG.NUM_SI 9 " [get_bd_cells ip_26_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 14 " [get_bd_cells ip_34_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 22 " [get_bd_cells ip_41_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_25_intc/irq_3] [get_bd_pins ip_3_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_4] [get_bd_pins ip_4_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_5] [get_bd_pins ip_5_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_6] [get_bd_pins ip_6_axi_timer/interrupt]
...
connect_bd_net [get_bd_pins ip_25_intc/irq_9] [get_bd_pins ip_14_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_10] [get_bd_pins ip_14_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_11] [get_bd_pins ip_15_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_12] [get_bd_pins ip_17_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_13] [get_bd_pins ip_18_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_14] [get_bd_pins ip_20_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_15] [get_bd_pins ip_21_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_25_intc/irq_16] [get_bd_pins ip_22_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_26_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI] [get_bd_intf_pins ip_26_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_26_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_microblaze/M_AXI_DP] [get_bd_intf_pins ip_26_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/M_AXI] [get_bd_intf_pins ip_26_axi/AXI_M5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_26_axi/AXI_M6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_26_axi/AXI_M7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_26_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_26_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_26_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_26_axi/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_26_axi/AXI_S12]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S13]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_25_intc/AXI] [get_bd_intf_pins ip_26_axi/AXI_S14]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXIS_MM2S] [get_bd_intf_pins ip_27_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_36_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_14_axi_dma/M_AXIS_MM2S]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_41_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_29_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_30_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_52_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_29_axis_broadcaster/M_AXIS_5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_52_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_31_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_52_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_32_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_0] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_1] [get_bd_pins ip_1_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_5] [get_bd_pins ip_6_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_6] [get_bd_pins ip_6_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_7] [get_bd_pins ip_6_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_8] [get_bd_pins ip_8_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_9] [get_bd_pins ip_8_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_10] [get_bd_pins ip_8_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_11] [get_bd_pins ip_8_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_12] [get_bd_pins ip_8_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_13] [get_bd_pins ip_8_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_14] [get_bd_pins ip_17_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_15] [get_bd_pins ip_17_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_16] [get_bd_pins ip_17_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_17] [get_bd_pins ip_22_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_18] [get_bd_pins ip_22_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_19] [get_bd_pins ip_22_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_17_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/out0] [get_bd_pins ip_6_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_6_axi_timer/capturetrig1]
...
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_0] [get_bd_pins ip_8_xadc_wiz/vbram_alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 176 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_52_axis_combiner/S_AXIS_2 declared=176 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_52_axis_combiner/S_AXIS_2 declared=176 actual=ERR $__err" }
if {[catch {
