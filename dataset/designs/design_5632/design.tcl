...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 58 CONFIG.Latency 12 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 220 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 57 -to 0 ip_0_accumulator/B
connect_bd_net [get_bd_pins ip_0_accumulator/B] [get_bd_pins ip_0_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 219 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 18 CONFIG.Latency 27 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 170 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x10 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 69 CONFIG.C_SDA_INERTIAL_DELAY 161 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 233.57890071565754 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x1ef02784bbe2675 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x3fa5cf50bdf7077 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_SHARED_STARTUP 0 " [get_bd_cells ip_8_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_10_fft/fft_0]
...
create_bd_pin -dir I -from 323 -to 0 ip_23_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_23_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_23_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_23_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_23_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 113 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 114 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 133 CONFIG.DIN_TO 124 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 143 CONFIG.DIN_TO 134 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 153 CONFIG.DIN_TO 144 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 163 CONFIG.DIN_TO 154 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 173 CONFIG.DIN_TO 164 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 183 CONFIG.DIN_TO 174 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 193 CONFIG.DIN_TO 184 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 203 CONFIG.DIN_TO 194 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 213 CONFIG.DIN_TO 204 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 223 CONFIG.DIN_TO 214 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 233 CONFIG.DIN_TO 224 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 243 CONFIG.DIN_TO 234 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 253 CONFIG.DIN_TO 244 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 263 CONFIG.DIN_TO 254 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 273 CONFIG.DIN_TO 264 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 283 CONFIG.DIN_TO 274 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 293 CONFIG.DIN_TO 284 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 303 CONFIG.DIN_TO 294 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 313 CONFIG.DIN_TO 304 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 323 CONFIG.DIN_TO 314 CONFIG.DIN_WIDTH 324 " [get_bd_cells ip_23_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_23_reduce/reduce_31]
...
create_bd_pin -dir O -from 17 -to 0 ip_24_slice_and_concat/out0
create_bd_pin -dir I -from 219 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 57 -to 0 ip_25_slice_and_concat/out0
create_bd_pin -dir I -from 219 -to 0 ip_25_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 219 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 219 -to 0 ip_27_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 82 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 16 -to 0 ip_28_slice_and_concat/out0
create_bd_pin -dir I -from 219 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 83 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 219 -to 0 ip_29_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_29_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 219 -to 0 ip_30_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 219 -to 0 ip_31_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 118 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 219 -to 0 ip_32_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_32_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 323 -to 0 ip_33_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 23 " [get_bd_cells ip_33_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_33_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 219 -to 0 ip_33_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 219 CONFIG.DIN_TO 147 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 169 -to 0 ip_33_slice_and_concat/in_4
...
create_bd_pin -dir I -from 16 -to 0 ip_33_slice_and_concat/in_7
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_7] [get_bd_pins ip_33_slice_and_concat/concat/In7]
create_bd_pin -dir I -from 3 -to 0 ip_33_slice_and_concat/in_8
...
create_bd_pin -dir I -from 0 -to 0 ip_33_slice_and_concat/in_22
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_22] [get_bd_pins ip_33_slice_and_concat/concat/In22]
...
connect_bd_net [get_bd_pins ip_16_reset/peripheral_areset_n] [get_bd_pins ip_8_axi_hwicap/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_16_reset/peripheral_areset_n] [get_bd_pins ip_9_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_16_reset/peripheral_areset_n] [get_bd_pins ip_11_axi_ethernet_lite/reset]
connect_bd_net [get_bd_pins ip_16_reset/peripheral_areset_n] [get_bd_pins ip_12_axi_quad_spi/reset]
connect_bd_net [get_bd_pins ip_16_reset/peripheral_areset_n] [get_bd_pins ip_13_axi_timer/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_17_clk_wiz/clk_out] [get_bd_pins ip_1_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_17_clk_wiz/clk_out] [get_bd_pins ip_8_axi_hwicap/icap_clk]
connect_bd_net [get_bd_pins ip_17_clk_wiz/clk_out] [get_bd_pins ip_8_axi_hwicap/s_axi_aclk]
connect_bd_net [get_bd_pins ip_17_clk_wiz/clk_out] [get_bd_pins ip_9_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_17_clk_wiz/clk_out] [get_bd_pins ip_12_axi_quad_spi/clk]
connect_bd_net [get_bd_pins ip_17_clk_wiz/clk_out] [get_bd_pins ip_13_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_0] [get_bd_pins ip_6_axi_iic/irq]
connect_bd_net [get_bd_pins ip_18_intc/irq_1] [get_bd_pins ip_8_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_18_intc/irq_2] [get_bd_pins ip_9_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_18_intc/irq_3] [get_bd_pins ip_10_fft/event_frame_started]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_6] [get_bd_pins ip_13_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_19_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_19_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_iic/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_19_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_timer/S_AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_19_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_timer/S_AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_19_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_intc/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_20_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_15_axi_dma/M_AXIS_MM2S]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_10_fft/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/B]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_8_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_5_dft/SIZE]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_4_dft/XN_IM]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_5_dft/XN_RE]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_4_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_23_reduce/in0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_4] [get_bd_pins ip_2_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_8] [get_bd_pins ip_4_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_9] [get_bd_pins ip_4_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_10] [get_bd_pins ip_4_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_11] [get_bd_pins ip_5_dft/RFFD]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_12] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_13] [get_bd_pins ip_5_dft/XK_IM]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_14] [get_bd_pins ip_5_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_15] [get_bd_pins ip_5_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_16] [get_bd_pins ip_5_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_17] [get_bd_pins ip_9_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_18] [get_bd_pins ip_9_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_19] [get_bd_pins ip_9_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_20] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_21] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_22] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_4_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_34_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_13_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_38_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_13_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/ot_out]
...
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/ot_out]
...
connect_bd_net [get_bd_pins ip_48_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/SCLR]
