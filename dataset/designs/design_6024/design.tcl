...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 16 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_1_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 58 CONFIG.aresetn 0 CONFIG.atuserwidth 168 CONFIG.bportwidth 61 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 30 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 176 CONFIG.Latency 15 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 183 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_9_accumulator/accumulator_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_17_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 175 -to 0 ip_18_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 12 " [get_bd_cells ip_18_slice_and_concat/concat]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_18_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_10] [get_bd_pins ip_18_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 182 -to 0 ip_18_slice_and_concat/in_11
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_11
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_11]
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 183 " [get_bd_cells ip_18_slice_and_concat/slice_11]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_11] [get_bd_pins ip_18_slice_and_concat/slice_11/din]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/slice_11/dout] [get_bd_pins ip_18_slice_and_concat/concat/In11]
...
set_property -dict "CONFIG.DIN_FROM 159 CONFIG.DIN_TO 147 CONFIG.DIN_WIDTH 183 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 160 CONFIG.DIN_TO 160 CONFIG.DIN_WIDTH 183 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 166 CONFIG.DIN_TO 161 CONFIG.DIN_WIDTH 183 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 182 -to 0 ip_22_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 182 CONFIG.DIN_TO 167 CONFIG.DIN_WIDTH 183 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_3] [get_bd_pins ip_4_uartlite/irq]
connect_bd_net [get_bd_pins ip_12_intc/irq_4] [get_bd_pins ip_5_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_timer/S_AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_13_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_timer/S_AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_gpio/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S6]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_2] [get_bd_pins ip_0_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_3] [get_bd_pins ip_0_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_0_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_6] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_7] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_8] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_9] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_10] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_11] [get_bd_pins ip_9_accumulator/Q]
