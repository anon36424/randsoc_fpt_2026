...
set_property -dict "CONFIG.AINIT_Value 156d986d74c4f2f02f5aea317 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 10 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 101 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 100 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7a CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 168 CONFIG.C_SDA_INERTIAL_DELAY 90 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 953.6965324287519 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 14 CONFIG.Iterations 15 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 39 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 48 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_2_cordic/cordic_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 1 CONFIG.C_SPI_MEMORY 1 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_3_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_MASK 0x138138ed554731d CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xdbeba6e87db465f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 38 CONFIG.Iterations 46 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 20 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 37 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_6_cordic/cordic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 54 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_BAUDRATE 38400 CONFIG.C_DATA_BITS 7 CONFIG.PARITY No_Parity " [get_bd_cells ip_8_uartlite/uart_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 102 -to 0 ip_22_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_22_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_22_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 78 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 79 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 82 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 102 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 103 " [get_bd_cells ip_22_reduce/slice_31]
...
create_bd_pin -dir I -from 100 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 101 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 102 -to 0 ip_24_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 100 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 101 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_reset/interconnect_aresetn] [get_bd_pins ip_6_cordic/aresetn]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_17_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_timer/S_AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_11_conv_encoder/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_9_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_9_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_9_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_9_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_9_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_9_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_7] [get_bd_pins ip_10_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_8] [get_bd_pins ip_10_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_9] [get_bd_pins ip_10_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_10] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_11] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_12] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/CE]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_11_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_10_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_28_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_13_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_29_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_13_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_30_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_6_cordic/aclken]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_31_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_32_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_10_axi_timer/capturetrig1]
