...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 12 CONFIG.aresetn 1 CONFIG.atuserwidth 123 CONFIG.bportwidth 39 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 18 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 29 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 16159 CONFIG.C_TAVDV_PS_MEM_1 15042 CONFIG.C_TAVDV_PS_MEM_2 16028 CONFIG.C_TCEDV_PS_MEM_0 14066 CONFIG.C_TCEDV_PS_MEM_1 14789 CONFIG.C_TCEDV_PS_MEM_2 14722 CONFIG.C_THZCE_PS_MEM_0 7130 CONFIG.C_THZCE_PS_MEM_1 6436 CONFIG.C_THZCE_PS_MEM_2 6758 CONFIG.C_THZOE_PS_MEM_0 7546 CONFIG.C_THZOE_PS_MEM_1 7242 CONFIG.C_THZOE_PS_MEM_2 6510 CONFIG.C_TLZWE_PS_MEM_0 8419 CONFIG.C_TLZWE_PS_MEM_1 8036 CONFIG.C_TLZWE_PS_MEM_2 2234 CONFIG.C_TWC_PS_MEM_0 16381 CONFIG.C_TWC_PS_MEM_1 16304 CONFIG.C_TWC_PS_MEM_2 15141 CONFIG.C_TWPH_PS_MEM_0 12201 CONFIG.C_TWPH_PS_MEM_1 11007 CONFIG.C_TWPH_PS_MEM_2 11874 CONFIG.C_TWP_PS_MEM_0 10812 CONFIG.C_TWP_PS_MEM_1 12305 CONFIG.C_TWP_PS_MEM_2 11704 CONFIG.C_WR_REC_TIME_MEM_0 27478 CONFIG.C_WR_REC_TIME_MEM_1 25783 CONFIG.C_WR_REC_TIME_MEM_2 27104 " [get_bd_cells ip_8_emc/emc_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 32 " [get_bd_cells ip_20_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_23_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_23_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_3] [get_bd_pins ip_5_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_11_intc/irq_4] [get_bd_pins ip_7_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_12_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_12_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_emc/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_14_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_0]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_5] [get_bd_pins ip_6_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_6_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_1] [get_bd_pins ip_6_dft/DATA_VALID]
