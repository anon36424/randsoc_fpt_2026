...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 42 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 44 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xc CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 62 CONFIG.C_SDA_INERTIAL_DELAY 86 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 288.3575498729974 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 6 CONFIG.C_GPIO_WIDTH 20 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 18 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 32 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x35 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 200 CONFIG.C_SDA_INERTIAL_DELAY 220 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 107.37505830485385 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 56 CONFIG.aresetn 1 CONFIG.bportwidth 50 CONFIG.btuserwidth 152 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 44 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 83 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 31 -to 0 ip_21_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 32 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 32 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_2] [get_bd_pins ip_7_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_iic/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_gpio/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_iic/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S3]
