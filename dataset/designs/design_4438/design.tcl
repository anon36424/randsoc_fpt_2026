...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 39 CONFIG.aresetn 1 CONFIG.atuserwidth 250 CONFIG.bportwidth 36 CONFIG.btuserwidth 231 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 6 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 25 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_18_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_7_intc/irq_0] [get_bd_pins ip_4_axi_timer/interrupt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_jtag_axi/M_AXI] [get_bd_intf_pins ip_9_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_timer/S_AXI] [get_bd_intf_pins ip_9_axi/AXI_S0]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_3_floating_point/aclken]
