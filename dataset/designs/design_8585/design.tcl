...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 426 CONFIG.convolution_code1 47 CONFIG.convolution_code2 327 CONFIG.convolution_code3 467 CONFIG.convolution_code4 432 CONFIG.convolution_code5 388 CONFIG.convolution_code6 350 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 12 CONFIG.puncture_code0 11111111 CONFIG.puncture_code1 10010011 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_2_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MASK 0x2002db032543630 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x779b965beaea57a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 71 CONFIG.convolution_code1 251 CONFIG.convolution_code2 59 CONFIG.convolution_code3 240 CONFIG.convolution_code4 9 CONFIG.convolution_code5 221 CONFIG.convolution_code6 70 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 12 CONFIG.output_rate 15 CONFIG.puncture_code0 011101101110 CONFIG.puncture_code1 000011111101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_5_conv_encoder/conv_encoder_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_11_axi/AXI_S4]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_1_axi_timer/pwm0]
