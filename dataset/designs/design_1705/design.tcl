...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xd CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 58 CONFIG.C_SDA_INERTIAL_DELAY 227 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 30.740047184130994 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 15 CONFIG.C_TAVDV_PS_MEM_0 15954 CONFIG.C_TAVDV_PS_MEM_1 15137 CONFIG.C_TCEDV_PS_MEM_0 14441 CONFIG.C_TCEDV_PS_MEM_1 16096 CONFIG.C_THZCE_PS_MEM_0 6626 CONFIG.C_THZCE_PS_MEM_1 6997 CONFIG.C_THZOE_PS_MEM_0 6654 CONFIG.C_THZOE_PS_MEM_1 7331 CONFIG.C_TLZWE_PS_MEM_0 7588 CONFIG.C_TLZWE_PS_MEM_1 1727 CONFIG.C_TWC_PS_MEM_0 14721 CONFIG.C_TWC_PS_MEM_1 15108 CONFIG.C_TWPH_PS_MEM_0 11273 CONFIG.C_TWPH_PS_MEM_1 10971 CONFIG.C_TWP_PS_MEM_0 12821 CONFIG.C_TWP_PS_MEM_1 12067 CONFIG.C_WR_REC_TIME_MEM_0 26464 CONFIG.C_WR_REC_TIME_MEM_1 29084 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x33698 CONFIG.C_DOUT_DEFAULT_2 0x8a56 CONFIG.C_GPIO2_WIDTH 10 CONFIG.C_GPIO_WIDTH 18 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x38bd1 CONFIG.C_TRI_DEFAULT_2 0x3ffff " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_9_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_emc/AXI] [get_bd_intf_pins ip_8_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_gpio/AXI] [get_bd_intf_pins ip_8_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_8_axi/AXI_S3]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_0] [get_bd_pins ip_0_dft/DATA_VALID]
