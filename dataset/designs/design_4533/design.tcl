...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6d CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 5 CONFIG.C_SDA_INERTIAL_DELAY 40 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 995.1035924375534 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 243 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 247 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 242 -to 0 ip_16_slice_and_concat/out0
...
create_bd_pin -dir I -from 246 -to 0 ip_16_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 239 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 247 " [get_bd_cells ip_16_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 246 CONFIG.DIN_TO 240 CONFIG.DIN_WIDTH 247 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_5] [get_bd_pins ip_6_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_12_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_12_axi/AXI_S4]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_3] [get_bd_pins ip_8_accumulator/Q]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_8_accumulator/Q]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/ADD]
