...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 8 CONFIG.convolution_code0 181 CONFIG.convolution_code1 234 CONFIG.convolution_code2 161 CONFIG.convolution_code3 79 CONFIG.convolution_code4 144 CONFIG.convolution_code5 99 CONFIG.convolution_code6 200 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 2 CONFIG.output_rate 3 CONFIG.puncture_code0 11 CONFIG.puncture_code1 10 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/capturetrig1]
