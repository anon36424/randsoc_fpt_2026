...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 4 CONFIG.convolution_code0 7 CONFIG.convolution_code1 6 CONFIG.convolution_code2 3 CONFIG.convolution_code3 13 CONFIG.convolution_code4 1 CONFIG.convolution_code5 10 CONFIG.convolution_code6 13 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 9 CONFIG.puncture_code0 00001101 CONFIG.puncture_code1 10011111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_8_axi_legacy/AXI_S3]
