...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3 CONFIG.C_DOUT_DEFAULT_2 0x7 CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 3 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x1 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 51 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_BAUDRATE 230400 CONFIG.C_DATA_BITS 6 CONFIG.PARITY Even " [get_bd_cells ip_5_uartlite/uart_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 17 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_6_dft/dft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 32 CONFIG.aresetn 0 CONFIG.bportwidth 35 CONFIG.btuserwidth 4 CONFIG.ctrltuserwidth 202 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 60 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 115 CONFIG.convolution_code1 358 CONFIG.convolution_code2 170 CONFIG.convolution_code3 317 CONFIG.convolution_code4 63 CONFIG.convolution_code5 447 CONFIG.convolution_code6 366 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 7 CONFIG.output_rate 8 CONFIG.puncture_code0 1100111 CONFIG.puncture_code1 1000011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_9_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 49 CONFIG.aresetn 1 CONFIG.bportwidth 11 CONFIG.ctrltuserwidth 215 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 54 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 256 CONFIG.C_SPI_MEMORY 4 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_11_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 36 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_12_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 48 CONFIG.Iterations 19 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 9 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 32 CONFIG.Round_Mode Truncate " [get_bd_cells ip_15_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 16384 " [get_bd_cells ip_17_fft/fft_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 5 " [get_bd_cells ip_33_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 36 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_36_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 8 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_37_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_46_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_49_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_51_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_51_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_52_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_8] [get_bd_pins ip_17_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_cdma/M_AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axi_dma/M_AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_M4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_39_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_27_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_68_slice_and_concat/out0] [get_bd_pins ip_14_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_14_accumulator/SCLR]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_17_fft/S_AXIS_CONFIG declared=42 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_fft/S_AXIS_CONFIG declared=42 actual=ERR $__err" }
if {[catch {
