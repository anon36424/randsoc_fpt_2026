...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 93 CONFIG.Latency 16 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 114 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 113 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x40 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 201 CONFIG.C_SDA_INERTIAL_DELAY 137 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 944.0382426734108 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x49 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 109 CONFIG.C_SDA_INERTIAL_DELAY 131 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 827.5915588805193 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
create_bd_pin -dir O -from 92 -to 0 ip_10_slice_and_concat/out0
create_bd_pin -dir I -from 113 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 114 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 22 -to 0 ip_11_slice_and_concat/out0
...
create_bd_pin -dir I -from 113 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 113 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 114 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_iic/AXI] [get_bd_intf_pins ip_9_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_9_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/out0] [get_bd_pins ip_3_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_0] [get_bd_pins ip_5_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig0]
