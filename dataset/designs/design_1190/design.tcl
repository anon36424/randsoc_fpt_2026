...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 47 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 195 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 9 CONFIG.aresetn 1 CONFIG.bportwidth 18 CONFIG.ctrltuserwidth 42 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 16 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x76895d CONFIG.C_GPIO2_WIDTH 12 CONFIG.C_GPIO_WIDTH 23 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_MI 3 " [get_bd_cells ip_8_axis_broadcaster/axis_broadcaster_0]
...
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ip_8_axis_broadcaster/M_AXIS_2
connect_bd_intf_net [get_bd_intf_pins ip_8_axis_broadcaster/M_AXIS_2] [get_bd_intf_pins ip_8_axis_broadcaster/axis_broadcaster_0/M02_AXIS]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_10_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 147 -to 0 ip_13_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 127 CONFIG.DIN_TO 124 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 131 CONFIG.DIN_TO 128 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 135 CONFIG.DIN_TO 132 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 136 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 143 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 147 CONFIG.DIN_TO 144 CONFIG.DIN_WIDTH 148 " [get_bd_cells ip_13_reduce/slice_31]
...
create_bd_pin -dir O -from 147 -to 0 ip_14_slice_and_concat/out0
create_bd_pin -dir I -from 194 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 147 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 195 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 194 -to 0 ip_15_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 194 CONFIG.DIN_TO 148 CONFIG.DIN_WIDTH 195 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_6_intc/irq_1] [get_bd_pins ip_3_gpio/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_7_axi/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_9_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_8_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_12_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/CE]
...
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_8_axis_broadcaster/axis_broadcaster_0/M02_AXIS]] * 8}]
  set __s [expr {$__aw == 8 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_8_axis_broadcaster/M_AXIS_2 declared=8 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_8_axis_broadcaster/M_AXIS_2 declared=8 actual=ERR $__err" }
if {[catch {
