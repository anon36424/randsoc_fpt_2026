...
set_property -dict "CONFIG.C_MASK 0xeecff9d9cd956c3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe84e99a2192e885 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0x7650d2841f69381 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x48ed311d028d422 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 1 CONFIG.NUM_SI 2 " [get_bd_cells ip_5_axi_legacy/axi_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_6_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_5] [get_bd_pins ip_6_slice_and_concat/concat/In5]
...
set_property -dict "CONFIG.NUM_PORTS 6 " [get_bd_cells ip_7_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_7_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_4] [get_bd_pins ip_7_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 0 -to 0 ip_7_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_5] [get_bd_pins ip_7_slice_and_concat/concat/In5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_microblaze/M_AXI_DP] [get_bd_intf_pins ip_5_axi_legacy/AXI_M1]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_4] [get_bd_pins ip_1_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_4] [get_bd_pins ip_1_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/alarm_out]
