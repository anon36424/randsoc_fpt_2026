...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 512 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 63 CONFIG.aresetn 0 CONFIG.bportwidth 25 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 36 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 6 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_15_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_16_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_5_reset/peripheral_areset_n] [get_bd_pins ip_3_xadc_wiz/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_6_clk_wiz/clk_out] [get_bd_pins ip_3_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_7_intc/irq_2] [get_bd_pins ip_3_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_3_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_6] [get_bd_pins ip_3_xadc_wiz/busy_out]
