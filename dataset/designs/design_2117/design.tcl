...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xd CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 128 CONFIG.C_SDA_INERTIAL_DELAY 145 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 54.7039314716287 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_5] [get_bd_pins ip_10_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_floating_point/S_AXIS_OPERATION] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_1_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_4_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_4_xadc_wiz/convst_in]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_8_floating_point/aclken]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/user_temp_alarm_out]
