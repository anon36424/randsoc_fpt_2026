...
set_property -dict "CONFIG.C_ADDR_WIDTH 50 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_6_dft/dft_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_SPI_MEMORY 2 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_7_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.add_sub_value Subtract CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_overflow 0 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage Medium_Usage CONFIG.c_tuser_width 8 CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 1 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type FMA CONFIG.result_tlast_behv Pass_B_TLAST " [get_bd_cells ip_10_floating_point/floating_point_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 33 CONFIG.aresetn 1 CONFIG.atuserwidth 170 CONFIG.bportwidth 43 CONFIG.ctrltuserwidth 241 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 8 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 41 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_11_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 33 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 47 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 32 -to 0 ip_13_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x8d7d487e118a65f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xf8e8134c9fd0eb9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0x22791388401650c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x61fe7d3243ae867 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 32 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 33 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_16_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 32 -to 0 ip_16_accumulator/Q
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_38_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_39_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_5] [get_bd_pins ip_39_slice_and_concat/concat/In5]
create_bd_pin -dir I -from 9 -to 0 ip_39_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_39_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_39_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 46 -to 0 ip_41_slice_and_concat/in_12
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_12
move_bd_cells [get_bd_cells ip_41_slice_and_concat] [get_bd_cells slice_12]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_41_slice_and_concat/slice_12]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_12] [get_bd_pins ip_41_slice_and_concat/slice_12/din]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/slice_12/dout] [get_bd_pins ip_41_slice_and_concat/concat/In12]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 32 -to 0 ip_44_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_44_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_44_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_reset/peripheral_areset_n] [get_bd_pins ip_4_axi_quad_spi/reset]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_4_axi_quad_spi/clk]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_1] [get_bd_pins ip_3_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_19_intc/irq_2] [get_bd_pins ip_4_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_19_intc/irq_3] [get_bd_pins ip_5_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_19_intc/irq_4] [get_bd_pins ip_7_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_19_intc/irq_5] [get_bd_pins ip_8_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_19_intc/irq_6] [get_bd_pins ip_12_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_4] [get_bd_pins ip_7_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_21_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_21_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_microblaze/M_AXI_DP] [get_bd_intf_pins ip_21_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_21_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_21_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_21_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_25_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_floating_point/S_AXIS_B] [get_bd_intf_pins ip_32_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_33_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_35_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_23_axis_broadcaster/M_AXIS_3]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_4] [get_bd_pins ip_6_dft/RFFD]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_5] [get_bd_pins ip_6_dft/XK_RE]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_6] [get_bd_pins ip_6_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_0] [get_bd_pins ip_6_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_1] [get_bd_pins ip_6_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_2] [get_bd_pins ip_6_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_6] [get_bd_pins ip_9_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_7] [get_bd_pins ip_9_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_8] [get_bd_pins ip_9_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_9] [get_bd_pins ip_9_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_10] [get_bd_pins ip_9_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_11] [get_bd_pins ip_9_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_12] [get_bd_pins ip_13_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/ot_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_broadcaster/M_AXIS_4 declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_broadcaster/M_AXIS_4 declared=32 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 192 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/S_AXIS_1 declared=192 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/S_AXIS_1 declared=192 actual=ERR $__err" }
if {[catch {
