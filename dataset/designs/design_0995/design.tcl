...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 19 CONFIG.aresetn 1 CONFIG.atuserwidth 18 CONFIG.bportwidth 18 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 17 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 23 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 9 CONFIG.C_TAVDV_PS_MEM_0 15803 CONFIG.C_TAVDV_PS_MEM_1 15069 CONFIG.C_TCEDV_PS_MEM_0 16495 CONFIG.C_TCEDV_PS_MEM_1 15985 CONFIG.C_THZCE_PS_MEM_0 6549 CONFIG.C_THZCE_PS_MEM_1 7025 CONFIG.C_THZOE_PS_MEM_0 7606 CONFIG.C_THZOE_PS_MEM_1 7489 CONFIG.C_TLZWE_PS_MEM_0 2975 CONFIG.C_TLZWE_PS_MEM_1 3088 CONFIG.C_TWC_PS_MEM_0 14605 CONFIG.C_TWC_PS_MEM_1 16049 CONFIG.C_TWPH_PS_MEM_0 12800 CONFIG.C_TWPH_PS_MEM_1 10835 CONFIG.C_TWP_PS_MEM_0 11235 CONFIG.C_TWP_PS_MEM_1 11167 CONFIG.C_WR_REC_TIME_MEM_0 28415 CONFIG.C_WR_REC_TIME_MEM_1 29036 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 64 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x27a71d91edeba15 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6faddb61fc95ad CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0x7546bc5ebaedf6c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xb8c18fb766dcc89 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 5 CONFIG.NUM_SI 5 " [get_bd_cells ip_14_axi_legacy/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_27_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_28_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_32_slice_and_concat/slice_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_14_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_14_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_14_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_microblaze/M_AXI_DP] [get_bd_intf_pins ip_14_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_microblaze/M_AXI_DP] [get_bd_intf_pins ip_14_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_2]
