...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 51 CONFIG.aresetn 1 CONFIG.atuserwidth 27 CONFIG.bportwidth 18 CONFIG.btuserwidth 67 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 5 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 48 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 2 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 14388 CONFIG.C_TAVDV_PS_MEM_1 16268 CONFIG.C_TCEDV_PS_MEM_0 15949 CONFIG.C_TCEDV_PS_MEM_1 16325 CONFIG.C_THZCE_PS_MEM_0 7280 CONFIG.C_THZCE_PS_MEM_1 6974 CONFIG.C_THZOE_PS_MEM_0 6436 CONFIG.C_THZOE_PS_MEM_1 6384 CONFIG.C_TLZWE_PS_MEM_0 7159 CONFIG.C_TLZWE_PS_MEM_1 8418 CONFIG.C_TWC_PS_MEM_0 14428 CONFIG.C_TWC_PS_MEM_1 14508 CONFIG.C_TWPH_PS_MEM_0 11934 CONFIG.C_TWPH_PS_MEM_1 13185 CONFIG.C_TWP_PS_MEM_0 11381 CONFIG.C_TWP_PS_MEM_1 10904 CONFIG.C_WR_REC_TIME_MEM_0 24966 CONFIG.C_WR_REC_TIME_MEM_1 25110 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 232 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 255 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 254 -to 0 ip_17_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 228 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_17_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 25 -to 0 ip_18_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 254 CONFIG.DIN_TO 229 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_1] [get_bd_pins ip_4_fft/event_frame_started]
