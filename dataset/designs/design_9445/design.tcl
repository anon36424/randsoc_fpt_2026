...
set_property -dict "CONFIG.C_MASK 0x21c4a00032be4c9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xd4e47c3e0702950 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir O -from 39 -to 0 ip_20_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_22_slice_and_concat/slice_0]
