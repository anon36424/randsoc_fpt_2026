...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 7 CONFIG.convolution_code0 54 CONFIG.convolution_code1 125 CONFIG.convolution_code2 108 CONFIG.convolution_code3 33 CONFIG.convolution_code4 41 CONFIG.convolution_code5 65 CONFIG.convolution_code6 109 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 7 CONFIG.output_rate 13 CONFIG.puncture_code0 1111111 CONFIG.puncture_code1 1111101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MASK 0xaa2fe8ef989fae1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xc1908407e11f116 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_0_conv_encoder/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/vbram_alarm_out]
