...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 213 CONFIG.C_SDA_INERTIAL_DELAY 246 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 608.3381224476263 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x4f CONFIG.C_GPIO2_WIDTH 10 CONFIG.C_GPIO_WIDTH 8 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 8192 " [get_bd_cells ip_4_fft/fft_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_2] [get_bd_pins ip_3_gpio/irq]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_7] [get_bd_pins ip_8_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_12_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_12_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_iic/AXI] [get_bd_intf_pins ip_12_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_12_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_1_floating_point/M_AXIS_RESULT]
