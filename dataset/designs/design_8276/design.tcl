...
set_property -dict "CONFIG.C_DUPLEX 0 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_0_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x1fffffff CONFIG.C_GPIO_WIDTH 29 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 445 CONFIG.convolution_code1 343 CONFIG.convolution_code2 365 CONFIG.convolution_code3 97 CONFIG.convolution_code4 0 CONFIG.convolution_code5 269 CONFIG.convolution_code6 191 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 2 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_2_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SPI_MEMORY 4 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_3_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_MASK 0xdf2d7c2bb1fabe5 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xc0fc67456c8dd61 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 16 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_5_dft/dft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 204 CONFIG.convolution_code1 119 CONFIG.convolution_code2 228 CONFIG.convolution_code3 156 CONFIG.convolution_code4 141 CONFIG.convolution_code5 174 CONFIG.convolution_code6 16 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 2 CONFIG.output_rate 3 CONFIG.puncture_code0 11 CONFIG.puncture_code1 01 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_8_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_BAUDRATE 19200 CONFIG.C_DATA_BITS 8 CONFIG.PARITY No_Parity " [get_bd_cells ip_9_uartlite/uart_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 159 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 203 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 CONFIG.Scale 1 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 158 -to 0 ip_10_accumulator/B
connect_bd_net [get_bd_pins ip_10_accumulator/B] [get_bd_pins ip_10_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 202 -to 0 ip_10_accumulator/Q
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_11_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 27 CONFIG.aresetn 0 CONFIG.atuserwidth 184 CONFIG.bportwidth 44 CONFIG.btuserwidth 61 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 42 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 57 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3f CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 1 CONFIG.C_SDA_INERTIAL_DELAY 5 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 180.42746354967383 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xa19c20c9aa661da CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x3f6fd8bb1eb12f1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_15_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_17_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 307 CONFIG.convolution_code1 435 CONFIG.convolution_code2 277 CONFIG.convolution_code3 122 CONFIG.convolution_code4 395 CONFIG.convolution_code5 432 CONFIG.convolution_code6 198 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 7 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_18_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16384 " [get_bd_cells ip_19_fft/fft_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_20_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 49 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_21_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options pipelined_streaming_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 128 " [get_bd_cells ip_22_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x1b1b3e86f52302 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_23_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x463a2ecd9f75588 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_23_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.AINIT_Value 9af33e08011ffea883ac2714d174447c784c843eec64921c182b29d99e72f4 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 182 CONFIG.Latency 30 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 253 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_24_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 181 -to 0 ip_24_accumulator/B
connect_bd_net [get_bd_pins ip_24_accumulator/B] [get_bd_pins ip_24_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 252 -to 0 ip_24_accumulator/Q
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 5 CONFIG.C_TAVDV_PS_MEM_0 15456 CONFIG.C_TAVDV_PS_MEM_1 16169 CONFIG.C_TCEDV_PS_MEM_0 14305 CONFIG.C_TCEDV_PS_MEM_1 16369 CONFIG.C_THZCE_PS_MEM_0 6794 CONFIG.C_THZCE_PS_MEM_1 7484 CONFIG.C_THZOE_PS_MEM_0 7438 CONFIG.C_THZOE_PS_MEM_1 6345 CONFIG.C_TLZWE_PS_MEM_0 2640 CONFIG.C_TLZWE_PS_MEM_1 1059 CONFIG.C_TWC_PS_MEM_0 16145 CONFIG.C_TWC_PS_MEM_1 13977 CONFIG.C_TWPH_PS_MEM_0 11480 CONFIG.C_TWPH_PS_MEM_1 12505 CONFIG.C_TWP_PS_MEM_0 12682 CONFIG.C_TWP_PS_MEM_1 11307 CONFIG.C_WR_REC_TIME_MEM_0 28473 CONFIG.C_WR_REC_TIME_MEM_1 26066 " [get_bd_cells ip_25_emc/emc_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_45_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 117 -to 0 ip_52_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 102 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 105 CONFIG.DIN_TO 103 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 108 CONFIG.DIN_TO 106 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 109 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 118 " [get_bd_cells ip_52_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_53_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_54_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 202 -to 0 ip_54_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_54_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 135 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_54_slice_and_concat/slice_5]
...
create_bd_pin -dir O -from 181 -to 0 ip_55_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 202 -to 0 ip_55_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_55_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 202 CONFIG.DIN_TO 136 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_55_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 252 -to 0 ip_55_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_55_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_55_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 117 -to 0 ip_56_slice_and_concat/out0
create_bd_pin -dir I -from 252 -to 0 ip_56_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_56_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 229 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_56_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 252 -to 0 ip_57_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_57_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 230 CONFIG.DIN_TO 230 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_57_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 246 CONFIG.DIN_TO 231 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_58_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 252 CONFIG.DIN_TO 247 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_59_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_26_reset/peripheral_areset_n] [get_bd_pins ip_0_axi_ethernet_lite/reset]
...
connect_bd_net [get_bd_pins ip_26_reset/peripheral_areset_n] [get_bd_pins ip_7_axi_quad_spi/reset4]
...
connect_bd_net [get_bd_pins ip_26_reset/mb_reset] [get_bd_pins ip_23_microblaze/Reset]
connect_bd_net [get_bd_pins ip_26_reset/peripheral_areset_n] [get_bd_pins ip_25_emc/rst]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_0_axi_ethernet_lite/clk]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_5_dft/CLK]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_7_axi_quad_spi/clk4]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_21_axi_cdma/m_axi_aclk]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_21_axi_cdma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_22_fft/aclk]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_23_microblaze/Clk]
...
connect_bd_net [get_bd_pins ip_28_intc/irq_0] [get_bd_pins ip_0_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_1] [get_bd_pins ip_1_gpio/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_2] [get_bd_pins ip_3_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_3] [get_bd_pins ip_6_uartlite/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_4] [get_bd_pins ip_7_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_5] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_6] [get_bd_pins ip_11_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_7] [get_bd_pins ip_13_axi_iic/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_8] [get_bd_pins ip_15_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_28_intc/irq_9] [get_bd_pins ip_16_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_28_intc/irq_10] [get_bd_pins ip_19_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_28_intc/irq_11] [get_bd_pins ip_20_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_28_intc/irq_12] [get_bd_pins ip_21_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_28_intc/irq_13] [get_bd_pins ip_22_fft/event_frame_started]
...
connect_bd_net [get_bd_pins ip_29_intc/irq_1] [get_bd_pins ip_1_gpio/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_2] [get_bd_pins ip_3_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_3] [get_bd_pins ip_6_uartlite/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_4] [get_bd_pins ip_7_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_5] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_6] [get_bd_pins ip_11_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_7] [get_bd_pins ip_13_axi_iic/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_8] [get_bd_pins ip_15_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_29_intc/irq_9] [get_bd_pins ip_16_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_29_intc/irq_10] [get_bd_pins ip_19_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_29_intc/irq_11] [get_bd_pins ip_20_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_29_intc/irq_12] [get_bd_pins ip_21_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_29_intc/irq_13] [get_bd_pins ip_22_fft/event_frame_started]
...
connect_bd_net [get_bd_pins ip_30_intc/irq_1] [get_bd_pins ip_1_gpio/irq]
...
connect_bd_net [get_bd_pins ip_30_intc/irq_6] [get_bd_pins ip_11_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_7] [get_bd_pins ip_13_axi_iic/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_8] [get_bd_pins ip_15_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_30_intc/irq_9] [get_bd_pins ip_16_axi_timer/interrupt]
...
connect_bd_net [get_bd_pins ip_30_intc/irq_13] [get_bd_pins ip_22_fft/event_frame_started]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_microblaze/INTERRUPT] [get_bd_intf_pins ip_30_intc/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_microblaze/M_AXI_DP] [get_bd_intf_pins ip_31_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_cdma/M_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_microblaze/M_AXI_DP] [get_bd_intf_pins ip_31_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_32_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_uartlite/AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_32_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_iic/AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_32_axi_legacy/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_timer/S_AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_gpio/AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S11]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_intc/AXI] [get_bd_intf_pins ip_32_axi_legacy/AXI_S14]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_36_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_37_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_40_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_45_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_fft/S_AXIS_DATA] [get_bd_intf_pins ip_48_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_fft/S_AXIS_DATA] [get_bd_intf_pins ip_40_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_36_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_37_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_fft/S_AXIS_DATA] [get_bd_intf_pins ip_49_axis_combiner/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_50_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_39_axis_broadcaster/M_AXIS_3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_51_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_5_dft/XN_IM]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_0] [get_bd_pins ip_5_dft/RFFD]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_1] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/B]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_0] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_1] [get_bd_pins ip_5_dft/XK_IM]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_2] [get_bd_pins ip_5_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_3] [get_bd_pins ip_5_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_4] [get_bd_pins ip_5_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_5] [get_bd_pins ip_10_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_1] [get_bd_pins ip_16_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_2] [get_bd_pins ip_16_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_3] [get_bd_pins ip_16_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_4] [get_bd_pins ip_24_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_5_dft/XN_RE]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/in_0] [get_bd_pins ip_24_accumulator/Q]
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_5_dft/SIZE]
connect_bd_net [get_bd_pins ip_59_slice_and_concat/in_0] [get_bd_pins ip_24_accumulator/Q]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/ADD]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/out0] [get_bd_pins ip_16_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_8_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_63_slice_and_concat/out0] [get_bd_pins ip_2_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_26_reset/interconnect_aresetn] [get_bd_pins ip_40_axis_broadcaster/aresetn]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_40_axis_broadcaster/aclk]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_DATA declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_DATA declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_19_fft/fft_0/M_AXIS_DATA]] * 8}]
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_fft/M_AXIS_DATA declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_fft/M_AXIS_DATA declared=160 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_CONFIG declared=33 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_CONFIG declared=33 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_20_fft/S_AXIS_CONFIG declared=25 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_fft/S_AXIS_CONFIG declared=25 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 25 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_44_axis_dwidth_converter/M_AXIS declared=25 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_44_axis_dwidth_converter/M_AXIS declared=25 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 14 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_45_axis_dwidth_converter/M_AXIS declared=14 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_45_axis_dwidth_converter/M_AXIS declared=14 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_48_axis_combiner/M_AXIS declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_48_axis_combiner/M_AXIS declared=160 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 8 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_49_axis_combiner/S_AXIS_3 declared=8 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_49_axis_combiner/S_AXIS_3 declared=8 actual=ERR $__err" }
if {[catch {
