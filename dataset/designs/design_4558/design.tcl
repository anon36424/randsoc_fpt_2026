...
set_property -dict "CONFIG.AINIT_Value 166719205707b0de75785df027215ca3cb63faf64322b253e6b542671 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 143 CONFIG.Latency 28 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 227 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 226 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 8192 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0xf35a1f27aeaf5fd CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x9e566d4e87bddc8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 12 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_4_dft/dft_0]
...
create_bd_pin -dir I -from 22 -to 0 ip_7_accumulator/B
connect_bd_net [get_bd_pins ip_7_accumulator/B] [get_bd_pins ip_7_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 24 -to 0 ip_7_accumulator/Q
...
set_property -dict "CONFIG.C_MASK 0x687325a568760f1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x15992b18ce85d7c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 14 CONFIG.aresetn 1 CONFIG.bportwidth 10 CONFIG.ctrltuserwidth 255 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 17 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_15_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0x407f9f799760009 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_16_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x38573cca3c8cea8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_16_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 17 CONFIG.aresetn 1 CONFIG.bportwidth 45 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 10 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_17_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_30_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 89 -to 0 ip_38_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 82 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 90 " [get_bd_cells ip_38_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 136 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 142 CONFIG.DIN_TO 137 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 142 -to 0 ip_44_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 226 CONFIG.DIN_TO 143 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 24 -to 0 ip_44_slice_and_concat/in_7
...
connect_bd_net [get_bd_pins ip_20_clk_wiz/clk_out] [get_bd_pins ip_8_axi_dma/m_axi_s2mm_aclk]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_3] [get_bd_pins ip_8_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_4] [get_bd_pins ip_8_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_5] [get_bd_pins ip_9_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_8] [get_bd_pins ip_13_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI] [get_bd_intf_pins ip_24_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_microblaze/M_AXI_DP] [get_bd_intf_pins ip_24_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_24_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_24_axi_legacy/AXI_M5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_24_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_24_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_24_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_24_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_24_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_uartlite/AXI] [get_bd_intf_pins ip_24_axi_legacy/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_DATA] [get_bd_intf_pins ip_5_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_3] [get_bd_pins ip_4_dft/XK_IM]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_4] [get_bd_pins ip_4_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_5] [get_bd_pins ip_4_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_6] [get_bd_pins ip_4_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_7] [get_bd_pins ip_7_accumulator/Q]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_8] [get_bd_pins ip_12_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_9] [get_bd_pins ip_12_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_10] [get_bd_pins ip_12_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_17_complex_multiplier/aclken]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/Bypass]
