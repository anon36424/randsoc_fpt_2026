...
set_property -dict "CONFIG.C_MASK 0x4f406b4ed978d09 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x88f6371100efc46 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BAUDRATE 57600 CONFIG.C_DATA_BITS 5 CONFIG.PARITY No_Parity " [get_bd_cells ip_2_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x66 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 101 CONFIG.C_SDA_INERTIAL_DELAY 203 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 312.0908028320302 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xdaf3e21290b08f0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xcf91f4fb1cb98c7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 10 CONFIG.aresetn 1 CONFIG.atuserwidth 38 CONFIG.bportwidth 55 CONFIG.btuserwidth 48 CONFIG.ctrltuserwidth 163 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 32 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 58 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8192 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.AINIT_Value 2dbb3416def808f2868f06e533c1fdd1d997 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 109 CONFIG.Latency 3 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 144 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_12_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 108 -to 0 ip_12_accumulator/B
connect_bd_net [get_bd_pins ip_12_accumulator/B] [get_bd_pins ip_12_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 143 -to 0 ip_12_accumulator/Q
...
set_property -dict "CONFIG.NUM_MI 9 CONFIG.NUM_SI 6 " [get_bd_cells ip_18_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 28 " [get_bd_cells ip_24_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir O -from 40 -to 0 ip_30_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 143 -to 0 ip_30_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 144 " [get_bd_cells ip_30_slice_and_concat/slice_6]
...
create_bd_pin -dir O -from 108 -to 0 ip_31_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 143 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 144 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_reset/interconnect_aresetn] [get_bd_pins ip_7_complex_multiplier/aresetn]
...
connect_bd_net [get_bd_pins ip_15_clk_wiz/clk_out] [get_bd_pins ip_9_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_1] [get_bd_pins ip_3_axi_iic/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_2] [get_bd_pins ip_4_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_3] [get_bd_pins ip_5_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_3] [get_bd_pins ip_5_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_18_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_18_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_microblaze/M_AXI_DP] [get_bd_intf_pins ip_18_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_18_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_18_axi/AXI_M5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_uartlite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_iic/AXI] [get_bd_intf_pins ip_18_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_18_axi/AXI_S6]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_9_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_9_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_3] [get_bd_pins ip_9_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_4] [get_bd_pins ip_9_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_5] [get_bd_pins ip_9_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_6] [get_bd_pins ip_12_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_11_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/ot_out]
