...
########## slice_and_concat ##########
create_bd_cell -type hier ip_4_slice_and_concat
create_bd_pin -dir O -from 17 -to 0 ip_4_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_4_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 2 " [get_bd_cells ip_4_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/out0] [get_bd_pins ip_4_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 0 -to 0 ip_4_slice_and_concat/in_0
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_0] [get_bd_pins ip_4_slice_and_concat/concat/In0]
create_bd_pin -dir I -from 17 -to 0 ip_4_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_4_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_4_slice_and_concat/slice_1]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_1] [get_bd_pins ip_4_slice_and_concat/slice_1/din]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/slice_1/dout] [get_bd_pins ip_4_slice_and_concat/concat/In1]


########## slice_and_concat ##########
create_bd_cell -type hier ip_5_slice_and_concat
create_bd_pin -dir O -from 17 -to 0 ip_5_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 17 -to 0 ip_5_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_5_slice_and_concat/slice_0]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_0] [get_bd_pins ip_5_slice_and_concat/slice_0/din]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/slice_0/dout] [get_bd_pins ip_5_slice_and_concat/concat/In0]
create_bd_pin -dir I -from 17 -to 0 ip_5_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_5_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 17 -to 0 ip_6_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 6 " [get_bd_cells ip_6_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/out0] [get_bd_pins ip_6_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 17 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 3 -to 0 ip_6_slice_and_concat/in_1
...
create_bd_pin -dir I -from 0 -to 0 ip_6_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_4] [get_bd_pins ip_6_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 17 -to 0 ip_6_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_6_slice_and_concat/slice_5]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_5] [get_bd_pins ip_6_slice_and_concat/slice_5/din]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/slice_5/dout] [get_bd_pins ip_6_slice_and_concat/concat/In5]


########## slice_and_concat ##########
create_bd_cell -type hier ip_7_slice_and_concat
create_bd_pin -dir O -from 1 -to 0 ip_7_slice_and_concat/out0
create_bd_pin -dir I -from 17 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_8_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 17 -to 0 ip_9_slice_and_concat/out0
create_bd_pin -dir I -from 17 -to 0 ip_9_slice_and_concat/in_0
...
connect_bd_net [get_bd_pins ip_2_reset/peripheral_areset] [get_bd_pins ip_0_dft/SCLR]
connect_bd_net [get_bd_pins ip_3_clk_wiz/clk_out] [get_bd_pins ip_0_dft/CLK]
...
connect_bd_net [get_bd_pins ip_4_slice_and_concat/out0] [get_bd_pins ip_1_dft/XN_RE]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_0] [get_bd_pins ip_0_dft/RFFD]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_1] [get_bd_pins ip_0_dft/XK_RE]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_IM]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_RE]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_1] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_RE]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_1] [get_bd_pins ip_0_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_2] [get_bd_pins ip_0_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_3] [get_bd_pins ip_0_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_4] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_5] [get_bd_pins ip_1_dft/XK_RE]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_0] [get_bd_pins ip_1_dft/XK_RE]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_0_dft/SIZE]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_1_dft/XK_RE]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_1_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_1_dft/SIZE]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_1] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_2] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/out0] [get_bd_pins ip_1_dft/FD_IN]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/out0] [get_bd_pins ip_1_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_0_dft/FD_IN]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_0_dft/CE]
