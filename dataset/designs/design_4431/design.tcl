...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 221 CONFIG.C_SDA_INERTIAL_DELAY 154 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 840.721181574699 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 64 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_SYNCH_PIPEDELAY_1 2 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 16400 CONFIG.C_TCEDV_PS_MEM_0 16004 CONFIG.C_THZCE_PS_MEM_0 7017 CONFIG.C_THZOE_PS_MEM_0 6580 CONFIG.C_TLZWE_PS_MEM_0 9220 CONFIG.C_TWC_PS_MEM_0 16163 CONFIG.C_TWPH_PS_MEM_0 13156 CONFIG.C_TWP_PS_MEM_0 12005 CONFIG.C_WR_REC_TIME_MEM_0 28906 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_4_dft/dft_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x44d7ebc662d630e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x66f07d8877c5363 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x43 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 72 CONFIG.C_SDA_INERTIAL_DELAY 94 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 930.7281290580293 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_10_axi_cdma/axi_cdma_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_22_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_22_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_23_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_24_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_25_slice_and_concat/in_4
...
create_bd_pin -dir I -from 37 -to 0 ip_27_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_27_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_8] [get_bd_pins ip_12_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_emc/AXI] [get_bd_intf_pins ip_18_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_5_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_DATA] [get_bd_intf_pins ip_19_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_3] [get_bd_pins ip_3_dft/RFFD]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_4] [get_bd_pins ip_3_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_3_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_1] [get_bd_pins ip_3_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_2] [get_bd_pins ip_3_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_4_dft/XK_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_6] [get_bd_pins ip_4_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_7] [get_bd_pins ip_4_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_8] [get_bd_pins ip_4_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_4_dft/SIZE]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_12_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_1] [get_bd_pins ip_12_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_2] [get_bd_pins ip_12_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_3] [get_bd_pins ip_12_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_3_dft/XN_IM]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_12_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_1] [get_bd_pins ip_13_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_3_dft/CE]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_12_xadc_wiz/convst_in]
