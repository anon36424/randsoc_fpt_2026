...
set_property -dict "CONFIG.C_MASK 0x35fcad990da5f52 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x13b4b6cfa5d89a9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 128 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 151 CONFIG.SCLR 0 CONFIG.SINIT 1 CONFIG.SINIT_Value 0 CONFIG.SSET 0 CONFIG.Scale 2 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 127 -to 0 ip_2_accumulator/B
connect_bd_net [get_bd_pins ip_2_accumulator/B] [get_bd_pins ip_2_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 150 -to 0 ip_2_accumulator/Q
...
create_bd_pin -dir I -from 0 -to 0 ip_2_accumulator/SINIT
connect_bd_net [get_bd_pins ip_2_accumulator/SINIT] [get_bd_pins ip_2_accumulator/accumulator_0/SINIT]
...
set_property -dict "CONFIG.C_MASK 0x8e1387b939e7cf7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x5443b5db645fdfc CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 6 CONFIG.C_TAVDV_PS_MEM_0 14664 CONFIG.C_TAVDV_PS_MEM_1 15380 CONFIG.C_TCEDV_PS_MEM_0 14026 CONFIG.C_TCEDV_PS_MEM_1 14324 CONFIG.C_THZCE_PS_MEM_0 6660 CONFIG.C_THZCE_PS_MEM_1 7666 CONFIG.C_THZOE_PS_MEM_0 7461 CONFIG.C_THZOE_PS_MEM_1 7599 CONFIG.C_TLZWE_PS_MEM_0 7052 CONFIG.C_TLZWE_PS_MEM_1 7007 CONFIG.C_TWC_PS_MEM_0 14481 CONFIG.C_TWC_PS_MEM_1 13757 CONFIG.C_TWPH_PS_MEM_0 11732 CONFIG.C_TWPH_PS_MEM_1 12982 CONFIG.C_TWP_PS_MEM_0 12529 CONFIG.C_TWP_PS_MEM_1 12745 CONFIG.C_WR_REC_TIME_MEM_0 28532 CONFIG.C_WR_REC_TIME_MEM_1 29360 " [get_bd_cells ip_10_emc/emc_0]
...
create_bd_pin -dir O -from 127 -to 0 ip_20_slice_and_concat/out0
create_bd_pin -dir I -from 150 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 127 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 151 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 150 -to 0 ip_21_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 150 CONFIG.DIN_TO 128 CONFIG.DIN_WIDTH 151 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 22 -to 0 ip_22_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_0] [get_bd_pins ip_6_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_0] [get_bd_pins ip_6_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_16_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_16_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_16_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_4] [get_bd_pins ip_11_dft/RFFD]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_11_dft/XN_RE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_11_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_11_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_1] [get_bd_pins ip_11_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_2] [get_bd_pins ip_11_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/SINIT]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_11_dft/FWD_INV]
