...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 11 CONFIG.C_TAVDV_PS_MEM_0 13632 CONFIG.C_TAVDV_PS_MEM_1 15191 CONFIG.C_TAVDV_PS_MEM_2 14977 CONFIG.C_TCEDV_PS_MEM_0 16116 CONFIG.C_TCEDV_PS_MEM_1 14006 CONFIG.C_TCEDV_PS_MEM_2 13534 CONFIG.C_THZCE_PS_MEM_0 7348 CONFIG.C_THZCE_PS_MEM_1 6421 CONFIG.C_THZCE_PS_MEM_2 7440 CONFIG.C_THZOE_PS_MEM_0 7145 CONFIG.C_THZOE_PS_MEM_1 6418 CONFIG.C_THZOE_PS_MEM_2 6421 CONFIG.C_TLZWE_PS_MEM_0 7954 CONFIG.C_TLZWE_PS_MEM_1 4621 CONFIG.C_TLZWE_PS_MEM_2 2025 CONFIG.C_TWC_PS_MEM_0 15098 CONFIG.C_TWC_PS_MEM_1 14649 CONFIG.C_TWC_PS_MEM_2 16285 CONFIG.C_TWPH_PS_MEM_0 12948 CONFIG.C_TWPH_PS_MEM_1 12023 CONFIG.C_TWPH_PS_MEM_2 11933 CONFIG.C_TWP_PS_MEM_0 11387 CONFIG.C_TWP_PS_MEM_1 10987 CONFIG.C_TWP_PS_MEM_2 12765 CONFIG.C_WR_REC_TIME_MEM_0 25118 CONFIG.C_WR_REC_TIME_MEM_1 27782 CONFIG.C_WR_REC_TIME_MEM_2 28052 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 37 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 32 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_14_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_4_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_1] [get_bd_pins ip_2_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_8_intc/irq_2] [get_bd_pins ip_3_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_9_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/S_AXIS_DATA] [get_bd_intf_pins ip_14_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_3] [get_bd_pins ip_5_dft/RFFD]
...
if {[catch {
  ...
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/S_AXIS declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/S_AXIS declared=256 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_10_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_0 declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_0 declared=256 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_10_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_1 declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_1 declared=256 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 23 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/M_AXIS declared=23 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/M_AXIS declared=23 actual=ERR $__err" }
if {[catch {
