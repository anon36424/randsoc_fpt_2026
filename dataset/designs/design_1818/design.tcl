...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x75 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 118 CONFIG.C_SDA_INERTIAL_DELAY 19 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 951.3932758907919 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_2_floating_point/aclken]
