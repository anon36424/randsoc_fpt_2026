...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_SHARED_STARTUP 0 " [get_bd_cells ip_0_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_BAUDRATE 9600 CONFIG.C_DATA_BITS 7 CONFIG.PARITY Odd " [get_bd_cells ip_5_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3 CONFIG.C_GPIO_WIDTH 2 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x3 " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_10_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 23 CONFIG.C_GPIO_WIDTH 16 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_13_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x25 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 76 CONFIG.C_SDA_INERTIAL_DELAY 176 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 150.13673192500633 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_17_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_18_reset/peripheral_areset] [get_bd_pins ip_15_xadc_wiz/reset_in]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_21_axi/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_gpio/AXI] [get_bd_intf_pins ip_21_axi/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_24_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_2_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_4] [get_bd_pins ip_15_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_5] [get_bd_pins ip_15_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_0_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_15_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_0] [get_bd_pins ip_15_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_15_xadc_wiz/vbram_alarm_out]
