...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 9 CONFIG.C_TAVDV_PS_MEM_0 15635 CONFIG.C_TAVDV_PS_MEM_1 13713 CONFIG.C_TAVDV_PS_MEM_2 15456 CONFIG.C_TCEDV_PS_MEM_0 16212 CONFIG.C_TCEDV_PS_MEM_1 13985 CONFIG.C_TCEDV_PS_MEM_2 16029 CONFIG.C_THZCE_PS_MEM_0 7208 CONFIG.C_THZCE_PS_MEM_1 7536 CONFIG.C_THZCE_PS_MEM_2 6919 CONFIG.C_THZOE_PS_MEM_0 6397 CONFIG.C_THZOE_PS_MEM_1 7176 CONFIG.C_THZOE_PS_MEM_2 7541 CONFIG.C_TLZWE_PS_MEM_0 7170 CONFIG.C_TLZWE_PS_MEM_1 2245 CONFIG.C_TLZWE_PS_MEM_2 3643 CONFIG.C_TWC_PS_MEM_0 14844 CONFIG.C_TWC_PS_MEM_1 14445 CONFIG.C_TWC_PS_MEM_2 15358 CONFIG.C_TWPH_PS_MEM_0 11291 CONFIG.C_TWPH_PS_MEM_1 11350 CONFIG.C_TWPH_PS_MEM_2 12267 CONFIG.C_TWP_PS_MEM_0 13046 CONFIG.C_TWP_PS_MEM_1 13142 CONFIG.C_TWP_PS_MEM_2 12575 CONFIG.C_WR_REC_TIME_MEM_0 24532 CONFIG.C_WR_REC_TIME_MEM_1 24578 CONFIG.C_WR_REC_TIME_MEM_2 27226 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 52 CONFIG.aresetn 0 CONFIG.bportwidth 62 CONFIG.btuserwidth 186 CONFIG.ctrltuserwidth 167 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 5 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 66 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_8_axi/AXI_S1]
...
connect_bd_net [get_bd_pins ip_4_reset/interconnect_aresetn] [get_bd_pins ip_11_axis_broadcaster/aresetn]
...
connect_bd_net [get_bd_pins ip_5_clk_wiz/clk_out] [get_bd_pins ip_11_axis_broadcaster/aclk]
...
if {[catch {
  ...
  set __s [expr {$__aw == 10 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/M_AXIS declared=10 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/M_AXIS declared=10 actual=ERR $__err" }
if {[catch {
