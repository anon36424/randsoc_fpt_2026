...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 17 CONFIG.aresetn 0 CONFIG.bportwidth 36 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 25 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 21 CONFIG.roundmode Truncate " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 52 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x10 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 231 CONFIG.C_SDA_INERTIAL_DELAY 97 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 976.238024457631 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 121 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 149 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 120 -to 0 ip_7_accumulator/B
connect_bd_net [get_bd_pins ip_7_accumulator/B] [get_bd_pins ip_7_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 148 -to 0 ip_7_accumulator/Q
...
create_bd_pin -dir I -from 242 -to 0 ip_8_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x73daded8ff829d0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x92215104e6c08e0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x22 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 240 CONFIG.C_SDA_INERTIAL_DELAY 219 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 506.5800845460703 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_12_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 2 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 18 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_16_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 1 -to 0 ip_16_accumulator/B
connect_bd_net [get_bd_pins ip_16_accumulator/B] [get_bd_pins ip_16_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 17 -to 0 ip_16_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 15 CONFIG.aresetn 0 CONFIG.atuserwidth 242 CONFIG.bportwidth 17 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 4 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 30 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_18_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 149 CONFIG.Latency 8 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 207 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_19_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 148 -to 0 ip_19_accumulator/B
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 3 " [get_bd_cells ip_30_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 3 " [get_bd_cells ip_35_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 126 -to 0 ip_36_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 126 CONFIG.DIN_TO 124 CONFIG.DIN_WIDTH 127 " [get_bd_cells ip_36_reduce/slice_31]
...
create_bd_pin -dir I -from 3 -to 0 ip_37_slice_and_concat/in_3
...
create_bd_pin -dir I -from 148 -to 0 ip_37_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_37_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 149 " [get_bd_cells ip_37_slice_and_concat/slice_6]
...
create_bd_pin -dir I -from 148 -to 0 ip_38_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_38_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 133 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 149 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 148 -to 0 ip_39_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_39_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 135 CONFIG.DIN_TO 134 CONFIG.DIN_WIDTH 149 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 141 CONFIG.DIN_TO 136 CONFIG.DIN_WIDTH 149 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 242 -to 0 ip_41_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 148 CONFIG.DIN_TO 142 CONFIG.DIN_WIDTH 149 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 251 -to 0 ip_41_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_41_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 235 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_41_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 243 CONFIG.DIN_TO 236 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 251 CONFIG.DIN_TO 244 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 44 -to 0 ip_43_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_43_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_43_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 126 -to 0 ip_44_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 206 -to 0 ip_44_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_44_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 207 " [get_bd_cells ip_44_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 206 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 207 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_0] [get_bd_pins ip_3_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_23_intc/irq_1] [get_bd_pins ip_5_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_23_intc/irq_2] [get_bd_pins ip_6_axi_iic/irq]
connect_bd_net [get_bd_pins ip_23_intc/irq_3] [get_bd_pins ip_10_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_23_intc/irq_4] [get_bd_pins ip_11_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_23_intc/irq_5] [get_bd_pins ip_12_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_8] [get_bd_pins ip_20_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_microblaze/M_AXI_DP] [get_bd_intf_pins ip_24_axi/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_24_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_24_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_24_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_iic/AXI] [get_bd_intf_pins ip_24_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_24_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_24_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_iic/AXI] [get_bd_intf_pins ip_24_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_uartlite/AXI] [get_bd_intf_pins ip_24_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_24_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_24_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_30_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_32_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/B]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_0] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_1] [get_bd_pins ip_2_dft/XK_RE]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_2] [get_bd_pins ip_2_dft/XK_IM]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_3] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_4] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_5] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_6] [get_bd_pins ip_7_accumulator/Q]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_1] [get_bd_pins ip_8_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_1] [get_bd_pins ip_16_accumulator/Q]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_2] [get_bd_pins ip_19_accumulator/Q]
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/B]
...
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_15_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/SCLR]
