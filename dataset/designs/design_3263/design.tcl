...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_4_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3e CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 150 CONFIG.C_SDA_INERTIAL_DELAY 57 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 709.5230774348108 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 38 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 39 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5e CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 2 CONFIG.C_SDA_INERTIAL_DELAY 179 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 418.8497305470437 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 226 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 246 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_9_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 225 -to 0 ip_9_accumulator/B
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x4ea6b7 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 12 CONFIG.C_GPIO_WIDTH 23 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_12_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 40 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 46 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
set_property -dict "CONFIG.AINIT_Value 7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 162 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 243 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_14_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 242 -to 0 ip_14_accumulator/Q
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7b CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 74 CONFIG.C_SDA_INERTIAL_DELAY 242 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 868.949195621418 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_15_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 112 -to 0 ip_25_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 82 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 83 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 88 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 89 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 101 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 106 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 107 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 113 " [get_bd_cells ip_25_reduce/slice_31]
...
create_bd_pin -dir I -from 38 -to 0 ip_27_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_27_slice_and_concat/slice_5]
...
create_bd_pin -dir I -from 38 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 155 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 246 " [get_bd_cells ip_28_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 39 -to 0 ip_29_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 195 CONFIG.DIN_TO 156 CONFIG.DIN_WIDTH 246 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 225 -to 0 ip_30_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 245 CONFIG.DIN_TO 196 CONFIG.DIN_WIDTH 246 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 242 -to 0 ip_30_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_30_slice_and_concat/slice_2]
...
create_bd_pin -dir O -from 112 -to 0 ip_31_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 242 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_5] [get_bd_pins ip_8_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_8] [get_bd_pins ip_12_gpio/irq]
connect_bd_net [get_bd_pins ip_18_intc/irq_9] [get_bd_pins ip_15_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_20_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_20_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_20_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_gpio/AXI] [get_bd_intf_pins ip_20_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_iic/AXI] [get_bd_intf_pins ip_20_axi/AXI_S8]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_4_axi_hwicap/eos_in]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/B]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_2] [get_bd_pins ip_2_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_4] [get_bd_pins ip_2_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_5] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_13_accumulator/Q]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_14_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_13_accumulator/CE]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_32_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_9_accumulator/CE]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/ot_out]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_14_accumulator/C_IN]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/ot_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 27 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_23_axis_dwidth_converter/M_AXIS declared=27 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_23_axis_dwidth_converter/M_AXIS declared=27 actual=ERR $__err" }
if {[catch {
