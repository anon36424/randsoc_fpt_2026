...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3e2fca CONFIG.C_GPIO_WIDTH 22 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0xac660 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 32 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 CONFIG.C_TAVDV_PS_MEM_0 15446 CONFIG.C_TCEDV_PS_MEM_0 14330 CONFIG.C_THZCE_PS_MEM_0 7494 CONFIG.C_THZOE_PS_MEM_0 6367 CONFIG.C_TLZWE_PS_MEM_0 2236 CONFIG.C_TWC_PS_MEM_0 13781 CONFIG.C_TWPH_PS_MEM_0 12776 CONFIG.C_TWP_PS_MEM_0 11732 CONFIG.C_WR_REC_TIME_MEM_0 27990 " [get_bd_cells ip_4_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xf CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 212 CONFIG.C_SDA_INERTIAL_DELAY 16 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 709.1404969934142 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_14_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_14_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_emc/AXI] [get_bd_intf_pins ip_14_axi/AXI_S5]
...
if {[catch {
  ...
  set __s [expr {$__aw == 19 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/M_AXIS declared=19 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/M_AXIS declared=19 actual=ERR $__err" }
if {[catch {
