...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 33 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 38 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x71 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 200 CONFIG.C_SDA_INERTIAL_DELAY 223 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 64.01628173959264 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 32 -to 0 ip_10_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_10_slice_and_concat/slice_0]
