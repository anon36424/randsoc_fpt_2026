...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 47 CONFIG.Latency 22 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 215 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 214 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 17 CONFIG.Iterations 28 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 22 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 46 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_1_cordic/cordic_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_2_dft/dft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 33 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.a_precision_type Single CONFIG.add_sub_value Both CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Condition_Code CONFIG.c_has_invalid_op 0 CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Compare CONFIG.result_tlast_behv OR_all_TLASTs " [get_bd_cells ip_5_floating_point/floating_point_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_6_fft/fft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 19 CONFIG.aresetn 0 CONFIG.bportwidth 12 CONFIG.btuserwidth 1 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 35 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 28 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_24_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 167 -to 0 ip_27_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 82 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 83 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 102 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 103 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 113 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 122 CONFIG.DIN_TO 118 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 127 CONFIG.DIN_TO 123 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 132 CONFIG.DIN_TO 128 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 137 CONFIG.DIN_TO 133 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 142 CONFIG.DIN_TO 138 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 147 CONFIG.DIN_TO 143 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 152 CONFIG.DIN_TO 148 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 157 CONFIG.DIN_TO 153 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 162 CONFIG.DIN_TO 158 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 167 CONFIG.DIN_TO 163 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 167 -to 0 ip_29_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 214 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_10_reset/peripheral_areset_n] [get_bd_pins ip_9_axi_quad_spi/reset]
...
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_1_cordic/aclk]
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_2_dft/CLK]
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_3_axi_cdma/m_axi_aclk]
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_3_axi_cdma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_4_fft/aclk]
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_5_floating_point/aclk]
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_6_fft/aclk]
...
connect_bd_net [get_bd_pins ip_11_clk_wiz/clk_out] [get_bd_pins ip_9_axi_quad_spi/clk]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_0] [get_bd_pins ip_3_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_12_intc/irq_1] [get_bd_pins ip_4_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_12_intc/irq_2] [get_bd_pins ip_6_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_12_intc/irq_3] [get_bd_pins ip_7_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_12_intc/irq_4] [get_bd_pins ip_9_axi_quad_spi/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/M_AXI] [get_bd_intf_pins ip_13_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_13_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_intc/AXI] [get_bd_intf_pins ip_13_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_14_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_floating_point/M_AXIS_RESULT] [get_bd_intf_pins ip_16_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/S_AXIS_DATA] [get_bd_intf_pins ip_14_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_22_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_23_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_14_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_0] [get_bd_pins ip_2_dft/RFFD]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_2_dft/CE]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_8_complex_multiplier/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/S_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/S_AXIS declared=288 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_15_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_0 declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_0 declared=288 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_15_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_1 declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_1 declared=288 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_15_axis_broadcaster/axis_broadcaster_0/M02_AXIS]] * 8}]
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_2 declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_2 declared=288 actual=ERR $__err" }
if {[catch {
