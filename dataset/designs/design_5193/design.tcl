...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 7 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 208 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 1 CONFIG.Scale 6 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1e CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 201 CONFIG.C_SDA_INERTIAL_DELAY 187 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 932.9505613348722 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x24 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 12 CONFIG.C_SDA_INERTIAL_DELAY 184 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 948.3094306792528 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 36 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_12_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 200 -to 0 ip_14_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_14_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 86 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 87 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 110 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 116 CONFIG.DIN_TO 111 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 122 CONFIG.DIN_TO 117 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 123 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 140 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 141 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 152 CONFIG.DIN_TO 147 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 158 CONFIG.DIN_TO 153 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 164 CONFIG.DIN_TO 159 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 165 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 176 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 182 CONFIG.DIN_TO 177 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 188 CONFIG.DIN_TO 183 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 194 CONFIG.DIN_TO 189 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 200 CONFIG.DIN_TO 195 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_14_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_14_reduce/reduce_31]
...
create_bd_pin -dir O -from 200 -to 0 ip_15_slice_and_concat/out0
create_bd_pin -dir I -from 207 -to 0 ip_15_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 200 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 208 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 207 -to 0 ip_16_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 207 CONFIG.DIN_TO 201 CONFIG.DIN_WIDTH 208 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_6_reset/interconnect_aresetn] [get_bd_pins ip_0_floating_point/aresetn]
connect_bd_net [get_bd_pins ip_6_reset/peripheral_areset_n] [get_bd_pins ip_3_axi_iic/reset]
connect_bd_net [get_bd_pins ip_6_reset/peripheral_areset_n] [get_bd_pins ip_4_axi_iic/reset]
connect_bd_net [get_bd_pins ip_6_reset/peripheral_areset_n] [get_bd_pins ip_5_axi_dma/axi_resetn]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_0_floating_point/aclk]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_1_accumulator/clk]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_2_fft/aclk]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_3_axi_iic/clk]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_4_axi_iic/clk]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_5_axi_dma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_7_clk_wiz/clk_out] [get_bd_pins ip_5_axi_dma/m_axi_s2mm_aclk]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_0] [get_bd_pins ip_2_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_8_intc/irq_1] [get_bd_pins ip_3_axi_iic/irq]
connect_bd_net [get_bd_pins ip_8_intc/irq_2] [get_bd_pins ip_4_axi_iic/irq]
connect_bd_net [get_bd_pins ip_8_intc/irq_3] [get_bd_pins ip_5_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_9_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_iic/AXI] [get_bd_intf_pins ip_9_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_9_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_9_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_intc/AXI] [get_bd_intf_pins ip_9_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_floating_point/M_AXIS_RESULT] [get_bd_intf_pins ip_10_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_floating_point/S_AXIS_A] [get_bd_intf_pins ip_11_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_13_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_10_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/SSET]
...
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/M_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/M_AXIS declared=288 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/S_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/S_AXIS declared=288 actual=ERR $__err" }
if {[catch {
