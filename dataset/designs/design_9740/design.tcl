...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_0_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 60 CONFIG.Latency 18 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 203 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 59 -to 0 ip_2_accumulator/B
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_9_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_10_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 145 -to 0 ip_12_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 101 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 105 CONFIG.DIN_TO 102 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 106 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 113 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 114 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 118 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 133 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 137 CONFIG.DIN_TO 134 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 141 CONFIG.DIN_TO 138 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 142 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_12_reduce/slice_31]
...
create_bd_pin -dir O -from 59 -to 0 ip_13_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 202 -to 0 ip_13_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_13_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 145 -to 0 ip_14_slice_and_concat/out0
create_bd_pin -dir I -from 202 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 202 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_3_reset/peripheral_areset_n] [get_bd_pins ip_0_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_4_clk_wiz/clk_out] [get_bd_pins ip_0_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_5_intc/irq_0] [get_bd_pins ip_0_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_9_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_1_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/CE]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_1_complex_multiplier/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_9_axis_dwidth_converter/M_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_9_axis_dwidth_converter/M_AXIS declared=128 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_dwidth_converter/S_AXIS declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_dwidth_converter/S_AXIS declared=144 actual=ERR $__err" }
if {[catch {
