...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x0 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 137 CONFIG.C_SDA_INERTIAL_DELAY 245 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 49.739579298809616 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x68 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 202 CONFIG.C_SDA_INERTIAL_DELAY 174 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 323.1839273279173 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_PORTS 8 " [get_bd_cells ip_10_intc/concat_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_10_intc/irq_7
connect_bd_net [get_bd_pins ip_10_intc/irq_7] [get_bd_pins ip_10_intc/concat_0/In7]
...
set_property -dict "CONFIG.NUM_MI 7 CONFIG.NUM_SI 6 " [get_bd_cells ip_11_axi/axi_0]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_6] [get_bd_pins ip_6_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_10_intc/irq_7] [get_bd_pins ip_7_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_11_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_11_axi/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_iic/AXI] [get_bd_intf_pins ip_11_axi/AXI_S5]
