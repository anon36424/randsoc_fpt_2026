...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 32 CONFIG.Iterations 48 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 28 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 32 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_0_cordic/cordic_0]
...
create_bd_pin -dir I -from 168 -to 0 ip_1_accumulator/B
...
create_bd_pin -dir O -from 30 -to 0 ip_6_slice_and_concat/out0
create_bd_pin -dir I -from 199 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 200 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 168 -to 0 ip_7_slice_and_concat/out0
create_bd_pin -dir I -from 199 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 199 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 200 " [get_bd_cells ip_7_slice_and_concat/slice_0]
