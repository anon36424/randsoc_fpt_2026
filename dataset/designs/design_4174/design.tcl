...
set_property -dict "CONFIG.C_MASK 0x178ff37d616feea CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6640c708d24b2b1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 13 CONFIG.aresetn 0 CONFIG.bportwidth 57 CONFIG.ctrltuserwidth 5 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 2 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.a_precision_type Single CONFIG.a_tuser_width 26 CONFIG.add_sub_value Both CONFIG.axi_optimize_goal Performance CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 1 CONFIG.c_mult_usage No_Usage CONFIG.flow_control Blocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_type Square_root CONFIG.result_tlast_behv Pass_A_TLAST " [get_bd_cells ip_2_floating_point/floating_point_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 201 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 206 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 200 -to 0 ip_3_accumulator/B
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 2 CONFIG.C_TAVDV_PS_MEM_0 14586 CONFIG.C_TAVDV_PS_MEM_1 14637 CONFIG.C_TCEDV_PS_MEM_0 16162 CONFIG.C_TCEDV_PS_MEM_1 15408 CONFIG.C_THZCE_PS_MEM_0 7156 CONFIG.C_THZCE_PS_MEM_1 6708 CONFIG.C_THZOE_PS_MEM_0 7674 CONFIG.C_THZOE_PS_MEM_1 7238 CONFIG.C_TLZWE_PS_MEM_0 3902 CONFIG.C_TLZWE_PS_MEM_1 9588 CONFIG.C_TWC_PS_MEM_0 15846 CONFIG.C_TWC_PS_MEM_1 14087 CONFIG.C_TWPH_PS_MEM_0 11363 CONFIG.C_TWPH_PS_MEM_1 12651 CONFIG.C_TWP_PS_MEM_0 12255 CONFIG.C_TWP_PS_MEM_1 12259 CONFIG.C_WR_REC_TIME_MEM_0 27887 CONFIG.C_WR_REC_TIME_MEM_1 27323 " [get_bd_cells ip_6_emc/emc_0]
...
create_bd_pin -dir I -from 205 -to 0 ip_17_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 206 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 205 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 206 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 205 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 206 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 205 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 206 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 205 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 206 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_9_intc/irq_0] [get_bd_pins ip_5_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_emc/AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S1]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_3] [get_bd_pins ip_4_dft/XK_IM]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_4_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_4_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_6] [get_bd_pins ip_4_dft/DATA_VALID]
