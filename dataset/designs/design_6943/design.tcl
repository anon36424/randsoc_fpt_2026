...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_2_dft/dft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 41 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MASK 0x1d26942879ab862 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x2b29d2374008ac0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 27 CONFIG.aresetn 0 CONFIG.bportwidth 11 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 26 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options pipelined_streaming_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_9_fft/fft_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 64 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 15 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_11_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 40 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 48 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_12_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x73 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 43 CONFIG.C_SDA_INERTIAL_DELAY 183 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 606.2867947317691 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.add_sub_value Both CONFIG.b_tuser_width 101 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Greater_Than CONFIG.c_has_invalid_op 1 CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Compare " [get_bd_cells ip_15_floating_point/floating_point_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_20_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x58 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 240 CONFIG.C_SDA_INERTIAL_DELAY 191 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 326.2324471057128 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_21_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x53ed6dcfa1eee05 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_22_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe6db2a85c94229b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_22_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_46_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_47_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_49_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_52_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_53_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_28_intc/irq_9] [get_bd_pins ip_17_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_microblaze/M_AXI_DP] [get_bd_intf_pins ip_29_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_29_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_29_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_29_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_iic/AXI] [get_bd_intf_pins ip_29_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_29_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_29_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_29_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_29_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_uartlite/AXI] [get_bd_intf_pins ip_29_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_uartlite/AXI] [get_bd_intf_pins ip_29_axi/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_iic/AXI] [get_bd_intf_pins ip_29_axi/AXI_S12]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_24_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_fft/S_AXIS_DATA] [get_bd_intf_pins ip_10_fft/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_3] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_4] [get_bd_pins ip_2_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_52_slice_and_concat/in_0] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/in_1] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/in_2] [get_bd_pins ip_2_dft/DATA_VALID]
...
if {[catch {
  ...
  set __s [expr {$__aw == 19 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_45_axis_dwidth_converter/M_AXIS declared=19 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_45_axis_dwidth_converter/M_AXIS declared=19 actual=ERR $__err" }
