...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 19 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 20 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 19 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 190 CONFIG.convolution_code1 5 CONFIG.convolution_code2 63 CONFIG.convolution_code3 229 CONFIG.convolution_code4 124 CONFIG.convolution_code5 216 CONFIG.convolution_code6 227 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 7 CONFIG.output_rate 8 CONFIG.puncture_code0 1010011 CONFIG.puncture_code1 0101011 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_1_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 8 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_3_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 6 CONFIG.convolution_code0 54 CONFIG.convolution_code1 10 CONFIG.convolution_code2 39 CONFIG.convolution_code3 41 CONFIG.convolution_code4 35 CONFIG.convolution_code5 14 CONFIG.convolution_code6 45 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 7 CONFIG.output_rate 13 CONFIG.puncture_code0 1111111 CONFIG.puncture_code1 1111011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_5_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.AINIT_Value 34a1f2bc4625017b787c04255c71908b9f41df8f8303823ffe CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 56 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 198 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 55 -to 0 ip_6_accumulator/B
connect_bd_net [get_bd_pins ip_6_accumulator/B] [get_bd_pins ip_6_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 197 -to 0 ip_6_accumulator/Q
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x1f CONFIG.C_GPIO2_WIDTH 4 CONFIG.C_GPIO_WIDTH 5 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 32 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_8_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_9_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Arc_Tan CONFIG.Input_Width 19 CONFIG.Iterations 4 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 48 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 48 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_10_cordic/cordic_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 256 CONFIG.C_SHARED_STARTUP 1 CONFIG.C_SPI_MEMORY 1 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_11_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_12_gpio/gpio_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_14_dft/dft_0]
...
set_property -dict "CONFIG.a_precision_type Custom CONFIG.a_tuser_width 14 CONFIG.add_sub_value Both CONFIG.c_a_exponent_width 7 CONFIG.c_a_fraction_width 26 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Absolute " [get_bd_cells ip_15_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 8 CONFIG.C_TAVDV_PS_MEM_0 14160 CONFIG.C_TCEDV_PS_MEM_0 14553 CONFIG.C_THZCE_PS_MEM_0 7326 CONFIG.C_THZOE_PS_MEM_0 6685 CONFIG.C_TLZWE_PS_MEM_0 3208 CONFIG.C_TWC_PS_MEM_0 15713 CONFIG.C_TWPH_PS_MEM_0 12024 CONFIG.C_TWP_PS_MEM_0 11240 CONFIG.C_WR_REC_TIME_MEM_0 25652 " [get_bd_cells ip_16_emc/emc_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 27 CONFIG.Iterations 11 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour Pass_Cartesian_TLAST CONFIG.Out_TREADY 1 CONFIG.Output_Width 17 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 27 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_17_cordic/cordic_0]
...
set_property -dict "CONFIG.ADC_OFFSET_AND_GAIN_CALIBRATION 0 CONFIG.ADC_OFFSET_CALIBRATION 1 CONFIG.CHANNEL_AVERAGING None CONFIG.ENABLE_CALIBRATION_AVERAGING 0 CONFIG.ENABLE_DCLK 0 CONFIG.ENABLE_JTAG_ARBITER 1 CONFIG.ENABLE_RESET 1 CONFIG.ENABLE_VBRAM_ALARM 1 CONFIG.INTERFACE_SELECTION None CONFIG.OT_ALARM 0 CONFIG.POWER_DOWN_ADCA 1 CONFIG.POWER_DOWN_ADCB 1 CONFIG.SENSOR_OFFSET_AND_GAIN_CALIBRATION 1 CONFIG.SENSOR_OFFSET_CALIBRATION 1 CONFIG.TIMING_MODE Continuous CONFIG.USER_TEMP_ALARM 1 CONFIG.VCCAUX_ALARM 1 CONFIG.VCCINT_ALARM 1 CONFIG.XADC_STARUP_SELECTION single_channel " [get_bd_cells ip_18_xadc_wiz/xadc_wiz_0]
create_bd_pin -dir I -from 0 -to 0 ip_18_xadc_wiz/reset_in
connect_bd_net [get_bd_pins ip_18_xadc_wiz/reset_in] [get_bd_pins ip_18_xadc_wiz/xadc_wiz_0/reset_in]
...
create_bd_pin -dir O -from 0 -to 0 ip_18_xadc_wiz/vccint_alarm_out
connect_bd_net [get_bd_pins ip_18_xadc_wiz/vccint_alarm_out] [get_bd_pins ip_18_xadc_wiz/xadc_wiz_0/vccint_alarm_out]
...
create_bd_pin -dir O -from 0 -to 0 ip_18_xadc_wiz/vbram_alarm_out
connect_bd_net [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out] [get_bd_pins ip_18_xadc_wiz/xadc_wiz_0/vbram_alarm_out]
...
create_bd_pin -dir O -from 0 -to 0 ip_18_xadc_wiz/jtaglocked_out
connect_bd_net [get_bd_pins ip_18_xadc_wiz/jtaglocked_out] [get_bd_pins ip_18_xadc_wiz/xadc_wiz_0/jtaglocked_out]
create_bd_pin -dir O -from 0 -to 0 ip_18_xadc_wiz/jtagmodified_out
connect_bd_net [get_bd_pins ip_18_xadc_wiz/jtagmodified_out] [get_bd_pins ip_18_xadc_wiz/xadc_wiz_0/jtagmodified_out]
create_bd_pin -dir O -from 0 -to 0 ip_18_xadc_wiz/jtagbusy_out
connect_bd_net [get_bd_pins ip_18_xadc_wiz/jtagbusy_out] [get_bd_pins ip_18_xadc_wiz/xadc_wiz_0/jtagbusy_out]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_20_dft/dft_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_20_dft/XN_RE
connect_bd_net [get_bd_pins ip_20_dft/XN_RE] [get_bd_pins ip_20_dft/dft_0/XN_RE]
create_bd_pin -dir I -from 9 -to 0 ip_20_dft/XN_IM
...
create_bd_pin -dir O -from 9 -to 0 ip_20_dft/XK_RE
connect_bd_net [get_bd_pins ip_20_dft/XK_RE] [get_bd_pins ip_20_dft/dft_0/XK_RE]
create_bd_pin -dir O -from 9 -to 0 ip_20_dft/XK_IM
...
set_property -dict "CONFIG.AINIT_Value 63c79909580ea00d4c0992bf1081ceb04ecac5cb CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 35 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 159 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_22_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 34 -to 0 ip_22_accumulator/B
connect_bd_net [get_bd_pins ip_22_accumulator/B] [get_bd_pins ip_22_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 158 -to 0 ip_22_accumulator/Q
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 65536 " [get_bd_cells ip_23_fft/fft_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 8 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_24_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 5 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 11 CONFIG.C_TAVDV_PS_MEM_0 16341 CONFIG.C_TAVDV_PS_MEM_1 15916 CONFIG.C_TCEDV_PS_MEM_0 16059 CONFIG.C_TCEDV_PS_MEM_1 13679 CONFIG.C_THZCE_PS_MEM_0 7167 CONFIG.C_THZCE_PS_MEM_1 7646 CONFIG.C_THZOE_PS_MEM_0 7442 CONFIG.C_THZOE_PS_MEM_1 6964 CONFIG.C_TLZWE_PS_MEM_0 3801 CONFIG.C_TLZWE_PS_MEM_1 7272 CONFIG.C_TWC_PS_MEM_0 14381 CONFIG.C_TWC_PS_MEM_1 16145 CONFIG.C_TWPH_PS_MEM_0 12773 CONFIG.C_TWPH_PS_MEM_1 11246 CONFIG.C_TWP_PS_MEM_0 11357 CONFIG.C_TWP_PS_MEM_1 11214 CONFIG.C_WR_REC_TIME_MEM_0 29148 CONFIG.C_WR_REC_TIME_MEM_1 25298 " [get_bd_cells ip_25_emc/emc_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 35 CONFIG.C_ENABLE_MULTI_CHANNEL 1 CONFIG.C_INCLUDE_MM2S 1 CONFIG.C_INCLUDE_S2MM 1 CONFIG.C_INCLUDE_SG 1 CONFIG.C_MICRO_DMA 0 CONFIG.C_MM2S_BURST_SIZE 4 CONFIG.C_M_AXIS_MM2S_TDATA_WIDTH 256 CONFIG.C_M_AXI_MM2S_DATA_WIDTH 256 CONFIG.C_M_AXI_S2MM_DATA_WIDTH 512 CONFIG.C_NUM_MM2S_CHANNELS 10 CONFIG.C_NUM_S2MM_CHANNELS 13 CONFIG.C_S2MM_BURST_SIZE 64 CONFIG.C_SG_INCLUDE_STSCNTRL_STRM 0 CONFIG.C_SG_LENGTH_WIDTH 14 CONFIG.C_SINGLE_INTERFACE 0 CONFIG.C_S_AXIS_S2MM_TDATA_WIDTH 256 " [get_bd_cells ip_26_axi_dma/axi_dma_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 18 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_27_dft/dft_0]
create_bd_pin -dir I -from 0 -to 0 ip_27_dft/CLK
connect_bd_net [get_bd_pins ip_27_dft/CLK] [get_bd_pins ip_27_dft/dft_0/CLK]
create_bd_pin -dir I -from 17 -to 0 ip_27_dft/XN_RE
connect_bd_net [get_bd_pins ip_27_dft/XN_RE] [get_bd_pins ip_27_dft/dft_0/XN_RE]
create_bd_pin -dir I -from 17 -to 0 ip_27_dft/XN_IM
...
create_bd_pin -dir O -from 17 -to 0 ip_27_dft/XK_RE
connect_bd_net [get_bd_pins ip_27_dft/XK_RE] [get_bd_pins ip_27_dft/dft_0/XK_RE]
create_bd_pin -dir O -from 17 -to 0 ip_27_dft/XK_IM
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_41_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_42_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 12 " [get_bd_cells ip_43_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 32 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_45_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 32 " [get_bd_cells ip_46_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 12 " [get_bd_cells ip_47_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.NUM_SI 5 " [get_bd_cells ip_48_axis_combiner/axis_combiner_0]
...
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 ip_48_axis_combiner/S_AXIS_4
connect_bd_intf_net [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_4] [get_bd_intf_pins ip_48_axis_combiner/axis_combiner_0/S04_AXIS]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_51_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 281 -to 0 ip_52_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 116 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 117 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 143 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 152 CONFIG.DIN_TO 144 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 161 CONFIG.DIN_TO 153 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 162 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 179 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 188 CONFIG.DIN_TO 180 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 197 CONFIG.DIN_TO 189 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 206 CONFIG.DIN_TO 198 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 215 CONFIG.DIN_TO 207 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 224 CONFIG.DIN_TO 216 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 233 CONFIG.DIN_TO 225 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_52_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 241 CONFIG.DIN_TO 234 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 8 " [get_bd_cells ip_52_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 249 CONFIG.DIN_TO 242 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 8 " [get_bd_cells ip_52_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 257 CONFIG.DIN_TO 250 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 8 " [get_bd_cells ip_52_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 265 CONFIG.DIN_TO 258 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 8 " [get_bd_cells ip_52_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 273 CONFIG.DIN_TO 266 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 8 " [get_bd_cells ip_52_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 281 CONFIG.DIN_TO 274 CONFIG.DIN_WIDTH 282 " [get_bd_cells ip_52_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 8 " [get_bd_cells ip_52_reduce/reduce_31]
...
create_bd_pin -dir I -from 19 -to 0 ip_53_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_53_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 20 " [get_bd_cells ip_53_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 281 -to 0 ip_54_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_54_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 24 " [get_bd_cells ip_54_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/out0] [get_bd_pins ip_54_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 19 -to 0 ip_54_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_54_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 20 " [get_bd_cells ip_54_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 197 -to 0 ip_54_slice_and_concat/in_4
...
create_bd_pin -dir I -from 9 -to 0 ip_54_slice_and_concat/in_18
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_18] [get_bd_pins ip_54_slice_and_concat/concat/In18]
create_bd_pin -dir I -from 9 -to 0 ip_54_slice_and_concat/in_19
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_19] [get_bd_pins ip_54_slice_and_concat/concat/In19]
create_bd_pin -dir I -from 3 -to 0 ip_54_slice_and_concat/in_20
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_20] [get_bd_pins ip_54_slice_and_concat/concat/In20]
create_bd_pin -dir I -from 0 -to 0 ip_54_slice_and_concat/in_21
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_21] [get_bd_pins ip_54_slice_and_concat/concat/In21]
create_bd_pin -dir I -from 0 -to 0 ip_54_slice_and_concat/in_22
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_22] [get_bd_pins ip_54_slice_and_concat/concat/In22]
create_bd_pin -dir I -from 158 -to 0 ip_54_slice_and_concat/in_23
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_23
move_bd_cells [get_bd_cells ip_54_slice_and_concat] [get_bd_cells slice_23]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_54_slice_and_concat/slice_23]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_23] [get_bd_pins ip_54_slice_and_concat/slice_23/din]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/slice_23/dout] [get_bd_pins ip_54_slice_and_concat/concat/In23]


########## slice_and_concat ##########
create_bd_cell -type hier ip_55_slice_and_concat
create_bd_pin -dir O -from 34 -to 0 ip_55_slice_and_concat/out0
create_bd_pin -dir I -from 158 -to 0 ip_55_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_55_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_55_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 158 -to 0 ip_56_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_56_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_56_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 55 -to 0 ip_57_slice_and_concat/out0
create_bd_pin -dir I -from 158 -to 0 ip_57_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_57_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_57_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 158 -to 0 ip_58_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_58_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 113 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_58_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 158 -to 0 ip_59_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_59_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 131 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_59_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 158 -to 0 ip_60_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_60_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 132 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_60_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 18 -to 0 ip_61_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 158 -to 0 ip_61_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_61_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 158 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_61_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_61_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_61_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_61_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_62_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_62_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_63_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_64_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_7_gpio/rst]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_9_axi_ethernet_lite/reset]
connect_bd_net [get_bd_pins ip_28_reset/interconnect_aresetn] [get_bd_pins ip_10_cordic/aresetn]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_11_axi_quad_spi/reset4]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_12_gpio/rst]
connect_bd_net [get_bd_pins ip_28_reset/interconnect_aresetn] [get_bd_pins ip_13_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset] [get_bd_pins ip_14_dft/SCLR]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_16_emc/rst]
connect_bd_net [get_bd_pins ip_28_reset/interconnect_aresetn] [get_bd_pins ip_17_cordic/aresetn]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset] [get_bd_pins ip_18_xadc_wiz/reset_in]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset] [get_bd_pins ip_20_dft/SCLR]
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_21_axi_dma/axi_resetn]
...
connect_bd_net [get_bd_pins ip_28_reset/peripheral_areset_n] [get_bd_pins ip_26_axi_dma/axi_resetn]
...
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_7_gpio/clk]
...
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_10_cordic/aclk]
...
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_12_gpio/clk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_13_conv_encoder/aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_14_dft/CLK]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_16_emc/clk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_16_emc/rdclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_17_cordic/aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_19_cordic/aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_20_dft/CLK]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_21_axi_dma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_21_axi_dma/m_axi_s2mm_aclk]
...
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_26_axi_dma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_26_axi_dma/m_axi_sg_aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_26_axi_dma/m_axi_mm2s_aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_26_axi_dma/m_axi_s2mm_aclk]
...
connect_bd_net [get_bd_pins ip_30_intc/irq_0] [get_bd_pins ip_2_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_1] [get_bd_pins ip_3_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_30_intc/irq_2] [get_bd_pins ip_4_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_30_intc/irq_3] [get_bd_pins ip_8_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_4] [get_bd_pins ip_9_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_5] [get_bd_pins ip_11_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_6] [get_bd_pins ip_12_gpio/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_7] [get_bd_pins ip_21_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_8] [get_bd_pins ip_23_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_30_intc/irq_9] [get_bd_pins ip_24_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_30_intc/irq_10] [get_bd_pins ip_26_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_11] [get_bd_pins ip_26_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_cdma/M_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_cdma/M_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_31_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_31_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_31_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_31_axi_legacy/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_gpio/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_gpio/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_emc/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axi_timer/S_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_25_emc/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S11]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_34_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_35_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_39_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_40_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_fft/S_AXIS_DATA] [get_bd_intf_pins ip_15_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_43_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_44_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_45_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_46_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_26_axi_dma/M_AXIS_MM2S]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_47_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_19_cordic/M_AXIS_DOUT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_47_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_32_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_34_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_35_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_4] [get_bd_intf_pins ip_36_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_48_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_32_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_33_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_37_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_50_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_51_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_20_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_1] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_2] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_3] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_4] [get_bd_pins ip_6_accumulator/Q]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_5] [get_bd_pins ip_14_dft/RFFD]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_6] [get_bd_pins ip_14_dft/XK_RE]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_7] [get_bd_pins ip_14_dft/XK_IM]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_8] [get_bd_pins ip_14_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_9] [get_bd_pins ip_14_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_10] [get_bd_pins ip_14_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_11] [get_bd_pins ip_18_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_12] [get_bd_pins ip_18_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_13] [get_bd_pins ip_18_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_14] [get_bd_pins ip_18_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_15] [get_bd_pins ip_18_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_16] [get_bd_pins ip_18_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_17] [get_bd_pins ip_20_dft/RFFD]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_18] [get_bd_pins ip_20_dft/XK_RE]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_19] [get_bd_pins ip_20_dft/XK_IM]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_20] [get_bd_pins ip_20_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_21] [get_bd_pins ip_20_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_22] [get_bd_pins ip_20_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_23] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_22_accumulator/B]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/out0] [get_bd_pins ip_14_dft/XN_IM]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/B]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_14_dft/XN_RE]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_20_dft/XN_RE]
connect_bd_net [get_bd_pins ip_59_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_27_dft/XN_IM]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/B]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_1] [get_bd_pins ip_24_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_2] [get_bd_pins ip_24_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_3] [get_bd_pins ip_24_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_4] [get_bd_pins ip_27_dft/RFFD]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_5] [get_bd_pins ip_27_dft/XK_RE]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_27_dft/XN_RE]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/in_0] [get_bd_pins ip_27_dft/XK_RE]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/in_1] [get_bd_pins ip_27_dft/XK_IM]
connect_bd_net [get_bd_pins ip_63_slice_and_concat/out0] [get_bd_pins ip_20_dft/SIZE]
connect_bd_net [get_bd_pins ip_63_slice_and_concat/in_0] [get_bd_pins ip_27_dft/XK_IM]
connect_bd_net [get_bd_pins ip_64_slice_and_concat/out0] [get_bd_pins ip_14_dft/SIZE]
connect_bd_net [get_bd_pins ip_64_slice_and_concat/in_0] [get_bd_pins ip_27_dft/XK_IM]
connect_bd_net [get_bd_pins ip_65_slice_and_concat/out0] [get_bd_pins ip_27_dft/SIZE]
connect_bd_net [get_bd_pins ip_65_slice_and_concat/in_0] [get_bd_pins ip_27_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_65_slice_and_concat/in_1] [get_bd_pins ip_27_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_65_slice_and_concat/in_2] [get_bd_pins ip_27_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_67_slice_and_concat/out0] [get_bd_pins ip_20_dft/CE]
connect_bd_net [get_bd_pins ip_67_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_67_slice_and_concat/out0] [get_bd_pins ip_67_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/ADD]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/out0] [get_bd_pins ip_68_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/CE]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_70_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_70_slice_and_concat/out0] [get_bd_pins ip_70_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_71_slice_and_concat/out0] [get_bd_pins ip_13_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_71_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/alarm_out]
...
connect_bd_net [get_bd_pins ip_72_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_72_slice_and_concat/out0] [get_bd_pins ip_72_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/out0] [get_bd_pins ip_27_dft/FD_IN]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/out0] [get_bd_pins ip_73_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_74_slice_and_concat/out0] [get_bd_pins ip_14_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_74_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_74_slice_and_concat/out0] [get_bd_pins ip_74_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_75_slice_and_concat/out0] [get_bd_pins ip_24_axi_timer/capturetrig0]
...
connect_bd_net [get_bd_pins ip_76_slice_and_concat/out0] [get_bd_pins ip_22_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/out0] [get_bd_pins ip_76_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_77_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_77_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_78_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_78_slice_and_concat/out0] [get_bd_pins ip_78_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/out0] [get_bd_pins ip_79_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_80_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_80_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/alarm_out]
...
connect_bd_net [get_bd_pins ip_81_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_81_slice_and_concat/out0] [get_bd_pins ip_81_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_82_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_82_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_82_slice_and_concat/out0] [get_bd_pins ip_82_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_83_slice_and_concat/out0] [get_bd_pins ip_24_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_83_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_83_slice_and_concat/out0] [get_bd_pins ip_83_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_84_slice_and_concat/out0] [get_bd_pins ip_17_cordic/aclken]
connect_bd_net [get_bd_pins ip_84_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_85_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_86_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_87_slice_and_concat/in_0] [get_bd_pins ip_18_xadc_wiz/vccint_alarm_out]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_15_floating_point/S_AXIS_A declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_floating_point/S_AXIS_A declared=40 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_15_floating_point/floating_point_0/M_AXIS_RESULT]] * 8}]
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_floating_point/M_AXIS_RESULT declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_floating_point/M_AXIS_RESULT declared=40 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_cordic/M_AXIS_DOUT declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_cordic/M_AXIS_DOUT declared=48 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_23_fft/S_AXIS_CONFIG declared=19 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_23_fft/S_AXIS_CONFIG declared=19 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_26_axi_dma/M_AXIS_MM2S declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_axi_dma/M_AXIS_MM2S declared=256 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_26_axi_dma/axi_dma_0/S_AXIS_S2MM]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_26_axi_dma/S_AXIS_S2MM declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_axi_dma/S_AXIS_S2MM declared=256 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 12 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_41_axis_dwidth_converter/M_AXIS declared=12 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_41_axis_dwidth_converter/M_AXIS declared=12 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_45_axis_dwidth_converter/M_AXIS declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_45_axis_dwidth_converter/M_AXIS declared=256 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_48_axis_combiner/axis_combiner_0/S04_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_48_axis_combiner/S_AXIS_4 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_48_axis_combiner/S_AXIS_4 declared=96 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_49_axis_combiner/S_AXIS_2 declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_49_axis_combiner/S_AXIS_2 declared=48 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 19 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_51_axis_dwidth_converter/M_AXIS declared=19 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_51_axis_dwidth_converter/M_AXIS declared=19 actual=ERR $__err" }
