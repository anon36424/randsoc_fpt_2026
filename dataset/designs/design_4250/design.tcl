...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 13917 CONFIG.C_TAVDV_PS_MEM_1 14109 CONFIG.C_TCEDV_PS_MEM_0 13656 CONFIG.C_TCEDV_PS_MEM_1 14336 CONFIG.C_THZCE_PS_MEM_0 7532 CONFIG.C_THZCE_PS_MEM_1 6649 CONFIG.C_THZOE_PS_MEM_0 6842 CONFIG.C_THZOE_PS_MEM_1 7451 CONFIG.C_TLZWE_PS_MEM_0 928 CONFIG.C_TLZWE_PS_MEM_1 6886 CONFIG.C_TWC_PS_MEM_0 13755 CONFIG.C_TWC_PS_MEM_1 16382 CONFIG.C_TWPH_PS_MEM_0 11380 CONFIG.C_TWPH_PS_MEM_1 11907 CONFIG.C_TWP_PS_MEM_0 12165 CONFIG.C_TWP_PS_MEM_1 10944 CONFIG.C_WR_REC_TIME_MEM_0 29204 CONFIG.C_WR_REC_TIME_MEM_1 27997 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xd CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 194 CONFIG.C_SDA_INERTIAL_DELAY 20 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 642.7948238143995 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 512 " [get_bd_cells ip_2_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MASK 0x295901ead515ec4 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x161f8e44d32bc14 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_DATA] [get_bd_intf_pins ip_15_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_0] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_1] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_2_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_7_axi_timer/pwm0]
...
if {[catch {
  ...
  set __s [expr {$__aw == 35 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_14_axis_dwidth_converter/M_AXIS declared=35 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_axis_dwidth_converter/M_AXIS declared=35 actual=ERR $__err" }
if {[catch {
