...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6b CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 59 CONFIG.C_SDA_INERTIAL_DELAY 113 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 881.8423105341027 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 53 CONFIG.aresetn 1 CONFIG.atuserwidth 78 CONFIG.bportwidth 31 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 31 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 81 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 22 " [get_bd_cells ip_9_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_iic/AXI] [get_bd_intf_pins ip_6_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_6_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_1_complex_multiplier/M_AXIS_DOUT]
...
if {[catch {
  ...
  set __s [expr {$__aw == 176 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_9_axis_dwidth_converter/S_AXIS declared=176 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_9_axis_dwidth_converter/S_AXIS declared=176 actual=ERR $__err" }
if {[catch {
