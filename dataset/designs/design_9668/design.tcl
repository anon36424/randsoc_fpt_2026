...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 512 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 62 CONFIG.aresetn 1 CONFIG.atuserwidth 183 CONFIG.bportwidth 18 CONFIG.btuserwidth 45 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 12 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 21 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_5_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3b CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 126 CONFIG.C_SDA_INERTIAL_DELAY 246 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 937.5529988704947 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_15_fft/fft_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 64 " [get_bd_cells ip_16_fft/fft_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_22_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 55 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_23_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 34 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 39 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_24_accumulator/accumulator_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 44 " [get_bd_cells ip_46_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 28 -to 0 ip_55_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_55_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 29 " [get_bd_cells ip_55_slice_and_concat/slice_6]
...
create_bd_pin -dir I -from 28 -to 0 ip_56_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_56_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 29 " [get_bd_cells ip_56_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 38 -to 0 ip_56_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_56_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_56_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_57_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_28_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_28_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axi_cdma/M_AXI] [get_bd_intf_pins ip_28_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_gpio/AXI] [get_bd_intf_pins ip_28_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_28_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_intc/AXI] [get_bd_intf_pins ip_28_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_fft/M_AXIS_DATA] [get_bd_intf_pins ip_29_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_44_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_9_axi_dma/M_AXIS_MM2S]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_45_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_17_floating_point/M_AXIS_RESULT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_45_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_fft/S_AXIS_DATA] [get_bd_intf_pins ip_30_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_34_axis_broadcaster/M_AXIS_2]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_14_accumulator/B]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_0] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_1] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_2] [get_bd_pins ip_1_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_3] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_4] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_5] [get_bd_pins ip_4_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/in_6] [get_bd_pins ip_14_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_1] [get_bd_pins ip_20_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_2] [get_bd_pins ip_20_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_3] [get_bd_pins ip_20_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_4] [get_bd_pins ip_20_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_5] [get_bd_pins ip_20_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/in_6] [get_bd_pins ip_20_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_11_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/capturetrig1]
...
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_24_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/in_0] [get_bd_pins ip_20_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_65_slice_and_concat/in_0] [get_bd_pins ip_20_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_2_floating_point/aclken]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_0] [get_bd_pins ip_20_xadc_wiz/vccaux_alarm_out]
