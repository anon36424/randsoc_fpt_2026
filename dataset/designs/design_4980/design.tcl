...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 43 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 43 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_10_axi_ethernet_lite/axi_ethernetlite_0]
...
create_bd_pin -dir I -from 42 -to 0 ip_18_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_18_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S6]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_4] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_5] [get_bd_pins ip_1_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_3] [get_bd_pins ip_9_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_9_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_9_axi_timer/pwm0]
