...
set_property -dict "CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 1 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_WRITE_FIFO_DEPTH 1024 " [get_bd_cells ip_2_axi_hwicap/axi_hwicap_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_16_slice_and_concat/in_6
...
connect_bd_net [get_bd_pins ip_7_intc/irq_1] [get_bd_pins ip_3_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_6] [get_bd_pins ip_3_xadc_wiz/temp_out]
