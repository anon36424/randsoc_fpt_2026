...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 20 CONFIG.aresetn 1 CONFIG.atuserwidth 131 CONFIG.bportwidth 12 CONFIG.ctrltuserwidth 62 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 54 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 5 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xe CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 16 CONFIG.C_SDA_INERTIAL_DELAY 61 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 266.9362955182175 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 67 CONFIG.convolution_code1 115 CONFIG.convolution_code2 116 CONFIG.convolution_code3 71 CONFIG.convolution_code4 51 CONFIG.convolution_code5 18 CONFIG.convolution_code6 62 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 10 CONFIG.output_rate 14 CONFIG.puncture_code0 1110011011 CONFIG.puncture_code1 1100110111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_9_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 35 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_11_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 256 " [get_bd_cells ip_12_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 4 CONFIG.C_GPIO_WIDTH 8 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_13_gpio/gpio_0]
...
create_bd_pin -dir I -from 47 -to 0 ip_31_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_31_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_cdma/M_AXI] [get_bd_intf_pins ip_17_axi/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_17_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_gpio/AXI] [get_bd_intf_pins ip_17_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_floating_point/S_AXIS_C] [get_bd_intf_pins ip_30_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_12_axi_hwicap/eos_in]
