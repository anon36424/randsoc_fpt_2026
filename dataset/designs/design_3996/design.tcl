...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x45 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 251 CONFIG.C_SDA_INERTIAL_DELAY 8 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 388.12763652749464 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_8_axi/AXI_M1]
