...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2c CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 2 CONFIG.C_SDA_INERTIAL_DELAY 33 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 436.6332143164198 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_MI 4 CONFIG.NUM_SI 2 " [get_bd_cells ip_6_axi_legacy/axi_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_6_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_iic/AXI] [get_bd_intf_pins ip_6_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/capturetrig0]
