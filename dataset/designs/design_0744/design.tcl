...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 2048 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 5 CONFIG.convolution_code0 30 CONFIG.convolution_code1 1 CONFIG.convolution_code2 28 CONFIG.convolution_code3 24 CONFIG.convolution_code4 17 CONFIG.convolution_code5 29 CONFIG.convolution_code6 29 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 12 CONFIG.output_rate 16 CONFIG.puncture_code0 111100110111 CONFIG.puncture_code1 101101001101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_7_conv_encoder/conv_encoder_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_4] [get_bd_pins ip_5_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_DATA] [get_bd_intf_pins ip_13_axis_broadcaster/M_AXIS_0]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_4_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_4_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/out0] [get_bd_pins ip_7_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_4_xadc_wiz/convst_in]
