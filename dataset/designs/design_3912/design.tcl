...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x27 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 145 CONFIG.C_SDA_INERTIAL_DELAY 90 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 956.6271909399585 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 57 CONFIG.aresetn 0 CONFIG.bportwidth 33 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 18 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 68 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 37 CONFIG.Iterations 47 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 19 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 27 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_5_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 512 " [get_bd_cells ip_6_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 62 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_9_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_MI 6 CONFIG.NUM_SI 4 " [get_bd_cells ip_15_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_2] [get_bd_pins ip_1_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/M_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_cdma/M_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_15_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/S_AXIS_DATA] [get_bd_intf_pins ip_11_conv_encoder/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_8_dft/RFFD]
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_27_axis_combiner/S_AXIS_3 declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_27_axis_combiner/S_AXIS_3 declared=48 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 21 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_dwidth_converter/M_AXIS declared=21 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_dwidth_converter/M_AXIS declared=21 actual=ERR $__err" }
if {[catch {
