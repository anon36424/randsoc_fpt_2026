...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1feb19 CONFIG.C_DOUT_DEFAULT_2 0x1521ff CONFIG.C_GPIO2_WIDTH 17 CONFIG.C_GPIO_WIDTH 21 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x1fffff CONFIG.C_TRI_DEFAULT_2 0x1fffff " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 171 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 231 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 170 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x4167fcf982ed63f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x86f693b6f97d85a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 59 -to 0 ip_6_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_6_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 60 " [get_bd_cells ip_6_reduce/slice_31]
...
create_bd_pin -dir O -from 59 -to 0 ip_7_slice_and_concat/out0
create_bd_pin -dir I -from 230 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 231 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 170 -to 0 ip_8_slice_and_concat/out0
create_bd_pin -dir I -from 230 -to 0 ip_8_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 230 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 231 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_microblaze/M_AXI_DP] [get_bd_intf_pins ip_5_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_gpio/AXI] [get_bd_intf_pins ip_5_axi_legacy/AXI_S0]
...
connect_bd_net [get_bd_pins ip_3_reset/interconnect_aresetn] [get_bd_pins ip_5_axi_legacy/reset]
connect_bd_net [get_bd_pins ip_4_clk_wiz/clk_out] [get_bd_pins ip_5_axi_legacy/clk]
