...
create_bd_pin -dir I -from 115 -to 0 ip_0_accumulator/B
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x13 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 236 CONFIG.C_SDA_INERTIAL_DELAY 197 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 637.4347171646853 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16384 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_10_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 54 -to 0 ip_11_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_11_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 171 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 115 -to 0 ip_13_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 171 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_3_reset/peripheral_areset_n] [get_bd_pins ip_1_axi_iic/reset]
connect_bd_net [get_bd_pins ip_4_clk_wiz/clk_out] [get_bd_pins ip_0_accumulator/clk]
connect_bd_net [get_bd_pins ip_4_clk_wiz/clk_out] [get_bd_pins ip_1_axi_iic/clk]
...
connect_bd_net [get_bd_pins ip_5_intc/irq_0] [get_bd_pins ip_1_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_iic/AXI] [get_bd_intf_pins ip_7_axi/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/S_AXIS_DATA] [get_bd_intf_pins ip_9_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_2_fft/M_AXIS_DATA]
