...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xfffffff CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 39 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 40 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 38 -to 0 ip_10_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_10_slice_and_concat/slice_0]
