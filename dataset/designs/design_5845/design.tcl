...
create_bd_pin -dir O -from 29 -to 0 ip_11_slice_and_concat/out0
...
create_bd_pin -dir I -from 42 -to 0 ip_11_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_11_slice_and_concat/slice_2]
...
create_bd_pin -dir I -from 42 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_9_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_2] [get_bd_pins ip_1_accumulator/Q]
