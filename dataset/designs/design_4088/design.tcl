...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 28 CONFIG.convolution_code1 13 CONFIG.convolution_code2 39 CONFIG.convolution_code3 20 CONFIG.convolution_code4 77 CONFIG.convolution_code5 49 CONFIG.convolution_code6 59 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 11 CONFIG.output_rate 14 CONFIG.puncture_code0 11100001101 CONFIG.puncture_code1 01110101111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_2_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 38 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 39 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 38 -to 0 ip_13_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_13_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_10_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_6] [get_bd_pins ip_5_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_5_accumulator/Bypass]
