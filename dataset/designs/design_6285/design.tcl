...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 132 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 159 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 158 -to 0 ip_0_accumulator/Q
...
create_bd_pin -dir O -from 131 -to 0 ip_7_slice_and_concat/out0
create_bd_pin -dir I -from 158 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 131 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 27 -to 0 ip_8_slice_and_concat/out0
...
create_bd_pin -dir I -from 158 -to 0 ip_8_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 158 CONFIG.DIN_TO 132 CONFIG.DIN_WIDTH 159 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_uartlite/AXI] [get_bd_intf_pins ip_6_axi/AXI_S0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_1] [get_bd_pins ip_2_dft/RFFD]
