...
set_property -dict "CONFIG.NUM_PORTS 4 " [get_bd_cells ip_5_intc/concat_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_5_intc/irq_3
connect_bd_net [get_bd_pins ip_5_intc/irq_3] [get_bd_pins ip_5_intc/concat_0/In3]
...
set_property -dict "CONFIG.NUM_MI 4 CONFIG.NUM_SI 3 " [get_bd_cells ip_6_axi/axi_0]
...
connect_bd_net [get_bd_pins ip_5_intc/irq_2] [get_bd_pins ip_1_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_5_intc/irq_3] [get_bd_pins ip_2_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_6_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_6_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_6_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_6_axi/AXI_S2]
