...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_1_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 3 CONFIG.C_GPIO_WIDTH 22 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3b CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 250 CONFIG.C_SDA_INERTIAL_DELAY 210 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 263.72853856517804 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 31 CONFIG.aresetn 1 CONFIG.bportwidth 60 CONFIG.btuserwidth 127 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 2 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 1 " [get_bd_cells ip_14_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 24 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 179 -to 0 ip_21_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 101 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 102 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 113 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 114 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 144 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 145 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 154 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 159 CONFIG.DIN_TO 155 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 164 CONFIG.DIN_TO 160 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 165 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 174 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 179 CONFIG.DIN_TO 175 CONFIG.DIN_WIDTH 180 " [get_bd_cells ip_21_reduce/slice_31]
...
create_bd_pin -dir I -from 206 -to 0 ip_22_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 207 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 206 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 180 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 207 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 31 -to 0 ip_24_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 206 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 206 CONFIG.DIN_TO 181 CONFIG.DIN_WIDTH 207 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_3] [get_bd_pins ip_4_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_4] [get_bd_pins ip_5_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_13_intc/irq_5] [get_bd_pins ip_7_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_13_intc/irq_6] [get_bd_pins ip_8_axi_iic/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_7] [get_bd_pins ip_10_fft/event_frame_started]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/M_AXI] [get_bd_intf_pins ip_14_axi/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_14_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_14_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_gpio/AXI] [get_bd_intf_pins ip_14_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_14_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_9_complex_multiplier/M_AXIS_DOUT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_18_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_DATA] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_5_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/freeze]
...
if {[catch {
  ...
  set __s [expr {$__aw == 12 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_18_axis_dwidth_converter/M_AXIS declared=12 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_18_axis_dwidth_converter/M_AXIS declared=12 actual=ERR $__err" }
if {[catch {
