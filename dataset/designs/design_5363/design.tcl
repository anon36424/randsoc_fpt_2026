...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xc CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 169 CONFIG.C_SDA_INERTIAL_DELAY 196 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 701.4451852915048 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x6d8b3164daef2bb CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x45daee98e1333cd CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 6 CONFIG.convolution_code1 228 CONFIG.convolution_code2 114 CONFIG.convolution_code3 17 CONFIG.convolution_code4 157 CONFIG.convolution_code5 250 CONFIG.convolution_code6 28 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 9 CONFIG.output_rate 15 CONFIG.puncture_code0 111111010 CONFIG.puncture_code1 011111111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 26 CONFIG.aresetn 1 CONFIG.bportwidth 36 CONFIG.btuserwidth 141 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 24 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x20 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 134 CONFIG.C_SDA_INERTIAL_DELAY 109 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 503.57348204179584 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 50 CONFIG.aresetn 1 CONFIG.atuserwidth 7 CONFIG.bportwidth 23 CONFIG.btuserwidth 70 CONFIG.ctrltuserwidth 53 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 28 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 29 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4c CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 172 CONFIG.C_SDA_INERTIAL_DELAY 104 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 64.6273255065987 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_11_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x65 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 192 CONFIG.C_SDA_INERTIAL_DELAY 32 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 724.2667289533301 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_12_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 401 CONFIG.convolution_code1 271 CONFIG.convolution_code2 266 CONFIG.convolution_code3 52 CONFIG.convolution_code4 107 CONFIG.convolution_code5 112 CONFIG.convolution_code6 31 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 3 CONFIG.output_rate 5 CONFIG.puncture_code0 110 CONFIG.puncture_code1 111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_15_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 256 CONFIG.C_SPI_MEMORY 1 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_16_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 14 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_36_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_9] [get_bd_pins ip_14_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_20_intc/irq_10] [get_bd_pins ip_16_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_21_axi/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_21_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_timer/S_AXI] [get_bd_intf_pins ip_21_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_21_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_21_axi/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_35_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_3] [get_bd_pins ip_17_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_4] [get_bd_pins ip_17_xadc_wiz/eos_out]
...
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_0] [get_bd_pins ip_17_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_0] [get_bd_pins ip_17_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_0] [get_bd_pins ip_17_xadc_wiz/vbram_alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 19 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_35_axis_dwidth_converter/M_AXIS declared=19 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_35_axis_dwidth_converter/M_AXIS declared=19 actual=ERR $__err" }
if {[catch {
