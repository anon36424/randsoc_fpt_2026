...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 18 CONFIG.aresetn 0 CONFIG.atuserwidth 125 CONFIG.bportwidth 27 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 34 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 35 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 15 CONFIG.C_TAVDV_PS_MEM_0 16152 CONFIG.C_TAVDV_PS_MEM_1 16249 CONFIG.C_TCEDV_PS_MEM_0 15811 CONFIG.C_TCEDV_PS_MEM_1 13685 CONFIG.C_THZCE_PS_MEM_0 7672 CONFIG.C_THZCE_PS_MEM_1 6373 CONFIG.C_THZOE_PS_MEM_0 7184 CONFIG.C_THZOE_PS_MEM_1 7022 CONFIG.C_TLZWE_PS_MEM_0 9838 CONFIG.C_TLZWE_PS_MEM_1 8144 CONFIG.C_TWC_PS_MEM_0 14533 CONFIG.C_TWC_PS_MEM_1 14893 CONFIG.C_TWPH_PS_MEM_0 11922 CONFIG.C_TWPH_PS_MEM_1 11545 CONFIG.C_TWP_PS_MEM_0 11356 CONFIG.C_TWP_PS_MEM_1 11590 CONFIG.C_WR_REC_TIME_MEM_0 28866 CONFIG.C_WR_REC_TIME_MEM_1 27948 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_3_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 65536 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.AINIT_Value 38b5bb2a5cd7dc1510ff2295770e90af5ed29e9e1a6d4eb8d7c9730db2cce66a1 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 242 CONFIG.Latency 21 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 258 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 241 -to 0 ip_8_accumulator/B
...
create_bd_pin -dir I -from 257 -to 0 ip_24_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_24_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 241 -to 0 ip_25_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 257 CONFIG.DIN_TO 257 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_1] [get_bd_pins ip_3_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_12_axi_legacy/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_23_axis_combiner/M_AXIS]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_8_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_7_conv_encoder/aclken]
