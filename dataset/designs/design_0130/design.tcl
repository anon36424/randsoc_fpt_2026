...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 5 CONFIG.convolution_code0 8 CONFIG.convolution_code1 0 CONFIG.convolution_code2 25 CONFIG.convolution_code3 31 CONFIG.convolution_code4 23 CONFIG.convolution_code5 18 CONFIG.convolution_code6 31 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 9 CONFIG.output_rate 11 CONFIG.puncture_code0 101111011 CONFIG.puncture_code1 100110010 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_3_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 142 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 169 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 54 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_10_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 64 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 64 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 8 CONFIG.C_MEM3_TYPE 1 CONFIG.C_MEM3_WIDTH 64 CONFIG.C_NUM_BANKS_MEM 4 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_PARITY_TYPE_MEM_3 0 CONFIG.C_SYNCH_PIPEDELAY_0 2 CONFIG.C_SYNCH_PIPEDELAY_1 2 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 5 CONFIG.C_TAVDV_PS_MEM_2 16007 CONFIG.C_TAVDV_PS_MEM_3 13718 CONFIG.C_TCEDV_PS_MEM_2 16336 CONFIG.C_TCEDV_PS_MEM_3 14437 CONFIG.C_THZCE_PS_MEM_2 7333 CONFIG.C_THZCE_PS_MEM_3 6328 CONFIG.C_THZOE_PS_MEM_2 7097 CONFIG.C_THZOE_PS_MEM_3 6923 CONFIG.C_TLZWE_PS_MEM_2 2201 CONFIG.C_TLZWE_PS_MEM_3 9923 CONFIG.C_TWC_PS_MEM_2 15798 CONFIG.C_TWC_PS_MEM_3 14682 CONFIG.C_TWPH_PS_MEM_2 12716 CONFIG.C_TWPH_PS_MEM_3 10925 CONFIG.C_TWP_PS_MEM_2 12573 CONFIG.C_TWP_PS_MEM_3 12794 CONFIG.C_WR_REC_TIME_MEM_2 29030 CONFIG.C_WR_REC_TIME_MEM_3 27667 " [get_bd_cells ip_11_emc/emc_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 28 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 168 -to 0 ip_30_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 169 " [get_bd_cells ip_30_slice_and_concat/slice_5]
...
create_bd_pin -dir O -from 141 -to 0 ip_31_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 168 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 169 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_emc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_intc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXIS_MM2S] [get_bd_intf_pins ip_16_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_floating_point/S_AXIS_OPERATION] [get_bd_intf_pins ip_20_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_0] [get_bd_pins ip_6_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_6_axi_timer/pwm0]
...
if {[catch {
  ...
  set __s [expr {$__aw == 13 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_28_axis_dwidth_converter/M_AXIS declared=13 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_28_axis_dwidth_converter/M_AXIS declared=13 actual=ERR $__err" }
