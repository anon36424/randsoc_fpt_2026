...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 64 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 14 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6b CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 109 CONFIG.C_SDA_INERTIAL_DELAY 225 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 452.23722089670036 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xc91 CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x1ffff CONFIG.C_GPIO2_WIDTH 12 CONFIG.C_GPIO_WIDTH 17 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_11_gpio/gpio_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_4] [get_bd_pins ip_4_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_15_intc/irq_5] [get_bd_pins ip_5_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_15_intc/irq_6] [get_bd_pins ip_7_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_15_intc/irq_7] [get_bd_pins ip_8_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_15_intc/irq_8] [get_bd_pins ip_9_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_16_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_emc/AXI] [get_bd_intf_pins ip_16_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_16_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_gpio/AXI] [get_bd_intf_pins ip_16_axi/AXI_S8]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_8_xadc_wiz/alarm_out]
