...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xd CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 63 CONFIG.C_SDA_INERTIAL_DELAY 172 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 247.53599446109308 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_8_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_10_slice_and_concat/slice_0]
