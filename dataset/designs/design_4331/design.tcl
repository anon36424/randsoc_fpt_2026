...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 33 CONFIG.aresetn 0 CONFIG.bportwidth 51 CONFIG.btuserwidth 181 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 47 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
connect_bd_net [get_bd_pins ip_2_reset/peripheral_areset_n] [get_bd_pins ip_0_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_3_clk_wiz/clk_out] [get_bd_pins ip_0_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_4_intc/irq_0] [get_bd_pins ip_0_axi_timer/interrupt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_timer/S_AXI] [get_bd_intf_pins ip_5_axi_legacy/AXI_S0]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_1] [get_bd_pins ip_0_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_2] [get_bd_pins ip_0_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_1_complex_multiplier/aclken]
