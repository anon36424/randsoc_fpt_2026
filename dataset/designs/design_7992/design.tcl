...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 24 CONFIG.aresetn 1 CONFIG.atuserwidth 129 CONFIG.bportwidth 29 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 53 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5a CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 131 CONFIG.C_SDA_INERTIAL_DELAY 107 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 635.6254140679013 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x67 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 117 CONFIG.C_SDA_INERTIAL_DELAY 69 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 329.9258482227598 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x7927c14ff53f14 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xbdfc6d944081fe9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_9_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 2048 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_12_dft/dft_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32 " [get_bd_cells ip_13_fft/fft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 37 CONFIG.aresetn 1 CONFIG.atuserwidth 133 CONFIG.bportwidth 17 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 4 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 49 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_16_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 1024 " [get_bd_cells ip_19_fft/fft_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_20_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_BAUDRATE 230400 CONFIG.C_DATA_BITS 5 CONFIG.PARITY No_Parity " [get_bd_cells ip_23_uartlite/uart_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 8 " [get_bd_cells ip_43_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_56_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_57_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_25_reset/peripheral_areset] [get_bd_pins ip_14_xadc_wiz/reset_in]
...
connect_bd_net [get_bd_pins ip_26_clk_wiz/clk_out] [get_bd_pins ip_14_xadc_wiz/dclk_in]
...
connect_bd_net [get_bd_pins ip_27_intc/irq_7] [get_bd_pins ip_15_axi_quad_spi/irq]
...
connect_bd_net [get_bd_pins ip_27_intc/irq_10] [get_bd_pins ip_20_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_27_intc/irq_11] [get_bd_pins ip_22_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_microblaze/M_AXI_DP] [get_bd_intf_pins ip_28_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_cdma/M_AXI] [get_bd_intf_pins ip_28_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_28_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_iic/AXI] [get_bd_intf_pins ip_28_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_28_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_28_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_28_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_28_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_28_axi_legacy/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_30_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_38_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_24_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_DATA] [get_bd_intf_pins ip_51_axis_combiner/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_33_axis_broadcaster/M_AXIS_4]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_20_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_0] [get_bd_pins ip_12_dft/RFFD]
...
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_12_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_57_slice_and_concat/in_7] [get_bd_pins ip_14_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/in_8] [get_bd_pins ip_14_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/in_9] [get_bd_pins ip_14_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_14_xadc_wiz/convst_in]
...
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_17_cordic/aclken]
...
connect_bd_net [get_bd_pins ip_63_slice_and_concat/out0] [get_bd_pins ip_11_floating_point/aclken]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_10_fft/S_AXIS_CONFIG declared=35 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_fft/S_AXIS_CONFIG declared=35 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 112 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_52_axis_combiner/S_AXIS_0 declared=112 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_52_axis_combiner/S_AXIS_0 declared=112 actual=ERR $__err" }
if {[catch {
