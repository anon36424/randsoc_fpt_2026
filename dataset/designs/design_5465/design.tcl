...
set_property -dict "CONFIG.C_ADDR_WIDTH 37 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_7_slice_and_concat/slice_0]
