...
set_property -dict "CONFIG.AINIT_Value 71abbddf98ecbacf37eb2a55b24006ea6fa28a1da156ea19323ec2ab111ab49 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 243 CONFIG.Latency 13 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 253 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 242 -to 0 ip_0_accumulator/B
connect_bd_net [get_bd_pins ip_0_accumulator/B] [get_bd_pins ip_0_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 252 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 27 CONFIG.aresetn 0 CONFIG.atuserwidth 11 CONFIG.bportwidth 43 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 23 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 5 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x6f934 CONFIG.C_GPIO2_WIDTH 27 CONFIG.C_GPIO_WIDTH 20 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 27 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 31 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16384 " [get_bd_cells ip_8_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 51 CONFIG.aresetn 0 CONFIG.bportwidth 37 CONFIG.btuserwidth 41 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 46 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 256 " [get_bd_cells ip_10_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_SYNCH_PIPEDELAY_1 1 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 7 CONFIG.C_TAVDV_PS_MEM_0 14698 CONFIG.C_TCEDV_PS_MEM_0 15637 CONFIG.C_THZCE_PS_MEM_0 6858 CONFIG.C_THZOE_PS_MEM_0 7060 CONFIG.C_TLZWE_PS_MEM_0 8760 CONFIG.C_TWC_PS_MEM_0 14386 CONFIG.C_TWPH_PS_MEM_0 11762 CONFIG.C_TWP_PS_MEM_0 11096 CONFIG.C_WR_REC_TIME_MEM_0 24403 " [get_bd_cells ip_12_emc/emc_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 7 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_13_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 120 CONFIG.C_SDA_INERTIAL_DELAY 62 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 740.9514081076308 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_15_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 32 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_17_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 242 -to 0 ip_35_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 252 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 30 -to 0 ip_35_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_35_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 31 " [get_bd_cells ip_35_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 31 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 31 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_9] [get_bd_pins ip_16_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_fft/S_AXIS_DATA] [get_bd_intf_pins ip_8_fft/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_5] [get_bd_pins ip_14_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_6] [get_bd_pins ip_14_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_7] [get_bd_pins ip_14_axi_timer/pwm0]
...
if {[catch {
  ...
  set __s [expr {$__aw == 36 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_33_axis_dwidth_converter/M_AXIS declared=36 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_33_axis_dwidth_converter/M_AXIS declared=36 actual=ERR $__err" }
