...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 CONFIG.C_TAVDV_PS_MEM_0 14451 CONFIG.C_TCEDV_PS_MEM_0 14840 CONFIG.C_THZCE_PS_MEM_0 7246 CONFIG.C_THZOE_PS_MEM_0 6679 CONFIG.C_TLZWE_PS_MEM_0 6434 CONFIG.C_TWC_PS_MEM_0 14810 CONFIG.C_TWPH_PS_MEM_0 11815 CONFIG.C_TWP_PS_MEM_0 12765 CONFIG.C_WR_REC_TIME_MEM_0 24722 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 25 CONFIG.aresetn 1 CONFIG.atuserwidth 194 CONFIG.bportwidth 28 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 25 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 24 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 26 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 64 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_SYNCH_PIPEDELAY_1 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 10 CONFIG.C_TAVDV_PS_MEM_0 13647 CONFIG.C_TAVDV_PS_MEM_2 16167 CONFIG.C_TCEDV_PS_MEM_0 16243 CONFIG.C_TCEDV_PS_MEM_2 15002 CONFIG.C_THZCE_PS_MEM_0 6718 CONFIG.C_THZCE_PS_MEM_2 7454 CONFIG.C_THZOE_PS_MEM_0 7692 CONFIG.C_THZOE_PS_MEM_2 7316 CONFIG.C_TLZWE_PS_MEM_0 4642 CONFIG.C_TLZWE_PS_MEM_2 4017 CONFIG.C_TWC_PS_MEM_0 13862 CONFIG.C_TWC_PS_MEM_2 16237 CONFIG.C_TWPH_PS_MEM_0 11491 CONFIG.C_TWPH_PS_MEM_2 12230 CONFIG.C_TWP_PS_MEM_0 11985 CONFIG.C_TWP_PS_MEM_2 13176 CONFIG.C_WR_REC_TIME_MEM_0 25078 CONFIG.C_WR_REC_TIME_MEM_2 25499 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 26 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 26 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_floating_point/S_AXIS_C] [get_bd_intf_pins ip_20_axis_dwidth_converter/M_AXIS]
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_7_floating_point/S_AXIS_C declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_7_floating_point/S_AXIS_C declared=48 actual=ERR $__err" }
if {[catch {
