...
set_property -dict "CONFIG.C_MASK 0xddb49f2ff77c52 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x3eb1c8849371f11 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4e CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 59 CONFIG.C_SDA_INERTIAL_DELAY 238 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 795.0992033003446 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3 CONFIG.C_DOUT_DEFAULT_2 0x3 CONFIG.C_GPIO2_WIDTH 6 CONFIG.C_GPIO_WIDTH 2 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x3 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 3 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 15215 CONFIG.C_TAVDV_PS_MEM_1 15197 CONFIG.C_TAVDV_PS_MEM_2 16028 CONFIG.C_TCEDV_PS_MEM_0 14400 CONFIG.C_TCEDV_PS_MEM_1 13579 CONFIG.C_TCEDV_PS_MEM_2 16164 CONFIG.C_THZCE_PS_MEM_0 6490 CONFIG.C_THZCE_PS_MEM_1 7375 CONFIG.C_THZCE_PS_MEM_2 7459 CONFIG.C_THZOE_PS_MEM_0 6504 CONFIG.C_THZOE_PS_MEM_1 6644 CONFIG.C_THZOE_PS_MEM_2 6621 CONFIG.C_TLZWE_PS_MEM_0 3686 CONFIG.C_TLZWE_PS_MEM_1 1109 CONFIG.C_TLZWE_PS_MEM_2 1680 CONFIG.C_TWC_PS_MEM_0 13852 CONFIG.C_TWC_PS_MEM_1 14992 CONFIG.C_TWC_PS_MEM_2 15691 CONFIG.C_TWPH_PS_MEM_0 11741 CONFIG.C_TWPH_PS_MEM_1 12552 CONFIG.C_TWPH_PS_MEM_2 12607 CONFIG.C_TWP_PS_MEM_0 12906 CONFIG.C_TWP_PS_MEM_1 12420 CONFIG.C_TWP_PS_MEM_2 10878 CONFIG.C_WR_REC_TIME_MEM_0 28712 CONFIG.C_WR_REC_TIME_MEM_1 24932 CONFIG.C_WR_REC_TIME_MEM_2 27587 " [get_bd_cells ip_5_emc/emc_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_6_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xffffffff CONFIG.C_GPIO_WIDTH 32 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 128 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_5] [get_bd_pins ip_6_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_10_intc/irq_6] [get_bd_pins ip_7_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_11_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_gpio/AXI] [get_bd_intf_pins ip_11_axi/AXI_S6]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_4_axi_dma/M_AXIS_MM2S declared=1024 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_4_axi_dma/M_AXIS_MM2S declared=1024 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_4_axi_dma/axi_dma_0/S_AXIS_S2MM]] * 8}]
  set __s [expr {$__aw == 1024 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_4_axi_dma/S_AXIS_S2MM declared=1024 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_4_axi_dma/S_AXIS_S2MM declared=1024 actual=ERR $__err" }
if {[catch {
