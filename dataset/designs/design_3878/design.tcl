...
set_property -dict "CONFIG.AINIT_Value 3ffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 128 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 162 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 127 -to 0 ip_0_accumulator/B
connect_bd_net [get_bd_pins ip_0_accumulator/B] [get_bd_pins ip_0_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 161 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 145 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 227 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_MASK 0xb2e7e3711858160 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x4471bcf6f3b815 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 3 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 28 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
set_property -dict "CONFIG.NUM_MI 5 CONFIG.NUM_SI 4 " [get_bd_cells ip_12_axi_legacy/axi_0]
...
create_bd_pin -dir I -from 139 -to 0 ip_15_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 127 CONFIG.DIN_TO 124 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 131 CONFIG.DIN_TO 128 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 135 CONFIG.DIN_TO 132 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 136 CONFIG.DIN_WIDTH 140 " [get_bd_cells ip_15_reduce/slice_31]
...
create_bd_pin -dir O -from 139 -to 0 ip_16_slice_and_concat/out0
create_bd_pin -dir I -from 161 -to 0 ip_16_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 162 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 144 -to 0 ip_17_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 161 -to 0 ip_17_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 161 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 162 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 226 -to 0 ip_17_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 122 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_17_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 226 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 123 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 127 -to 0 ip_19_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 226 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 226 CONFIG.DIN_TO 124 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 27 -to 0 ip_19_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 28 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 2 -to 0 ip_20_slice_and_concat/out0
create_bd_pin -dir I -from 27 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 28 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_9_reset/peripheral_areset_n] [get_bd_pins ip_8_axi_hwicap/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_7_axi_dma/m_axi_sg_aclk]
...
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_8_axi_hwicap/icap_clk]
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_8_axi_hwicap/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_4] [get_bd_pins ip_8_axi_hwicap/ip2intc_irpt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_microblaze/INTERRUPT] [get_bd_intf_pins ip_11_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_microblaze/M_AXI_DP] [get_bd_intf_pins ip_12_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_12_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_12_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_12_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_uartlite/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_gpio/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_1] [get_bd_pins ip_1_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/ADD]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/SCLR]
