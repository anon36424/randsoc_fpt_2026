...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 1 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_SHARED_STARTUP 0 " [get_bd_cells ip_0_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 138 CONFIG.Latency 12 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 234 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 137 -to 0 ip_4_accumulator/B
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 216 CONFIG.convolution_code1 362 CONFIG.convolution_code2 396 CONFIG.convolution_code3 388 CONFIG.convolution_code4 64 CONFIG.convolution_code5 85 CONFIG.convolution_code6 142 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 2 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 1 " [get_bd_cells ip_7_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.NUM_SI 4 " [get_bd_cells ip_22_axis_combiner/axis_combiner_0]
...
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 ip_22_axis_combiner/S_AXIS_3
connect_bd_intf_net [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_22_axis_combiner/axis_combiner_0/S03_AXIS]
...
create_bd_pin -dir I -from 95 -to 0 ip_24_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 86 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 87 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 96 " [get_bd_cells ip_24_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_25_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 233 -to 0 ip_28_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 131 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 234 " [get_bd_cells ip_28_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 137 CONFIG.DIN_TO 132 CONFIG.DIN_WIDTH 234 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 95 -to 0 ip_30_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 233 CONFIG.DIN_TO 138 CONFIG.DIN_WIDTH 234 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_reset/peripheral_areset_n] [get_bd_pins ip_0_axi_hwicap/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_8_reset/interconnect_aresetn] [get_bd_pins ip_7_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_0_axi_hwicap/icap_clk]
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_0_axi_hwicap/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_3_dft/CLK]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_7_conv_encoder/aclk]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_0] [get_bd_pins ip_0_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_10_intc/irq_1] [get_bd_pins ip_5_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_10_intc/irq_2] [get_bd_pins ip_5_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI] [get_bd_intf_pins ip_11_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_11_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_11_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_intc/AXI] [get_bd_intf_pins ip_11_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_13_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_12_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_13_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_14_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_3] [get_bd_pins ip_4_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_7_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_8_reset/interconnect_aresetn] [get_bd_pins ip_22_axis_combiner/aresetn]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_22_axis_combiner/aclk]
...
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_22_axis_combiner/axis_combiner_0/S03_AXIS]] * 8}]
  set __s [expr {$__aw == 8 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_combiner/S_AXIS_3 declared=8 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_combiner/S_AXIS_3 declared=8 actual=ERR $__err" }
if {[catch {
