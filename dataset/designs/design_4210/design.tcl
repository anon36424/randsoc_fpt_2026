...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 175 CONFIG.Latency 4 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 254 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 174 -to 0 ip_0_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x827c6e0cdd3cf0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xf21fcb71e16c41f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir O -from 174 -to 0 ip_9_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 174 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 182 CONFIG.DIN_TO 175 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 79 -to 0 ip_11_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 253 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 253 CONFIG.DIN_TO 183 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_7_axi_legacy/AXI_S0]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_3_dft/RFFD]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_2] [get_bd_pins ip_3_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_0] [get_bd_pins ip_3_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_1] [get_bd_pins ip_3_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_2] [get_bd_pins ip_3_dft/DATA_VALID]
