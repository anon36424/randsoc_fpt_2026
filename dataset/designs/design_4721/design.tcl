...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 1 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 " [get_bd_cells ip_1_emc/emc_0]
...
create_bd_pin -dir O -from 42 -to 0 ip_5_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_5_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/C_IN]
