...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x17c5 CONFIG.C_DOUT_DEFAULT_2 0x1492 CONFIG.C_GPIO2_WIDTH 15 CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x54a " [get_bd_cells ip_1_gpio/gpio_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_4] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_5] [get_bd_pins ip_2_axi_timer/pwm0]
