...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 12 CONFIG.aresetn 1 CONFIG.bportwidth 57 CONFIG.ctrltuserwidth 124 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 40 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 59 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 1 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 17 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_6_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x13 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 202 CONFIG.C_SDA_INERTIAL_DELAY 226 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 268.6471996917684 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_PORTS 11 " [get_bd_cells ip_12_intc/concat_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_12_intc/irq_9
connect_bd_net [get_bd_pins ip_12_intc/irq_9] [get_bd_pins ip_12_intc/concat_0/In9]
create_bd_pin -dir I -from 0 -to 0 ip_12_intc/irq_10
connect_bd_net [get_bd_pins ip_12_intc/irq_10] [get_bd_pins ip_12_intc/concat_0/In10]
...
set_property -dict "CONFIG.NUM_MI 9 CONFIG.NUM_SI 5 " [get_bd_cells ip_13_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_17_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 128 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_18_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 16 -to 0 ip_23_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_23_slice_and_concat/slice_3]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_2] [get_bd_pins ip_1_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_12_intc/irq_3] [get_bd_pins ip_1_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_12_intc/irq_4] [get_bd_pins ip_2_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_12_intc/irq_5] [get_bd_pins ip_2_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_12_intc/irq_6] [get_bd_pins ip_4_gpio/irq]
connect_bd_net [get_bd_pins ip_12_intc/irq_7] [get_bd_pins ip_5_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_12_intc/irq_8] [get_bd_pins ip_7_uartlite/irq]
connect_bd_net [get_bd_pins ip_12_intc/irq_9] [get_bd_pins ip_8_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_12_intc/irq_10] [get_bd_pins ip_9_axi_iic/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI] [get_bd_intf_pins ip_13_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_13_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_13_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_13_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_13_axi/AXI_M4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_gpio/AXI] [get_bd_intf_pins ip_13_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_13_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_iic/AXI] [get_bd_intf_pins ip_13_axi/AXI_S7]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_2] [get_bd_pins ip_6_dft/RFFD]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_3] [get_bd_pins ip_6_dft/XK_RE]
