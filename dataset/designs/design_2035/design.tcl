...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2e CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 83 CONFIG.C_SDA_INERTIAL_DELAY 44 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 236.887283707947 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 90 CONFIG.convolution_code1 116 CONFIG.convolution_code2 118 CONFIG.convolution_code3 89 CONFIG.convolution_code4 116 CONFIG.convolution_code5 124 CONFIG.convolution_code6 56 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 10 CONFIG.output_rate 16 CONFIG.puncture_code0 1111111100 CONFIG.puncture_code1 1111010111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_3_conv_encoder/conv_encoder_0]
...
connect_bd_net [get_bd_pins ip_6_intc/irq_2] [get_bd_pins ip_2_axi_iic/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_7_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI] [get_bd_intf_pins ip_7_axi/AXI_M1]
