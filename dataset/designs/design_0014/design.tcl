...
set_property -dict "CONFIG.C_ADDR_WIDTH 52 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 34 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x55 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 129 CONFIG.C_SDA_INERTIAL_DELAY 127 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 991.4637250857254 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 16 CONFIG.aresetn 0 CONFIG.atuserwidth 38 CONFIG.bportwidth 11 CONFIG.btuserwidth 17 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 25 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 2 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_5_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1fffffff CONFIG.C_GPIO_WIDTH 29 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x1fffffff " [get_bd_cells ip_11_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 4 " [get_bd_cells ip_15_axi_legacy/axi_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_9] [get_bd_pins ip_11_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_15_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_gpio/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_4_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_4_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_4_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_10_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_10_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_7] [get_bd_pins ip_10_axi_timer/pwm0]
