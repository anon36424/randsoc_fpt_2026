...
set_property -dict "CONFIG.AINIT_Value 16bbc9f018da20089ed04351c81f451f4cae93c694e15c8d30ca957eab42444a CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 244 CONFIG.Latency 7 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 254 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 243 -to 0 ip_0_accumulator/B
...
set_property -dict "CONFIG.C_BAUDRATE 1200 CONFIG.C_DATA_BITS 7 CONFIG.PARITY No_Parity " [get_bd_cells ip_1_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x5599406 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 30 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x3fffffff CONFIG.C_TRI_DEFAULT_2 0x3fffffff " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 31 CONFIG.aresetn 0 CONFIG.bportwidth 59 CONFIG.btuserwidth 143 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 12 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 16 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 243 -to 0 ip_21_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 253 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_21_slice_and_concat/slice_0]
