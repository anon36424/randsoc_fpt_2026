...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 407 CONFIG.convolution_code1 100 CONFIG.convolution_code2 300 CONFIG.convolution_code3 75 CONFIG.convolution_code4 487 CONFIG.convolution_code5 178 CONFIG.convolution_code6 336 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 2 CONFIG.output_rate 3 CONFIG.puncture_code0 10 CONFIG.puncture_code1 11 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_5_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xf CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 174 CONFIG.C_SDA_INERTIAL_DELAY 137 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 406.5081631160316 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 46 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_8_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 241 CONFIG.Latency 14 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 241 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_14_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 240 -to 0 ip_14_accumulator/B
...
create_bd_pin -dir O -from 240 -to 0 ip_26_slice_and_concat/out0
...
create_bd_pin -dir I -from 15 -to 0 ip_26_slice_and_concat/in_5
...
create_bd_pin -dir I -from 240 -to 0 ip_26_slice_and_concat/in_15
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_15
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_15]
set_property -dict "CONFIG.DIN_FROM 192 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_26_slice_and_concat/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 208 CONFIG.DIN_TO 193 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 218 CONFIG.DIN_TO 209 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 224 CONFIG.DIN_TO 219 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 240 CONFIG.DIN_TO 225 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_1] [get_bd_pins ip_7_axi_iic/irq]
connect_bd_net [get_bd_pins ip_17_intc/irq_2] [get_bd_pins ip_8_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_iic/AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S6]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_9] [get_bd_pins ip_11_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_10] [get_bd_pins ip_11_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_11] [get_bd_pins ip_11_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_12] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_13] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_14] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_15] [get_bd_pins ip_14_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_3_conv_encoder/aclken]
