...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1b CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 160 CONFIG.C_SDA_INERTIAL_DELAY 143 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 567.4264208370809 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 37 CONFIG.C_ENABLE_MULTI_CHANNEL 0 CONFIG.C_INCLUDE_MM2S 1 CONFIG.C_INCLUDE_MM2S_DRE 1 CONFIG.C_INCLUDE_S2MM 0 CONFIG.C_INCLUDE_SG 1 CONFIG.C_MICRO_DMA 0 CONFIG.C_MM2S_BURST_SIZE 2 CONFIG.C_M_AXIS_MM2S_TDATA_WIDTH 512 CONFIG.C_M_AXI_MM2S_DATA_WIDTH 1024 CONFIG.C_SG_INCLUDE_STSCNTRL_STRM 1 CONFIG.C_SG_LENGTH_WIDTH 15 CONFIG.C_SINGLE_INTERFACE 0 " [get_bd_cells ip_1_axi_dma/axi_dma_0]
...
set_property -dict "CONFIG.C_MASK 0x748c21c72db50f3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xda702fa1b8a3fe4 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.AINIT_Value 1b505139715dbbfd229a5fcc4d3726a2cc1b3796fc92a534b61a94097ed6d1b79 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 252 CONFIG.Latency 25 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 257 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 251 -to 0 ip_3_accumulator/B
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_7_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 1 CONFIG.C_WRITE_FIFO_DEPTH 512 " [get_bd_cells ip_9_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 64 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 3 " [get_bd_cells ip_27_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 33 " [get_bd_cells ip_32_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 82 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 40 -to 0 ip_43_slice_and_concat/in_1
...
create_bd_pin -dir I -from 12 -to 0 ip_43_slice_and_concat/in_6
...
connect_bd_net [get_bd_pins ip_18_reset/peripheral_areset] [get_bd_pins ip_16_dft/SCLR]
...
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_1_axi_dma/m_axi_sg_aclk]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_3] [get_bd_pins ip_9_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_21_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_21_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_microblaze/M_AXI_DP] [get_bd_intf_pins ip_21_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_21_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_21_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_21_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_21_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_21_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_21_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXIS_CNTRL] [get_bd_intf_pins ip_22_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_25_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_31_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_31_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_6_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_35_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_35_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_4]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_2] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_3] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_4] [get_bd_pins ip_7_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/ADD]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_6_complex_multiplier/M_AXIS_DOUT declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_6_complex_multiplier/M_AXIS_DOUT declared=224 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_combiner/S_AXIS_1 declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_combiner/S_AXIS_1 declared=224 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_combiner/M_AXIS declared=264 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_combiner/M_AXIS declared=264 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 264 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_32_axis_dwidth_converter/S_AXIS declared=264 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_32_axis_dwidth_converter/S_AXIS declared=264 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_33_axis_combiner/S_AXIS_2 declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_33_axis_combiner/S_AXIS_2 declared=40 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/S_AXIS_3 declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/S_AXIS_3 declared=40 actual=ERR $__err" }
if {[catch {
