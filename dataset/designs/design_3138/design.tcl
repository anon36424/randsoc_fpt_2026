...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xe CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 244 CONFIG.C_SDA_INERTIAL_DELAY 42 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 877.0348270896696 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_11_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_12_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_0_axi_timer/generateout0]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_0_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_0_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_2] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_3] [get_bd_pins ip_1_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_4] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_5] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_6] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_7] [get_bd_pins ip_5_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_8] [get_bd_pins ip_5_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_9] [get_bd_pins ip_5_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_5_xadc_wiz/ot_out]
