...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 258 CONFIG.convolution_code1 134 CONFIG.convolution_code2 92 CONFIG.convolution_code3 432 CONFIG.convolution_code4 51 CONFIG.convolution_code5 427 CONFIG.convolution_code6 33 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 6 CONFIG.output_rate 11 CONFIG.puncture_code0 111111 CONFIG.puncture_code1 011111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir O -from 0 -to 0 ip_5_slice_and_concat/out0
create_bd_pin -dir I -from 0 -to 0 ip_5_slice_and_concat/in_0


########## slice_and_concat ##########
create_bd_cell -type hier ip_6_slice_and_concat
create_bd_pin -dir O -from 11 -to 0 ip_6_slice_and_concat/out0
create_bd_pin -dir I -from 11 -to 0 ip_6_slice_and_concat/in_0
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_5_slice_and_concat/out0] [get_bd_pins ip_5_slice_and_concat/in_0]
...
connect_bd_net [get_bd_pins ip_7_slice_and_concat/out0] [get_bd_pins ip_1_dft/SIZE]
