...
set_property -dict "CONFIG.C_ADDR_WIDTH 55 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 62 CONFIG.aresetn 0 CONFIG.bportwidth 9 CONFIG.btuserwidth 131 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 50 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 248 CONFIG.Latency 13 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 250 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 247 -to 0 ip_6_accumulator/B
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_8_dft/dft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 53 CONFIG.aresetn 1 CONFIG.bportwidth 31 CONFIG.btuserwidth 74 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 11 CONFIG.roundmode Truncate " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_12_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3f CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 36 CONFIG.C_SDA_INERTIAL_DELAY 137 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 101.65085183797612 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 64 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 " [get_bd_cells ip_14_emc/emc_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 49 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_17_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 2048 " [get_bd_cells ip_18_fft/fft_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 5 " [get_bd_cells ip_22_axi_legacy/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_38_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_39_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_47_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_48_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 82 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_49_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 247 -to 0 ip_51_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_51_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 19 " [get_bd_cells ip_51_slice_and_concat/concat]
...
set_property -dict "CONFIG.DIN_FROM 249 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 250 " [get_bd_cells ip_51_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_51_slice_and_concat/in_8
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_8] [get_bd_pins ip_51_slice_and_concat/concat/In8]
create_bd_pin -dir I -from 17 -to 0 ip_51_slice_and_concat/in_9
...
connect_bd_net [get_bd_pins ip_20_clk_wiz/clk_out] [get_bd_pins ip_5_axi_dma/m_axi_mm2s_aclk]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_2] [get_bd_pins ip_5_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_3] [get_bd_pins ip_11_uartlite/irq]
connect_bd_net [get_bd_pins ip_21_intc/irq_4] [get_bd_pins ip_13_axi_iic/irq]
connect_bd_net [get_bd_pins ip_21_intc/irq_5] [get_bd_pins ip_15_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_6] [get_bd_pins ip_15_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_7] [get_bd_pins ip_16_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_21_intc/irq_8] [get_bd_pins ip_17_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_22_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_22_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_uartlite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_iic/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_emc/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_22_axi_legacy/AXI_S7]
...
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_4] [get_bd_pins ip_2_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_5] [get_bd_pins ip_2_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_1] [get_bd_pins ip_8_dft/RFFD]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_2] [get_bd_pins ip_8_dft/XK_RE]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_3] [get_bd_pins ip_8_dft/XK_IM]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_4] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_5] [get_bd_pins ip_8_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_6] [get_bd_pins ip_8_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_7] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_8] [get_bd_pins ip_9_dft/XK_RE]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_9] [get_bd_pins ip_9_dft/XK_IM]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_10] [get_bd_pins ip_9_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_11] [get_bd_pins ip_9_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_12] [get_bd_pins ip_9_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_13] [get_bd_pins ip_12_dft/RFFD]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_14] [get_bd_pins ip_12_dft/XK_RE]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_15] [get_bd_pins ip_12_dft/XK_IM]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_16] [get_bd_pins ip_12_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_17] [get_bd_pins ip_12_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_18] [get_bd_pins ip_12_dft/DATA_VALID]
