...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 55 CONFIG.aresetn 1 CONFIG.bportwidth 15 CONFIG.btuserwidth 139 CONFIG.ctrltuserwidth 146 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 25 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 63 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
connect_bd_net [get_bd_pins ip_7_intc/irq_4] [get_bd_pins ip_4_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_uartlite/AXI] [get_bd_intf_pins ip_8_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_8_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_8_axi/AXI_S3]
