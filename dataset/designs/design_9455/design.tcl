...
create_bd_pin -dir I -from 190 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 32 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 5 CONFIG.C_TAVDV_PS_MEM_0 15943 CONFIG.C_TAVDV_PS_MEM_1 16408 CONFIG.C_TCEDV_PS_MEM_0 15303 CONFIG.C_TCEDV_PS_MEM_1 14264 CONFIG.C_THZCE_PS_MEM_0 7088 CONFIG.C_THZCE_PS_MEM_1 6799 CONFIG.C_THZOE_PS_MEM_0 6629 CONFIG.C_THZOE_PS_MEM_1 7158 CONFIG.C_TLZWE_PS_MEM_0 6382 CONFIG.C_TLZWE_PS_MEM_1 6167 CONFIG.C_TWC_PS_MEM_0 13772 CONFIG.C_TWC_PS_MEM_1 13753 CONFIG.C_TWPH_PS_MEM_0 12820 CONFIG.C_TWPH_PS_MEM_1 11429 CONFIG.C_TWP_PS_MEM_0 13072 CONFIG.C_TWP_PS_MEM_1 11629 CONFIG.C_WR_REC_TIME_MEM_0 24460 CONFIG.C_WR_REC_TIME_MEM_1 27129 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5c CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 162 CONFIG.C_SDA_INERTIAL_DELAY 23 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 825.7508533956773 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_14_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 214 -to 0 ip_17_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_17_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 190 -to 0 ip_18_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 214 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 214 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_1] [get_bd_pins ip_7_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_emc/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_5_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_5_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_6] [get_bd_pins ip_5_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_5_xadc_wiz/convst_in]
