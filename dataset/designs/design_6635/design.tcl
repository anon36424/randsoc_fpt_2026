...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3f CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 24 CONFIG.C_SDA_INERTIAL_DELAY 248 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 158.1046559813183 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 215 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 241 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 214 -to 0 ip_2_accumulator/B
...
create_bd_pin -dir I -from 240 -to 0 ip_8_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 214 -to 0 ip_9_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 240 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_9_slice_and_concat/slice_0]
