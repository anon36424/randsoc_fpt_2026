...
create_bd_pin -dir O -from 5 -to 0 ip_4_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_4_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 6 " [get_bd_cells ip_4_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_4_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_4] [get_bd_pins ip_4_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 0 -to 0 ip_4_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_5] [get_bd_pins ip_4_slice_and_concat/concat/In5]


########## slice_and_concat ##########
create_bd_cell -type hier ip_5_slice_and_concat
create_bd_pin -dir O -from 15 -to 0 ip_5_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 15 -to 0 ip_5_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_5_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 6 -to 0 ip_6_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 15 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_6_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 15 -to 0 ip_7_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_7_slice_and_concat/in_3
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_3] [get_bd_pins ip_7_slice_and_concat/concat/In3]
...
connect_bd_net [get_bd_pins ip_4_slice_and_concat/out0] [get_bd_pins ip_1_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_4] [get_bd_pins ip_0_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_5] [get_bd_pins ip_0_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_3] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_1_dft/FWD_INV]
