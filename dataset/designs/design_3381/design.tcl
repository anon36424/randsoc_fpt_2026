...
set_property -dict "CONFIG.C_MASK 0x9e7edad996e0e83 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x9dbdd27da1a82b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.AINIT_Value 2e3e24df89282b62afaf4d239b170512270ba9cb060a8ef8e50810dd28bb CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 146 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 238 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 145 -to 0 ip_3_accumulator/B
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 46 CONFIG.Iterations 20 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 8 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 38 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_4_cordic/cordic_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 16 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_5_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 8 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_7_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.NUM_MI 3 CONFIG.NUM_SI 1 " [get_bd_cells ip_12_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_15_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 103 -to 0 ip_16_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_16_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 61 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 62 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 82 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 83 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 88 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 89 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 101 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_16_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_16_reduce/reduce_31]
...
create_bd_pin -dir O -from 47 -to 0 ip_17_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 7 " [get_bd_cells ip_17_slice_and_concat/concat]
...
create_bd_pin -dir I -from 237 -to 0 ip_17_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 238 " [get_bd_cells ip_17_slice_and_concat/slice_6]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_6] [get_bd_pins ip_17_slice_and_concat/slice_6/din]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/slice_6/dout] [get_bd_pins ip_17_slice_and_concat/concat/In6]


########## slice_and_concat ##########
create_bd_cell -type hier ip_18_slice_and_concat
create_bd_pin -dir O -from 145 -to 0 ip_18_slice_and_concat/out0
create_bd_pin -dir I -from 237 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 187 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 238 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 103 -to 0 ip_19_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 237 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 237 CONFIG.DIN_TO 188 CONFIG.DIN_WIDTH 238 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 47 -to 0 ip_19_slice_and_concat/in_7
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_9_reset/mb_reset] [get_bd_pins ip_2_microblaze/Reset]
connect_bd_net [get_bd_pins ip_9_reset/peripheral_areset_n] [get_bd_pins ip_5_axi_timer/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_0_xadc_wiz/convstclk_in]
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_2_microblaze/Clk]
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_3_accumulator/clk]
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_5_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_0] [get_bd_pins ip_5_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_11_intc/irq_1] [get_bd_pins ip_7_axi_timer/interrupt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_microblaze/INTERRUPT] [get_bd_intf_pins ip_11_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_microblaze/M_AXI_DP] [get_bd_intf_pins ip_12_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_intc/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/B]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_1] [get_bd_pins ip_0_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_2] [get_bd_pins ip_0_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_4] [get_bd_pins ip_0_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_5] [get_bd_pins ip_0_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_6] [get_bd_pins ip_3_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_16_reduce/in0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_3_accumulator/Q]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_4] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_5] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_6] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_7] [get_bd_pins ip_8_accumulator/Q]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_7_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/CE]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_7_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_26_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_7_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_27_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/ot_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_dwidth_converter/M_AXIS declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_dwidth_converter/M_AXIS declared=24 actual=ERR $__err" }
