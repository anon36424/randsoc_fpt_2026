...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 62 CONFIG.aresetn 1 CONFIG.atuserwidth 69 CONFIG.bportwidth 41 CONFIG.btuserwidth 178 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 84 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_BAUDRATE 38400 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Odd " [get_bd_cells ip_1_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x55 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 162 CONFIG.C_SDA_INERTIAL_DELAY 68 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 156.71674288534956 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 105 CONFIG.C_SDA_INERTIAL_DELAY 153 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 707.6046393618194 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xcca10f2bf9f70ba CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x4c860c61b0c4a49 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 26 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 38 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 22 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 37 -to 0 ip_15_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_15_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 38 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/SCLR]
