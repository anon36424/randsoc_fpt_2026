...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2b CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 11 CONFIG.C_SDA_INERTIAL_DELAY 27 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 585.0435810866155 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 39 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x74 CONFIG.C_DOUT_DEFAULT_2 0x7f CONFIG.C_GPIO2_WIDTH 31 CONFIG.C_GPIO_WIDTH 7 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x7f CONFIG.C_TRI_DEFAULT_2 0x7f " [get_bd_cells ip_3_gpio/gpio_0]
...
connect_bd_net [get_bd_pins ip_9_intc/irq_3] [get_bd_pins ip_3_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_gpio/AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_3] [get_bd_pins ip_6_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_4] [get_bd_pins ip_6_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_5] [get_bd_pins ip_6_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_6_axi_timer/capturetrig0]
