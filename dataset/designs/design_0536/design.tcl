...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x3f CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 8 CONFIG.C_GPIO_WIDTH 6 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 46 CONFIG.aresetn 0 CONFIG.atuserwidth 111 CONFIG.bportwidth 56 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 39 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 58 CONFIG.Latency 18 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 251 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 57 -to 0 ip_10_accumulator/B
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 27 CONFIG.Iterations 40 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 12 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 31 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_11_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_12_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 27 CONFIG.aresetn 0 CONFIG.atuserwidth 164 CONFIG.bportwidth 43 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 26 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 61 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_13_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 8 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_25_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 196 -to 0 ip_31_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 82 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 88 CONFIG.DIN_TO 83 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 89 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 106 CONFIG.DIN_TO 101 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 107 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 118 CONFIG.DIN_TO 113 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 119 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 130 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 136 CONFIG.DIN_TO 131 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 142 CONFIG.DIN_TO 137 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 148 CONFIG.DIN_TO 143 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 154 CONFIG.DIN_TO 149 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 160 CONFIG.DIN_TO 155 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 166 CONFIG.DIN_TO 161 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 172 CONFIG.DIN_TO 167 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 178 CONFIG.DIN_TO 173 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 184 CONFIG.DIN_TO 179 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 190 CONFIG.DIN_TO 185 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 196 CONFIG.DIN_TO 191 CONFIG.DIN_WIDTH 197 " [get_bd_cells ip_31_reduce/slice_31]
...
create_bd_pin -dir O -from 57 -to 0 ip_32_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 12 -to 0 ip_32_slice_and_concat/in_5
...
create_bd_pin -dir I -from 250 -to 0 ip_32_slice_and_concat/in_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_9
move_bd_cells [get_bd_cells ip_32_slice_and_concat] [get_bd_cells slice_9]
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_32_slice_and_concat/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 196 -to 0 ip_36_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 250 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_0] [get_bd_pins ip_0_gpio/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_1] [get_bd_pins ip_2_gpio/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_2] [get_bd_pins ip_3_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_3] [get_bd_pins ip_4_uartlite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_4] [get_bd_pins ip_5_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_5] [get_bd_pins ip_7_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_6] [get_bd_pins ip_8_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_gpio/AXI] [get_bd_intf_pins ip_18_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_18_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_25_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_8_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_1] [get_bd_pins ip_8_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_2] [get_bd_pins ip_8_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_3] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_4] [get_bd_pins ip_9_dft/XK_RE]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_5] [get_bd_pins ip_9_dft/XK_IM]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_6] [get_bd_pins ip_9_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_7] [get_bd_pins ip_9_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_8] [get_bd_pins ip_9_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_9] [get_bd_pins ip_10_accumulator/Q]
...
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_broadcaster/M_AXIS_2 declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_broadcaster/M_AXIS_2 declared=128 actual=ERR $__err" }
if {[catch {
