...
set_property -dict "CONFIG.C_ADDR_WIDTH 43 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MASK 0xaa4d337fd4d8452 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6ce7e36ae473413 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_9_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x61 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 174 CONFIG.C_SDA_INERTIAL_DELAY 72 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 405.88065903061596 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x7fffffff CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 31 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x44dee10 CONFIG.C_TRI_DEFAULT_2 0x7fffffff " [get_bd_cells ip_15_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x27 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 90 CONFIG.C_SDA_INERTIAL_DELAY 76 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 2.0417870265211144 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_16_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_17_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 512 " [get_bd_cells ip_19_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MASK 0xa06eb09795624b4 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_21_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x97d6e95e381f2f7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_21_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 14 CONFIG.NUM_SI 3 " [get_bd_cells ip_26_axi/axi_0]
...
create_bd_pin -dir I -from 34 -to 0 ip_40_slice_and_concat/in_0
...
connect_bd_net [get_bd_pins ip_22_reset/peripheral_areset_n] [get_bd_pins ip_1_axi_quad_spi/reset4]
...
connect_bd_net [get_bd_pins ip_22_reset/peripheral_areset_n] [get_bd_pins ip_13_axi_quad_spi/reset4]
...
connect_bd_net [get_bd_pins ip_22_reset/peripheral_areset_n] [get_bd_pins ip_18_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_22_reset/peripheral_areset_n] [get_bd_pins ip_19_axi_hwicap/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_1_axi_quad_spi/clk4]
...
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_13_axi_quad_spi/clk4]
...
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_18_axi_timer/s_axi_aclk]
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_19_axi_hwicap/icap_clk]
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_19_axi_hwicap/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_3] [get_bd_pins ip_10_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_4] [get_bd_pins ip_11_uartlite/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_5] [get_bd_pins ip_12_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_6] [get_bd_pins ip_13_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_7] [get_bd_pins ip_16_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_8] [get_bd_pins ip_17_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_9] [get_bd_pins ip_18_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_10] [get_bd_pins ip_19_axi_hwicap/ip2intc_irpt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_microblaze/INTERRUPT] [get_bd_intf_pins ip_24_intc/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_0] [get_bd_pins ip_1_axi_quad_spi/irq]
...
connect_bd_net [get_bd_pins ip_25_intc/irq_3] [get_bd_pins ip_10_axi_iic/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_4] [get_bd_pins ip_11_uartlite/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_5] [get_bd_pins ip_12_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_6] [get_bd_pins ip_13_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_7] [get_bd_pins ip_16_axi_iic/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_8] [get_bd_pins ip_17_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_9] [get_bd_pins ip_18_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_10] [get_bd_pins ip_19_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_microblaze/M_AXI_DP] [get_bd_intf_pins ip_26_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_iic/AXI] [get_bd_intf_pins ip_26_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_uartlite/AXI] [get_bd_intf_pins ip_26_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_26_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_26_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_gpio/AXI] [get_bd_intf_pins ip_26_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_iic/AXI] [get_bd_intf_pins ip_26_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_timer/S_AXI] [get_bd_intf_pins ip_26_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_26_axi/AXI_S11]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_28_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_floating_point/S_AXIS_A] [get_bd_intf_pins ip_33_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_34_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_20_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_35_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_9_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_DATA] [get_bd_intf_pins ip_29_axis_broadcaster/M_AXIS_1]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_39_reduce/in0]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_0] [get_bd_pins ip_7_accumulator/Q]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_1] [get_bd_pins ip_12_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_2] [get_bd_pins ip_12_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/out0] [get_bd_pins ip_19_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_0] [get_bd_pins ip_12_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_0] [get_bd_pins ip_17_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_1] [get_bd_pins ip_17_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_2] [get_bd_pins ip_17_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_12_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_8_cordic/aclken]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/out0] [get_bd_pins ip_5_floating_point/aclken]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_17_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_48_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/CE]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/out0] [get_bd_pins ip_12_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/Bypass]
