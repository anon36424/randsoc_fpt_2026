...
set_property -dict "CONFIG.C_MASK 0xb14804fb89cd942 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe39a0c2b226484b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 28 -to 0 ip_12_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 29 " [get_bd_cells ip_12_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 29 " [get_bd_cells ip_13_slice_and_concat/slice_0]
