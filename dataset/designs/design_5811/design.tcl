...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 25 CONFIG.aresetn 1 CONFIG.atuserwidth 144 CONFIG.bportwidth 29 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 47 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 19 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_5_dft/dft_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 205 CONFIG.Latency 23 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 210 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_24_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_24_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 209 -to 0 ip_27_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 210 " [get_bd_cells ip_27_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 209 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 210 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 238 -to 0 ip_28_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 239 " [get_bd_cells ip_28_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 204 -to 0 ip_29_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 223 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 239 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 238 CONFIG.DIN_TO 224 CONFIG.DIN_WIDTH 239 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_15_axi_legacy/AXI_M1]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_5_dft/RFFD]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_5_dft/XK_IM]
