...
set_property -dict "CONFIG.C_MASK 0x9aafe6700c4b5ff CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x658e17a5a4c458a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0xaa6b257c5d3cc26 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x558493493612109 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 18 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_5_dft/dft_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_17_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_17_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_18_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_1] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_2] [get_bd_pins ip_5_dft/RFFD]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_5_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_6_floating_point/aclken]
