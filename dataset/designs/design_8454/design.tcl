...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 1 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_2_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_5_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Arc_Tan CONFIG.Input_Width 15 CONFIG.Iterations 45 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 30 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 38 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_6_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 128 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 54 CONFIG.aresetn 1 CONFIG.bportwidth 19 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 48 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_BAUDRATE 115200 CONFIG.C_DATA_BITS 5 CONFIG.PARITY No_Parity " [get_bd_cells ip_9_uartlite/uart_0]
...
set_property -dict "CONFIG.C_MASK 0x6ab2e4981a5de78 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x323889c6f02436b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 46 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_11_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 27 CONFIG.aresetn 1 CONFIG.bportwidth 49 CONFIG.btuserwidth 195 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 19 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 71 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 6 CONFIG.convolution_code0 28 CONFIG.convolution_code1 12 CONFIG.convolution_code2 31 CONFIG.convolution_code3 39 CONFIG.convolution_code4 3 CONFIG.convolution_code5 12 CONFIG.convolution_code6 57 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 15 CONFIG.puncture_code0 11111111 CONFIG.puncture_code1 11111101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_15_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 32 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 35 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_16_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 31 -to 0 ip_16_accumulator/B
connect_bd_net [get_bd_pins ip_16_accumulator/B] [get_bd_pins ip_16_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 34 -to 0 ip_16_accumulator/Q
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32 " [get_bd_cells ip_18_fft/fft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 13 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_19_dft/dft_0]
...
create_bd_pin -dir I -from 34 -to 0 ip_49_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_49_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 35 " [get_bd_cells ip_49_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 35 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 35 " [get_bd_cells ip_51_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 35 " [get_bd_cells ip_52_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 12 -to 0 ip_52_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_52_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_52_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_53_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_26_intc/irq_3] [get_bd_pins ip_3_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_26_intc/irq_6] [get_bd_pins ip_7_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_26_intc/irq_7] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_26_intc/irq_8] [get_bd_pins ip_11_axi_cdma/cdma_introut]
...
connect_bd_net [get_bd_pins ip_26_intc/irq_12] [get_bd_pins ip_23_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_timer/S_AXI] [get_bd_intf_pins ip_27_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_fft/S_AXIS_DATA] [get_bd_intf_pins ip_32_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_47_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_31_axis_broadcaster/M_AXIS_3]
...
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_3] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_4] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_5] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_6] [get_bd_pins ip_16_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_4] [get_bd_pins ip_21_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_5] [get_bd_pins ip_21_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_6] [get_bd_pins ip_21_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_17_floating_point/aclken]
