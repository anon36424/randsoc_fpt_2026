...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x10fa9c0 CONFIG.C_DOUT_DEFAULT_2 0x27a8d0c CONFIG.C_GPIO2_WIDTH 3 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x62 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 46 CONFIG.C_SDA_INERTIAL_DELAY 151 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 392.0670298903701 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.add_sub_value Add CONFIG.axi_optimize_goal Performance CONFIG.c_accum_input_msb -863 CONFIG.c_accum_lsb -994 CONFIG.c_accum_msb -815 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_accum_input_overflow 1 CONFIG.c_has_accum_overflow 1 CONFIG.c_has_invalid_op 1 CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 1 CONFIG.c_mult_usage Medium_Usage CONFIG.c_optimization Low_Latency CONFIG.flow_control Blocking CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_type Accumulator " [get_bd_cells ip_4_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 6 CONFIG.C_TAVDV_PS_MEM_0 16466 CONFIG.C_TAVDV_PS_MEM_1 15844 CONFIG.C_TCEDV_PS_MEM_0 13648 CONFIG.C_TCEDV_PS_MEM_1 14341 CONFIG.C_THZCE_PS_MEM_0 7572 CONFIG.C_THZCE_PS_MEM_1 6749 CONFIG.C_THZOE_PS_MEM_0 6800 CONFIG.C_THZOE_PS_MEM_1 6946 CONFIG.C_TLZWE_PS_MEM_0 8246 CONFIG.C_TLZWE_PS_MEM_1 2086 CONFIG.C_TWC_PS_MEM_0 13693 CONFIG.C_TWC_PS_MEM_1 15045 CONFIG.C_TWPH_PS_MEM_0 11907 CONFIG.C_TWPH_PS_MEM_1 12431 CONFIG.C_TWP_PS_MEM_0 10971 CONFIG.C_TWP_PS_MEM_1 12677 CONFIG.C_WR_REC_TIME_MEM_0 24419 CONFIG.C_WR_REC_TIME_MEM_1 29524 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_20_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 44 -to 0 ip_21_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 13 -to 0 ip_24_slice_and_concat/in_3
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_17_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_intc/AXI] [get_bd_intf_pins ip_17_axi/AXI_S10]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_8_dft/XK_IM]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_8_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_8_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_10_axi_timer/capturetrig1]
