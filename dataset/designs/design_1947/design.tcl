...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x39 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 159 CONFIG.C_SDA_INERTIAL_DELAY 240 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 426.04635351929323 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
create_bd_pin -dir O -from 18 -to 0 ip_9_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 24 -to 0 ip_10_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_10_slice_and_concat/slice_0]
