...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SPI_MEMORY 4 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_0_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_BAUDRATE 300 CONFIG.C_DATA_BITS 5 CONFIG.PARITY No_Parity " [get_bd_cells ip_2_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 34 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3fff CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x51 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 99 CONFIG.C_SDA_INERTIAL_DELAY 138 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 393.4074505135458 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_9_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MASK 0x6d942051b9b318b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x8a1ad6dfa8ffc0e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0x33a1f79aeafee2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x85adbdf870122d6 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_15_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 33 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_18_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_MI 5 CONFIG.NUM_SI 1 " [get_bd_cells ip_28_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 44 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_31_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.NUM_PORTS 17 " [get_bd_cells ip_33_slice_and_concat/concat]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_6] [get_bd_pins ip_7_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_7] [get_bd_pins ip_8_uartlite/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_8] [get_bd_pins ip_9_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_24_intc/irq_9] [get_bd_pins ip_12_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_24_intc/irq_10] [get_bd_pins ip_13_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_13] [get_bd_pins ip_17_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_14] [get_bd_pins ip_18_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_24_intc/irq_15] [get_bd_pins ip_19_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_16] [get_bd_pins ip_20_uartlite/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_17] [get_bd_pins ip_21_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_25_intc/irq_8] [get_bd_pins ip_9_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_25_intc/irq_9] [get_bd_pins ip_12_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_10] [get_bd_pins ip_13_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_11] [get_bd_pins ip_15_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_25_intc/irq_12] [get_bd_pins ip_16_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_13] [get_bd_pins ip_17_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_14] [get_bd_pins ip_18_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_25_intc/irq_15] [get_bd_pins ip_19_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_25_intc/irq_16] [get_bd_pins ip_20_uartlite/irq]
connect_bd_net [get_bd_pins ip_25_intc/irq_17] [get_bd_pins ip_21_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_26_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_27_axi/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_27_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_27_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_iic/AXI] [get_bd_intf_pins ip_27_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_uartlite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S12]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_timer/S_AXI] [get_bd_intf_pins ip_27_axi/AXI_S13]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_timer/S_AXI] [get_bd_intf_pins ip_27_axi/AXI_S14]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S15]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axi/AXI_S1] [get_bd_intf_pins ip_28_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axi_timer/S_AXI] [get_bd_intf_pins ip_28_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_uartlite/AXI] [get_bd_intf_pins ip_28_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_28_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_intc/AXI] [get_bd_intf_pins ip_28_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_25_intc/AXI] [get_bd_intf_pins ip_28_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_31_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_29_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_fft/S_AXIS_DATA] [get_bd_intf_pins ip_31_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_1] [get_bd_pins ip_1_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_2] [get_bd_pins ip_14_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_3] [get_bd_pins ip_14_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_4] [get_bd_pins ip_14_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_5] [get_bd_pins ip_14_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_6] [get_bd_pins ip_14_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_7] [get_bd_pins ip_14_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_8] [get_bd_pins ip_16_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_9] [get_bd_pins ip_16_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_10] [get_bd_pins ip_16_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_11] [get_bd_pins ip_17_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_12] [get_bd_pins ip_17_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_13] [get_bd_pins ip_17_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_14] [get_bd_pins ip_19_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_15] [get_bd_pins ip_19_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_16] [get_bd_pins ip_19_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_17_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_19_axi_timer/capturetrig0]
...
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_16_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/out0] [get_bd_pins ip_16_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/in_0] [get_bd_pins ip_14_xadc_wiz/alarm_out]
