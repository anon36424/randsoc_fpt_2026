...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 4 CONFIG.convolution_code0 1 CONFIG.convolution_code1 15 CONFIG.convolution_code2 8 CONFIG.convolution_code3 12 CONFIG.convolution_code4 1 CONFIG.convolution_code5 7 CONFIG.convolution_code6 7 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 11 CONFIG.output_rate 13 CONFIG.puncture_code0 10101001101 CONFIG.puncture_code1 10001101111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_1_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MASK 0xa3fab77c7d7d647 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe5e778b0bb29465 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.a_precision_type Custom CONFIG.add_sub_value Both CONFIG.b_tuser_width 85 CONFIG.c_a_exponent_width 12 CONFIG.c_a_fraction_width 63 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage Medium_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 0 CONFIG.has_aclken 1 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 1 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 1 CONFIG.has_operation_tuser 1 CONFIG.maximum_latency 1 CONFIG.operation_tuser_width 12 CONFIG.operation_type FMA CONFIG.result_tlast_behv AND_all_TLASTs " [get_bd_cells ip_3_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xac9 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 17 CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x1fff CONFIG.C_TRI_DEFAULT_2 0x17b4 " [get_bd_cells ip_4_gpio/gpio_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_10_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_floating_point/S_AXIS_OPERATION] [get_bd_intf_pins ip_14_axis_dwidth_converter/M_AXIS]
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_3_floating_point/S_AXIS_C declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_3_floating_point/S_AXIS_C declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_3_floating_point/M_AXIS_RESULT declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_3_floating_point/M_AXIS_RESULT declared=80 actual=ERR $__err" }
if {[catch {
