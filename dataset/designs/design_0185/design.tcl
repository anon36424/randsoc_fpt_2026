...
set_property -dict "CONFIG.channels 6 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 44 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 46 -to 0 ip_17_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_17_slice_and_concat/slice_0]
