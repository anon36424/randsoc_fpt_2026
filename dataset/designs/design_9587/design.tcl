...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3f CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 165 CONFIG.C_SDA_INERTIAL_DELAY 103 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 171.08650897591107 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 235 CONFIG.Latency 29 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 256 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 255 -to 0 ip_9_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_9_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 231 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_9_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 255 CONFIG.DIN_TO 232 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_10_slice_and_concat/slice_0]
