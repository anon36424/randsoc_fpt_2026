...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 49 CONFIG.aresetn 1 CONFIG.atuserwidth 109 CONFIG.bportwidth 13 CONFIG.btuserwidth 215 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 11 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x31 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 10 CONFIG.C_SDA_INERTIAL_DELAY 176 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 192.71866563401312 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 10 CONFIG.aresetn 1 CONFIG.bportwidth 42 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 52 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x21 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 235 CONFIG.C_SDA_INERTIAL_DELAY 137 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 539.6209192333912 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 14 CONFIG.C_TAVDV_PS_MEM_0 14420 CONFIG.C_TCEDV_PS_MEM_0 16109 CONFIG.C_THZCE_PS_MEM_0 6720 CONFIG.C_THZOE_PS_MEM_0 7651 CONFIG.C_TLZWE_PS_MEM_0 5749 CONFIG.C_TWC_PS_MEM_0 14451 CONFIG.C_TWPH_PS_MEM_0 11087 CONFIG.C_TWP_PS_MEM_0 12198 CONFIG.C_WR_REC_TIME_MEM_0 28992 " [get_bd_cells ip_9_emc/emc_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_15_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_15_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_1] [get_bd_pins ip_7_dft/XK_RE]
