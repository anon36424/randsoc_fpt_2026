...
set_property -dict "CONFIG.AINIT_Value c73f271ba004b4840475ff504e4a2e524c0bb7299ac991e3e8c6f CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 203 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 212 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 202 -to 0 ip_0_accumulator/B
connect_bd_net [get_bd_pins ip_0_accumulator/B] [get_bd_pins ip_0_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 211 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 27 CONFIG.aresetn 1 CONFIG.atuserwidth 183 CONFIG.bportwidth 42 CONFIG.ctrltuserwidth 249 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 59 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 32 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6a CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 174 CONFIG.C_SDA_INERTIAL_DELAY 106 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 280.83277486575633 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.AINIT_Value 1035c2de78bfb44de3be2eafeb6887f3b6ab2024f767e46569532f106cdf6ce CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 249 CONFIG.Latency 27 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 249 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_9_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 20 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 27 CONFIG.Iterations 12 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 21 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 45 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_13_cordic/cordic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 48 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 48 CONFIG.S_TDATA_NUM_BYTES 8 " [get_bd_cells ip_31_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 212 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 212 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 248 -to 0 ip_35_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 211 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 212 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 248 -to 0 ip_35_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_35_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 249 " [get_bd_cells ip_35_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 249 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 249 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 249 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 202 -to 0 ip_39_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 248 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 249 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_5] [get_bd_pins ip_10_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_iic/AXI] [get_bd_intf_pins ip_18_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_19_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_32_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_19_axis_broadcaster/M_AXIS_4]
...
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_3_cordic/aclken]
...
connect_bd_net [get_bd_pins ip_49_slice_and_concat/out0] [get_bd_pins ip_9_accumulator/ADD]
