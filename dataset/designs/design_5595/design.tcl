...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_4] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_5] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_6] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_7] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_8] [get_bd_pins ip_4_axi_timer/generateout1]
