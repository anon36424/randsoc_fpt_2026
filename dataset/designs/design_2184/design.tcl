...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_2_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.channels 6 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 2048 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 36 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 38 CONFIG.aresetn 1 CONFIG.bportwidth 45 CONFIG.ctrltuserwidth 85 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 27 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 23 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4a CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 230 CONFIG.C_SDA_INERTIAL_DELAY 15 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 304.549408102528 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_12_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 3 " [get_bd_cells ip_16_axi_legacy/axi_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_4] [get_bd_pins ip_5_axi_cdma/cdma_introut]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_7] [get_bd_pins ip_9_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_15_intc/irq_8] [get_bd_pins ip_10_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_9] [get_bd_pins ip_11_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_16_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_timer/S_AXI] [get_bd_intf_pins ip_16_axi_legacy/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/S_AXIS_DATA] [get_bd_intf_pins ip_4_fft/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_6] [get_bd_pins ip_11_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_7] [get_bd_pins ip_11_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_8] [get_bd_pins ip_11_axi_timer/pwm0]
