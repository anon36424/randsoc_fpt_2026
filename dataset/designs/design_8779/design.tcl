...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 35 CONFIG.aresetn 1 CONFIG.bportwidth 57 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 23 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 59 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0x8867c24f1efedd8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x9189c83534192fb CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BAUDRATE 300 CONFIG.C_DATA_BITS 6 CONFIG.PARITY No_Parity " [get_bd_cells ip_6_uartlite/uart_0]
...
set_property -dict "CONFIG.C_MASK 0xd9b85165c3da7ac CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xea86a3a15aca51a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 59 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_9_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 1024 " [get_bd_cells ip_12_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5b CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 119 CONFIG.C_SDA_INERTIAL_DELAY 242 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 735.9411173318022 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_22_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.NUM_PORTS 15 " [get_bd_cells ip_25_slice_and_concat/concat]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_iic/AXI] [get_bd_intf_pins ip_18_axi/AXI_S7]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_4] [get_bd_pins ip_2_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_2_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_6] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_7] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_8] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_9] [get_bd_pins ip_10_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_10] [get_bd_pins ip_10_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_11] [get_bd_pins ip_10_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_12] [get_bd_pins ip_11_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_13] [get_bd_pins ip_11_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_14] [get_bd_pins ip_11_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_2_xadc_wiz/convst_in]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_10_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_11_axi_timer/capturetrig0]
