...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x27 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 124 CONFIG.C_SDA_INERTIAL_DELAY 40 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 129.98005522471004 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_5_intc/irq_2] [get_bd_pins ip_2_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_iic/AXI] [get_bd_intf_pins ip_7_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_7_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_intc/AXI] [get_bd_intf_pins ip_7_axi/AXI_S4]
