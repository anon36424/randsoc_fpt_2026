...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1ff CONFIG.C_DOUT_DEFAULT_2 0x50 CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x77 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 43 CONFIG.aresetn 1 CONFIG.bportwidth 42 CONFIG.btuserwidth 3 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 25 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 65 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 40 " [get_bd_cells ip_16_axis_dwidth_converter/axis_dwidth_converter_0]
