...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 64 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x7fffffff CONFIG.C_GPIO_WIDTH 31 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x7fffffff " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 512 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x77 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 58 CONFIG.C_SDA_INERTIAL_DELAY 170 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 395.85995275381083 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 62 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_10_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 45 CONFIG.Iterations 30 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 30 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 42 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_13_cordic/cordic_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 43 CONFIG.Iterations 10 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 35 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 46 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_14_cordic/cordic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x2ee770 CONFIG.C_GPIO_WIDTH 22 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_15_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 38 CONFIG.aresetn 0 CONFIG.atuserwidth 33 CONFIG.bportwidth 25 CONFIG.btuserwidth 154 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 36 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 19 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_16_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 425 CONFIG.convolution_code1 17 CONFIG.convolution_code2 67 CONFIG.convolution_code3 256 CONFIG.convolution_code4 259 CONFIG.convolution_code5 138 CONFIG.convolution_code6 144 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 8 CONFIG.output_rate 10 CONFIG.puncture_code0 00111110 CONFIG.puncture_code1 10011011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_19_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 36 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 39 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_20_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_21_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 48 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_22_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7d CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 72 CONFIG.C_SDA_INERTIAL_DELAY 55 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 946.4352234570869 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_23_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 38 -to 0 ip_46_slice_and_concat/in_15
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_15
move_bd_cells [get_bd_cells ip_46_slice_and_concat] [get_bd_cells slice_15]
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_46_slice_and_concat/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 39 " [get_bd_cells ip_47_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axi_cdma/M_AXI] [get_bd_intf_pins ip_27_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_timer/S_AXI] [get_bd_intf_pins ip_27_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axi_iic/AXI] [get_bd_intf_pins ip_27_axi/AXI_S11]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_floating_point/S_AXIS_B] [get_bd_intf_pins ip_44_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_floating_point/S_AXIS_C] [get_bd_intf_pins ip_45_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_30_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_3] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_4] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_5] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_6] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_7] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_8] [get_bd_pins ip_4_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_9] [get_bd_pins ip_4_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_10] [get_bd_pins ip_4_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_11] [get_bd_pins ip_4_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_12] [get_bd_pins ip_9_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_13] [get_bd_pins ip_9_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_14] [get_bd_pins ip_9_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_15] [get_bd_pins ip_20_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_20_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_52_slice_and_concat/out0] [get_bd_pins ip_20_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/ot_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_3 declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_3 declared=128 actual=ERR $__err" }
if {[catch {
