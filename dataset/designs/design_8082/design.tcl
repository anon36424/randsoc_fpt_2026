...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Arc_Tan CONFIG.Input_Width 48 CONFIG.Iterations 11 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 21 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 47 CONFIG.Round_Mode Truncate " [get_bd_cells ip_0_cordic/cordic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 54 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DUPLEX 0 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_3_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 7 CONFIG.convolution_code0 111 CONFIG.convolution_code1 82 CONFIG.convolution_code2 51 CONFIG.convolution_code3 86 CONFIG.convolution_code4 21 CONFIG.convolution_code5 5 CONFIG.convolution_code6 12 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 9 CONFIG.output_rate 15 CONFIG.puncture_code0 010111111 CONFIG.puncture_code1 110111111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 512 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 12 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_8_dft/dft_0]
...
set_property -dict "CONFIG.C_BAUDRATE 19200 CONFIG.C_DATA_BITS 5 CONFIG.PARITY No_Parity " [get_bd_cells ip_9_uartlite/uart_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 12 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 43 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_10_accumulator/B
connect_bd_net [get_bd_pins ip_10_accumulator/B] [get_bd_pins ip_10_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 42 -to 0 ip_10_accumulator/Q
...
set_property -dict "CONFIG.C_BAUDRATE 110 CONFIG.C_DATA_BITS 6 CONFIG.PARITY Odd " [get_bd_cells ip_11_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2c CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 103 CONFIG.C_SDA_INERTIAL_DELAY 148 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 745.8556630927172 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_12_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 23 CONFIG.aresetn 0 CONFIG.atuserwidth 24 CONFIG.bportwidth 17 CONFIG.btuserwidth 133 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 14 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 32 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_14_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_16_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16 " [get_bd_cells ip_17_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_SIZE 40 CONFIG.C_AREA_OPTIMIZED 1 CONFIG.C_DEBUG_COUNTER_WIDTH 32 CONFIG.C_DEBUG_ENABLED 2 CONFIG.C_DEBUG_EVENT_COUNTERS 43 CONFIG.C_DEBUG_EXTERNAL_TRACE 1 CONFIG.C_DEBUG_LATENCY_COUNTERS 0 CONFIG.C_DEBUG_PROFILE_SIZE 4096 CONFIG.C_DEBUG_TRACE_SIZE 64 CONFIG.C_D_AXI 1 CONFIG.C_D_LMB 1 CONFIG.C_FAULT_TOLERANT 0 CONFIG.C_FPU_EXCEPTION 0 CONFIG.C_ILL_OPCODE_EXCEPTION 0 CONFIG.C_I_LMB 1 CONFIG.C_NUMBER_OF_PC_BRK 7 CONFIG.C_NUMBER_OF_RD_ADDR_BRK 1 CONFIG.C_NUMBER_OF_WR_ADDR_BRK 1 CONFIG.C_PVR 0 CONFIG.C_RESET_MSR_BIP 1 CONFIG.C_RESET_MSR_DCE 1 CONFIG.C_RESET_MSR_EE 0 CONFIG.C_RESET_MSR_EIP 0 CONFIG.C_RESET_MSR_ICE 1 CONFIG.C_RESET_MSR_IE 1 CONFIG.C_UNALIGNED_EXCEPTIONS 1 CONFIG.C_USE_BARREL 1 CONFIG.C_USE_DIV 0 CONFIG.C_USE_FPU 2 CONFIG.C_USE_HW_MUL 0 CONFIG.C_USE_INTERRUPT 0 CONFIG.C_USE_MSR_INSTR 1 CONFIG.C_USE_PCMP_INSTR 1 CONFIG.C_USE_REORDER_INSTR 1 CONFIG.C_USE_STACK_PROTECTION 1 " [get_bd_cells ip_18_microblaze/microblaze_0]
...
set_property -dict "CONFIG.C_MASK 0x3799861b321ee88 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x3cb7b2dbc1cef83 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_19_fft/fft_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 32 CONFIG.Iterations 8 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 27 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 40 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_20_cordic/cordic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 17 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 41 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_21_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 1 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_WRITE_FIFO_DEPTH 1024 " [get_bd_cells ip_24_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.AINIT_Value 7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 46 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 251 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_26_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 45 -to 0 ip_26_accumulator/B
connect_bd_net [get_bd_pins ip_26_accumulator/B] [get_bd_pins ip_26_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 250 -to 0 ip_26_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 20 CONFIG.aresetn 1 CONFIG.atuserwidth 198 CONFIG.bportwidth 33 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 5 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_27_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 40 " [get_bd_cells ip_44_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 32 " [get_bd_cells ip_46_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 3 " [get_bd_cells ip_58_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 277 -to 0 ip_59_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 116 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 117 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 143 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 152 CONFIG.DIN_TO 144 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 161 CONFIG.DIN_TO 153 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 162 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 179 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 188 CONFIG.DIN_TO 180 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 197 CONFIG.DIN_TO 189 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 9 " [get_bd_cells ip_59_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 205 CONFIG.DIN_TO 198 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 213 CONFIG.DIN_TO 206 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 221 CONFIG.DIN_TO 214 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 229 CONFIG.DIN_TO 222 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 237 CONFIG.DIN_TO 230 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 245 CONFIG.DIN_TO 238 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 253 CONFIG.DIN_TO 246 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 261 CONFIG.DIN_TO 254 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 269 CONFIG.DIN_TO 262 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 277 CONFIG.DIN_TO 270 CONFIG.DIN_WIDTH 278 " [get_bd_cells ip_59_reduce/slice_31]
...
create_bd_pin -dir O -from 277 -to 0 ip_61_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_61_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 15 " [get_bd_cells ip_61_slice_and_concat/concat]
...
create_bd_pin -dir I -from 11 -to 0 ip_61_slice_and_concat/in_5
...
create_bd_pin -dir I -from 42 -to 0 ip_61_slice_and_concat/in_12
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_12] [get_bd_pins ip_61_slice_and_concat/concat/In12]
create_bd_pin -dir I -from 40 -to 0 ip_61_slice_and_concat/in_13
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_13] [get_bd_pins ip_61_slice_and_concat/concat/In13]
create_bd_pin -dir I -from 250 -to 0 ip_61_slice_and_concat/in_14
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_14
move_bd_cells [get_bd_cells ip_61_slice_and_concat] [get_bd_cells slice_14]
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_61_slice_and_concat/slice_14]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_14] [get_bd_pins ip_61_slice_and_concat/slice_14/din]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/slice_14/dout] [get_bd_pins ip_61_slice_and_concat/concat/In14]


########## slice_and_concat ##########
create_bd_cell -type hier ip_62_slice_and_concat
create_bd_pin -dir O -from 11 -to 0 ip_62_slice_and_concat/out0
create_bd_pin -dir I -from 250 -to 0 ip_62_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_62_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 157 CONFIG.DIN_TO 146 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_62_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 250 -to 0 ip_63_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_63_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 158 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_63_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 250 -to 0 ip_64_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_64_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 186 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_64_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 250 -to 0 ip_65_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_65_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 198 CONFIG.DIN_TO 187 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_65_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 250 -to 0 ip_66_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_66_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 204 CONFIG.DIN_TO 199 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_66_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 45 -to 0 ip_67_slice_and_concat/out0
create_bd_pin -dir I -from 250 -to 0 ip_67_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_67_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 250 CONFIG.DIN_TO 205 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_67_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_17_fft/aclk]
...
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_22_axi_dma/m_axi_sg_aclk]
connect_bd_net [get_bd_pins ip_29_clk_wiz/clk_out] [get_bd_pins ip_22_axi_dma/m_axi_s2mm_aclk]
...
connect_bd_net [get_bd_pins ip_30_intc/irq_2] [get_bd_pins ip_3_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_3] [get_bd_pins ip_4_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_4] [get_bd_pins ip_5_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_30_intc/irq_5] [get_bd_pins ip_7_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_30_intc/irq_6] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_7] [get_bd_pins ip_11_uartlite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_8] [get_bd_pins ip_12_axi_iic/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_9] [get_bd_pins ip_13_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_30_intc/irq_10] [get_bd_pins ip_15_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_11] [get_bd_pins ip_15_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_12] [get_bd_pins ip_16_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_13] [get_bd_pins ip_17_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_30_intc/irq_14] [get_bd_pins ip_19_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_30_intc/irq_15] [get_bd_pins ip_22_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_30_intc/irq_16] [get_bd_pins ip_24_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_cdma/M_AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_31_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_31_axi_legacy/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_uartlite/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_iic/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_31_axi_legacy/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_30_intc/AXI] [get_bd_intf_pins ip_31_axi_legacy/AXI_S12]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_33_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXIS_MM2S] [get_bd_intf_pins ip_35_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_37_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/M_AXIS_DATA] [get_bd_intf_pins ip_39_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_40_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_42_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_fft/S_AXIS_DATA] [get_bd_intf_pins ip_43_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_44_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_17_fft/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_44_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_45_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_37_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_46_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_19_fft/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_46_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_38_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_25_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_48_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_25_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_54_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_32_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_54_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_33_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_54_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_34_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_55_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_56_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_34_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_56_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_39_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_56_axis_combiner/S_AXIS_4] [get_bd_intf_pins ip_39_axis_broadcaster/M_AXIS_4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_fft/S_AXIS_DATA] [get_bd_intf_pins ip_56_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_57_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_32_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_DATA] [get_bd_intf_pins ip_57_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_58_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_36_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_58_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_24_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/in_0] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_60_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/out0] [get_bd_pins ip_59_reduce/in0]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_0] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_1] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_2] [get_bd_pins ip_5_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_3] [get_bd_pins ip_5_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_4] [get_bd_pins ip_5_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_5] [get_bd_pins ip_5_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_6] [get_bd_pins ip_8_dft/RFFD]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_7] [get_bd_pins ip_8_dft/XK_RE]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_8] [get_bd_pins ip_8_dft/XK_IM]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_9] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_10] [get_bd_pins ip_8_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_11] [get_bd_pins ip_8_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_12] [get_bd_pins ip_10_accumulator/Q]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_13] [get_bd_pins ip_21_accumulator/Q]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_14] [get_bd_pins ip_26_accumulator/Q]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/B]
...
connect_bd_net [get_bd_pins ip_64_slice_and_concat/out0] [get_bd_pins ip_21_accumulator/B]
connect_bd_net [get_bd_pins ip_64_slice_and_concat/in_0] [get_bd_pins ip_26_accumulator/Q]
connect_bd_net [get_bd_pins ip_65_slice_and_concat/out0] [get_bd_pins ip_8_dft/XN_RE]
...
connect_bd_net [get_bd_pins ip_67_slice_and_concat/out0] [get_bd_pins ip_26_accumulator/B]
connect_bd_net [get_bd_pins ip_67_slice_and_concat/in_0] [get_bd_pins ip_26_accumulator/Q]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_23_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_70_slice_and_concat/out0] [get_bd_pins ip_21_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_71_slice_and_concat/out0] [get_bd_pins ip_26_accumulator/ADD]
connect_bd_net [get_bd_pins ip_72_slice_and_concat/out0] [get_bd_pins ip_21_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/out0] [get_bd_pins ip_8_dft/FWD_INV]
...
connect_bd_net [get_bd_pins ip_74_slice_and_concat/out0] [get_bd_pins ip_21_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_75_slice_and_concat/out0] [get_bd_pins ip_27_complex_multiplier/aclken]
...
connect_bd_net [get_bd_pins ip_76_slice_and_concat/out0] [get_bd_pins ip_6_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_0] [get_bd_pins ip_5_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/out0] [get_bd_pins ip_76_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_77_slice_and_concat/out0] [get_bd_pins ip_21_accumulator/CE]
...
connect_bd_net [get_bd_pins ip_78_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/out0] [get_bd_pins ip_25_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_80_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/SCLR]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_0_cordic/M_AXIS_DOUT declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_0_cordic/M_AXIS_DOUT declared=24 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_17_fft/S_AXIS_CONFIG declared=18 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_fft/S_AXIS_CONFIG declared=18 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_DATA declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_DATA declared=256 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_19_fft/fft_0/M_AXIS_DATA]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_fft/M_AXIS_DATA declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_fft/M_AXIS_DATA declared=256 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_19_fft/fft_0/S_AXIS_CONFIG]] * 8}]
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_CONFIG declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_fft/S_AXIS_CONFIG declared=32 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_cordic/M_AXIS_DOUT declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_cordic/M_AXIS_DOUT declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/S_AXIS declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/S_AXIS declared=24 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_36_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_0 declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_0 declared=24 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_36_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_1 declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_1 declared=24 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_36_axis_broadcaster/axis_broadcaster_0/M02_AXIS]] * 8}]
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_2 declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_2 declared=24 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_39_axis_broadcaster/M_AXIS_4 declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_39_axis_broadcaster/M_AXIS_4 declared=32 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_54_axis_combiner/S_AXIS_2 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_54_axis_combiner/S_AXIS_2 declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_56_axis_combiner/S_AXIS_3 declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_56_axis_combiner/S_AXIS_3 declared=32 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_58_axis_dwidth_converter/S_AXIS declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_58_axis_dwidth_converter/S_AXIS declared=24 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 18 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_58_axis_dwidth_converter/M_AXIS declared=18 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_58_axis_dwidth_converter/M_AXIS declared=18 actual=ERR $__err" }
