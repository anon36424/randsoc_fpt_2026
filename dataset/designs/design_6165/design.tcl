...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x72 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 220 CONFIG.C_SDA_INERTIAL_DELAY 76 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 45.758186099467956 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 9 CONFIG.aresetn 0 CONFIG.bportwidth 43 CONFIG.btuserwidth 230 CONFIG.ctrltuserwidth 73 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 50 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 34 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1b CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 26 CONFIG.C_SDA_INERTIAL_DELAY 150 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 182.60945380863325 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 168 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 193 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 167 -to 0 ip_6_accumulator/B
...
create_bd_pin -dir O -from 167 -to 0 ip_17_slice_and_concat/out0
...
create_bd_pin -dir I -from 192 -to 0 ip_17_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 164 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_17_slice_and_concat/slice_3]
...
create_bd_pin -dir I -from 192 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 192 CONFIG.DIN_TO 165 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_18_slice_and_concat/slice_0]
