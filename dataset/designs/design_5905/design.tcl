...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x39 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 109 CONFIG.C_SDA_INERTIAL_DELAY 224 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 23.612946245565944 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/M_AXI] [get_bd_intf_pins ip_8_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_8_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_8_axi_legacy/AXI_S4]
