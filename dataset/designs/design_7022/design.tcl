...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xdedf2ed CONFIG.C_DOUT_DEFAULT_2 0xfffffff CONFIG.C_GPIO2_WIDTH 10 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xfffffff CONFIG.C_TRI_DEFAULT_2 0xfffffff " [get_bd_cells ip_1_gpio/gpio_0]
