...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6c CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 245 CONFIG.C_SDA_INERTIAL_DELAY 226 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 298.69248448667435 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xf CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 0 CONFIG.C_SDA_INERTIAL_DELAY 228 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 786.8317658871937 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1a CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 110 CONFIG.C_SDA_INERTIAL_DELAY 192 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 597.4630159076975 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 6 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 1024 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_9_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x17c8f05b8ee9fc8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xa68d9d23121468e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_6] [get_bd_pins ip_6_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_13_intc/irq_7] [get_bd_pins ip_7_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_13_intc/irq_8] [get_bd_pins ip_9_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_14_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S5]
...
connect_bd_net [get_bd_pins ip_20_slice_and_concat/in_3] [get_bd_pins ip_6_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/in_4] [get_bd_pins ip_6_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_3_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_0] [get_bd_pins ip_6_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_21_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_8_conv_encoder/aclken]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_9_fft/S_AXIS_CONFIG declared=35 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_9_fft/S_AXIS_CONFIG declared=35 actual=ERR $__err" }
if {[catch {
