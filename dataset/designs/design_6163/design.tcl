...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_1_dft/dft_0]
...
create_bd_pin -dir O -from 8 -to 0 ip_4_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_4_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 5 " [get_bd_cells ip_4_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_4_slice_and_concat/in_1
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_1] [get_bd_pins ip_4_slice_and_concat/concat/In1]
create_bd_pin -dir I -from 0 -to 0 ip_4_slice_and_concat/in_2
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_2] [get_bd_pins ip_4_slice_and_concat/concat/In2]
create_bd_pin -dir I -from 0 -to 0 ip_4_slice_and_concat/in_3
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_3] [get_bd_pins ip_4_slice_and_concat/concat/In3]
create_bd_pin -dir I -from 8 -to 0 ip_4_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_4_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_4_slice_and_concat/slice_4]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_4] [get_bd_pins ip_4_slice_and_concat/slice_4/din]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/slice_4/dout] [get_bd_pins ip_4_slice_and_concat/concat/In4]
...
create_bd_pin -dir I -from 8 -to 0 ip_5_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_5_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 8 -to 0 ip_5_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_5_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 8 -to 0 ip_6_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 8 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_6_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 3 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_3_clk_wiz/clk_out] [get_bd_pins ip_0_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_4_slice_and_concat/out0] [get_bd_pins ip_1_dft/XN_IM]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_1] [get_bd_pins ip_0_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_2] [get_bd_pins ip_0_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_3] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_4] [get_bd_pins ip_1_dft/XK_RE]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/out0] [get_bd_pins ip_1_dft/SIZE]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_0] [get_bd_pins ip_1_dft/XK_RE]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_1] [get_bd_pins ip_1_dft/XK_IM]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/out0] [get_bd_pins ip_1_dft/XN_RE]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_0] [get_bd_pins ip_1_dft/XK_IM]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_1] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_0] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_1] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_2] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_1_dft/FD_IN]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vccint_alarm_out]
