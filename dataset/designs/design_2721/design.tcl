...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 64 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 1 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 10 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 253 CONFIG.Latency 5 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 256 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 252 -to 0 ip_7_accumulator/B
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 2 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MASK 0x22415a4ce73d1a1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x5ae6a264e10a8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0x7b4146ffc9ebac3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x4f05a0ea1096a19 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 194 CONFIG.convolution_code1 23 CONFIG.convolution_code2 100 CONFIG.convolution_code3 348 CONFIG.convolution_code4 365 CONFIG.convolution_code5 294 CONFIG.convolution_code6 450 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_15_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MASK 0x1e13e3806c83dff CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x19f862475c95094 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 9 CONFIG.NUM_SI 6 " [get_bd_cells ip_24_axi_legacy/axi_0]
...
create_bd_pin -dir O -from 252 -to 0 ip_38_slice_and_concat/out0
...
create_bd_pin -dir I -from 255 -to 0 ip_38_slice_and_concat/in_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_9
move_bd_cells [get_bd_cells ip_38_slice_and_concat] [get_bd_cells slice_9]
set_property -dict "CONFIG.DIN_FROM 206 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_38_slice_and_concat/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 216 CONFIG.DIN_TO 207 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 234 CONFIG.DIN_TO 217 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 252 CONFIG.DIN_TO 235 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 255 CONFIG.DIN_TO 253 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_2] [get_bd_pins ip_9_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_3] [get_bd_pins ip_10_gpio/irq]
connect_bd_net [get_bd_pins ip_21_intc/irq_4] [get_bd_pins ip_14_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_5] [get_bd_pins ip_14_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_2] [get_bd_pins ip_9_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_22_intc/irq_3] [get_bd_pins ip_10_gpio/irq]
connect_bd_net [get_bd_pins ip_22_intc/irq_4] [get_bd_pins ip_14_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_2] [get_bd_pins ip_9_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_23_intc/irq_3] [get_bd_pins ip_10_gpio/irq]
connect_bd_net [get_bd_pins ip_23_intc/irq_4] [get_bd_pins ip_14_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_24_axi_legacy/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_24_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/M_AXI] [get_bd_intf_pins ip_24_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_microblaze/M_AXI_DP] [get_bd_intf_pins ip_24_axi_legacy/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_emc/AXI] [get_bd_intf_pins ip_24_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_24_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_intc/AXI] [get_bd_intf_pins ip_24_axi_legacy/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_floating_point/S_AXIS_B] [get_bd_intf_pins ip_28_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_34_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_14_axi_dma/M_AXIS_MM2S]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_6] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_7] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_8] [get_bd_pins ip_1_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_9] [get_bd_pins ip_7_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/out0] [get_bd_pins ip_8_cordic/aclken]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_0] [get_bd_pins ip_17_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_52_slice_and_concat/out0] [get_bd_pins ip_0_dft/FWD_INV]
