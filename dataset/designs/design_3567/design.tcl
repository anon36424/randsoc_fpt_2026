...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 244 CONFIG.Latency 6 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 258 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 243 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 27 CONFIG.aresetn 1 CONFIG.atuserwidth 76 CONFIG.bportwidth 51 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 41 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_3_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 185 CONFIG.convolution_code1 449 CONFIG.convolution_code2 282 CONFIG.convolution_code3 259 CONFIG.convolution_code4 397 CONFIG.convolution_code5 451 CONFIG.convolution_code6 493 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 11 CONFIG.puncture_code0 11011010 CONFIG.puncture_code1 01111110 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7d CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 34 CONFIG.C_SDA_INERTIAL_DELAY 245 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 166.32758306480028 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 100 -to 0 ip_9_accumulator/B
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x24 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 146 CONFIG.C_SDA_INERTIAL_DELAY 204 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 779.1229193607052 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.a_tuser_width 35 CONFIG.add_sub_value Both CONFIG.axi_optimize_goal Performance CONFIG.b_tuser_width 97 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_mult_usage No_Usage CONFIG.flow_control Blocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 1 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_tuser_width 15 CONFIG.operation_type Compare CONFIG.result_tlast_behv Pass_A_TLAST " [get_bd_cells ip_11_floating_point/floating_point_0]
...
create_bd_pin -dir I -from 257 -to 0 ip_31_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_31_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 243 -to 0 ip_34_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 257 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 104 -to 0 ip_34_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 101 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 105 " [get_bd_cells ip_34_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 102 CONFIG.DIN_WIDTH 105 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_0] [get_bd_pins ip_3_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_17_axi_legacy/AXI_S0]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_4] [get_bd_pins ip_1_accumulator/Q]
