...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 2 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 5 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_MEM3_TYPE 2 CONFIG.C_MEM3_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 4 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_PARITY_TYPE_MEM_3 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 14589 CONFIG.C_TAVDV_PS_MEM_1 14391 CONFIG.C_TAVDV_PS_MEM_2 15722 CONFIG.C_TAVDV_PS_MEM_3 13580 CONFIG.C_TCEDV_PS_MEM_0 15416 CONFIG.C_TCEDV_PS_MEM_1 14503 CONFIG.C_TCEDV_PS_MEM_2 13912 CONFIG.C_TCEDV_PS_MEM_3 15107 CONFIG.C_THZCE_PS_MEM_0 7387 CONFIG.C_THZCE_PS_MEM_1 7504 CONFIG.C_THZCE_PS_MEM_2 6618 CONFIG.C_THZCE_PS_MEM_3 6797 CONFIG.C_THZOE_PS_MEM_0 7359 CONFIG.C_THZOE_PS_MEM_1 6833 CONFIG.C_THZOE_PS_MEM_2 7275 CONFIG.C_THZOE_PS_MEM_3 7630 CONFIG.C_TLZWE_PS_MEM_0 2954 CONFIG.C_TLZWE_PS_MEM_1 3591 CONFIG.C_TLZWE_PS_MEM_2 9797 CONFIG.C_TLZWE_PS_MEM_3 1272 CONFIG.C_TWC_PS_MEM_0 15438 CONFIG.C_TWC_PS_MEM_1 14164 CONFIG.C_TWC_PS_MEM_2 14549 CONFIG.C_TWC_PS_MEM_3 15061 CONFIG.C_TWPH_PS_MEM_0 11331 CONFIG.C_TWPH_PS_MEM_1 13046 CONFIG.C_TWPH_PS_MEM_2 10899 CONFIG.C_TWPH_PS_MEM_3 11907 CONFIG.C_TWP_PS_MEM_0 11714 CONFIG.C_TWP_PS_MEM_1 12698 CONFIG.C_TWP_PS_MEM_2 11730 CONFIG.C_TWP_PS_MEM_3 12925 CONFIG.C_WR_REC_TIME_MEM_0 27227 CONFIG.C_WR_REC_TIME_MEM_1 26991 CONFIG.C_WR_REC_TIME_MEM_2 27568 CONFIG.C_WR_REC_TIME_MEM_3 26297 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 9 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_10_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 44 " [get_bd_cells ip_11_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 9 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_12_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_4_reset/interconnect_aresetn] [get_bd_pins ip_2_floating_point/aresetn]
connect_bd_net [get_bd_pins ip_4_reset/peripheral_areset_n] [get_bd_pins ip_3_xadc_wiz/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_5_clk_wiz/clk_out] [get_bd_pins ip_3_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_6_intc/irq_1] [get_bd_pins ip_3_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_2_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_DATA] [get_bd_intf_pins ip_9_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_1] [get_bd_pins ip_3_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_2] [get_bd_pins ip_3_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_3] [get_bd_pins ip_3_xadc_wiz/alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 352 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_11_axis_dwidth_converter/S_AXIS declared=352 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_11_axis_dwidth_converter/S_AXIS declared=352 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/M_AXIS declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/M_AXIS declared=72 actual=ERR $__err" }
