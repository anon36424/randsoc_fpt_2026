...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x67 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 204 CONFIG.C_SDA_INERTIAL_DELAY 231 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 695.4201715386345 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 89 CONFIG.C_SDA_INERTIAL_DELAY 248 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 37.58972970285005 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_BYTE_LEVEL_INTERRUPT_EN 0 CONFIG.C_FIFO_DEPTH 256 CONFIG.C_NUM_TRANSFER_BITS 32 CONFIG.C_SCK_RATIO 16 CONFIG.C_SHARED_STARTUP 1 CONFIG.C_SPI_MODE 0 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 CONFIG.Multiples16 91 " [get_bd_cells ip_3_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 28 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_12_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_4] [get_bd_pins ip_5_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_5_xadc_wiz/vccaux_alarm_out]
