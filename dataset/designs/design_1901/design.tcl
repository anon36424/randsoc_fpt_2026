...
set_property -dict "CONFIG.AINIT_Value c99253eeae9dd39f3fb CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 56 CONFIG.Latency 24 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 76 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 75 -to 0 ip_0_accumulator/Q
...
create_bd_pin -dir I -from 75 -to 0 ip_9_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_9_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 76 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 75 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 76 " [get_bd_cells ip_10_slice_and_concat/slice_0]
