...
set_property -dict "CONFIG.C_ADDR_WIDTH 62 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 65536 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x38 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 249 CONFIG.C_SDA_INERTIAL_DELAY 123 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 895.3883309681075 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1d CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 46 CONFIG.C_SDA_INERTIAL_DELAY 152 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 637.5668787807947 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 47 CONFIG.Iterations 27 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 37 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 40 CONFIG.Round_Mode Truncate " [get_bd_cells ip_10_cordic/cordic_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 8 CONFIG.Iterations 43 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour Pass_Cartesian_TLAST CONFIG.Out_TREADY 0 CONFIG.Output_Width 35 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 45 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_11_cordic/cordic_0]
...
set_property -dict "CONFIG.C_MASK 0xd5fadb629ed21af CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xb175b1c7a64c0d2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_6] [get_bd_pins ip_14_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_10_cordic/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_1] [get_bd_pins ip_7_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_11_cordic/aclken]
