...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 249 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 251 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 248 -to 0 ip_8_accumulator/B
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_17_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_19_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_19_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 248 -to 0 ip_22_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 3 -to 0 ip_22_slice_and_concat/in_7
...
create_bd_pin -dir I -from 250 -to 0 ip_22_slice_and_concat/in_10
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_10
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_10]
set_property -dict "CONFIG.DIN_FROM 213 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_22_slice_and_concat/slice_10]
...
create_bd_pin -dir I -from 250 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 231 CONFIG.DIN_TO 214 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 250 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 250 CONFIG.DIN_TO 232 CONFIG.DIN_WIDTH 251 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_9_reset/interconnect_aresetn] [get_bd_pins ip_4_floating_point/aresetn]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_1] [get_bd_pins ip_6_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_13_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_13_axi/AXI_S1]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_1] [get_bd_pins ip_2_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_2] [get_bd_pins ip_2_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_3_dft/SIZE]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_5_dft/SIZE]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_3_dft/RFFD]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_3_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_7] [get_bd_pins ip_5_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_8] [get_bd_pins ip_5_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_9] [get_bd_pins ip_5_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_10] [get_bd_pins ip_8_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/ADD]
