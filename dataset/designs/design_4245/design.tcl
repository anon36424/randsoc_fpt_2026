...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 35 CONFIG.aresetn 1 CONFIG.atuserwidth 124 CONFIG.bportwidth 63 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 46 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 2 CONFIG.roundmode Truncate " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DUPLEX 0 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_1_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 16 CONFIG.GEN0_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.enable_timer2 0 CONFIG.mode_64bit 0 " [get_bd_cells ip_2_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 512 " [get_bd_cells ip_3_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 45 CONFIG.aresetn 0 CONFIG.atuserwidth 174 CONFIG.bportwidth 39 CONFIG.btuserwidth 205 CONFIG.ctrltuserwidth 184 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 29 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 150 CONFIG.convolution_code1 184 CONFIG.convolution_code2 29 CONFIG.convolution_code3 79 CONFIG.convolution_code4 296 CONFIG.convolution_code5 104 CONFIG.convolution_code6 296 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_5_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 59 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.add_sub_value Both CONFIG.axi_optimize_goal Resources CONFIG.b_tuser_width 123 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_has_overflow 0 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage Medium_Usage CONFIG.c_optimization Low_Latency CONFIG.flow_control Blocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 0 CONFIG.has_aclken 1 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_type Multiply CONFIG.result_tlast_behv Pass_B_TLAST " [get_bd_cells ip_7_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_BAUDRATE 230400 CONFIG.C_DATA_BITS 6 CONFIG.PARITY No_Parity " [get_bd_cells ip_10_uartlite/uart_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 CONFIG.C_TAVDV_PS_MEM_0 14440 CONFIG.C_TAVDV_PS_MEM_1 13983 CONFIG.C_TAVDV_PS_MEM_2 16231 CONFIG.C_TCEDV_PS_MEM_0 15253 CONFIG.C_TCEDV_PS_MEM_1 16070 CONFIG.C_TCEDV_PS_MEM_2 14856 CONFIG.C_THZCE_PS_MEM_0 7233 CONFIG.C_THZCE_PS_MEM_1 6638 CONFIG.C_THZCE_PS_MEM_2 7505 CONFIG.C_THZOE_PS_MEM_0 7120 CONFIG.C_THZOE_PS_MEM_1 7198 CONFIG.C_THZOE_PS_MEM_2 6807 CONFIG.C_TLZWE_PS_MEM_0 5150 CONFIG.C_TLZWE_PS_MEM_1 574 CONFIG.C_TLZWE_PS_MEM_2 1356 CONFIG.C_TWC_PS_MEM_0 16394 CONFIG.C_TWC_PS_MEM_1 15497 CONFIG.C_TWC_PS_MEM_2 15139 CONFIG.C_TWPH_PS_MEM_0 11508 CONFIG.C_TWPH_PS_MEM_1 12795 CONFIG.C_TWPH_PS_MEM_2 11614 CONFIG.C_TWP_PS_MEM_0 12473 CONFIG.C_TWP_PS_MEM_1 11041 CONFIG.C_TWP_PS_MEM_2 11312 CONFIG.C_WR_REC_TIME_MEM_0 27097 CONFIG.C_WR_REC_TIME_MEM_1 29551 CONFIG.C_WR_REC_TIME_MEM_2 28372 " [get_bd_cells ip_12_emc/emc_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 24 CONFIG.Iterations 38 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 36 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 46 CONFIG.Round_Mode Truncate " [get_bd_cells ip_13_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 17 CONFIG.C_SDA_INERTIAL_DELAY 20 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 981.1925835892422 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_14_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_16_dft/dft_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_16_dft/XN_RE
connect_bd_net [get_bd_pins ip_16_dft/XN_RE] [get_bd_pins ip_16_dft/dft_0/XN_RE]
create_bd_pin -dir I -from 9 -to 0 ip_16_dft/XN_IM
...
create_bd_pin -dir O -from 9 -to 0 ip_16_dft/XK_RE
connect_bd_net [get_bd_pins ip_16_dft/XK_RE] [get_bd_pins ip_16_dft/dft_0/XK_RE]
create_bd_pin -dir O -from 9 -to 0 ip_16_dft/XK_IM
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.add_sub_value Both CONFIG.b_tuser_width 94 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_has_overflow 0 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage Max_Usage CONFIG.c_optimization Low_Latency CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Multiply CONFIG.result_tlast_behv AND_all_TLASTs " [get_bd_cells ip_17_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_MASK 0xaf829215bfd9c5 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x291f9a3bbb29ee9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.AINIT_Value fa83973b9795356db27d89f07c0e30f95260230170af3bcaf0ea6b8 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 109 CONFIG.Latency 18 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 221 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_19_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 108 -to 0 ip_19_accumulator/B
connect_bd_net [get_bd_pins ip_19_accumulator/B] [get_bd_pins ip_19_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 220 -to 0 ip_19_accumulator/Q
...
set_property -dict "CONFIG.a_precision_type Single CONFIG.a_tuser_width 41 CONFIG.add_sub_value Subtract CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 0 CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 1 CONFIG.c_mult_usage Medium_Usage CONFIG.c_optimization Speed_Optimized CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 1 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Add_Subtract " [get_bd_cells ip_20_floating_point/floating_point_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_21_dft/dft_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_21_dft/XN_RE
connect_bd_net [get_bd_pins ip_21_dft/XN_RE] [get_bd_pins ip_21_dft/dft_0/XN_RE]
create_bd_pin -dir I -from 14 -to 0 ip_21_dft/XN_IM
...
create_bd_pin -dir O -from 14 -to 0 ip_21_dft/XK_RE
connect_bd_net [get_bd_pins ip_21_dft/XK_RE] [get_bd_pins ip_21_dft/dft_0/XK_RE]
create_bd_pin -dir O -from 14 -to 0 ip_21_dft/XK_IM
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 61 CONFIG.aresetn 1 CONFIG.bportwidth 24 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 36 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 24 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_22_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_SIZE 52 CONFIG.C_AREA_OPTIMIZED 2 CONFIG.C_BRANCH_TARGET_CACHE_SIZE 2 CONFIG.C_DEBUG_ENABLED 1 CONFIG.C_D_AXI 1 CONFIG.C_D_LMB 1 CONFIG.C_FAULT_TOLERANT 1 CONFIG.C_FPU_EXCEPTION 1 CONFIG.C_ILL_OPCODE_EXCEPTION 1 CONFIG.C_I_LMB 1 CONFIG.C_M_AXI_D_BUS_EXCEPTION 1 CONFIG.C_M_AXI_I_BUS_EXCEPTION 0 CONFIG.C_NUMBER_OF_PC_BRK 2 CONFIG.C_NUMBER_OF_RD_ADDR_BRK 1 CONFIG.C_NUMBER_OF_WR_ADDR_BRK 3 CONFIG.C_OPCODE_0x0_ILLEGAL 0 CONFIG.C_PVR 2 CONFIG.C_PVR_USER1 0xfc CONFIG.C_PVR_USER2 0x1d12fd26 CONFIG.C_RESET_MSR_BIP 1 CONFIG.C_RESET_MSR_DCE 1 CONFIG.C_RESET_MSR_EE 1 CONFIG.C_RESET_MSR_EIP 1 CONFIG.C_RESET_MSR_ICE 1 CONFIG.C_RESET_MSR_IE 1 CONFIG.C_UNALIGNED_EXCEPTIONS 0 CONFIG.C_USE_BARREL 1 CONFIG.C_USE_BRANCH_TARGET_CACHE 1 CONFIG.C_USE_DIV 0 CONFIG.C_USE_FPU 1 CONFIG.C_USE_HW_MUL 2 CONFIG.C_USE_INTERRUPT 2 CONFIG.C_USE_MSR_INSTR 0 CONFIG.C_USE_PCMP_INSTR 1 CONFIG.C_USE_REORDER_INSTR 0 CONFIG.C_USE_STACK_PROTECTION 1 " [get_bd_cells ip_23_microblaze/microblaze_0]
...
set_property -dict "CONFIG.C_EXT_RESET_HIGH 1 " [get_bd_cells ip_23_microblaze/lmb_d]
...
set_property -dict "CONFIG.C_MASK 0x3f703e92bc63303 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_23_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_EXT_RESET_HIGH 1 " [get_bd_cells ip_23_microblaze/lmb_i]
...
set_property -dict "CONFIG.C_MASK 0xd6a3f1d234ac462 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_23_microblaze/lmb_ctrl_i]
...
move_bd_cells [get_bd_cells ip_23_microblaze] [get_bd_cells mdm]
set_property -dict "CONFIG.C_DBG_REG_ACCESS 0 CONFIG.C_JTAG_CHAIN 4 " [get_bd_cells ip_23_microblaze/mdm]
connect_bd_intf_net [get_bd_intf_pins ip_23_microblaze/mdm/MBDEBUG_0] [get_bd_intf_pins ip_23_microblaze/microblaze_0/DEBUG]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 18 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_24_gpio/gpio_0]
...
########## xadc_wiz ##########
create_bd_cell -type hier ip_25_xadc_wiz
create_bd_cell -type ip -vlnv xilinx.com:ip:xadc_wiz:3.3 xadc_wiz_0
move_bd_cells [get_bd_cells ip_25_xadc_wiz] [get_bd_cells xadc_wiz_0]
set_property -dict "CONFIG.ADC_OFFSET_AND_GAIN_CALIBRATION 0 CONFIG.ADC_OFFSET_CALIBRATION 0 CONFIG.CHANNEL_AVERAGING 16 CONFIG.ENABLE_CALIBRATION_AVERAGING 1 CONFIG.ENABLE_JTAG_ARBITER 0 CONFIG.ENABLE_RESET 1 CONFIG.ENABLE_VBRAM_ALARM 0 CONFIG.INTERFACE_SELECTION ENABLE_DRP CONFIG.OT_ALARM 1 CONFIG.POWER_DOWN_ADCA 1 CONFIG.POWER_DOWN_ADCB 1 CONFIG.SENSOR_OFFSET_AND_GAIN_CALIBRATION 1 CONFIG.SENSOR_OFFSET_CALIBRATION 1 CONFIG.TIMING_MODE Continuous CONFIG.USER_TEMP_ALARM 0 CONFIG.VCCAUX_ALARM 0 CONFIG.VCCINT_ALARM 0 CONFIG.XADC_STARUP_SELECTION channel_sequencer " [get_bd_cells ip_25_xadc_wiz/xadc_wiz_0]
create_bd_pin -dir I -from 0 -to 0 ip_25_xadc_wiz/dclk_in
connect_bd_net [get_bd_pins ip_25_xadc_wiz/dclk_in] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/dclk_in]
create_bd_pin -dir I -from 0 -to 0 ip_25_xadc_wiz/reset_in
connect_bd_net [get_bd_pins ip_25_xadc_wiz/reset_in] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/reset_in]
create_bd_pin -dir O -from 0 -to 0 ip_25_xadc_wiz/ot_out
connect_bd_net [get_bd_pins ip_25_xadc_wiz/ot_out] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/ot_out]
create_bd_pin -dir O -from 0 -to 0 ip_25_xadc_wiz/eoc_out
connect_bd_net [get_bd_pins ip_25_xadc_wiz/eoc_out] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/eoc_out]
create_bd_pin -dir O -from 0 -to 0 ip_25_xadc_wiz/eos_out
connect_bd_net [get_bd_pins ip_25_xadc_wiz/eos_out] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/eos_out]
create_bd_pin -dir O -from 0 -to 0 ip_25_xadc_wiz/alarm_out
connect_bd_net [get_bd_pins ip_25_xadc_wiz/alarm_out] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/alarm_out]
create_bd_pin -dir O -from 0 -to 0 ip_25_xadc_wiz/busy_out
connect_bd_net [get_bd_pins ip_25_xadc_wiz/busy_out] [get_bd_pins ip_25_xadc_wiz/xadc_wiz_0/busy_out]
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 ip_25_xadc_wiz/Vp_Vn
connect_bd_intf_net [get_bd_intf_pins ip_25_xadc_wiz/Vp_Vn] [get_bd_intf_pins ip_25_xadc_wiz/xadc_wiz_0/Vp_Vn]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 21 CONFIG.aresetn 0 CONFIG.bportwidth 50 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 28 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_26_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0xb50a70b8ffed36f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_27_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_EXT_RESET_HIGH 1 " [get_bd_cells ip_27_microblaze/lmb_i]
...
set_property -dict "CONFIG.C_MASK 0xd3adfdb5200907c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_27_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Assume_Synchronous_Clk 0 CONFIG.EN_SAFETY_CKT 1 CONFIG.Memory_Type True_Dual_Port_RAM CONFIG.use_bram_block BRAM_Controller " [get_bd_cells ip_27_microblaze/mem]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 41 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_28_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_PORTS 10 " [get_bd_cells ip_32_intc/concat_0]
...
set_property -dict "CONFIG.NUM_PORTS 10 " [get_bd_cells ip_33_intc/concat_0]
...
set_property -dict "CONFIG.NUM_MI 14 CONFIG.NUM_SI 5 " [get_bd_cells ip_34_axi_legacy/axi_0]
...
set_property -dict "CONFIG.NUM_MI 5 " [get_bd_cells ip_36_axis_broadcaster/axis_broadcaster_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_47_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_48_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 14 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_50_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 8 " [get_bd_cells ip_51_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_52_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_55_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_59_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_61_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_64_axis_dwidth_converter/axis_dwidth_converter_0]
...
########## axis_combiner ##########
create_bd_cell -type hier ip_65_axis_combiner
create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 axis_combiner_0
move_bd_cells [get_bd_cells ip_65_axis_combiner] [get_bd_cells axis_combiner_0]
set_property -dict "CONFIG.NUM_SI 2 " [get_bd_cells ip_65_axis_combiner/axis_combiner_0]
create_bd_pin -dir I -from 0 -to 0 ip_65_axis_combiner/aclk
connect_bd_net [get_bd_pins ip_65_axis_combiner/aclk] [get_bd_pins ip_65_axis_combiner/axis_combiner_0/aclk]
create_bd_pin -dir I -from 0 -to 0 ip_65_axis_combiner/aresetn
connect_bd_net [get_bd_pins ip_65_axis_combiner/aresetn] [get_bd_pins ip_65_axis_combiner/axis_combiner_0/aresetn]
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 ip_65_axis_combiner/S_AXIS_0
connect_bd_intf_net [get_bd_intf_pins ip_65_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_65_axis_combiner/axis_combiner_0/S00_AXIS]
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 ip_65_axis_combiner/S_AXIS_1
connect_bd_intf_net [get_bd_intf_pins ip_65_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_65_axis_combiner/axis_combiner_0/S01_AXIS]
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ip_65_axis_combiner/M_AXIS
connect_bd_intf_net [get_bd_intf_pins ip_65_axis_combiner/M_AXIS] [get_bd_intf_pins ip_65_axis_combiner/axis_combiner_0/M_AXIS]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_66_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 121 -to 0 ip_67_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_67_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 106 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_67_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 107 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_67_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_67_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 113 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_67_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 118 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_67_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 119 CONFIG.DIN_WIDTH 122 " [get_bd_cells ip_67_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 3 " [get_bd_cells ip_67_reduce/reduce_31]
...
set_property -dict "CONFIG.NUM_PORTS 8 " [get_bd_cells ip_68_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_68_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_4] [get_bd_pins ip_68_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 0 -to 0 ip_68_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_5] [get_bd_pins ip_68_slice_and_concat/concat/In5]
create_bd_pin -dir I -from 0 -to 0 ip_68_slice_and_concat/in_6
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_6] [get_bd_pins ip_68_slice_and_concat/concat/In6]
create_bd_pin -dir I -from 9 -to 0 ip_68_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_68_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_68_slice_and_concat/slice_7]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_7] [get_bd_pins ip_68_slice_and_concat/slice_7/din]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/slice_7/dout] [get_bd_pins ip_68_slice_and_concat/concat/In7]


########## slice_and_concat ##########
create_bd_cell -type hier ip_69_slice_and_concat
create_bd_pin -dir O -from 108 -to 0 ip_69_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_69_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 6 " [get_bd_cells ip_69_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_69_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 9 -to 0 ip_69_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_69_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_69_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_69_slice_and_concat/in_1
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_1] [get_bd_pins ip_69_slice_and_concat/concat/In1]
create_bd_pin -dir I -from 3 -to 0 ip_69_slice_and_concat/in_2
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_2] [get_bd_pins ip_69_slice_and_concat/concat/In2]
create_bd_pin -dir I -from 0 -to 0 ip_69_slice_and_concat/in_3
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_3] [get_bd_pins ip_69_slice_and_concat/concat/In3]
create_bd_pin -dir I -from 0 -to 0 ip_69_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_4] [get_bd_pins ip_69_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 220 -to 0 ip_69_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_69_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 221 " [get_bd_cells ip_69_slice_and_concat/slice_5]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_5] [get_bd_pins ip_69_slice_and_concat/slice_5/din]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/slice_5/dout] [get_bd_pins ip_69_slice_and_concat/concat/In5]


########## slice_and_concat ##########
create_bd_cell -type hier ip_70_slice_and_concat
create_bd_pin -dir O -from 5 -to 0 ip_70_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 221 " [get_bd_cells ip_70_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 121 -to 0 ip_71_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 218 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 221 " [get_bd_cells ip_71_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 220 -to 0 ip_72_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_72_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 219 CONFIG.DIN_TO 219 CONFIG.DIN_WIDTH 221 " [get_bd_cells ip_72_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 14 -to 0 ip_73_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_73_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 3 " [get_bd_cells ip_73_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/out0] [get_bd_pins ip_73_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 220 -to 0 ip_73_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_73_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 220 CONFIG.DIN_TO 220 CONFIG.DIN_WIDTH 221 " [get_bd_cells ip_73_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_73_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_73_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_73_slice_and_concat/slice_2]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/in_2] [get_bd_pins ip_73_slice_and_concat/slice_2/din]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/slice_2/dout] [get_bd_pins ip_73_slice_and_concat/concat/In2]
...
create_bd_pin -dir I -from 14 -to 0 ip_74_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_74_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_74_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_74_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_74_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_74_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 9 -to 0 ip_75_slice_and_concat/out0
create_bd_pin -dir I -from 14 -to 0 ip_75_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_75_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_75_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 9 -to 0 ip_76_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_76_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 7 " [get_bd_cells ip_76_slice_and_concat/concat]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/out0] [get_bd_pins ip_76_slice_and_concat/concat/dout]
create_bd_pin -dir I -from 14 -to 0 ip_76_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_76_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_76_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 3 -to 0 ip_76_slice_and_concat/in_1
...
create_bd_pin -dir I -from 0 -to 0 ip_76_slice_and_concat/in_6
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_6] [get_bd_pins ip_76_slice_and_concat/concat/In6]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 2 " [get_bd_cells ip_78_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 1 -to 0 ip_90_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_90_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 2 " [get_bd_cells ip_90_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 1 -to 0 ip_91_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_91_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 2 " [get_bd_cells ip_91_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_93_slice_and_concat/in_0


########## slice_and_concat ##########
create_bd_cell -type hier ip_94_slice_and_concat
create_bd_pin -dir O -from 0 -to 0 ip_94_slice_and_concat/out0
create_bd_pin -dir I -from 1 -to 0 ip_94_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_94_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 2 " [get_bd_cells ip_94_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_95_slice_and_concat/in_0
...
create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 ip_25_xadc_wiz_Vp_Vn
connect_bd_intf_net [get_bd_intf_pins ip_25_xadc_wiz_Vp_Vn] [get_bd_intf_pins ip_25_xadc_wiz/Vp_Vn]
...
connect_bd_intf_net [get_bd_intf_pins external_axis_source] [get_bd_intf_pins ip_35_axis_broadcaster/S_AXIS]
connect_bd_intf_net [get_bd_intf_pins external_axis_sink] [get_bd_intf_pins ip_52_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_0_complex_multiplier/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_1_axi_ethernet_lite/reset]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_2_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_3_axi_hwicap/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_5_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_8_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_9_uartlite/reset]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_10_uartlite/reset]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_11_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_12_emc/rst]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_14_axi_iic/reset]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_15_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/mb_reset] [get_bd_pins ip_18_microblaze/Reset]
...
connect_bd_net [get_bd_pins ip_29_reset/mb_reset] [get_bd_pins ip_23_microblaze/Reset]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset_n] [get_bd_pins ip_24_gpio/rst]
connect_bd_net [get_bd_pins ip_29_reset/peripheral_areset] [get_bd_pins ip_25_xadc_wiz/reset_in]
connect_bd_net [get_bd_pins ip_29_reset/mb_reset] [get_bd_pins ip_27_microblaze/Reset]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_0_complex_multiplier/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_1_axi_ethernet_lite/clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_2_axi_timer/s_axi_aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_3_axi_hwicap/icap_clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_3_axi_hwicap/s_axi_aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_4_complex_multiplier/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_5_conv_encoder/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_6_axi_cdma/m_axi_aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_6_axi_cdma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_7_floating_point/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_8_axi_timer/s_axi_aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_9_uartlite/clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_10_uartlite/clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_11_conv_encoder/aclk]
...
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_14_axi_iic/clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_15_conv_encoder/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_16_dft/CLK]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_17_floating_point/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_18_microblaze/Clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_19_accumulator/clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_20_floating_point/aclk]
...
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_23_microblaze/Clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_24_gpio/clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_25_xadc_wiz/dclk_in]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_26_complex_multiplier/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_27_microblaze/Clk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_28_axi_cdma/m_axi_aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_28_axi_cdma/s_axi_lite_aclk]
...
connect_bd_net [get_bd_pins ip_31_intc/irq_0] [get_bd_pins ip_1_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_31_intc/irq_1] [get_bd_pins ip_2_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_31_intc/irq_2] [get_bd_pins ip_3_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_31_intc/irq_3] [get_bd_pins ip_6_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_31_intc/irq_4] [get_bd_pins ip_8_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_31_intc/irq_5] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_31_intc/irq_6] [get_bd_pins ip_10_uartlite/irq]
connect_bd_net [get_bd_pins ip_31_intc/irq_7] [get_bd_pins ip_14_axi_iic/irq]
connect_bd_net [get_bd_pins ip_31_intc/irq_8] [get_bd_pins ip_24_gpio/irq]
connect_bd_net [get_bd_pins ip_31_intc/irq_9] [get_bd_pins ip_28_axi_cdma/cdma_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_microblaze/INTERRUPT] [get_bd_intf_pins ip_31_intc/irq]
connect_bd_net [get_bd_pins ip_32_intc/irq_0] [get_bd_pins ip_1_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_32_intc/irq_1] [get_bd_pins ip_2_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_32_intc/irq_2] [get_bd_pins ip_3_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_32_intc/irq_3] [get_bd_pins ip_6_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_32_intc/irq_4] [get_bd_pins ip_8_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_32_intc/irq_5] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_32_intc/irq_6] [get_bd_pins ip_10_uartlite/irq]
connect_bd_net [get_bd_pins ip_32_intc/irq_7] [get_bd_pins ip_14_axi_iic/irq]
connect_bd_net [get_bd_pins ip_32_intc/irq_8] [get_bd_pins ip_24_gpio/irq]
connect_bd_net [get_bd_pins ip_32_intc/irq_9] [get_bd_pins ip_28_axi_cdma/cdma_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_microblaze/INTERRUPT] [get_bd_intf_pins ip_32_intc/irq]
connect_bd_net [get_bd_pins ip_33_intc/irq_0] [get_bd_pins ip_1_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_33_intc/irq_1] [get_bd_pins ip_2_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_33_intc/irq_2] [get_bd_pins ip_3_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_33_intc/irq_3] [get_bd_pins ip_6_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_33_intc/irq_4] [get_bd_pins ip_8_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_33_intc/irq_5] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_33_intc/irq_6] [get_bd_pins ip_10_uartlite/irq]
connect_bd_net [get_bd_pins ip_33_intc/irq_7] [get_bd_pins ip_14_axi_iic/irq]
connect_bd_net [get_bd_pins ip_33_intc/irq_8] [get_bd_pins ip_24_gpio/irq]
connect_bd_net [get_bd_pins ip_33_intc/irq_9] [get_bd_pins ip_28_axi_cdma/cdma_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_microblaze/INTERRUPT] [get_bd_intf_pins ip_33_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/M_AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_microblaze/M_AXI_DP] [get_bd_intf_pins ip_34_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_microblaze/M_AXI_DP] [get_bd_intf_pins ip_34_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_microblaze/M_AXI_DP] [get_bd_intf_pins ip_34_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_axi_cdma/M_AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_timer/S_AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_34_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_34_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_timer/S_AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_uartlite/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_emc/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_iic/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_gpio/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_34_axi_legacy/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_31_intc/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_32_intc/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S12]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_33_intc/AXI] [get_bd_intf_pins ip_34_axi_legacy/AXI_S13]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_36_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_floating_point/M_AXIS_RESULT] [get_bd_intf_pins ip_37_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_38_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_39_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_41_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_35_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_41_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_floating_point/S_AXIS_A] [get_bd_intf_pins ip_42_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_43_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_37_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_floating_point/S_AXIS_A] [get_bd_intf_pins ip_43_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_44_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_17_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_45_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_46_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_5_conv_encoder/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_46_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_47_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_11_conv_encoder/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_47_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_49_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_39_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_49_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_50_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_51_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_26_complex_multiplier/M_AXIS_DOUT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_floating_point/S_AXIS_B] [get_bd_intf_pins ip_51_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_52_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_20_floating_point/M_AXIS_RESULT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_53_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_38_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_53_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_40_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_54_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_55_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_40_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_55_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_56_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_36_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_floating_point/S_AXIS_B] [get_bd_intf_pins ip_56_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_57_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_36_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_floating_point/S_AXIS_B] [get_bd_intf_pins ip_57_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_59_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_61_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_62_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_35_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_63_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_64_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_39_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_64_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_65_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_38_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_65_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_38_axis_broadcaster/M_AXIS_4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_66_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_65_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_floating_point/S_AXIS_A] [get_bd_intf_pins ip_66_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/out0] [get_bd_pins ip_21_dft/XN_IM]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_0] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_1] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_2] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_3] [get_bd_pins ip_8_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_4] [get_bd_pins ip_8_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_5] [get_bd_pins ip_8_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_6] [get_bd_pins ip_16_dft/RFFD]
connect_bd_net [get_bd_pins ip_68_slice_and_concat/in_7] [get_bd_pins ip_16_dft/XK_RE]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/B]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_0] [get_bd_pins ip_16_dft/XK_RE]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_1] [get_bd_pins ip_16_dft/XK_IM]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_2] [get_bd_pins ip_16_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_3] [get_bd_pins ip_16_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_4] [get_bd_pins ip_16_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_69_slice_and_concat/in_5] [get_bd_pins ip_19_accumulator/Q]
connect_bd_net [get_bd_pins ip_70_slice_and_concat/out0] [get_bd_pins ip_21_dft/SIZE]
connect_bd_net [get_bd_pins ip_70_slice_and_concat/in_0] [get_bd_pins ip_19_accumulator/Q]
connect_bd_net [get_bd_pins ip_71_slice_and_concat/out0] [get_bd_pins ip_67_reduce/in0]
connect_bd_net [get_bd_pins ip_71_slice_and_concat/in_0] [get_bd_pins ip_19_accumulator/Q]
connect_bd_net [get_bd_pins ip_72_slice_and_concat/out0] [get_bd_pins ip_3_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_72_slice_and_concat/in_0] [get_bd_pins ip_19_accumulator/Q]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/out0] [get_bd_pins ip_21_dft/XN_RE]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/in_0] [get_bd_pins ip_19_accumulator/Q]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/in_1] [get_bd_pins ip_21_dft/RFFD]
connect_bd_net [get_bd_pins ip_73_slice_and_concat/in_2] [get_bd_pins ip_21_dft/XK_RE]
connect_bd_net [get_bd_pins ip_74_slice_and_concat/out0] [get_bd_pins ip_16_dft/SIZE]
connect_bd_net [get_bd_pins ip_74_slice_and_concat/in_0] [get_bd_pins ip_21_dft/XK_RE]
connect_bd_net [get_bd_pins ip_74_slice_and_concat/in_1] [get_bd_pins ip_21_dft/XK_IM]
connect_bd_net [get_bd_pins ip_75_slice_and_concat/out0] [get_bd_pins ip_16_dft/XN_IM]
connect_bd_net [get_bd_pins ip_75_slice_and_concat/in_0] [get_bd_pins ip_21_dft/XK_IM]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/out0] [get_bd_pins ip_16_dft/XN_RE]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_0] [get_bd_pins ip_21_dft/XK_IM]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_1] [get_bd_pins ip_21_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_2] [get_bd_pins ip_21_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_3] [get_bd_pins ip_21_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_4] [get_bd_pins ip_25_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_5] [get_bd_pins ip_25_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_76_slice_and_concat/in_6] [get_bd_pins ip_25_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_77_slice_and_concat/out0] [get_bd_pins ip_16_dft/CE]
connect_bd_net [get_bd_pins ip_78_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/out0] [get_bd_pins ip_21_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_79_slice_and_concat/out0] [get_bd_pins ip_79_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_80_slice_and_concat/out0] [get_bd_pins ip_16_dft/FD_IN]
connect_bd_net [get_bd_pins ip_80_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_80_slice_and_concat/out0] [get_bd_pins ip_80_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_81_slice_and_concat/out0] [get_bd_pins ip_16_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_81_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_81_slice_and_concat/out0] [get_bd_pins ip_81_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_82_slice_and_concat/out0] [get_bd_pins ip_8_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_82_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_82_slice_and_concat/out0] [get_bd_pins ip_82_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_83_slice_and_concat/out0] [get_bd_pins ip_4_complex_multiplier/aclken]
connect_bd_net [get_bd_pins ip_83_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_83_slice_and_concat/out0] [get_bd_pins ip_83_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_84_slice_and_concat/out0] [get_bd_pins ip_22_complex_multiplier/aclken]
connect_bd_net [get_bd_pins ip_84_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_84_slice_and_concat/out0] [get_bd_pins ip_84_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_85_slice_and_concat/out0] [get_bd_pins ip_7_floating_point/aclken]
connect_bd_net [get_bd_pins ip_85_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_85_slice_and_concat/out0] [get_bd_pins ip_85_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_86_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_86_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_86_slice_and_concat/out0] [get_bd_pins ip_86_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_87_slice_and_concat/out0] [get_bd_pins ip_11_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_87_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_87_slice_and_concat/out0] [get_bd_pins ip_87_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_88_slice_and_concat/out0] [get_bd_pins ip_20_floating_point/aclken]
connect_bd_net [get_bd_pins ip_88_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_88_slice_and_concat/out0] [get_bd_pins ip_88_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_89_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_89_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_89_slice_and_concat/out0] [get_bd_pins ip_89_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_90_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_91_slice_and_concat/out0] [get_bd_pins ip_0_complex_multiplier/aclken]
connect_bd_net [get_bd_pins ip_92_slice_and_concat/out0] [get_bd_pins ip_21_dft/FD_IN]
connect_bd_net [get_bd_pins ip_92_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_92_slice_and_concat/out0] [get_bd_pins ip_92_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_93_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_93_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_93_slice_and_concat/out0] [get_bd_pins ip_93_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_94_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/CE]
connect_bd_net [get_bd_pins ip_95_slice_and_concat/out0] [get_bd_pins ip_8_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_95_slice_and_concat/in_0] [get_bd_pins ip_25_xadc_wiz/alarm_out]
connect_bd_net [get_bd_pins ip_95_slice_and_concat/out0] [get_bd_pins ip_95_slice_and_concat/in_0]
...
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_58_axis_combiner/aresetn]
...
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_62_axis_combiner/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_63_axis_dwidth_converter/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_64_axis_dwidth_converter/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_65_axis_combiner/aresetn]
connect_bd_net [get_bd_pins ip_29_reset/interconnect_aresetn] [get_bd_pins ip_66_axis_dwidth_converter/aresetn]
...
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_58_axis_combiner/aclk]
...
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_62_axis_combiner/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_63_axis_dwidth_converter/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_64_axis_dwidth_converter/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_65_axis_combiner/aclk]
connect_bd_net [get_bd_pins ip_30_clk_wiz/clk_out] [get_bd_pins ip_66_axis_dwidth_converter/aclk]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_4_complex_multiplier/M_AXIS_DOUT declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_4_complex_multiplier/M_AXIS_DOUT declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_floating_point/S_AXIS_B declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_floating_point/S_AXIS_B declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_floating_point/S_AXIS_B declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_floating_point/S_AXIS_B declared=32 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_complex_multiplier/S_AXIS_B declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_complex_multiplier/S_AXIS_B declared=48 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_22_complex_multiplier/cmpy_0/M_AXIS_DOUT]] * 8}]
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_complex_multiplier/M_AXIS_DOUT declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_complex_multiplier/M_AXIS_DOUT declared=48 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_26_complex_multiplier/cmpy_0/S_AXIS_A]] * 8}]
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_26_complex_multiplier/S_AXIS_A declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_complex_multiplier/S_AXIS_A declared=48 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_26_complex_multiplier/S_AXIS_B declared=112 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_complex_multiplier/S_AXIS_B declared=112 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_26_complex_multiplier/cmpy_0/M_AXIS_DOUT]] * 8}]
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_26_complex_multiplier/M_AXIS_DOUT declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_complex_multiplier/M_AXIS_DOUT declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_4 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_broadcaster/M_AXIS_4 declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/S_AXIS declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/S_AXIS declared=80 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_40_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/M_AXIS_0 declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/M_AXIS_0 declared=80 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_40_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/M_AXIS_1 declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/M_AXIS_1 declared=80 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_40_axis_broadcaster/axis_broadcaster_0/M02_AXIS]] * 8}]
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/M_AXIS_2 declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_broadcaster/M_AXIS_2 declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_50_axis_dwidth_converter/S_AXIS declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_50_axis_dwidth_converter/S_AXIS declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_51_axis_dwidth_converter/S_AXIS declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_51_axis_dwidth_converter/S_AXIS declared=64 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_53_axis_combiner/S_AXIS_1 declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_53_axis_combiner/S_AXIS_1 declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_55_axis_dwidth_converter/S_AXIS declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_55_axis_dwidth_converter/S_AXIS declared=80 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_55_axis_dwidth_converter/M_AXIS declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_55_axis_dwidth_converter/M_AXIS declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_58_axis_combiner/S_AXIS_0 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_58_axis_combiner/S_AXIS_0 declared=64 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_58_axis_combiner/axis_combiner_0/S01_AXIS]] * 8}]
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_58_axis_combiner/S_AXIS_1 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_58_axis_combiner/S_AXIS_1 declared=64 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_58_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_58_axis_combiner/M_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_58_axis_combiner/M_AXIS declared=128 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_59_axis_dwidth_converter/S_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_59_axis_dwidth_converter/S_AXIS declared=128 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_59_axis_dwidth_converter/M_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_59_axis_dwidth_converter/M_AXIS declared=128 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_60_axis_combiner/S_AXIS_1 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_60_axis_combiner/S_AXIS_1 declared=64 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_60_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_60_axis_combiner/M_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_60_axis_combiner/M_AXIS declared=128 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_61_axis_dwidth_converter/S_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_61_axis_dwidth_converter/S_AXIS declared=128 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_61_axis_dwidth_converter/M_AXIS declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_61_axis_dwidth_converter/M_AXIS declared=128 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_64_axis_dwidth_converter/S_AXIS declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_64_axis_dwidth_converter/S_AXIS declared=48 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_64_axis_dwidth_converter/M_AXIS declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_64_axis_dwidth_converter/M_AXIS declared=48 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_65_axis_combiner/axis_combiner_0/S00_AXIS]] * 8}]
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_65_axis_combiner/S_AXIS_0 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_65_axis_combiner/S_AXIS_0 declared=16 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_65_axis_combiner/axis_combiner_0/S01_AXIS]] * 8}]
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_65_axis_combiner/S_AXIS_1 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_65_axis_combiner/S_AXIS_1 declared=16 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_65_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_65_axis_combiner/M_AXIS declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_65_axis_combiner/M_AXIS declared=32 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_66_axis_dwidth_converter/S_AXIS declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_66_axis_dwidth_converter/S_AXIS declared=32 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_66_axis_dwidth_converter/M_AXIS declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_66_axis_dwidth_converter/M_AXIS declared=32 actual=ERR $__err" }
