...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xffff CONFIG.C_DOUT_DEFAULT_2 0xffff CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 16 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xffff CONFIG.C_TRI_DEFAULT_2 0xffff " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xfffff CONFIG.C_DOUT_DEFAULT_2 0xb93ec CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 20 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x4494d CONFIG.C_TRI_DEFAULT_2 0x10f77 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 39 CONFIG.aresetn 0 CONFIG.atuserwidth 131 CONFIG.bportwidth 39 CONFIG.btuserwidth 160 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 13 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 10 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 15 CONFIG.aresetn 1 CONFIG.atuserwidth 3 CONFIG.bportwidth 52 CONFIG.btuserwidth 137 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 17 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 67 CONFIG.roundmode Truncate " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_gpio/AXI] [get_bd_intf_pins ip_10_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_11_axis_broadcaster/M_AXIS_3]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_1] [get_bd_pins ip_6_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_2] [get_bd_pins ip_6_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_3] [get_bd_pins ip_6_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_6_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_6_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_20_slice_and_concat/out0] [get_bd_pins ip_5_floating_point/aclken]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/alarm_out]
