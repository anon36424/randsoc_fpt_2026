...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 2 CONFIG.C_TAVDV_PS_MEM_0 13859 CONFIG.C_TCEDV_PS_MEM_0 16436 CONFIG.C_THZCE_PS_MEM_0 6906 CONFIG.C_THZOE_PS_MEM_0 6502 CONFIG.C_TLZWE_PS_MEM_0 4645 CONFIG.C_TWC_PS_MEM_0 15565 CONFIG.C_TWPH_PS_MEM_0 11222 CONFIG.C_TWP_PS_MEM_0 12560 CONFIG.C_WR_REC_TIME_MEM_0 24425 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x71 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 37 CONFIG.C_SDA_INERTIAL_DELAY 39 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 609.6797387635901 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 3 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 15 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 30 CONFIG.aresetn 0 CONFIG.bportwidth 57 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 33 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 4 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_14_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_4] [get_bd_pins ip_6_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_5] [get_bd_pins ip_6_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_3_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/ot_out]
