...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 256 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 16 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_2_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_MASK 0xbee2d2bc906bc14 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x2c279839740082 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 18 CONFIG.C_GPIO_WIDTH 12 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_6_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 17 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_7_dft/dft_0]
...
set_property -dict "CONFIG.C_MASK 0x1a09559c55ddd77 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfee927f3a0c6cd CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 47 CONFIG.Iterations 6 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 41 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 41 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_9_cordic/cordic_0]
...
set_property -dict "CONFIG.C_MASK 0xbe1d25b2beebc9c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x716c3f67b63d910 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_20_fft/fft_0]
...
set_property -dict "CONFIG.NUM_MI 15 CONFIG.NUM_SI 6 " [get_bd_cells ip_27_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_33_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_34_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 16 -to 0 ip_36_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_36_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_36_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 43 -to 0 ip_38_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_38_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_38_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_8] [get_bd_pins ip_15_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_24_intc/irq_9] [get_bd_pins ip_16_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_10] [get_bd_pins ip_17_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_microblaze/M_AXI_DP] [get_bd_intf_pins ip_27_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_microblaze/M_AXI_DP] [get_bd_intf_pins ip_27_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_27_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_27_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_27_axi/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_27_axi/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_30_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_15_axi_dma/M_AXIS_MM2S]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_33_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_12_floating_point/M_AXIS_RESULT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_fft/S_AXIS_DATA] [get_bd_intf_pins ip_33_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_3] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_4] [get_bd_pins ip_7_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_2] [get_bd_pins ip_7_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_3] [get_bd_pins ip_7_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_4] [get_bd_pins ip_7_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_5] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_6] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_7] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_8] [get_bd_pins ip_14_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_7_dft/XN_IM]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_14_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_1] [get_bd_pins ip_14_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_2] [get_bd_pins ip_18_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/out0] [get_bd_pins ip_42_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_7_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_0] [get_bd_pins ip_14_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_0] [get_bd_pins ip_14_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/out0] [get_bd_pins ip_44_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_7_dft/FD_IN]
...
connect_bd_net [get_bd_pins ip_48_slice_and_concat/in_0] [get_bd_pins ip_14_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_18_accumulator/SCLR]
...
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_19_cordic/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 11 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_35_axis_dwidth_converter/M_AXIS declared=11 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_35_axis_dwidth_converter/M_AXIS declared=11 actual=ERR $__err" }
