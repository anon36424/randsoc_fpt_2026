...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 9 CONFIG.aresetn 1 CONFIG.atuserwidth 194 CONFIG.bportwidth 63 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 60 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x44 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 240 CONFIG.C_SDA_INERTIAL_DELAY 254 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 757.4434700933735 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_20_slice_and_concat/slice_4]
...
create_bd_pin -dir I -from 8 -to 0 ip_23_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_23_slice_and_concat/slice_4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_12_axi/AXI_S3]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_3] [get_bd_pins ip_6_dft/RFFD]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_4] [get_bd_pins ip_6_dft/XK_RE]
