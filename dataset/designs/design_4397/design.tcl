...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 14 CONFIG.C_TAVDV_PS_MEM_0 14887 CONFIG.C_TCEDV_PS_MEM_0 15396 CONFIG.C_THZCE_PS_MEM_0 7428 CONFIG.C_THZOE_PS_MEM_0 7130 CONFIG.C_TLZWE_PS_MEM_0 531 CONFIG.C_TWC_PS_MEM_0 14651 CONFIG.C_TWPH_PS_MEM_0 12043 CONFIG.C_TWP_PS_MEM_0 10838 CONFIG.C_WR_REC_TIME_MEM_0 24546 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x38 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 228 CONFIG.C_SDA_INERTIAL_DELAY 177 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 728.3921239169972 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 40 -to 0 ip_15_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_15_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_18_slice_and_concat/slice_3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_1] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_3] [get_bd_pins ip_6_accumulator/Q]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_0] [get_bd_pins ip_6_accumulator/Q]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_7_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_3] [get_bd_pins ip_7_dft/XK_IM]
