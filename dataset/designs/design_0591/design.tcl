...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 512 " [get_bd_cells ip_0_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 13 CONFIG.aresetn 0 CONFIG.atuserwidth 164 CONFIG.bportwidth 53 CONFIG.btuserwidth 159 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 16 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 21 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 33 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 18 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_8_dft/dft_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_23_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_25_slice_and_concat/slice_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_16_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_16_axi/AXI_M4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_16_axi/AXI_S1]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_4] [get_bd_pins ip_11_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_5] [get_bd_pins ip_11_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_6] [get_bd_pins ip_11_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_7] [get_bd_pins ip_11_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_8] [get_bd_pins ip_11_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_9] [get_bd_pins ip_11_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_10] [get_bd_pins ip_12_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_11] [get_bd_pins ip_12_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_0_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_12_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_11_xadc_wiz/vccaux_alarm_out]
