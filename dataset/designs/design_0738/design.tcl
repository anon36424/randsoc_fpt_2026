...
set_property -dict "CONFIG.C_MASK 0xb25532dc90db939 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xee35212a89859e6 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir O -from 11 -to 0 ip_1_accumulator/Q
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 3 CONFIG.C_TAVDV_PS_MEM_0 14727 CONFIG.C_TCEDV_PS_MEM_0 15078 CONFIG.C_THZCE_PS_MEM_0 6776 CONFIG.C_THZOE_PS_MEM_0 6870 CONFIG.C_TLZWE_PS_MEM_0 4735 CONFIG.C_TWC_PS_MEM_0 14737 CONFIG.C_TWPH_PS_MEM_0 12752 CONFIG.C_TWP_PS_MEM_0 10916 CONFIG.C_WR_REC_TIME_MEM_0 24394 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 53 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x23 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 204 CONFIG.C_SDA_INERTIAL_DELAY 95 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 979.8901597484188 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 32 CONFIG.Iterations 14 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour OR_of_TLAST CONFIG.Out_TREADY 0 CONFIG.Output_Width 35 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 46 CONFIG.Round_Mode Truncate " [get_bd_cells ip_7_cordic/cordic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 28 CONFIG.aresetn 0 CONFIG.bportwidth 41 CONFIG.ctrltuserwidth 186 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 11 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 33 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 144 CONFIG.convolution_code1 245 CONFIG.convolution_code2 90 CONFIG.convolution_code3 245 CONFIG.convolution_code4 168 CONFIG.convolution_code5 163 CONFIG.convolution_code6 168 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 10 CONFIG.puncture_code0 01011100 CONFIG.puncture_code1 00111111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_10_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 38 CONFIG.aresetn 1 CONFIG.bportwidth 26 CONFIG.btuserwidth 167 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 40 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_13_fft/fft_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 27 CONFIG.Iterations 10 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 8 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 11 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_14_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1c CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 58 CONFIG.C_SDA_INERTIAL_DELAY 21 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 185.52430002055496 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_16_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_0] [get_bd_pins ip_3_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_3] [get_bd_pins ip_6_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_20_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/M_AXI] [get_bd_intf_pins ip_20_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_emc/AXI] [get_bd_intf_pins ip_20_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_20_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_20_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_iic/AXI] [get_bd_intf_pins ip_20_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_20_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_DATA] [get_bd_intf_pins ip_31_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_33_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_39_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_21_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_21_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_0] [get_bd_pins ip_15_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_1] [get_bd_pins ip_15_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_2] [get_bd_pins ip_15_axi_timer/pwm0]
