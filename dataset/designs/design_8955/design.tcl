...
create_bd_pin -dir I -from 230 -to 0 ip_2_accumulator/B
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_4_dft/dft_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_6_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.NUM_MI 7 CONFIG.NUM_SI 2 " [get_bd_cells ip_10_axi_legacy/axi_0]
...
create_bd_pin -dir O -from 22 -to 0 ip_12_slice_and_concat/out0
create_bd_pin -dir I -from 253 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 230 -to 0 ip_16_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 253 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_16_slice_and_concat/in_2
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_2] [get_bd_pins ip_16_slice_and_concat/concat/In2]
create_bd_pin -dir I -from 14 -to 0 ip_16_slice_and_concat/in_3
...
connect_bd_net [get_bd_pins ip_9_intc/irq_3] [get_bd_pins ip_5_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_uartlite/AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_10_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_10_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_10_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_10_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_6_axi_hwicap/eos_in]
