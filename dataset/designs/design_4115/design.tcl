...
set_property -dict "CONFIG.NUM_PORTS 7 " [get_bd_cells ip_6_slice_and_concat/concat]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_timer/S_AXI] [get_bd_intf_pins ip_5_axi_legacy/AXI_S0]
...
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_4] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_5] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_6] [get_bd_pins ip_1_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vbram_alarm_out]
