...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 2048 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 36 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6c CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 226 CONFIG.C_SDA_INERTIAL_DELAY 220 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 654.6345111845407 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x73 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 235 CONFIG.C_SDA_INERTIAL_DELAY 121 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 515.9576808448162 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_PORTS 12 " [get_bd_cells ip_14_intc/concat_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_14_intc/irq_11
connect_bd_net [get_bd_pins ip_14_intc/irq_11] [get_bd_pins ip_14_intc/concat_0/In11]
...
set_property -dict "CONFIG.NUM_MI 12 CONFIG.NUM_SI 1 " [get_bd_cells ip_15_axi_legacy/axi_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_6] [get_bd_pins ip_6_axi_iic/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_7] [get_bd_pins ip_7_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_8] [get_bd_pins ip_8_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_14_intc/irq_9] [get_bd_pins ip_9_uartlite/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_10] [get_bd_pins ip_10_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_14_intc/irq_11] [get_bd_pins ip_11_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_15_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_DATA] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_10_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_3] [get_bd_pins ip_10_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_4] [get_bd_pins ip_10_axi_timer/pwm0]
