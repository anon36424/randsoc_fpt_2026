...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x7f CONFIG.C_DOUT_DEFAULT_2 0x48 CONFIG.C_GPIO2_WIDTH 32 CONFIG.C_GPIO_WIDTH 7 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 1 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_3_axi_hwicap/axi_hwicap_0]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_6] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_7] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_3_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_0] [get_bd_pins ip_1_axi_timer/pwm0]
