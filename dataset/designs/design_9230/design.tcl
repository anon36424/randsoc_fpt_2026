...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 55 CONFIG.aresetn 0 CONFIG.bportwidth 39 CONFIG.btuserwidth 112 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 85 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_12_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.NUM_PORTS 12 " [get_bd_cells ip_13_slice_and_concat/concat]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_13_slice_and_concat/in_8
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_8] [get_bd_pins ip_13_slice_and_concat/concat/In8]
create_bd_pin -dir I -from 0 -to 0 ip_13_slice_and_concat/in_9
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_9] [get_bd_pins ip_13_slice_and_concat/concat/In9]
create_bd_pin -dir I -from 0 -to 0 ip_13_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_10] [get_bd_pins ip_13_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 41 -to 0 ip_13_slice_and_concat/in_11
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_11
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_11]
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_13_slice_and_concat/slice_11]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_11] [get_bd_pins ip_13_slice_and_concat/slice_11/din]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/slice_11/dout] [get_bd_pins ip_13_slice_and_concat/concat/In11]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_6_clk_wiz/clk_out] [get_bd_pins ip_1_xadc_wiz/dclk_in]
...
connect_bd_net [get_bd_pins ip_7_intc/irq_0] [get_bd_pins ip_2_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_10_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_2] [get_bd_pins ip_0_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_3] [get_bd_pins ip_0_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_4] [get_bd_pins ip_0_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_6] [get_bd_pins ip_1_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_7] [get_bd_pins ip_1_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_8] [get_bd_pins ip_1_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_9] [get_bd_pins ip_1_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_10] [get_bd_pins ip_1_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_11] [get_bd_pins ip_3_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_0_dft/FD_IN]
