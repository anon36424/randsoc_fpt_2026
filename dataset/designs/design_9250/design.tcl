...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 10 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 125 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 124 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 93 CONFIG.convolution_code1 41 CONFIG.convolution_code2 41 CONFIG.convolution_code3 67 CONFIG.convolution_code4 145 CONFIG.convolution_code5 169 CONFIG.convolution_code6 96 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 6 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_1_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 9 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 39 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 65536 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 50 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 217 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 227 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 216 -to 0 ip_8_accumulator/B
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 23 CONFIG.aresetn 0 CONFIG.bportwidth 39 CONFIG.btuserwidth 185 CONFIG.ctrltuserwidth 47 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 56 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0x9763a756e6e4e07 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xec43eacd5384479 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 3 CONFIG.NUM_SI 2 " [get_bd_cells ip_15_axi/axi_0]
...
create_bd_pin -dir I -from 157 -to 0 ip_28_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 144 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 145 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 153 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 157 CONFIG.DIN_TO 154 CONFIG.DIN_WIDTH 158 " [get_bd_cells ip_28_reduce/slice_31]
...
create_bd_pin -dir I -from 124 -to 0 ip_29_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_29_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 125 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 157 -to 0 ip_30_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 124 -to 0 ip_30_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 125 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 38 -to 0 ip_30_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_4] [get_bd_pins ip_30_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 226 -to 0 ip_30_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_30_slice_and_concat/slice_5]
...
create_bd_pin -dir O -from 216 -to 0 ip_31_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 217 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 226 CONFIG.DIN_TO 218 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_reset/peripheral_areset_n] [get_bd_pins ip_9_axi_ethernet_lite/reset]
...
connect_bd_net [get_bd_pins ip_13_clk_wiz/clk_out] [get_bd_pins ip_2_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_13_clk_wiz/clk_out] [get_bd_pins ip_9_axi_ethernet_lite/clk]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_0] [get_bd_pins ip_2_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_4] [get_bd_pins ip_9_axi_ethernet_lite/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_microblaze/INTERRUPT] [get_bd_intf_pins ip_14_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/M_AXI] [get_bd_intf_pins ip_15_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_microblaze/M_AXI_DP] [get_bd_intf_pins ip_15_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_15_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_18_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_DATA] [get_bd_intf_pins ip_19_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_26_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_19_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_2_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_2_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_4] [get_bd_pins ip_4_accumulator/Q]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_5] [get_bd_pins ip_8_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/C_IN]
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_24_axis_combiner/S_AXIS_2 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_axis_combiner/S_AXIS_2 declared=64 actual=ERR $__err" }
if {[catch {
