...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 2048 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x7641580fcca4c41 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x279bcc46ba32783 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 32 CONFIG.Iterations 39 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 42 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 45 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_8_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2e CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 6 CONFIG.C_SDA_INERTIAL_DELAY 200 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 922.1682829322483 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_12_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_MI 9 CONFIG.NUM_SI 6 " [get_bd_cells ip_17_axi_legacy/axi_0]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_2] [get_bd_pins ip_1_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_16_intc/irq_3] [get_bd_pins ip_2_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_16_intc/irq_4] [get_bd_pins ip_3_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_5] [get_bd_pins ip_4_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_16_intc/irq_6] [get_bd_pins ip_5_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_16_intc/irq_7] [get_bd_pins ip_6_uartlite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_8] [get_bd_pins ip_11_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_9] [get_bd_pins ip_12_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_17_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_17_axi_legacy/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_17_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_iic/AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_10_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_DATA] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_19_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_DATA] [get_bd_intf_pins ip_27_axis_combiner/M_AXIS]
...
if {[catch {
  ...
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_27_axis_combiner/S_AXIS_3 declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_27_axis_combiner/S_AXIS_3 declared=256 actual=ERR $__err" }
if {[catch {
