...
set_property -dict "CONFIG.C_MASK 0xd94dd99460d2179 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x53e5eef37c1e6fa CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4b CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 120 CONFIG.C_SDA_INERTIAL_DELAY 73 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 228.95018262255962 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 51 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x16 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 72 CONFIG.C_SDA_INERTIAL_DELAY 231 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 733.6435110923276 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x81b3a59d91beb5d CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x8bd09dc9850e7a0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 1 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_SHARED_STARTUP 0 " [get_bd_cells ip_10_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_BAUDRATE 128000 CONFIG.C_DATA_BITS 7 CONFIG.PARITY Odd " [get_bd_cells ip_11_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 12 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_12_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 154 CONFIG.Latency 27 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 227 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.a_tuser_width 92 CONFIG.add_sub_value Both CONFIG.b_tuser_width 32 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Equal CONFIG.c_has_invalid_op 1 CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Compare CONFIG.result_tlast_behv Pass_A_TLAST " [get_bd_cells ip_14_floating_point/floating_point_0]
...
create_bd_pin -dir I -from 72 -to 0 ip_27_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 73 " [get_bd_cells ip_27_reduce/slice_31]
...
create_bd_pin -dir O -from 72 -to 0 ip_28_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 226 -to 0 ip_28_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_28_slice_and_concat/slice_6]
...
create_bd_pin -dir O -from 153 -to 0 ip_29_slice_and_concat/out0
create_bd_pin -dir I -from 226 -to 0 ip_29_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_29_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 197 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 226 -to 0 ip_30_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 208 CONFIG.DIN_TO 198 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 209 CONFIG.DIN_TO 209 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 220 CONFIG.DIN_TO 210 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 226 CONFIG.DIN_TO 221 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_6] [get_bd_pins ip_12_gpio/irq]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_4] [get_bd_pins ip_10_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_19_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_19_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_uartlite/AXI] [get_bd_intf_pins ip_19_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_gpio/AXI] [get_bd_intf_pins ip_19_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_intc/AXI] [get_bd_intf_pins ip_19_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_8_conv_encoder/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_floating_point/S_AXIS_A] [get_bd_intf_pins ip_23_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_floating_point/S_AXIS_B] [get_bd_intf_pins ip_26_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_27_reduce/in0]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_1] [get_bd_pins ip_7_dft/XK_RE]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_2] [get_bd_pins ip_7_dft/XK_IM]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_3] [get_bd_pins ip_7_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_4] [get_bd_pins ip_7_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_5] [get_bd_pins ip_7_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_6] [get_bd_pins ip_13_accumulator/Q]
