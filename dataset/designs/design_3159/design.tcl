...
set_property -dict "CONFIG.AINIT_Value 52469a0d0f5a14e6d434cc29c859fc89e4bb2af195bb885febe8 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 193 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 212 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 192 -to 0 ip_1_accumulator/B
...
create_bd_pin -dir O -from 192 -to 0 ip_6_slice_and_concat/out0
create_bd_pin -dir I -from 211 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 192 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 212 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 211 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 211 CONFIG.DIN_TO 193 CONFIG.DIN_WIDTH 212 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/Bypass]
