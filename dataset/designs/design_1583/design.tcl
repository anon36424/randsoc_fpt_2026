...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5f CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 215 CONFIG.C_SDA_INERTIAL_DELAY 147 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 591.7664927143664 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x92f63680177aa15 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6b17fc53c0ff6eb CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x98635 CONFIG.C_GPIO_WIDTH 21 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x90ad4 " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 24 CONFIG.Iterations 15 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 47 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 48 CONFIG.Round_Mode Truncate " [get_bd_cells ip_8_cordic/cordic_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 14 CONFIG.C_GPIO_WIDTH 8 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_9_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3fff CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.AINIT_Value 7fffffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 51 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 79 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_12_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 50 -to 0 ip_12_accumulator/B
connect_bd_net [get_bd_pins ip_12_accumulator/B] [get_bd_pins ip_12_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 78 -to 0 ip_12_accumulator/Q
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3c CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 239 CONFIG.C_SDA_INERTIAL_DELAY 122 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 998.7782522242956 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 32 -to 0 ip_26_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_26_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_26_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_26_reduce/slice_31]
...
create_bd_pin -dir I -from 78 -to 0 ip_28_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 79 " [get_bd_cells ip_28_slice_and_concat/slice_2]
...
create_bd_pin -dir I -from 78 -to 0 ip_29_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_29_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 78 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 79 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_18_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_gpio/AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_2_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_4_axi_timer/generateout0]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_1] [get_bd_pins ip_4_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_2] [get_bd_pins ip_12_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_1] [get_bd_pins ip_14_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_2] [get_bd_pins ip_14_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_3] [get_bd_pins ip_14_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_12_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_4_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_5_conv_encoder/aclken]
