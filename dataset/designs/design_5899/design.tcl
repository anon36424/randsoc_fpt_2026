...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x65 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 128 CONFIG.C_SDA_INERTIAL_DELAY 93 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 212.30476081766886 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.NUM_PORTS 9 " [get_bd_cells ip_11_intc/concat_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_11_intc/irq_8
connect_bd_net [get_bd_pins ip_11_intc/irq_8] [get_bd_pins ip_11_intc/concat_0/In8]
...
set_property -dict "CONFIG.NUM_MI 9 CONFIG.NUM_SI 4 " [get_bd_cells ip_12_axi_legacy/axi_0]
...
set_property -dict "CONFIG.NUM_PORTS 9 " [get_bd_cells ip_16_slice_and_concat/concat]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_5] [get_bd_pins ip_5_uartlite/irq]
connect_bd_net [get_bd_pins ip_11_intc/irq_6] [get_bd_pins ip_6_axi_iic/irq]
connect_bd_net [get_bd_pins ip_11_intc/irq_7] [get_bd_pins ip_7_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_11_intc/irq_8] [get_bd_pins ip_8_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_12_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_iic/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_6] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_7] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_8] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_4_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_7_axi_timer/capturetrig0]
