...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1fff CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x7c5 " [get_bd_cells ip_0_gpio/gpio_0]
