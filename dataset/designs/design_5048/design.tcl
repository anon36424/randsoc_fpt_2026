...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0xb0ac1b2 CONFIG.C_DOUT_DEFAULT_2 0x1fffffff CONFIG.C_GPIO2_WIDTH 11 CONFIG.C_GPIO_WIDTH 29 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 39 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_8_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 27 CONFIG.Iterations 19 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 39 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 45 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_9_cordic/cordic_0]
...
set_property -dict "CONFIG.C_MASK 0xd2e3fb857f8eb37 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xd342c7cfa6bb527 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BAUDRATE 300 CONFIG.C_DATA_BITS 7 CONFIG.PARITY No_Parity " [get_bd_cells ip_12_uartlite/uart_0]
...
set_property -dict "CONFIG.C_MASK 0xc5d3824c7842fb8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x1b1666c01a96c72 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x44 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 23 CONFIG.C_SDA_INERTIAL_DELAY 207 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 517.486103711971 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_15_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_24_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_10] [get_bd_pins ip_15_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_10] [get_bd_pins ip_15_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_uartlite/AXI] [get_bd_intf_pins ip_20_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_timer/S_AXI] [get_bd_intf_pins ip_20_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_1_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_6_dft/RFFD]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_7] [get_bd_pins ip_6_dft/XK_RE]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_6_dft/SIZE]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_6_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_2] [get_bd_pins ip_6_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_3] [get_bd_pins ip_6_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_4] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_5] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_6] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_7] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_8] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_5_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_13_axi_timer/pwm0]
