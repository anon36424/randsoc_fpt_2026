...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_1_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x16 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 34 CONFIG.C_SDA_INERTIAL_DELAY 4 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 275.3461250367345 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 59 CONFIG.aresetn 1 CONFIG.atuserwidth 163 CONFIG.bportwidth 61 CONFIG.btuserwidth 178 CONFIG.ctrltuserwidth 43 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 109 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 1 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 36 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 35 -to 0 ip_5_accumulator/Q
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 1 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_7_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.channels 6 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16384 " [get_bd_cells ip_12_fft/fft_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 8 CONFIG.C_TAVDV_PS_MEM_0 16476 CONFIG.C_TCEDV_PS_MEM_0 16356 CONFIG.C_THZCE_PS_MEM_0 7330 CONFIG.C_THZOE_PS_MEM_0 6902 CONFIG.C_TLZWE_PS_MEM_0 4308 CONFIG.C_TWC_PS_MEM_0 13680 CONFIG.C_TWPH_PS_MEM_0 11591 CONFIG.C_TWP_PS_MEM_0 11333 CONFIG.C_WR_REC_TIME_MEM_0 25014 " [get_bd_cells ip_13_emc/emc_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 37 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 41 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_14_accumulator/accumulator_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 28 " [get_bd_cells ip_28_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 39 -to 0 ip_29_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_31_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 35 -to 0 ip_33_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 36 " [get_bd_cells ip_33_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 36 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 36 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 36 -to 0 ip_36_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 36 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_36_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 40 -to 0 ip_38_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_38_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_38_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_0] [get_bd_pins ip_2_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_3] [get_bd_pins ip_7_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_7] [get_bd_pins ip_12_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_19_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_19_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_19_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_19_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_19_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_emc/AXI] [get_bd_intf_pins ip_19_axi/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_23_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_12_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_DATA] [get_bd_intf_pins ip_25_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_fft/S_AXIS_DATA] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_28_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_4] [get_bd_pins ip_5_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_3] [get_bd_pins ip_8_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_3] [get_bd_pins ip_14_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_1_dft/FWD_INV]
...
if {[catch {
  ...
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/S_AXIS declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/S_AXIS declared=224 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_20_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_0 declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_0 declared=224 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_20_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_1 declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_1 declared=224 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_20_axis_broadcaster/axis_broadcaster_0/M02_AXIS]] * 8}]
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_2 declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_2 declared=224 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 12 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_28_axis_dwidth_converter/M_AXIS declared=12 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_28_axis_dwidth_converter/M_AXIS declared=12 actual=ERR $__err" }
