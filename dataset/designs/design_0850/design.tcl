...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 34 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 47 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 14006 CONFIG.C_TAVDV_PS_MEM_1 13745 CONFIG.C_TAVDV_PS_MEM_2 16069 CONFIG.C_TCEDV_PS_MEM_0 14441 CONFIG.C_TCEDV_PS_MEM_1 15761 CONFIG.C_TCEDV_PS_MEM_2 14364 CONFIG.C_THZCE_PS_MEM_0 6650 CONFIG.C_THZCE_PS_MEM_1 7432 CONFIG.C_THZCE_PS_MEM_2 7270 CONFIG.C_THZOE_PS_MEM_0 7108 CONFIG.C_THZOE_PS_MEM_1 7573 CONFIG.C_THZOE_PS_MEM_2 7597 CONFIG.C_TLZWE_PS_MEM_0 6699 CONFIG.C_TLZWE_PS_MEM_1 345 CONFIG.C_TLZWE_PS_MEM_2 2984 CONFIG.C_TWC_PS_MEM_0 15217 CONFIG.C_TWC_PS_MEM_1 14675 CONFIG.C_TWC_PS_MEM_2 14609 CONFIG.C_TWPH_PS_MEM_0 11193 CONFIG.C_TWPH_PS_MEM_1 12965 CONFIG.C_TWPH_PS_MEM_2 11839 CONFIG.C_TWP_PS_MEM_0 10954 CONFIG.C_TWP_PS_MEM_1 12343 CONFIG.C_TWP_PS_MEM_2 11434 CONFIG.C_WR_REC_TIME_MEM_0 26802 CONFIG.C_WR_REC_TIME_MEM_1 24356 CONFIG.C_WR_REC_TIME_MEM_2 26785 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 60 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
create_bd_pin -dir O -from 212 -to 0 ip_5_accumulator/Q
...
set_property -dict "CONFIG.C_ADDR_WIDTH 52 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_9_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 3 " [get_bd_cells ip_15_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_17_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 46 -to 0 ip_21_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 212 -to 0 ip_21_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 212 -to 0 ip_22_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 173 -to 0 ip_23_slice_and_concat/out0
create_bd_pin -dir I -from 212 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 212 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_0] [get_bd_pins ip_3_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_15_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_15_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_18_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_1] [get_bd_pins ip_5_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_0_cordic/aclken]
