...
set_property -dict "CONFIG.C_BAUDRATE 300 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Even " [get_bd_cells ip_1_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_9_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_BAUDRATE 1200 CONFIG.C_DATA_BITS 5 CONFIG.PARITY No_Parity " [get_bd_cells ip_10_uartlite/uart_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 13 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_11_dft/dft_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 256 CONFIG.C_SPI_MEMORY 3 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_12_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.AINIT_Value 1ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 138 CONFIG.Latency 24 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 257 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 137 -to 0 ip_13_accumulator/B
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x20912 CONFIG.C_GPIO_WIDTH 18 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_16_gpio/gpio_0]
...
create_bd_pin -dir I -from 123 -to 0 ip_36_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 118 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_36_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 78 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_37_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 79 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 123 -to 0 ip_39_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 214 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 226 CONFIG.DIN_TO 215 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 239 CONFIG.DIN_TO 227 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 240 CONFIG.DIN_TO 240 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 246 CONFIG.DIN_TO 241 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 252 CONFIG.DIN_TO 247 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 253 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_45_slice_and_concat/slice_2]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_7] [get_bd_pins ip_16_gpio/irq]
connect_bd_net [get_bd_pins ip_22_intc/irq_8] [get_bd_pins ip_18_axi_ethernet_lite/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_23_axi_legacy/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_uartlite/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_uartlite/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_gpio/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_3] [get_bd_pins ip_11_dft/XK_IM]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_4] [get_bd_pins ip_11_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_5] [get_bd_pins ip_11_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_6] [get_bd_pins ip_11_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_7] [get_bd_pins ip_13_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_2] [get_bd_pins ip_15_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_3] [get_bd_pins ip_15_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_4] [get_bd_pins ip_15_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_13_accumulator/CE]
