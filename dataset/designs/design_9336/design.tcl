...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_2_dft/dft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 45 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_10_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_11_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_DATA] [get_bd_intf_pins ip_9_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_6] [get_bd_pins ip_3_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_7] [get_bd_pins ip_3_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_8] [get_bd_pins ip_3_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_2_dft/FWD_INV]
