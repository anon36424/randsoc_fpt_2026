...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x23 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 215 CONFIG.C_SDA_INERTIAL_DELAY 165 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 939.7522520019975 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 24 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 43 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x41 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 67 CONFIG.C_SDA_INERTIAL_DELAY 218 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 14.324846895200004 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 29 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 24 -to 0 ip_14_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 29 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 42 -to 0 ip_14_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_14_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 23 -to 0 ip_15_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_11_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_11_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_11_axi/AXI_S5]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_1] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/CE]
