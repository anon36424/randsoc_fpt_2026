...
set_property -dict "CONFIG.C_DUPLEX 0 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_0_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 37 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 45 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 127 -to 0 ip_6_accumulator/B
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 11 CONFIG.Iterations 19 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour Pass_Phase_TLAST CONFIG.Out_TREADY 0 CONFIG.Output_Width 18 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 29 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_7_cordic/cordic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_16_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 123 -to 0 ip_18_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 118 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 124 " [get_bd_cells ip_18_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_19_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 123 -to 0 ip_20_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 203 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 240 CONFIG.DIN_TO 204 CONFIG.DIN_WIDTH 241 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_3] [get_bd_pins ip_4_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_12_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_15_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_7_cordic/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_4] [get_bd_pins ip_6_accumulator/Q]
