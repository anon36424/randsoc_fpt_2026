...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 45 CONFIG.aresetn 1 CONFIG.atuserwidth 194 CONFIG.bportwidth 27 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 19 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 19 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 63 CONFIG.aresetn 1 CONFIG.atuserwidth 186 CONFIG.bportwidth 45 CONFIG.btuserwidth 152 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 29 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 65 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 14765 CONFIG.C_TCEDV_PS_MEM_0 13782 CONFIG.C_THZCE_PS_MEM_0 7052 CONFIG.C_THZOE_PS_MEM_0 7108 CONFIG.C_TLZWE_PS_MEM_0 1329 CONFIG.C_TWC_PS_MEM_0 14934 CONFIG.C_TWPH_PS_MEM_0 12127 CONFIG.C_TWP_PS_MEM_0 12153 CONFIG.C_WR_REC_TIME_MEM_0 28926 " [get_bd_cells ip_5_emc/emc_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 34 CONFIG.aresetn 0 CONFIG.atuserwidth 116 CONFIG.bportwidth 34 CONFIG.ctrltuserwidth 102 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 48 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 47 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 14 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_10_dft/dft_0]
...
set_property -dict "CONFIG.C_BAUDRATE 9600 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Even " [get_bd_cells ip_12_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 1 " [get_bd_cells ip_16_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 26 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 29 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_19_accumulator/accumulator_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_34_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_49_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_51_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_52_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_20_reset/interconnect_aresetn] [get_bd_pins ip_0_cordic/aresetn]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_1] [get_bd_pins ip_9_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_22_intc/irq_2] [get_bd_pins ip_11_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_5] [get_bd_pins ip_14_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_23_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_23_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_23_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_emc/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_dma/M_AXIS_MM2S] [get_bd_intf_pins ip_28_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_44_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_44_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_27_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_1] [get_bd_pins ip_9_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_2] [get_bd_pins ip_9_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_52_slice_and_concat/in_1] [get_bd_pins ip_19_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_3_complex_multiplier/aclken]
...
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vccint_alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_38_axis_combiner/S_AXIS_0 declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_38_axis_combiner/S_AXIS_0 declared=40 actual=ERR $__err" }
if {[catch {
