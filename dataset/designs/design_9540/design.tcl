...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_3_dft/dft_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 65536 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 24 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 176 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 175 -to 0 ip_6_accumulator/Q
...
set_property -dict "CONFIG.AINIT_Value 5faa52b3531e8c044a03d5aeb54b85378c247e690c38028f55a983 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 181 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 217 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 216 -to 0 ip_8_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 37 CONFIG.aresetn 0 CONFIG.bportwidth 10 CONFIG.ctrltuserwidth 103 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 47 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 16 CONFIG.Iterations 25 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 34 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 36 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_10_cordic/cordic_0]
...
set_property -dict "CONFIG.NUM_MI 4 CONFIG.NUM_SI 1 " [get_bd_cells ip_14_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 12 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 8 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_20_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 193 -to 0 ip_23_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_23_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 7 " [get_bd_cells ip_23_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 61 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 62 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 104 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 127 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 133 CONFIG.DIN_TO 128 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 134 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 151 CONFIG.DIN_TO 146 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 157 CONFIG.DIN_TO 152 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 163 CONFIG.DIN_TO 158 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 164 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 175 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 181 CONFIG.DIN_TO 176 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 187 CONFIG.DIN_TO 182 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 193 CONFIG.DIN_TO 188 CONFIG.DIN_WIDTH 194 " [get_bd_cells ip_23_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_23_reduce/reduce_31]
...
create_bd_pin -dir I -from 9 -to 0 ip_24_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_24_slice_and_concat/slice_2]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_24_slice_and_concat/slice_2/din]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/slice_2/dout] [get_bd_pins ip_24_slice_and_concat/concat/In2]


########## slice_and_concat ##########
create_bd_cell -type hier ip_25_slice_and_concat
create_bd_pin -dir O -from 180 -to 0 ip_25_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 20 " [get_bd_cells ip_25_slice_and_concat/concat]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_25_slice_and_concat/in_16
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_16] [get_bd_pins ip_25_slice_and_concat/concat/In16]
create_bd_pin -dir I -from 0 -to 0 ip_25_slice_and_concat/in_17
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_17] [get_bd_pins ip_25_slice_and_concat/concat/In17]
create_bd_pin -dir I -from 0 -to 0 ip_25_slice_and_concat/in_18
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_18] [get_bd_pins ip_25_slice_and_concat/concat/In18]
create_bd_pin -dir I -from 175 -to 0 ip_25_slice_and_concat/in_19
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_19
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_19]
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_25_slice_and_concat/slice_19]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_19] [get_bd_pins ip_25_slice_and_concat/slice_19/din]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/slice_19/dout] [get_bd_pins ip_25_slice_and_concat/concat/In19]


########## slice_and_concat ##########
create_bd_cell -type hier ip_26_slice_and_concat
create_bd_pin -dir O -from 9 -to 0 ip_26_slice_and_concat/out0
create_bd_pin -dir I -from 175 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 106 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 9 -to 0 ip_27_slice_and_concat/out0
create_bd_pin -dir I -from 175 -to 0 ip_27_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 116 CONFIG.DIN_TO 107 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 122 CONFIG.DIN_TO 117 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_29_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_29_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 123 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_30_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_31_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 157 CONFIG.DIN_TO 147 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_32_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_32_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 163 CONFIG.DIN_TO 158 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_33_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 175 CONFIG.DIN_TO 164 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 216 -to 0 ip_33_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 181 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 217 " [get_bd_cells ip_33_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 192 CONFIG.DIN_TO 182 CONFIG.DIN_WIDTH 217 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 216 -to 0 ip_35_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_35_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 216 CONFIG.DIN_TO 193 CONFIG.DIN_WIDTH 217 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset] [get_bd_pins ip_1_dft/SCLR]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset] [get_bd_pins ip_2_dft/SCLR]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_4_xadc_wiz/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_7_axi_quad_spi/reset]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_7_axi_quad_spi/reset4]
connect_bd_net [get_bd_pins ip_11_reset/interconnect_aresetn] [get_bd_pins ip_10_cordic/aresetn]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_0_axi_dma/s_axi_lite_aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_0_axi_dma/m_axi_s2mm_aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_1_dft/CLK]
...
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_5_fft/aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_6_accumulator/clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_7_axi_quad_spi/ext_spi_clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_7_axi_quad_spi/clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_7_axi_quad_spi/clk4]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_8_accumulator/clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_9_complex_multiplier/aclk]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_0] [get_bd_pins ip_0_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_4_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_13_intc/irq_2] [get_bd_pins ip_5_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_13_intc/irq_3] [get_bd_pins ip_7_axi_quad_spi/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_14_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_14_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_intc/AXI] [get_bd_intf_pins ip_14_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_15_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/M_AXIS_DATA] [get_bd_intf_pins ip_17_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_18_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_19_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_DATA] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_20_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_22_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_RE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_1_dft/XK_RE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_1_dft/XK_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/B]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_1_dft/XK_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_1] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_2] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_3] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_4] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_2_dft/XK_RE]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_6] [get_bd_pins ip_2_dft/XK_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_7] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_8] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_9] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_10] [get_bd_pins ip_3_dft/RFFD]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_11] [get_bd_pins ip_3_dft/XK_RE]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_12] [get_bd_pins ip_3_dft/XK_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_13] [get_bd_pins ip_3_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_14] [get_bd_pins ip_3_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_15] [get_bd_pins ip_3_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_16] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_17] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_18] [get_bd_pins ip_4_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_19] [get_bd_pins ip_6_accumulator/Q]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_1_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_3_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_36_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/out0] [get_bd_pins ip_10_cordic/aclken]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_38_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_1_dft/FWD_INV]
...
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_1_dft/FD_IN]
...
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vccaux_alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/S_AXIS declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/S_AXIS declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_15_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_0 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_0 declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_15_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_1 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_broadcaster/M_AXIS_1 declared=96 actual=ERR $__err" }
if {[catch {
