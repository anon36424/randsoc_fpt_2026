...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x59 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 29 CONFIG.C_SDA_INERTIAL_DELAY 224 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 52.595765518803404 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 18 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_2_dft/dft_0]
...
set_property -dict "CONFIG.C_MASK 0x53f375cded21eaa CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x656e069355d3ea1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 207 CONFIG.convolution_code1 49 CONFIG.convolution_code2 131 CONFIG.convolution_code3 49 CONFIG.convolution_code4 224 CONFIG.convolution_code5 187 CONFIG.convolution_code6 207 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 11 CONFIG.output_rate 15 CONFIG.puncture_code0 00111111110 CONFIG.puncture_code1 10000111111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_5_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_BAUDRATE 9600 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Even " [get_bd_cells ip_7_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 29 CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_9_gpio/gpio_0]
...
set_property -dict "CONFIG.a_precision_type Half CONFIG.a_tuser_width 8 CONFIG.add_sub_value Add CONFIG.axi_optimize_goal Performance CONFIG.b_tuser_width 28 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_overflow 0 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage Full_Usage CONFIG.c_tuser_width 3 CONFIG.flow_control Blocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 1 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 1 CONFIG.has_c_tuser 1 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_type FMA CONFIG.result_tlast_behv OR_all_TLASTs " [get_bd_cells ip_10_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_MASK 0xe2f3eba23b4753b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x1969091f6aa4d36 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_MASK 0xeb30584ec081594 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xd4d2abddb7569e6 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_5] [get_bd_pins ip_9_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_intc/AXI] [get_bd_intf_pins ip_20_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_floating_point/S_AXIS_C] [get_bd_intf_pins ip_31_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_4] [get_bd_pins ip_4_xadc_wiz/temp_out]
