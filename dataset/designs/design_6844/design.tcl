...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x9 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 150 CONFIG.C_SDA_INERTIAL_DELAY 6 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 936.7346001466117 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_12_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_iic/AXI] [get_bd_intf_pins ip_8_axi/AXI_S1]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_6] [get_bd_pins ip_4_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_7] [get_bd_pins ip_4_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_8] [get_bd_pins ip_4_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_1_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vbram_alarm_out]
