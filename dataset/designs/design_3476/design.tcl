...
set_property -dict "CONFIG.AINIT_Value 1ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 180 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 233 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 179 -to 0 ip_1_accumulator/B
connect_bd_net [get_bd_pins ip_1_accumulator/B] [get_bd_pins ip_1_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 232 -to 0 ip_1_accumulator/Q
...
set_property -dict "CONFIG.C_FIFO_DEPTH 256 CONFIG.C_SPI_MEMORY 0 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_4_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 206 CONFIG.C_SDA_INERTIAL_DELAY 185 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 153.50258890173296 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 19 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 11 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 46 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 186 CONFIG.convolution_code1 261 CONFIG.convolution_code2 319 CONFIG.convolution_code3 457 CONFIG.convolution_code4 200 CONFIG.convolution_code5 471 CONFIG.convolution_code6 265 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_14_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MASK 0x409b8ac4413c8a3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x5d6d7243d2e1c18 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 40 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_18_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_MI 12 CONFIG.NUM_SI 2 " [get_bd_cells ip_22_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 40 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 40 " [get_bd_cells ip_27_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 93 -to 0 ip_29_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 86 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 87 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 94 " [get_bd_cells ip_29_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 93 -to 0 ip_33_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 232 -to 0 ip_33_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 233 " [get_bd_cells ip_33_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 179 -to 0 ip_34_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 232 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 233 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 45 -to 0 ip_34_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_34_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_6] [get_bd_pins ip_10_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_gpio/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_22_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_timer/S_AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_uartlite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_intc/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_24_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_DATA] [get_bd_intf_pins ip_26_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_28_axis_combiner/M_AXIS]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_2] [get_bd_pins ip_0_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_3] [get_bd_pins ip_0_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_4] [get_bd_pins ip_1_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_1] [get_bd_pins ip_11_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_2] [get_bd_pins ip_11_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_3] [get_bd_pins ip_11_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_4] [get_bd_pins ip_13_accumulator/Q]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_1] [get_bd_pins ip_16_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_2] [get_bd_pins ip_16_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_3] [get_bd_pins ip_16_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_14_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_0_dft/CE]
