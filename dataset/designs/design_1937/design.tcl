...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1d5afe CONFIG.C_GPIO_WIDTH 24 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0xffffff " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 5 CONFIG.C_TAVDV_PS_MEM_1 14284 CONFIG.C_TCEDV_PS_MEM_1 14301 CONFIG.C_THZCE_PS_MEM_1 6926 CONFIG.C_THZOE_PS_MEM_1 6753 CONFIG.C_TLZWE_PS_MEM_1 7246 CONFIG.C_TWC_PS_MEM_1 16460 CONFIG.C_TWPH_PS_MEM_1 11360 CONFIG.C_TWP_PS_MEM_1 12992 CONFIG.C_WR_REC_TIME_MEM_1 28014 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xa CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 128 CONFIG.C_SDA_INERTIAL_DELAY 253 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 22.75044319755551 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1ffffff CONFIG.C_GPIO_WIDTH 25 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x1ffffff " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_8_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.a_precision_type Custom CONFIG.add_sub_value Both CONFIG.axi_optimize_goal Resources CONFIG.b_tuser_width 40 CONFIG.c_a_exponent_width 12 CONFIG.c_a_fraction_width 28 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 0 CONFIG.c_has_overflow 0 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage No_Usage CONFIG.c_optimization Speed_Optimized CONFIG.flow_control Blocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 0 CONFIG.has_aclken 1 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 1 CONFIG.has_result_tready 1 CONFIG.maximum_latency 1 CONFIG.operation_tuser_width 10 CONFIG.operation_type Add_Subtract " [get_bd_cells ip_9_floating_point/floating_point_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 2 " [get_bd_cells ip_14_axi/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_14_axi/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_14_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_floating_point/S_AXIS_OPERATION] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_9_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_2]
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_combiner/M_AXIS declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_combiner/M_AXIS declared=40 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_combiner/M_AXIS declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_combiner/M_AXIS declared=40 actual=ERR $__err" }
if {[catch {
