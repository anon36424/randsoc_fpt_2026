...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 14928 CONFIG.C_TCEDV_PS_MEM_0 13522 CONFIG.C_THZCE_PS_MEM_0 7020 CONFIG.C_THZOE_PS_MEM_0 6916 CONFIG.C_TLZWE_PS_MEM_0 599 CONFIG.C_TWC_PS_MEM_0 13967 CONFIG.C_TWPH_PS_MEM_0 12521 CONFIG.C_TWP_PS_MEM_0 12875 CONFIG.C_WR_REC_TIME_MEM_0 25358 " [get_bd_cells ip_0_emc/emc_0]
...
create_bd_pin -dir I -from 107 -to 0 ip_6_accumulator/B
connect_bd_net [get_bd_pins ip_6_accumulator/B] [get_bd_pins ip_6_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 130 -to 0 ip_6_accumulator/Q
...
create_bd_pin -dir I -from 130 -to 0 ip_12_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 131 " [get_bd_cells ip_12_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 107 -to 0 ip_13_slice_and_concat/out0
create_bd_pin -dir I -from 130 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 130 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 131 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_timer/S_AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_10_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_3] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/freeze]
