...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 8 CONFIG.Iterations 44 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 11 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 20 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_7_cordic/cordic_0]
...
connect_bd_net [get_bd_pins ip_8_reset/peripheral_areset_n] [get_bd_pins ip_1_xadc_wiz/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_1_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_1] [get_bd_pins ip_1_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_10_intc/irq_2] [get_bd_pins ip_2_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_10_intc/irq_3] [get_bd_pins ip_3_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_10_intc/irq_4] [get_bd_pins ip_4_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_10_intc/irq_5] [get_bd_pins ip_5_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_timer/S_AXI] [get_bd_intf_pins ip_11_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_11_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_11_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_11_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_floating_point/S_AXIS_B] [get_bd_intf_pins ip_15_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/S_AXIS_STS] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_3] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_6] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_7] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_8] [get_bd_pins ip_3_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_1_xadc_wiz/convst_in]
