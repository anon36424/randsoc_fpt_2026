...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 16 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 33 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 15 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 32 CONFIG.Iterations 30 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 17 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 45 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_3_cordic/cordic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x4f64a CONFIG.C_DOUT_DEFAULT_2 0x7ffff CONFIG.C_GPIO2_WIDTH 2 CONFIG.C_GPIO_WIDTH 19 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_6_dft/dft_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 40 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 48 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 39 -to 0 ip_8_accumulator/B
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 17 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 215 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_9_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 16 -to 0 ip_9_accumulator/B
connect_bd_net [get_bd_pins ip_9_accumulator/B] [get_bd_pins ip_9_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 214 -to 0 ip_9_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 43 CONFIG.aresetn 0 CONFIG.atuserwidth 94 CONFIG.bportwidth 35 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 70 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.add_sub_value Both CONFIG.axi_optimize_goal Resources CONFIG.b_tuser_width 33 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Greater_Than CONFIG.c_has_invalid_op 1 CONFIG.c_mult_usage No_Usage CONFIG.flow_control Blocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.has_result_tready 0 CONFIG.maximum_latency 1 CONFIG.operation_type Compare CONFIG.result_tlast_behv Pass_B_TLAST " [get_bd_cells ip_11_floating_point/floating_point_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 21 CONFIG.aresetn 0 CONFIG.bportwidth 39 CONFIG.btuserwidth 61 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 42 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 8 CONFIG.roundmode Truncate " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 77 CONFIG.convolution_code1 132 CONFIG.convolution_code2 176 CONFIG.convolution_code3 159 CONFIG.convolution_code4 32 CONFIG.convolution_code5 184 CONFIG.convolution_code6 175 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 8 CONFIG.output_rate 10 CONFIG.puncture_code0 11011101 CONFIG.puncture_code1 00111100 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_13_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.a_precision_type Half CONFIG.a_tuser_width 23 CONFIG.add_sub_value Both CONFIG.b_tuser_width 27 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Greater_Than CONFIG.c_has_invalid_op 0 CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Compare " [get_bd_cells ip_14_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5b CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 214 CONFIG.C_SDA_INERTIAL_DELAY 52 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 364.3452315016264 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_15_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x23983508b15965c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_16_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe4fd2f2d01d9ce1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_16_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 19 CONFIG.aresetn 0 CONFIG.atuserwidth 75 CONFIG.bportwidth 56 CONFIG.btuserwidth 130 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 38 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 27 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_17_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.NUM_PORTS 3 " [get_bd_cells ip_20_intc/concat_0]
...
set_property -dict "CONFIG.NUM_MI 3 CONFIG.NUM_SI 1 " [get_bd_cells ip_21_axi/axi_0]
...
set_property -dict "CONFIG.NUM_MI 4 " [get_bd_cells ip_22_axis_broadcaster/axis_broadcaster_0]
...
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ip_22_axis_broadcaster/M_AXIS_3
connect_bd_intf_net [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_3] [get_bd_intf_pins ip_22_axis_broadcaster/axis_broadcaster_0/M03_AXIS]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_29_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_36_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 226 -to 0 ip_49_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 86 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 87 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 101 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 135 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 142 CONFIG.DIN_TO 136 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 143 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 156 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 163 CONFIG.DIN_TO 157 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 164 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 177 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 184 CONFIG.DIN_TO 178 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 191 CONFIG.DIN_TO 185 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 198 CONFIG.DIN_TO 192 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 205 CONFIG.DIN_TO 199 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 212 CONFIG.DIN_TO 206 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 219 CONFIG.DIN_TO 213 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 226 CONFIG.DIN_TO 220 CONFIG.DIN_WIDTH 227 " [get_bd_cells ip_49_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 226 -to 0 ip_51_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 32 -to 0 ip_51_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_51_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_51_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 47 -to 0 ip_51_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_10] [get_bd_pins ip_51_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 214 -to 0 ip_51_slice_and_concat/in_11
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_11
move_bd_cells [get_bd_cells ip_51_slice_and_concat] [get_bd_cells slice_11]
set_property -dict "CONFIG.DIN_FROM 123 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_51_slice_and_concat/slice_11]
...
create_bd_pin -dir O -from 39 -to 0 ip_52_slice_and_concat/out0
create_bd_pin -dir I -from 214 -to 0 ip_52_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_52_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 163 CONFIG.DIN_TO 124 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_52_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 214 -to 0 ip_53_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_53_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 172 CONFIG.DIN_TO 164 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_53_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 181 CONFIG.DIN_TO 173 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_54_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 197 CONFIG.DIN_TO 182 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_55_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 214 CONFIG.DIN_TO 198 CONFIG.DIN_WIDTH 215 " [get_bd_cells ip_56_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_18_reset/interconnect_aresetn] [get_bd_pins ip_3_cordic/aresetn]
...
connect_bd_net [get_bd_pins ip_18_reset/interconnect_aresetn] [get_bd_pins ip_13_conv_encoder/aresetn]
...
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_2_xadc_wiz/dclk_in]
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_2_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_8_accumulator/clk]
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_9_accumulator/clk]
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_10_complex_multiplier/aclk]
...
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_13_conv_encoder/aclk]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_1] [get_bd_pins ip_4_gpio/irq]
connect_bd_net [get_bd_pins ip_20_intc/irq_2] [get_bd_pins ip_15_axi_iic/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_microblaze/INTERRUPT] [get_bd_intf_pins ip_20_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_microblaze/M_AXI_DP] [get_bd_intf_pins ip_21_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_gpio/AXI] [get_bd_intf_pins ip_21_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_iic/AXI] [get_bd_intf_pins ip_21_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_intc/AXI] [get_bd_intf_pins ip_21_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_22_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_23_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_24_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_5_conv_encoder/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_28_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_29_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_30_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_floating_point/S_AXIS_B] [get_bd_intf_pins ip_30_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_31_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_32_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_13_conv_encoder/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_32_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_33_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_23_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_34_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_37_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_26_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_39_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_41_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_23_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_42_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_43_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_25_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_45_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_45_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_24_axis_broadcaster/M_AXIS_3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_47_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_25_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_48_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_23_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_6_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_1] [get_bd_pins ip_2_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_2] [get_bd_pins ip_2_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_4] [get_bd_pins ip_6_dft/RFFD]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_5] [get_bd_pins ip_6_dft/XK_RE]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_6] [get_bd_pins ip_6_dft/XK_IM]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_7] [get_bd_pins ip_6_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_8] [get_bd_pins ip_6_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_9] [get_bd_pins ip_6_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_10] [get_bd_pins ip_8_accumulator/Q]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_11] [get_bd_pins ip_9_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_57_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_9_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_5_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_60_slice_and_concat/out0] [get_bd_pins ip_60_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_61_slice_and_concat/out0] [get_bd_pins ip_61_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/ADD]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_62_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_63_slice_and_concat/out0] [get_bd_pins ip_3_cordic/aclken]
connect_bd_net [get_bd_pins ip_63_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/ot_out]
...
connect_bd_net [get_bd_pins ip_66_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_66_slice_and_concat/out0] [get_bd_pins ip_66_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_67_slice_and_concat/out0] [get_bd_pins ip_9_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_68_slice_and_concat/out0] [get_bd_pins ip_10_complex_multiplier/aclken]
...
connect_bd_net [get_bd_pins ip_69_slice_and_concat/out0] [get_bd_pins ip_12_complex_multiplier/aclken]
...
connect_bd_net [get_bd_pins ip_18_reset/interconnect_aresetn] [get_bd_pins ip_37_axis_dwidth_converter/aresetn]
...
connect_bd_net [get_bd_pins ip_19_clk_wiz/clk_out] [get_bd_pins ip_37_axis_dwidth_converter/aclk]
...
if {[catch {
  ...
  set __s [expr {$__aw == 8 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_14_floating_point/M_AXIS_RESULT declared=8 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_floating_point/M_AXIS_RESULT declared=8 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_22_axis_broadcaster/axis_broadcaster_0/M03_AXIS]] * 8}]
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_broadcaster/M_AXIS_3 declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_broadcaster/M_AXIS_3 declared=32 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_24_axis_broadcaster/M_AXIS_3 declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_axis_broadcaster/M_AXIS_3 declared=48 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_29_axis_dwidth_converter/S_AXIS declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_29_axis_dwidth_converter/S_AXIS declared=144 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 17 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_dwidth_converter/M_AXIS declared=17 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_dwidth_converter/M_AXIS declared=17 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_39_axis_combiner/M_AXIS declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_39_axis_combiner/M_AXIS declared=80 actual=ERR $__err" }
if {[catch {
