...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 14 CONFIG.C_TAVDV_PS_MEM_0 14289 CONFIG.C_TAVDV_PS_MEM_1 13993 CONFIG.C_TCEDV_PS_MEM_0 13736 CONFIG.C_TCEDV_PS_MEM_1 14718 CONFIG.C_THZCE_PS_MEM_0 6410 CONFIG.C_THZCE_PS_MEM_1 6736 CONFIG.C_THZOE_PS_MEM_0 7080 CONFIG.C_THZOE_PS_MEM_1 6900 CONFIG.C_TLZWE_PS_MEM_0 7754 CONFIG.C_TLZWE_PS_MEM_1 7306 CONFIG.C_TWC_PS_MEM_0 14988 CONFIG.C_TWC_PS_MEM_1 15948 CONFIG.C_TWPH_PS_MEM_0 13011 CONFIG.C_TWPH_PS_MEM_1 12193 CONFIG.C_TWP_PS_MEM_0 11068 CONFIG.C_TWP_PS_MEM_1 13142 CONFIG.C_WR_REC_TIME_MEM_0 28410 CONFIG.C_WR_REC_TIME_MEM_1 28291 " [get_bd_cells ip_3_emc/emc_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 33 CONFIG.Iterations 22 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 40 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 43 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_4_cordic/cordic_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_16_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_17_slice_and_concat/slice_1]
...
connect_bd_net [get_bd_pins ip_8_reset/peripheral_areset_n] [get_bd_pins ip_6_xadc_wiz/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_6_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_2] [get_bd_pins ip_6_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_5] [get_bd_pins ip_6_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_6] [get_bd_pins ip_6_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_7] [get_bd_pins ip_6_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_4_cordic/aclken]
