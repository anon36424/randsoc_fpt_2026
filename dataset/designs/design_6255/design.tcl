...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 256 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 258 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 255 -to 0 ip_0_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x586c2ee35c52551 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x94b81942b2ff255 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir O -from 1 -to 0 ip_5_slice_and_concat/out0
create_bd_pin -dir I -from 257 -to 0 ip_5_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_5_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 255 -to 0 ip_6_slice_and_concat/out0
create_bd_pin -dir I -from 257 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 257 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_6_slice_and_concat/slice_0]
