...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 37 CONFIG.Iterations 28 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 32 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 45 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_2_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x37d2643 CONFIG.C_DOUT_DEFAULT_2 0x41e969e CONFIG.C_GPIO2_WIDTH 13 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x3bbb4be9 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 146 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 231 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 230 -to 0 ip_5_accumulator/Q
...
set_property -dict "CONFIG.a_precision_type Single CONFIG.add_sub_value Both CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_mult_usage No_Usage CONFIG.c_result_exponent_width 47 CONFIG.c_result_fraction_width 3 CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Float_to_fixed CONFIG.result_precision_type Custom " [get_bd_cells ip_9_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_MASK 0xbf3b9b58ff37cd8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x618e07f12b1a9cb CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 7 " [get_bd_cells ip_17_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 84 -to 0 ip_18_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 78 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 79 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 82 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 83 CONFIG.DIN_WIDTH 85 " [get_bd_cells ip_18_reduce/slice_31]
...
create_bd_pin -dir O -from 145 -to 0 ip_19_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 231 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 84 -to 0 ip_20_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 230 CONFIG.DIN_TO 146 CONFIG.DIN_WIDTH 231 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_3_gpio/irq]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_5] [get_bd_pins ip_8_axi_cdma/cdma_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_microblaze/INTERRUPT] [get_bd_intf_pins ip_13_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_cdma/M_AXI] [get_bd_intf_pins ip_14_axi/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_gpio/AXI] [get_bd_intf_pins ip_14_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_floating_point/S_AXIS_A] [get_bd_intf_pins ip_16_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_9_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_5_accumulator/SCLR]
...
if {[catch {
  ...
  set __s [expr {$__aw == 56 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/S_AXIS declared=56 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/S_AXIS declared=56 actual=ERR $__err" }
if {[catch {
