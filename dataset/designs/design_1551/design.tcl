...
set_property -dict "CONFIG.NUM_PORTS 8 " [get_bd_cells ip_8_slice_and_concat/concat]
...
create_bd_pin -dir I -from 17 -to 0 ip_8_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_8_slice_and_concat/slice_7]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_7] [get_bd_pins ip_8_slice_and_concat/slice_7/din]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/slice_7/dout] [get_bd_pins ip_8_slice_and_concat/concat/In7]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_10_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_3_reset/peripheral_areset] [get_bd_pins ip_0_xadc_wiz/reset_in]
...
connect_bd_net [get_bd_pins ip_5_intc/irq_0] [get_bd_pins ip_2_axi_ethernet_lite/irq]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_4] [get_bd_pins ip_0_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_5] [get_bd_pins ip_0_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_6] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_7] [get_bd_pins ip_1_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/ot_out]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/alarm_out]
