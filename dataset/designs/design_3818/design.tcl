...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 255 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 258 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 12 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_2_dft/dft_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 24 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 35 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_MASK 0xf04ce2bf660d50 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xdeb9696c8b7dc6a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 6 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 1024 " [get_bd_cells ip_8_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x58 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 212 CONFIG.C_SDA_INERTIAL_DELAY 32 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 670.8349162454891 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x7f CONFIG.C_DOUT_DEFAULT_2 0x7f CONFIG.C_GPIO2_WIDTH 11 CONFIG.C_GPIO_WIDTH 7 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x7f " [get_bd_cells ip_10_gpio/gpio_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_18_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 23 -to 0 ip_19_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 257 -to 0 ip_19_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 254 -to 0 ip_21_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 257 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 34 -to 0 ip_22_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 35 " [get_bd_cells ip_22_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 35 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_4] [get_bd_pins ip_9_axi_iic/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_microblaze/INTERRUPT] [get_bd_intf_pins ip_13_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_microblaze/M_AXI_DP] [get_bd_intf_pins ip_14_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_iic/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/temp_out]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/ADD]
