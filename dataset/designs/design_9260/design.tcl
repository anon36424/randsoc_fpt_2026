...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 17 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_1_dft/dft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 22 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 47 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 256 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x89be63051a0233c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xec9128bc977ad6e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_14_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.AINIT_Value 1492445ef11126c63381 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 66 CONFIG.Latency 20 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 77 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_16_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 65 -to 0 ip_16_accumulator/B
...
create_bd_pin -dir I -from 14 -to 0 ip_25_slice_and_concat/in_1
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_25_slice_and_concat/slice_2]
...
create_bd_pin -dir I -from 14 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_27_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_29_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 65 -to 0 ip_31_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 16 " [get_bd_cells ip_31_slice_and_concat/concat]
...
create_bd_pin -dir I -from 13 -to 0 ip_31_slice_and_concat/in_5
...
create_bd_pin -dir I -from 76 -to 0 ip_31_slice_and_concat/in_15
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_15
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_15]
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_31_slice_and_concat/slice_15]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_15] [get_bd_pins ip_31_slice_and_concat/slice_15/din]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/slice_15/dout] [get_bd_pins ip_31_slice_and_concat/concat/In15]


########## slice_and_concat ##########
create_bd_cell -type hier ip_32_slice_and_concat
create_bd_pin -dir O -from 14 -to 0 ip_32_slice_and_concat/out0
create_bd_pin -dir I -from 76 -to 0 ip_32_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_32_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 76 -to 0 ip_33_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 76 -to 0 ip_34_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 76 -to 0 ip_35_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_35_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_3] [get_bd_pins ip_8_uartlite/irq]
...
connect_bd_net [get_bd_pins ip_20_intc/irq_6] [get_bd_pins ip_11_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_21_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_uartlite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_7_dft/XN_IM]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_RE]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_1] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_2] [get_bd_pins ip_1_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_9] [get_bd_pins ip_11_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_10] [get_bd_pins ip_11_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_11] [get_bd_pins ip_11_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_12] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_13] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_14] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_15] [get_bd_pins ip_16_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_11_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_38_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_16_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_0] [get_bd_pins ip_11_xadc_wiz/ot_out]
