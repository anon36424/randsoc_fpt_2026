...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 66 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 173 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 172 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 36 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 41 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.AINIT_Value 31d8b898eb22d84d74be4d4fa3eebc48a CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 107 CONFIG.Latency 10 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 130 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 106 -to 0 ip_2_accumulator/B
connect_bd_net [get_bd_pins ip_2_accumulator/B] [get_bd_pins ip_2_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 129 -to 0 ip_2_accumulator/Q
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x68 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 72 CONFIG.C_SDA_INERTIAL_DELAY 5 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 509.8854752366773 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_BAUDRATE 4800 CONFIG.C_DATA_BITS 7 CONFIG.PARITY Odd " [get_bd_cells ip_4_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7d CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 88 CONFIG.C_SDA_INERTIAL_DELAY 132 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 563.3671714843689 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 8 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_7_dft/dft_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 4096 " [get_bd_cells ip_8_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0xe5bbd7f40c5411e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfd70f08be17a529 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 141 -to 0 ip_18_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_18_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_18_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_18_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_18_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_18_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 82 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 101 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 105 CONFIG.DIN_TO 102 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 106 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 113 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 117 CONFIG.DIN_TO 114 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 118 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 133 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 137 CONFIG.DIN_TO 134 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 141 CONFIG.DIN_TO 138 CONFIG.DIN_WIDTH 142 " [get_bd_cells ip_18_reduce/slice_31]
...
create_bd_pin -dir O -from 7 -to 0 ip_19_slice_and_concat/out0
create_bd_pin -dir I -from 172 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 173 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 106 -to 0 ip_20_slice_and_concat/out0
create_bd_pin -dir I -from 172 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 173 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 248 -to 0 ip_21_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 172 -to 0 ip_21_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 172 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 173 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 40 -to 0 ip_21_slice_and_concat/in_1
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_1] [get_bd_pins ip_21_slice_and_concat/concat/In1]
create_bd_pin -dir I -from 129 -to 0 ip_21_slice_and_concat/in_2
...
create_bd_pin -dir I -from 7 -to 0 ip_21_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_21_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 7 -to 0 ip_21_slice_and_concat/in_5
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_21_slice_and_concat/slice_6]
...
create_bd_pin -dir O -from 35 -to 0 ip_22_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 254 -to 0 ip_22_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_22_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 141 -to 0 ip_23_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 174 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 254 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 182 CONFIG.DIN_TO 175 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 254 -to 0 ip_25_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 188 CONFIG.DIN_TO 183 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 65 -to 0 ip_26_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 254 CONFIG.DIN_TO 189 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_2_accumulator/clk]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_2] [get_bd_pins ip_5_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_microblaze/M_AXI_DP] [get_bd_intf_pins ip_14_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_iic/AXI] [get_bd_intf_pins ip_14_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_iic/AXI] [get_bd_intf_pins ip_14_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_16_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_6_conv_encoder/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_1] [get_bd_pins ip_1_accumulator/Q]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_2] [get_bd_pins ip_2_accumulator/Q]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_3] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_7_dft/XK_RE]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_7_dft/XK_IM]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_6] [get_bd_pins ip_7_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/B]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_0] [get_bd_pins ip_7_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_1] [get_bd_pins ip_7_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_2] [get_bd_pins ip_7_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_3] [get_bd_pins ip_9_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_7_dft/FD_IN]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_7_dft/CE]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_7_dft/FWD_INV]
...
if {[catch {
  ...
  set __s [expr {$__aw == 36 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/M_AXIS declared=36 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/M_AXIS declared=36 actual=ERR $__err" }
