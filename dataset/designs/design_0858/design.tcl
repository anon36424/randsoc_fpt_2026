...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x34 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 43 CONFIG.C_SDA_INERTIAL_DELAY 38 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 710.2931530779296 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_6_intc/irq_2] [get_bd_pins ip_2_fft/event_frame_started]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_uartlite/AXI] [get_bd_intf_pins ip_7_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_iic/AXI] [get_bd_intf_pins ip_7_axi_legacy/AXI_S1]
