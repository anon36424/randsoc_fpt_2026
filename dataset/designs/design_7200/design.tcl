...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 22 CONFIG.aresetn 1 CONFIG.bportwidth 56 CONFIG.btuserwidth 141 CONFIG.ctrltuserwidth 79 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 12 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 69 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 6 CONFIG.C_GPIO_WIDTH 11 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 5 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_MEM3_TYPE 4 CONFIG.C_MEM3_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 4 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_PARITY_TYPE_MEM_3 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 2 CONFIG.C_TAVDV_PS_MEM_0 15087 CONFIG.C_TAVDV_PS_MEM_1 16040 CONFIG.C_TAVDV_PS_MEM_2 13735 CONFIG.C_TAVDV_PS_MEM_3 16142 CONFIG.C_TCEDV_PS_MEM_0 15137 CONFIG.C_TCEDV_PS_MEM_1 16188 CONFIG.C_TCEDV_PS_MEM_2 14833 CONFIG.C_TCEDV_PS_MEM_3 13683 CONFIG.C_THZCE_PS_MEM_0 6440 CONFIG.C_THZCE_PS_MEM_1 7213 CONFIG.C_THZCE_PS_MEM_2 7628 CONFIG.C_THZCE_PS_MEM_3 6797 CONFIG.C_THZOE_PS_MEM_0 7266 CONFIG.C_THZOE_PS_MEM_1 7342 CONFIG.C_THZOE_PS_MEM_2 7316 CONFIG.C_THZOE_PS_MEM_3 7133 CONFIG.C_TLZWE_PS_MEM_0 5607 CONFIG.C_TLZWE_PS_MEM_1 2367 CONFIG.C_TLZWE_PS_MEM_2 6688 CONFIG.C_TLZWE_PS_MEM_3 8250 CONFIG.C_TWC_PS_MEM_0 15065 CONFIG.C_TWC_PS_MEM_1 15700 CONFIG.C_TWC_PS_MEM_2 14567 CONFIG.C_TWC_PS_MEM_3 15183 CONFIG.C_TWPH_PS_MEM_0 12988 CONFIG.C_TWPH_PS_MEM_1 11796 CONFIG.C_TWPH_PS_MEM_2 12177 CONFIG.C_TWPH_PS_MEM_3 11468 CONFIG.C_TWP_PS_MEM_0 11360 CONFIG.C_TWP_PS_MEM_1 11216 CONFIG.C_TWP_PS_MEM_2 11307 CONFIG.C_TWP_PS_MEM_3 11571 CONFIG.C_WR_REC_TIME_MEM_0 29468 CONFIG.C_WR_REC_TIME_MEM_1 27810 CONFIG.C_WR_REC_TIME_MEM_2 25083 CONFIG.C_WR_REC_TIME_MEM_3 24399 " [get_bd_cells ip_4_emc/emc_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_emc/AXI] [get_bd_intf_pins ip_9_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_9_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_12_axis_dwidth_converter/M_AXIS]
...
if {[catch {
  ...
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/S_AXIS declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/S_AXIS declared=144 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_10_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_0 declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_0 declared=144 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_10_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_1 declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_1 declared=144 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/S_AXIS declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/S_AXIS declared=144 actual=ERR $__err" }
if {[catch {
