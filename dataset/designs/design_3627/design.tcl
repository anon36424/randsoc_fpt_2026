...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 14 CONFIG.C_TAVDV_PS_MEM_0 14862 CONFIG.C_TCEDV_PS_MEM_0 15067 CONFIG.C_THZCE_PS_MEM_0 6594 CONFIG.C_THZOE_PS_MEM_0 7465 CONFIG.C_TLZWE_PS_MEM_0 9418 CONFIG.C_TWC_PS_MEM_0 16238 CONFIG.C_TWPH_PS_MEM_0 13198 CONFIG.C_TWP_PS_MEM_0 12901 CONFIG.C_WR_REC_TIME_MEM_0 24380 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 38 CONFIG.aresetn 1 CONFIG.atuserwidth 14 CONFIG.bportwidth 36 CONFIG.btuserwidth 30 CONFIG.ctrltuserwidth 67 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 3 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 41 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 42 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 40 -to 0 ip_15_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_9_axis_broadcaster/M_AXIS_3]
