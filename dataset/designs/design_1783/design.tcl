...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 39 CONFIG.Latency 24 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 133 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 132 -to 0 ip_3_accumulator/Q
...
set_property -dict "CONFIG.C_MASK 0xa53bef5378a7f5e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x3cbd641bc158e21 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 1 " [get_bd_cells ip_5_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8 " [get_bd_cells ip_6_fft/fft_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 19 CONFIG.Iterations 27 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 9 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 45 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_7_cordic/cordic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_17_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_18_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 40 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 330 -to 0 ip_20_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 11 " [get_bd_cells ip_20_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 130 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 140 CONFIG.DIN_TO 131 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 150 CONFIG.DIN_TO 141 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 160 CONFIG.DIN_TO 151 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 161 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 180 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 190 CONFIG.DIN_TO 181 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 200 CONFIG.DIN_TO 191 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 210 CONFIG.DIN_TO 201 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 220 CONFIG.DIN_TO 211 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 230 CONFIG.DIN_TO 221 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 240 CONFIG.DIN_TO 231 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 250 CONFIG.DIN_TO 241 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 260 CONFIG.DIN_TO 251 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 270 CONFIG.DIN_TO 261 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 280 CONFIG.DIN_TO 271 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 290 CONFIG.DIN_TO 281 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 300 CONFIG.DIN_TO 291 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 310 CONFIG.DIN_TO 301 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 320 CONFIG.DIN_TO 311 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 330 CONFIG.DIN_TO 321 CONFIG.DIN_WIDTH 331 " [get_bd_cells ip_20_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_20_reduce/reduce_31]
...
create_bd_pin -dir O -from 38 -to 0 ip_21_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 231 -to 0 ip_22_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 231 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 330 -to 0 ip_24_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 231 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 231 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_24_slice_and_concat/in_3
...
create_bd_pin -dir I -from 132 -to 0 ip_24_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 130 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 133 " [get_bd_cells ip_24_slice_and_concat/slice_7]
...
create_bd_pin -dir I -from 132 -to 0 ip_25_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 132 CONFIG.DIN_TO 131 CONFIG.DIN_WIDTH 133 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_0] [get_bd_pins ip_5_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_6_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_13_intc/irq_2] [get_bd_pins ip_9_uartlite/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_microblaze/INTERRUPT] [get_bd_intf_pins ip_13_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_microblaze/M_AXI_DP] [get_bd_intf_pins ip_14_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_gpio/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_15_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/S_AXIS_DATA] [get_bd_intf_pins ip_19_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_2_dft/XK_RE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_2_dft/XK_IM]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_6] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_7] [get_bd_pins ip_3_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_8_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_1] [get_bd_pins ip_8_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_2] [get_bd_pins ip_8_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_3] [get_bd_pins ip_8_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_4] [get_bd_pins ip_8_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_5] [get_bd_pins ip_8_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_2_dft/FWD_INV]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_8_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_28_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/C_IN]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_2_dft/FD_IN]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_2_dft/CE]
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/M_AXIS declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_dwidth_converter/M_AXIS declared=24 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 320 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_dwidth_converter/M_AXIS declared=320 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_dwidth_converter/M_AXIS declared=320 actual=ERR $__err" }
