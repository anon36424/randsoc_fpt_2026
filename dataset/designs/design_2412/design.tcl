...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1b CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 226 CONFIG.C_SDA_INERTIAL_DELAY 124 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 20.424387324670658 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 54 CONFIG.aresetn 0 CONFIG.atuserwidth 59 CONFIG.bportwidth 61 CONFIG.btuserwidth 141 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 38 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 11 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8192 " [get_bd_cells ip_5_fft/fft_0]
