...
set_property -dict "CONFIG.C_MASK 0x3407769a7803669 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xa981739c7fcdeea CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 8 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 13 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 6 CONFIG.convolution_code0 35 CONFIG.convolution_code1 60 CONFIG.convolution_code2 60 CONFIG.convolution_code3 32 CONFIG.convolution_code4 60 CONFIG.convolution_code5 9 CONFIG.convolution_code6 56 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 6 CONFIG.output_rate 7 CONFIG.puncture_code0 101011 CONFIG.puncture_code1 010011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_2_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 54 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 64 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_8_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 51 CONFIG.aresetn 0 CONFIG.atuserwidth 163 CONFIG.bportwidth 22 CONFIG.btuserwidth 249 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 11 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 48 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_14_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 14 CONFIG.S_TDATA_NUM_BYTES 32 " [get_bd_cells ip_28_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_18_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_11_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_DATA] [get_bd_intf_pins ip_20_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_4] [get_bd_pins ip_12_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_5] [get_bd_pins ip_12_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_6] [get_bd_pins ip_12_axi_timer/pwm0]
