...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 232 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 248 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 247 -to 0 ip_1_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 63 CONFIG.aresetn 0 CONFIG.bportwidth 61 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 68 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x3ffff CONFIG.C_GPIO_WIDTH 18 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 64 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_9_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 17 CONFIG.Latency 26 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 187 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_11_accumulator/accumulator_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 190 -to 0 ip_23_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 101 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 102 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 113 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 114 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 131 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 137 CONFIG.DIN_TO 132 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 143 CONFIG.DIN_TO 138 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 144 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 155 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 161 CONFIG.DIN_TO 156 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 167 CONFIG.DIN_TO 162 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 173 CONFIG.DIN_TO 168 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 179 CONFIG.DIN_TO 174 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 185 CONFIG.DIN_TO 180 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 190 CONFIG.DIN_TO 186 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_23_reduce/slice_31]
...
create_bd_pin -dir I -from 247 -to 0 ip_25_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 159 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_25_slice_and_concat/slice_5]
...
create_bd_pin -dir I -from 247 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 172 CONFIG.DIN_TO 160 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 189 CONFIG.DIN_TO 173 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 204 CONFIG.DIN_TO 190 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 219 CONFIG.DIN_TO 205 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 232 CONFIG.DIN_TO 220 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 231 -to 0 ip_31_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 247 CONFIG.DIN_TO 233 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 12 -to 0 ip_31_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_5] [get_bd_pins ip_31_slice_and_concat/concat/In5]
create_bd_pin -dir I -from 12 -to 0 ip_31_slice_and_concat/in_6
...
create_bd_pin -dir I -from 186 -to 0 ip_31_slice_and_concat/in_10
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_10
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_10]
set_property -dict "CONFIG.DIN_FROM 180 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 187 " [get_bd_cells ip_31_slice_and_concat/slice_10]
...
create_bd_pin -dir I -from 186 -to 0 ip_32_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_32_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 186 CONFIG.DIN_TO 181 CONFIG.DIN_WIDTH 187 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_1] [get_bd_pins ip_5_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/M_AXI] [get_bd_intf_pins ip_15_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_15_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_15_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_gpio/AXI] [get_bd_intf_pins ip_15_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_15_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_intc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_floating_point/M_AXIS_RESULT] [get_bd_intf_pins ip_17_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_4_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_1_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_4] [get_bd_pins ip_10_dft/RFFD]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_5] [get_bd_pins ip_10_dft/XK_RE]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_6] [get_bd_pins ip_10_dft/XK_IM]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_7] [get_bd_pins ip_10_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_8] [get_bd_pins ip_10_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_9] [get_bd_pins ip_10_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vccaux_alarm_out]
