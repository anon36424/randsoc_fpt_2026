...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 10 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x3ff " [get_bd_cells ip_0_gpio/gpio_0]
...
create_bd_pin -dir I -from 155 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_6_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 99 -to 0 ip_8_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 78 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 79 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 82 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 93 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 94 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 100 " [get_bd_cells ip_8_reduce/slice_31]
...
create_bd_pin -dir O -from 155 -to 0 ip_9_slice_and_concat/out0
create_bd_pin -dir I -from 255 -to 0 ip_9_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_9_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 155 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 255 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 255 CONFIG.DIN_TO 156 CONFIG.DIN_WIDTH 256 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_3_reset/interconnect_aresetn] [get_bd_pins ip_2_floating_point/aresetn]
