...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x58 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 162 CONFIG.C_SDA_INERTIAL_DELAY 93 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 661.3269532691202 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x63205eff6a59393 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x253e8c6f66f22cd CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_1] [get_bd_pins ip_0_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_2] [get_bd_pins ip_0_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_4] [get_bd_pins ip_0_xadc_wiz/alarm_out]
