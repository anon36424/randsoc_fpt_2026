...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 10 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_PORTS 12 " [get_bd_cells ip_9_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_9_slice_and_concat/in_6
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_6] [get_bd_pins ip_9_slice_and_concat/concat/In6]
create_bd_pin -dir I -from 0 -to 0 ip_9_slice_and_concat/in_7
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_7] [get_bd_pins ip_9_slice_and_concat/concat/In7]
create_bd_pin -dir I -from 0 -to 0 ip_9_slice_and_concat/in_8
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_8] [get_bd_pins ip_9_slice_and_concat/concat/In8]
create_bd_pin -dir I -from 0 -to 0 ip_9_slice_and_concat/in_9
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_9] [get_bd_pins ip_9_slice_and_concat/concat/In9]
create_bd_pin -dir I -from 0 -to 0 ip_9_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_10] [get_bd_pins ip_9_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 0 -to 0 ip_9_slice_and_concat/in_11
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_11] [get_bd_pins ip_9_slice_and_concat/concat/In11]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_3] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_4] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_5] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_6] [get_bd_pins ip_3_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_7] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_8] [get_bd_pins ip_3_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_9] [get_bd_pins ip_3_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_10] [get_bd_pins ip_3_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_11] [get_bd_pins ip_3_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/ot_out]
