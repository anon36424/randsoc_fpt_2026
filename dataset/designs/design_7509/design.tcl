...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8192 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3b CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 235 CONFIG.C_SDA_INERTIAL_DELAY 158 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 520.5694684139733 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 12 " [get_bd_cells ip_12_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 20 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_8_axi/AXI_S0]
