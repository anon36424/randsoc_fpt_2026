...
set_property -dict "CONFIG.C_MASK 0xe0e9f66c8cc6ba6 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfd697fb92934127 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 100 CONFIG.Latency 24 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 228 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 227 -to 0 ip_8_accumulator/Q
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x71 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 229 CONFIG.C_SDA_INERTIAL_DELAY 76 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 791.8613889663961 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5c CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 76 CONFIG.C_SDA_INERTIAL_DELAY 147 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 972.7091043356448 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 48 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 48 " [get_bd_cells ip_22_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 136 -to 0 ip_24_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_24_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 77 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 88 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 89 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 101 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 108 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 109 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 116 CONFIG.DIN_TO 113 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 117 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 132 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 136 CONFIG.DIN_TO 133 CONFIG.DIN_WIDTH 137 " [get_bd_cells ip_24_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 4 " [get_bd_cells ip_24_reduce/reduce_31]
...
create_bd_pin -dir O -from 99 -to 0 ip_25_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 227 -to 0 ip_25_slice_and_concat/in_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_9
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_9]
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 228 " [get_bd_cells ip_25_slice_and_concat/slice_9]
...
create_bd_pin -dir O -from 14 -to 0 ip_26_slice_and_concat/out0
create_bd_pin -dir I -from 227 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 105 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 228 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 136 -to 0 ip_27_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 227 CONFIG.DIN_TO 106 CONFIG.DIN_WIDTH 228 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_27_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_27_slice_and_concat/slice_2]
...
connect_bd_net [get_bd_pins ip_15_reset/mb_reset] [get_bd_pins ip_3_microblaze/Reset]
...
connect_bd_net [get_bd_pins ip_16_clk_wiz/clk_out] [get_bd_pins ip_3_microblaze/Clk]
...
connect_bd_net [get_bd_pins ip_16_clk_wiz/clk_out] [get_bd_pins ip_6_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_4] [get_bd_pins ip_7_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_17_intc/irq_5] [get_bd_pins ip_10_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_8] [get_bd_pins ip_14_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/M_AXI] [get_bd_intf_pins ip_18_axi/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_timer/S_AXI] [get_bd_intf_pins ip_18_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_iic/AXI] [get_bd_intf_pins ip_18_axi/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_18_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_DATA] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_5_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_23_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_3] [get_bd_pins ip_6_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_4] [get_bd_pins ip_6_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_6_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_6] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_7] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_8] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_9] [get_bd_pins ip_8_accumulator/Q]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_12_dft/XN_RE]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_8_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_1] [get_bd_pins ip_12_dft/RFFD]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_2] [get_bd_pins ip_12_dft/XK_RE]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_2_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_0] [get_bd_pins ip_12_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_0] [get_bd_pins ip_12_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_12_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_12_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_7_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_12_dft/FD_IN]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_38_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_1_conv_encoder/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 384 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_21_axis_dwidth_converter/M_AXIS declared=384 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_21_axis_dwidth_converter/M_AXIS declared=384 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 384 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_22_axis_dwidth_converter/S_AXIS declared=384 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_22_axis_dwidth_converter/S_AXIS declared=384 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 22 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_23_axis_dwidth_converter/M_AXIS declared=22 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_23_axis_dwidth_converter/M_AXIS declared=22 actual=ERR $__err" }
