...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 4 CONFIG.convolution_code0 4 CONFIG.convolution_code1 14 CONFIG.convolution_code2 13 CONFIG.convolution_code3 12 CONFIG.convolution_code4 11 CONFIG.convolution_code5 4 CONFIG.convolution_code6 6 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 5 CONFIG.output_rate 6 CONFIG.puncture_code0 01110 CONFIG.puncture_code1 01110 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_1_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MASK 0x707076241e4744f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x187728b7484a5a5 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 48 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 26 CONFIG.aresetn 1 CONFIG.bportwidth 14 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 37 CONFIG.roundmode Truncate " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 7 CONFIG.C_TAVDV_PS_MEM_0 14091 CONFIG.C_TAVDV_PS_MEM_1 16225 CONFIG.C_TCEDV_PS_MEM_0 15433 CONFIG.C_TCEDV_PS_MEM_1 15281 CONFIG.C_THZCE_PS_MEM_0 7636 CONFIG.C_THZCE_PS_MEM_1 6731 CONFIG.C_THZOE_PS_MEM_0 6566 CONFIG.C_THZOE_PS_MEM_1 7413 CONFIG.C_TLZWE_PS_MEM_0 5246 CONFIG.C_TLZWE_PS_MEM_1 3181 CONFIG.C_TWC_PS_MEM_0 14935 CONFIG.C_TWC_PS_MEM_1 15438 CONFIG.C_TWPH_PS_MEM_0 13035 CONFIG.C_TWPH_PS_MEM_1 11765 CONFIG.C_TWP_PS_MEM_0 11141 CONFIG.C_TWP_PS_MEM_1 12403 CONFIG.C_WR_REC_TIME_MEM_0 28582 CONFIG.C_WR_REC_TIME_MEM_1 24732 " [get_bd_cells ip_10_emc/emc_0]
...
set_property -dict "CONFIG.NUM_MI 6 CONFIG.NUM_SI 6 " [get_bd_cells ip_15_axi/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_6] [get_bd_pins ip_9_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_15_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI] [get_bd_intf_pins ip_15_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_15_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_15_axi/AXI_M5]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_3] [get_bd_pins ip_9_xadc_wiz/temp_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 36 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_21_axis_dwidth_converter/M_AXIS declared=36 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_21_axis_dwidth_converter/M_AXIS declared=36 actual=ERR $__err" }
if {[catch {
