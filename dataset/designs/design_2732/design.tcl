...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 8 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_SYNCH_PIPEDELAY_1 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 7 CONFIG.C_TAVDV_PS_MEM_0 14139 CONFIG.C_TAVDV_PS_MEM_2 14137 CONFIG.C_TCEDV_PS_MEM_0 15030 CONFIG.C_TCEDV_PS_MEM_2 16280 CONFIG.C_THZCE_PS_MEM_0 7033 CONFIG.C_THZCE_PS_MEM_2 6920 CONFIG.C_THZOE_PS_MEM_0 7143 CONFIG.C_THZOE_PS_MEM_2 6898 CONFIG.C_TLZWE_PS_MEM_0 4938 CONFIG.C_TLZWE_PS_MEM_2 1082 CONFIG.C_TWC_PS_MEM_0 14484 CONFIG.C_TWC_PS_MEM_2 15834 CONFIG.C_TWPH_PS_MEM_0 10851 CONFIG.C_TWPH_PS_MEM_2 12625 CONFIG.C_TWP_PS_MEM_0 12141 CONFIG.C_TWP_PS_MEM_2 11175 CONFIG.C_WR_REC_TIME_MEM_0 27755 CONFIG.C_WR_REC_TIME_MEM_2 25579 " [get_bd_cells ip_7_emc/emc_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 64 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 7 CONFIG.C_TAVDV_PS_MEM_0 14576 CONFIG.C_TAVDV_PS_MEM_1 14467 CONFIG.C_TAVDV_PS_MEM_2 15186 CONFIG.C_TCEDV_PS_MEM_0 13513 CONFIG.C_TCEDV_PS_MEM_1 16280 CONFIG.C_TCEDV_PS_MEM_2 15746 CONFIG.C_THZCE_PS_MEM_0 7593 CONFIG.C_THZCE_PS_MEM_1 6864 CONFIG.C_THZCE_PS_MEM_2 7690 CONFIG.C_THZOE_PS_MEM_0 6639 CONFIG.C_THZOE_PS_MEM_1 6870 CONFIG.C_THZOE_PS_MEM_2 7525 CONFIG.C_TLZWE_PS_MEM_0 2230 CONFIG.C_TLZWE_PS_MEM_1 4365 CONFIG.C_TLZWE_PS_MEM_2 6663 CONFIG.C_TWC_PS_MEM_0 16488 CONFIG.C_TWC_PS_MEM_1 16388 CONFIG.C_TWC_PS_MEM_2 14868 CONFIG.C_TWPH_PS_MEM_0 12011 CONFIG.C_TWPH_PS_MEM_1 11324 CONFIG.C_TWPH_PS_MEM_2 12200 CONFIG.C_TWP_PS_MEM_0 12302 CONFIG.C_TWP_PS_MEM_1 12666 CONFIG.C_TWP_PS_MEM_2 10982 CONFIG.C_WR_REC_TIME_MEM_0 29561 CONFIG.C_WR_REC_TIME_MEM_1 25627 CONFIG.C_WR_REC_TIME_MEM_2 28823 " [get_bd_cells ip_8_emc/emc_0]
...
set_property -dict "CONFIG.NUM_MI 10 CONFIG.NUM_SI 1 " [get_bd_cells ip_15_axi/axi_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_3] [get_bd_pins ip_4_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_19_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/out0] [get_bd_pins ip_10_complex_multiplier/aclken]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_6_conv_encoder/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_broadcaster/S_AXIS declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_broadcaster/S_AXIS declared=72 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_19_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_broadcaster/M_AXIS_0 declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_broadcaster/M_AXIS_0 declared=72 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_19_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_broadcaster/M_AXIS_1 declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_broadcaster/M_AXIS_1 declared=72 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_24_axis_combiner/S_AXIS_3 declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_axis_combiner/S_AXIS_3 declared=72 actual=ERR $__err" }
if {[catch {
