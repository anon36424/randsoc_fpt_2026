...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 1 CONFIG.C_SPI_MEMORY 0 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_0_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 8 CONFIG.convolution_code0 26 CONFIG.convolution_code1 64 CONFIG.convolution_code2 144 CONFIG.convolution_code3 75 CONFIG.convolution_code4 126 CONFIG.convolution_code5 115 CONFIG.convolution_code6 104 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 10 CONFIG.output_rate 16 CONFIG.puncture_code0 1110100011 CONFIG.puncture_code1 1111111111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_1_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 49 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 4096 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 8 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_6_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 16 CONFIG.GEN0_ASSERT Active_Low CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_7_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 8 CONFIG.Iterations 31 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 35 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 42 CONFIG.Round_Mode Truncate " [get_bd_cells ip_8_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7f CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 117 CONFIG.C_SDA_INERTIAL_DELAY 176 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 943.5455762180419 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 140 CONFIG.Latency 12 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 213 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 139 -to 0 ip_10_accumulator/B
connect_bd_net [get_bd_pins ip_10_accumulator/B] [get_bd_pins ip_10_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 212 -to 0 ip_10_accumulator/Q
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 512 " [get_bd_cells ip_11_axi_hwicap/axi_hwicap_0]
...
create_bd_pin -dir O -from 22 -to 0 ip_12_accumulator/Q
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0xfff CONFIG.C_GPIO2_WIDTH 10 CONFIG.C_GPIO_WIDTH 12 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x177 " [get_bd_cells ip_13_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 8192 " [get_bd_cells ip_14_fft/fft_0]
...
set_property -dict "CONFIG.C_BAUDRATE 110 CONFIG.C_DATA_BITS 8 CONFIG.PARITY No_Parity " [get_bd_cells ip_15_uartlite/uart_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 5 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 34 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_17_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 4 -to 0 ip_17_accumulator/B
connect_bd_net [get_bd_pins ip_17_accumulator/B] [get_bd_pins ip_17_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 33 -to 0 ip_17_accumulator/Q
...
set_property -dict "CONFIG.C_MASK 0x62b885a5e76d404 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x76b8bdbf661a482 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_18_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 63 CONFIG.aresetn 0 CONFIG.atuserwidth 214 CONFIG.bportwidth 38 CONFIG.btuserwidth 170 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 80 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_19_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 53 CONFIG.C_ENABLE_MULTI_CHANNEL 0 CONFIG.C_INCLUDE_MM2S 1 CONFIG.C_INCLUDE_MM2S_DRE 0 CONFIG.C_INCLUDE_S2MM 1 CONFIG.C_INCLUDE_S2MM_DRE 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_MICRO_DMA 0 CONFIG.C_MM2S_BURST_SIZE 64 CONFIG.C_M_AXIS_MM2S_TDATA_WIDTH 8 CONFIG.C_M_AXI_MM2S_DATA_WIDTH 128 CONFIG.C_M_AXI_S2MM_DATA_WIDTH 128 CONFIG.C_S2MM_BURST_SIZE 64 CONFIG.C_SG_INCLUDE_STSCNTRL_STRM 0 CONFIG.C_SG_LENGTH_WIDTH 12 CONFIG.C_SINGLE_INTERFACE 1 CONFIG.C_S_AXIS_S2MM_TDATA_WIDTH 8 " [get_bd_cells ip_20_axi_dma/axi_dma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x18 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 20 CONFIG.C_SDA_INERTIAL_DELAY 45 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 872.2147222620675 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_21_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.AINIT_Value 374bfbaae2f5a8b66561fa0c33fda4677960736a2735a75481adfd3b341a CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 174 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 238 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_22_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 173 -to 0 ip_22_accumulator/B
connect_bd_net [get_bd_pins ip_22_accumulator/B] [get_bd_pins ip_22_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 237 -to 0 ip_22_accumulator/Q
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 1 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_23_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_24_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x42631eafc63079f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_25_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x133d7cac1f097e2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_25_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 16 CONFIG.NUM_SI 6 " [get_bd_cells ip_30_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 12 " [get_bd_cells ip_41_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 20 " [get_bd_cells ip_45_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 174 -to 0 ip_46_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 6 " [get_bd_cells ip_46_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 144 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 145 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 154 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 159 CONFIG.DIN_TO 155 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 164 CONFIG.DIN_TO 160 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 165 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 174 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_46_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_46_reduce/reduce_31]
...
create_bd_pin -dir O -from 21 -to 0 ip_47_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_47_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 10 " [get_bd_cells ip_47_slice_and_concat/concat]
...
create_bd_pin -dir I -from 212 -to 0 ip_47_slice_and_concat/in_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_9
move_bd_cells [get_bd_cells ip_47_slice_and_concat] [get_bd_cells slice_9]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_47_slice_and_concat/slice_9]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_9] [get_bd_pins ip_47_slice_and_concat/slice_9/din]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/slice_9/dout] [get_bd_pins ip_47_slice_and_concat/concat/In9]


########## slice_and_concat ##########
create_bd_cell -type hier ip_48_slice_and_concat
create_bd_pin -dir O -from 4 -to 0 ip_48_slice_and_concat/out0
create_bd_pin -dir I -from 212 -to 0 ip_48_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_48_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_48_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 174 -to 0 ip_49_slice_and_concat/out0
create_bd_pin -dir I -from 212 -to 0 ip_49_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_49_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 192 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_49_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 173 -to 0 ip_50_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 212 -to 0 ip_50_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_50_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 212 CONFIG.DIN_TO 193 CONFIG.DIN_WIDTH 213 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 22 -to 0 ip_50_slice_and_concat/in_1
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_1] [get_bd_pins ip_50_slice_and_concat/concat/In1]
create_bd_pin -dir I -from 33 -to 0 ip_50_slice_and_concat/in_2
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_2] [get_bd_pins ip_50_slice_and_concat/concat/In2]
create_bd_pin -dir I -from 237 -to 0 ip_50_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_50_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 238 " [get_bd_cells ip_50_slice_and_concat/slice_3]
...
create_bd_pin -dir I -from 237 -to 0 ip_51_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_51_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 238 " [get_bd_cells ip_51_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 139 -to 0 ip_52_slice_and_concat/out0
create_bd_pin -dir I -from 237 -to 0 ip_52_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_52_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 237 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 238 " [get_bd_cells ip_52_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_53_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_55_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_58_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_60_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_61_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_63_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_26_reset/peripheral_areset_n] [get_bd_pins ip_0_axi_quad_spi/reset4]
connect_bd_net [get_bd_pins ip_26_reset/interconnect_aresetn] [get_bd_pins ip_1_conv_encoder/aresetn]
...
connect_bd_net [get_bd_pins ip_26_reset/peripheral_areset_n] [get_bd_pins ip_13_gpio/rst]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_0_axi_quad_spi/clk4]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_1_conv_encoder/aclk]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_8_cordic/aclk]
...
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_12_accumulator/clk]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_13_gpio/clk]
connect_bd_net [get_bd_pins ip_27_clk_wiz/clk_out] [get_bd_pins ip_14_fft/aclk]
...
connect_bd_net [get_bd_pins ip_28_intc/irq_3] [get_bd_pins ip_4_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_28_intc/irq_4] [get_bd_pins ip_5_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_28_intc/irq_5] [get_bd_pins ip_6_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_28_intc/irq_6] [get_bd_pins ip_7_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_28_intc/irq_7] [get_bd_pins ip_9_axi_iic/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_8] [get_bd_pins ip_11_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_28_intc/irq_9] [get_bd_pins ip_13_gpio/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_10] [get_bd_pins ip_14_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_28_intc/irq_11] [get_bd_pins ip_15_uartlite/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_12] [get_bd_pins ip_16_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_28_intc/irq_13] [get_bd_pins ip_20_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_28_intc/irq_14] [get_bd_pins ip_20_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_28_intc/irq_15] [get_bd_pins ip_21_axi_iic/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_16] [get_bd_pins ip_23_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_28_intc/irq_17] [get_bd_pins ip_24_fft/event_frame_started]
...
connect_bd_net [get_bd_pins ip_29_intc/irq_3] [get_bd_pins ip_4_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_29_intc/irq_4] [get_bd_pins ip_5_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_29_intc/irq_5] [get_bd_pins ip_6_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_29_intc/irq_6] [get_bd_pins ip_7_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_29_intc/irq_7] [get_bd_pins ip_9_axi_iic/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_8] [get_bd_pins ip_11_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_29_intc/irq_9] [get_bd_pins ip_13_gpio/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_10] [get_bd_pins ip_14_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_29_intc/irq_11] [get_bd_pins ip_15_uartlite/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_12] [get_bd_pins ip_16_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_29_intc/irq_13] [get_bd_pins ip_20_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_29_intc/irq_14] [get_bd_pins ip_20_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_29_intc/irq_15] [get_bd_pins ip_21_axi_iic/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_16] [get_bd_pins ip_23_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_29_intc/irq_17] [get_bd_pins ip_24_fft/event_frame_started]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_25_microblaze/INTERRUPT] [get_bd_intf_pins ip_29_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_cdma/M_AXI] [get_bd_intf_pins ip_30_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/M_AXI] [get_bd_intf_pins ip_30_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_30_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_microblaze/M_AXI_DP] [get_bd_intf_pins ip_30_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_dma/M_AXI] [get_bd_intf_pins ip_30_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_25_microblaze/M_AXI_DP] [get_bd_intf_pins ip_30_axi/AXI_M5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_30_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_30_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_30_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_30_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_timer/S_AXI] [get_bd_intf_pins ip_30_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_timer/S_AXI] [get_bd_intf_pins ip_30_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_iic/AXI] [get_bd_intf_pins ip_30_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_30_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_gpio/AXI] [get_bd_intf_pins ip_30_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_uartlite/AXI] [get_bd_intf_pins ip_30_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_30_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_30_axi/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_iic/AXI] [get_bd_intf_pins ip_30_axi/AXI_S12]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_30_axi/AXI_S13]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_intc/AXI] [get_bd_intf_pins ip_30_axi/AXI_S14]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_29_intc/AXI] [get_bd_intf_pins ip_30_axi/AXI_S15]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_fft/M_AXIS_DATA] [get_bd_intf_pins ip_31_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_36_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_37_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_axi_dma/M_AXIS_MM2S]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_37_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_40_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_34_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_14_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_fft/S_AXIS_DATA] [get_bd_intf_pins ip_34_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_45_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_31_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_0] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_1] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_2] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_3] [get_bd_pins ip_6_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_4] [get_bd_pins ip_6_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_5] [get_bd_pins ip_6_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_6] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_7] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_8] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_9] [get_bd_pins ip_10_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_1] [get_bd_pins ip_12_accumulator/Q]
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_2] [get_bd_pins ip_17_accumulator/Q]
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_3] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_11_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/B]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/in_0] [get_bd_pins ip_22_accumulator/Q]
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/Bypass]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/out0] [get_bd_pins ip_22_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_1_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/out0] [get_bd_pins ip_7_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/out0] [get_bd_pins ip_6_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_17_accumulator/ADD]
...
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_6_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_63_slice_and_concat/out0] [get_bd_pins ip_12_accumulator/ADD]
connect_bd_net [get_bd_pins ip_64_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_65_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/CE]
connect_bd_net [get_bd_pins ip_66_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/ADD]
connect_bd_net [get_bd_pins ip_67_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/capturetrig0]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_14_fft/S_AXIS_DATA declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_fft/S_AXIS_DATA declared=256 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_14_fft/fft_0/M_AXIS_DATA]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_14_fft/M_AXIS_DATA declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_fft/M_AXIS_DATA declared=256 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_14_fft/S_AXIS_CONFIG declared=34 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_fft/S_AXIS_CONFIG declared=34 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_19_complex_multiplier/M_AXIS_DOUT declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_complex_multiplier/M_AXIS_DOUT declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_20_axi_dma/axi_dma_0/M_AXIS_MM2S]] * 8}]
  set __s [expr {$__aw == 8 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axi_dma/M_AXIS_MM2S declared=8 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axi_dma/M_AXIS_MM2S declared=8 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_24_fft/S_AXIS_DATA declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_fft/S_AXIS_DATA declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_24_fft/fft_0/M_AXIS_DATA]] * 8}]
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_24_fft/M_AXIS_DATA declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_fft/M_AXIS_DATA declared=160 actual=ERR $__err" }
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_24_fft/S_AXIS_CONFIG declared=26 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_24_fft/S_AXIS_CONFIG declared=26 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_31_axis_broadcaster/axis_broadcaster_0/S_AXIS]] * 8}]
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/S_AXIS declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/S_AXIS declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_31_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_0 declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_0 declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_31_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_1 declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_1 declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_31_axis_broadcaster/axis_broadcaster_0/M02_AXIS]] * 8}]
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_2 declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_broadcaster/M_AXIS_2 declared=160 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 26 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_37_axis_dwidth_converter/M_AXIS declared=26 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_37_axis_dwidth_converter/M_AXIS declared=26 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 160 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_43_axis_combiner/S_AXIS_0 declared=160 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_43_axis_combiner/S_AXIS_0 declared=160 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_43_axis_combiner/axis_combiner_0/S01_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_43_axis_combiner/S_AXIS_1 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_43_axis_combiner/S_AXIS_1 declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_43_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_43_axis_combiner/M_AXIS declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_43_axis_combiner/M_AXIS declared=256 actual=ERR $__err" }
if {[catch {
