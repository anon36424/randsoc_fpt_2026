...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 33 CONFIG.aresetn 1 CONFIG.bportwidth 39 CONFIG.btuserwidth 157 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 37 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_timer/S_AXI] [get_bd_intf_pins ip_8_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_8_axi/AXI_S1]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_3] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_4] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_5] [get_bd_pins ip_1_axi_timer/pwm0]
