...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3 CONFIG.C_DOUT_DEFAULT_2 0x3 CONFIG.C_GPIO2_WIDTH 23 CONFIG.C_GPIO_WIDTH 2 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x3 CONFIG.C_TRI_DEFAULT_2 0x3 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_3_dft/dft_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 17 CONFIG.Iterations 20 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour Pass_Cartesian_TLAST CONFIG.Out_TREADY 1 CONFIG.Output_Width 11 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 38 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_5_cordic/cordic_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 18 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 45 CONFIG.aresetn 0 CONFIG.bportwidth 46 CONFIG.btuserwidth 41 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 3 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 91 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_2] [get_bd_pins ip_2_gpio/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_3] [get_bd_pins ip_4_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_13_intc/irq_4] [get_bd_pins ip_4_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_14_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_gpio/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_3_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_5_cordic/aclken]
