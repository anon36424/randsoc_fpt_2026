...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 2 CONFIG.C_GPIO_WIDTH 17 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 8 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 9 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 12 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 8 -to 0 ip_5_accumulator/B
connect_bd_net [get_bd_pins ip_5_accumulator/B] [get_bd_pins ip_5_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 11 -to 0 ip_5_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 14 CONFIG.aresetn 1 CONFIG.atuserwidth 31 CONFIG.bportwidth 49 CONFIG.btuserwidth 16 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 42 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 4 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_9_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.AINIT_Value 3ffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 122 CONFIG.Latency 14 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 154 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 121 -to 0 ip_10_accumulator/B
connect_bd_net [get_bd_pins ip_10_accumulator/B] [get_bd_pins ip_10_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 153 -to 0 ip_10_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 7 CONFIG.convolution_code0 34 CONFIG.convolution_code1 125 CONFIG.convolution_code2 20 CONFIG.convolution_code3 27 CONFIG.convolution_code4 80 CONFIG.convolution_code5 14 CONFIG.convolution_code6 118 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 9 CONFIG.output_rate 14 CONFIG.puncture_code0 110011110 CONFIG.puncture_code1 110111111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_11_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Translate CONFIG.Input_Width 33 CONFIG.Iterations 20 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 46 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 0 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_13_cordic/cordic_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_14_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.AINIT_Value 7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 241 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 243 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_16_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 240 -to 0 ip_16_accumulator/B
connect_bd_net [get_bd_pins ip_16_accumulator/B] [get_bd_pins ip_16_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 242 -to 0 ip_16_accumulator/Q
...
########## jtag_axi ##########
create_bd_cell -type hier ip_20_jtag_axi
create_bd_cell -type ip -vlnv xilinx.com:ip:jtag_axi:1.2 jtag_axi_0
move_bd_cells [get_bd_cells ip_20_jtag_axi] [get_bd_cells jtag_axi_0]
set_property -dict "CONFIG.PROTOCOL AXI4LITE " [get_bd_cells ip_20_jtag_axi/jtag_axi_0]
create_bd_pin -dir I -from 0 -to 0 ip_20_jtag_axi/aclk
connect_bd_net [get_bd_pins ip_20_jtag_axi/aclk] [get_bd_pins ip_20_jtag_axi/jtag_axi_0/aclk]
create_bd_pin -dir I -from 0 -to 0 ip_20_jtag_axi/aresetn
connect_bd_net [get_bd_pins ip_20_jtag_axi/aresetn] [get_bd_pins ip_20_jtag_axi/jtag_axi_0/aresetn]
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 ip_20_jtag_axi/M_AXI
connect_bd_intf_net [get_bd_intf_pins ip_20_jtag_axi/M_AXI] [get_bd_intf_pins ip_20_jtag_axi/jtag_axi_0/M_AXI]
...
set_property -dict "CONFIG.NUM_MI 6 CONFIG.NUM_SI 1 " [get_bd_cells ip_21_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 3 " [get_bd_cells ip_34_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir O -from 240 -to 0 ip_44_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 153 -to 0 ip_44_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_10] [get_bd_pins ip_44_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 242 -to 0 ip_44_slice_and_concat/in_11
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_11
move_bd_cells [get_bd_cells ip_44_slice_and_concat] [get_bd_cells slice_11]
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_44_slice_and_concat/slice_11]
...
create_bd_pin -dir O -from 44 -to 0 ip_45_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 110 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 111 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_47_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 242 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 243 " [get_bd_cells ip_48_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_7_complex_multiplier/aresetn]
...
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_11_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_12_conv_encoder/aresetn]
connect_bd_net [get_bd_pins ip_17_reset/peripheral_areset_n] [get_bd_pins ip_14_axi_hwicap/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_15_conv_encoder/aresetn]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_2_fft/aclk]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_7_complex_multiplier/aclk]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_10_accumulator/clk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_11_conv_encoder/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_12_conv_encoder/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_13_cordic/aclk]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_15_conv_encoder/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_16_accumulator/clk]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_1] [get_bd_pins ip_2_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_19_intc/irq_2] [get_bd_pins ip_3_axi_timer/interrupt]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_5] [get_bd_pins ip_9_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_19_intc/irq_6] [get_bd_pins ip_14_axi_hwicap/ip2intc_irpt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_jtag_axi/M_AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_gpio/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_timer/S_AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_timer/S_AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_21_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_intc/AXI] [get_bd_intf_pins ip_21_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_23_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/M_AXIS_DATA] [get_bd_intf_pins ip_25_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_27_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_28_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_29_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_30_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_31_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_11_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/S_AXIS_DATA] [get_bd_intf_pins ip_15_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_floating_point/S_AXIS_B] [get_bd_intf_pins ip_33_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_38_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_23_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_38_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_27_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_39_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_40_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_26_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_40_axis_combiner/S_AXIS_3] [get_bd_intf_pins ip_27_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/S_AXIS_DATA] [get_bd_intf_pins ip_40_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_41_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_22_axis_broadcaster/M_AXIS_4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_27_axis_broadcaster/M_AXIS_3]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/out0] [get_bd_pins ip_16_accumulator/B]
...
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_3] [get_bd_pins ip_5_accumulator/Q]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_4] [get_bd_pins ip_8_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_5] [get_bd_pins ip_8_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_6] [get_bd_pins ip_8_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_7] [get_bd_pins ip_9_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_8] [get_bd_pins ip_9_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_9] [get_bd_pins ip_9_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_10] [get_bd_pins ip_10_accumulator/Q]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/in_11] [get_bd_pins ip_16_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_14_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_47_slice_and_concat/in_0] [get_bd_pins ip_16_accumulator/Q]
connect_bd_net [get_bd_pins ip_48_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/B]
connect_bd_net [get_bd_pins ip_48_slice_and_concat/in_0] [get_bd_pins ip_16_accumulator/Q]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/out0] [get_bd_pins ip_49_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_5_accumulator/CE]
connect_bd_net [get_bd_pins ip_50_slice_and_concat/out0] [get_bd_pins ip_50_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_4_floating_point/aclken]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_51_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_52_slice_and_concat/out0] [get_bd_pins ip_9_axi_timer/capturetrig0]
...
connect_bd_net [get_bd_pins ip_54_slice_and_concat/out0] [get_bd_pins ip_7_complex_multiplier/aclken]
...
connect_bd_net [get_bd_pins ip_56_slice_and_concat/out0] [get_bd_pins ip_9_axi_timer/capturetrig1]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_8_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_62_slice_and_concat/out0] [get_bd_pins ip_1_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_20_jtag_axi/aresetn]
...
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_26_axis_broadcaster/aresetn]
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_27_axis_broadcaster/aresetn]
...
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_37_axis_dwidth_converter/aresetn]
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_38_axis_combiner/aresetn]
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_39_axis_dwidth_converter/aresetn]
connect_bd_net [get_bd_pins ip_17_reset/interconnect_aresetn] [get_bd_pins ip_40_axis_combiner/aresetn]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_20_jtag_axi/aclk]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_26_axis_broadcaster/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_27_axis_broadcaster/aclk]
...
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_37_axis_dwidth_converter/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_38_axis_combiner/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_39_axis_dwidth_converter/aclk]
connect_bd_net [get_bd_pins ip_18_clk_wiz/clk_out] [get_bd_pins ip_40_axis_combiner/aclk]
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_4_floating_point/S_AXIS_A declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_4_floating_point/S_AXIS_A declared=24 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_4_floating_point/floating_point_0/S_AXIS_B]] * 8}]
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_4_floating_point/S_AXIS_B declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_4_floating_point/S_AXIS_B declared=24 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_26_axis_broadcaster/M_AXIS_2 declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_axis_broadcaster/M_AXIS_2 declared=24 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_combiner/S_AXIS_1 declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_combiner/S_AXIS_1 declared=24 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_38_axis_combiner/S_AXIS_2 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_38_axis_combiner/S_AXIS_2 declared=96 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 24 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_combiner/S_AXIS_2 declared=24 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_combiner/S_AXIS_2 declared=24 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_40_axis_combiner/axis_combiner_0/S03_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_combiner/S_AXIS_3 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_combiner/S_AXIS_3 declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_40_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 256 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_40_axis_combiner/M_AXIS declared=256 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_40_axis_combiner/M_AXIS declared=256 actual=ERR $__err" }
if {[catch {
