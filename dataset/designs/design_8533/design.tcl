...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x12 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 61 CONFIG.C_SDA_INERTIAL_DELAY 184 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 537.5534381574923 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_3_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_4] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_5] [get_bd_pins ip_3_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_10_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/ot_out]
