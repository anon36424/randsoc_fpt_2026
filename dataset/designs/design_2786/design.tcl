...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x30 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 69 CONFIG.C_SDA_INERTIAL_DELAY 226 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 456.4594623857947 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x1fffffff CONFIG.C_GPIO_WIDTH 29 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_6] [get_bd_pins ip_7_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_floating_point/S_AXIS_OPERATION] [get_bd_intf_pins ip_15_axis_dwidth_converter/M_AXIS]
