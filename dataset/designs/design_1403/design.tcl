...
create_bd_pin -dir I -from 20 -to 0 ip_8_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 21 " [get_bd_cells ip_8_slice_and_concat/slice_2]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_2] [get_bd_pins ip_8_slice_and_concat/slice_2/din]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/slice_2/dout] [get_bd_pins ip_8_slice_and_concat/concat/In2]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 21 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_2] [get_bd_pins ip_2_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/vbram_alarm_out]
