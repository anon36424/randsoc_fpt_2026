...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options pipelined_streaming_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 2048 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x7ffff CONFIG.C_GPIO_WIDTH 19 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x7ffff " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1 CONFIG.C_DOUT_DEFAULT_2 0x3 CONFIG.C_GPIO2_WIDTH 11 CONFIG.C_GPIO_WIDTH 3 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x7 " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 20 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MASK 0x70d0bf540852b7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xcc1ac7cf0788181 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_9_dft/dft_0]
...
set_property -dict "CONFIG.a_precision_type Double CONFIG.a_tuser_width 74 CONFIG.add_sub_value Both CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Absolute " [get_bd_cells ip_12_floating_point/floating_point_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 5 CONFIG.convolution_code0 6 CONFIG.convolution_code1 22 CONFIG.convolution_code2 13 CONFIG.convolution_code3 4 CONFIG.convolution_code4 19 CONFIG.convolution_code5 25 CONFIG.convolution_code6 17 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 13 CONFIG.puncture_code0 11111001 CONFIG.puncture_code1 01111111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_13_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 256 " [get_bd_cells ip_15_fft/fft_0]
...
set_property -dict "CONFIG.C_BAUDRATE 128000 CONFIG.C_DATA_BITS 7 CONFIG.PARITY Even " [get_bd_cells ip_16_uartlite/uart_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 1024 " [get_bd_cells ip_19_fft/fft_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_21_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_22_dft/dft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 13 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_23_dft/dft_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_42_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_46_slice_and_concat/slice_4]
...
create_bd_pin -dir I -from 12 -to 0 ip_49_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_49_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_49_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_26_intc/irq_4] [get_bd_pins ip_10_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_26_intc/irq_5] [get_bd_pins ip_15_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_26_intc/irq_6] [get_bd_pins ip_16_uartlite/irq]
connect_bd_net [get_bd_pins ip_26_intc/irq_7] [get_bd_pins ip_18_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_26_intc/irq_8] [get_bd_pins ip_19_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_26_intc/irq_9] [get_bd_pins ip_21_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_27_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_microblaze/M_AXI_DP] [get_bd_intf_pins ip_27_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_27_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_27_axi/AXI_M4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_uartlite/AXI] [get_bd_intf_pins ip_27_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_27_axi/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_34_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_12_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_17_cordic/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_15_fft/M_AXIS_DATA]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/S_AXIS_DATA] [get_bd_intf_pins ip_19_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_dma/S_AXIS_STS] [get_bd_intf_pins ip_40_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_fft/S_AXIS_DATA] [get_bd_intf_pins ip_28_axis_broadcaster/M_AXIS_2]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/out0] [get_bd_pins ip_23_dft/XN_RE]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_3] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_4] [get_bd_pins ip_9_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_3] [get_bd_pins ip_23_dft/RFFD]
connect_bd_net [get_bd_pins ip_49_slice_and_concat/in_4] [get_bd_pins ip_23_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_56_slice_and_concat/out0] [get_bd_pins ip_23_dft/FD_IN]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_14_conv_encoder/aclken]
...
connect_bd_net [get_bd_pins ip_63_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/capturetrig0]
...
if {[catch {
  ...
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_41_axis_combiner/S_AXIS_1 declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_41_axis_combiner/S_AXIS_1 declared=224 actual=ERR $__err" }
if {[catch {
