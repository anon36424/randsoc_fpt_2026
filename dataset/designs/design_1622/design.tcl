...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 32 CONFIG.C_MEM3_TYPE 4 CONFIG.C_MEM3_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 4 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_PARITY_TYPE_MEM_3 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 2 CONFIG.C_TAVDV_PS_MEM_0 14380 CONFIG.C_TAVDV_PS_MEM_1 14724 CONFIG.C_TAVDV_PS_MEM_2 14401 CONFIG.C_TAVDV_PS_MEM_3 16186 CONFIG.C_TCEDV_PS_MEM_0 15921 CONFIG.C_TCEDV_PS_MEM_1 15622 CONFIG.C_TCEDV_PS_MEM_2 15482 CONFIG.C_TCEDV_PS_MEM_3 16326 CONFIG.C_THZCE_PS_MEM_0 6610 CONFIG.C_THZCE_PS_MEM_1 7388 CONFIG.C_THZCE_PS_MEM_2 6921 CONFIG.C_THZCE_PS_MEM_3 7374 CONFIG.C_THZOE_PS_MEM_0 7506 CONFIG.C_THZOE_PS_MEM_1 6836 CONFIG.C_THZOE_PS_MEM_2 7504 CONFIG.C_THZOE_PS_MEM_3 6476 CONFIG.C_TLZWE_PS_MEM_0 4719 CONFIG.C_TLZWE_PS_MEM_1 1866 CONFIG.C_TLZWE_PS_MEM_2 7482 CONFIG.C_TLZWE_PS_MEM_3 9916 CONFIG.C_TWC_PS_MEM_0 15570 CONFIG.C_TWC_PS_MEM_1 13646 CONFIG.C_TWC_PS_MEM_2 14322 CONFIG.C_TWC_PS_MEM_3 14944 CONFIG.C_TWPH_PS_MEM_0 12326 CONFIG.C_TWPH_PS_MEM_1 11713 CONFIG.C_TWPH_PS_MEM_2 12714 CONFIG.C_TWPH_PS_MEM_3 12471 CONFIG.C_TWP_PS_MEM_0 10987 CONFIG.C_TWP_PS_MEM_1 12351 CONFIG.C_TWP_PS_MEM_2 12626 CONFIG.C_TWP_PS_MEM_3 11359 CONFIG.C_WR_REC_TIME_MEM_0 29234 CONFIG.C_WR_REC_TIME_MEM_1 24637 CONFIG.C_WR_REC_TIME_MEM_2 27960 CONFIG.C_WR_REC_TIME_MEM_3 28190 " [get_bd_cells ip_3_emc/emc_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 19 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x7ffff " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 51 CONFIG.aresetn 0 CONFIG.bportwidth 35 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 11 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_gpio/AXI] [get_bd_intf_pins ip_11_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_12_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_14_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_12_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_13_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_floating_point/S_AXIS_C] [get_bd_intf_pins ip_22_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_13_axis_broadcaster/M_AXIS_3]
...
connect_bd_net [get_bd_pins ip_8_reset/interconnect_aresetn] [get_bd_pins ip_19_axis_combiner/aresetn]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_19_axis_combiner/aclk]
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_combiner/S_AXIS_2 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_combiner/S_AXIS_2 declared=64 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_19_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_combiner/M_AXIS declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_combiner/M_AXIS declared=80 actual=ERR $__err" }
if {[catch {
