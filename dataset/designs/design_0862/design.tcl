...
set_property -dict "CONFIG.C_MASK 0x3dc2b7ca57f165e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x510350874ff40c8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 5 " [get_bd_cells ip_12_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir O -from 38 -to 0 ip_13_slice_and_concat/out0
create_bd_pin -dir I -from 43 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 22 -to 0 ip_14_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_14_slice_and_concat/in_7
...
connect_bd_net [get_bd_pins ip_9_intc/irq_2] [get_bd_pins ip_6_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_10_axi/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_2_cordic/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_1] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_2] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_3] [get_bd_pins ip_4_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_4] [get_bd_pins ip_6_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_5] [get_bd_pins ip_6_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_6] [get_bd_pins ip_6_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_7] [get_bd_pins ip_6_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_2_cordic/aclken]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/ot_out]
