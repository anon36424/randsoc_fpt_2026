...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_0_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 33 CONFIG.Iterations 35 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 31 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 40 CONFIG.Round_Mode Truncate " [get_bd_cells ip_1_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 32 CONFIG.C_SDA_INERTIAL_DELAY 219 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 604.8869119652628 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 51 CONFIG.aresetn 0 CONFIG.bportwidth 30 CONFIG.btuserwidth 45 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 5 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 7 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x115c CONFIG.C_DOUT_DEFAULT_2 0x1ffff CONFIG.C_GPIO2_WIDTH 4 CONFIG.C_GPIO_WIDTH 17 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.AINIT_Value a9b0205a9f8d4adae32f84883a7d2faff006d91379375b31734a58673cccebc CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 200 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 254 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 199 -to 0 ip_8_accumulator/B
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 58 CONFIG.aresetn 0 CONFIG.bportwidth 59 CONFIG.btuserwidth 218 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 76 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_11_fft/fft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x30 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 199 CONFIG.C_SDA_INERTIAL_DELAY 97 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 950.6627681252829 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x65 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 8 CONFIG.C_SDA_INERTIAL_DELAY 202 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 277.7180609310869 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_14_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xbaa98991b19b9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x65d3b741e27ab80 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir O -from 56 -to 0 ip_34_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 253 -to 0 ip_34_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_34_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 199 -to 0 ip_35_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 253 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 254 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_4] [get_bd_pins ip_7_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_18_intc/irq_5] [get_bd_pins ip_11_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_18_intc/irq_6] [get_bd_pins ip_13_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_timer/S_AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_iic/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_19_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_gpio/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_19_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_19_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_iic/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_iic/AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_3] [get_bd_pins ip_8_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/capturetrig1]
