...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7b CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 42 CONFIG.C_SDA_INERTIAL_DELAY 38 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 629.9382821022322 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x39dec3bc1e74ae3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6651a9c7a698334 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 256 CONFIG.C_SPI_MEMORY 1 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_4_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 11 CONFIG.aresetn 0 CONFIG.atuserwidth 171 CONFIG.bportwidth 57 CONFIG.ctrltuserwidth 146 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 66 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 14298 CONFIG.C_TCEDV_PS_MEM_0 15352 CONFIG.C_THZCE_PS_MEM_0 6610 CONFIG.C_THZOE_PS_MEM_0 6387 CONFIG.C_TLZWE_PS_MEM_0 5531 CONFIG.C_TWC_PS_MEM_0 14870 CONFIG.C_TWPH_PS_MEM_0 11747 CONFIG.C_TWP_PS_MEM_0 10850 CONFIG.C_WR_REC_TIME_MEM_0 29435 " [get_bd_cells ip_8_emc/emc_0]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_20_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S2]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_0] [get_bd_pins ip_1_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_9_conv_encoder/aclken]
