...
create_bd_pin -dir O -from 32 -to 0 ip_8_slice_and_concat/out0
...
create_bd_pin -dir I -from 44 -to 0 ip_8_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_8_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 45 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_2_accumulator/Q]
