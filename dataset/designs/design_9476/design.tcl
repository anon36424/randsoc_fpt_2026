...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 13 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 8 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_5_dft/dft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 57 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_MI 3 CONFIG.NUM_SI 3 " [get_bd_cells ip_11_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 64 " [get_bd_cells ip_12_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_14_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.NUM_PORTS 9 " [get_bd_cells ip_17_slice_and_concat/concat]
...
create_bd_pin -dir I -from 17 -to 0 ip_17_slice_and_concat/in_8
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_8
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_8]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_17_slice_and_concat/slice_8]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_8] [get_bd_pins ip_17_slice_and_concat/slice_8/din]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/slice_8/dout] [get_bd_pins ip_17_slice_and_concat/concat/In8]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_22_slice_and_concat/slice_6]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_0] [get_bd_pins ip_4_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_10_intc/irq_1] [get_bd_pins ip_7_axi_cdma/cdma_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_11_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_11_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/M_AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_11_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_11_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_intc/AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_4_axi_dma/M_AXIS_MM2S]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_5_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_0_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_4] [get_bd_pins ip_1_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_6] [get_bd_pins ip_1_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_7] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_8] [get_bd_pins ip_2_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_5] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_6] [get_bd_pins ip_5_dft/XK_IM]
...
if {[catch {
  ...
  set __s [expr {$__aw == 512 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/S_AXIS declared=512 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_dwidth_converter/S_AXIS declared=512 actual=ERR $__err" }
if {[catch {
