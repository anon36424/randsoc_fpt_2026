...
set_property -dict "CONFIG.C_MASK 0x7c5b3c308fa6a2b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x80ddbae7482121 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_17_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 12 -to 0 ip_18_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_18_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_microblaze/M_AXI_DP] [get_bd_intf_pins ip_11_axi/AXI_M0]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_2] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_3] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_2_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_6] [get_bd_pins ip_4_xadc_wiz/busy_out]
