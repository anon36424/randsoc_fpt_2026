...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 50 CONFIG.aresetn 0 CONFIG.atuserwidth 54 CONFIG.bportwidth 44 CONFIG.btuserwidth 188 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 31 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 95 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x51 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 161 CONFIG.C_SDA_INERTIAL_DELAY 65 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 732.0617369664837 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x75 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 215 CONFIG.C_SDA_INERTIAL_DELAY 30 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 843.6006108393913 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 32 CONFIG.C_GPIO_WIDTH 25 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 31 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x7fffffff " [get_bd_cells ip_6_gpio/gpio_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_17_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_4] [get_bd_pins ip_7_dft/XK_RE]
