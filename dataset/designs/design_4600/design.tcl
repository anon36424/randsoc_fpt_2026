...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 117 CONFIG.convolution_code1 308 CONFIG.convolution_code2 481 CONFIG.convolution_code3 436 CONFIG.convolution_code4 210 CONFIG.convolution_code5 158 CONFIG.convolution_code6 266 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 7 CONFIG.output_rate 10 CONFIG.puncture_code0 1111101 CONFIG.puncture_code1 0110101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_4_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x29 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 4 CONFIG.C_SDA_INERTIAL_DELAY 90 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 741.3649278524841 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x51 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 23 CONFIG.C_SDA_INERTIAL_DELAY 244 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 587.3636198590135 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x17317aee9da453f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x7e167def1812efa CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 28 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 41 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 14 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_15_dft/dft_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 15 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_17_dft/dft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x357ad953 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_18_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 14 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 33 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_19_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 13 -to 0 ip_19_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x3468b5dcfb4f819 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_20_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe0ec94b86ecc59b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_20_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_32_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 33 -to 0 ip_41_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_41_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 34 " [get_bd_cells ip_41_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 27 -to 0 ip_42_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 34 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_43_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_44_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_46_slice_and_concat/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_47_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 32 -to 0 ip_48_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_48_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_48_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_49_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_50_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_21_reset/peripheral_areset_n] [get_bd_pins ip_9_xadc_wiz/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_21_reset/peripheral_areset_n] [get_bd_pins ip_10_axi_iic/reset]
connect_bd_net [get_bd_pins ip_21_reset/interconnect_aresetn] [get_bd_pins ip_11_complex_multiplier/aresetn]
...
connect_bd_net [get_bd_pins ip_21_reset/interconnect_aresetn] [get_bd_pins ip_16_cordic/aresetn]
...
connect_bd_net [get_bd_pins ip_22_clk_wiz/clk_out] [get_bd_pins ip_9_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_1] [get_bd_pins ip_3_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_4] [get_bd_pins ip_7_axi_iic/irq]
connect_bd_net [get_bd_pins ip_23_intc/irq_5] [get_bd_pins ip_9_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_23_intc/irq_6] [get_bd_pins ip_10_axi_iic/irq]
connect_bd_net [get_bd_pins ip_23_intc/irq_7] [get_bd_pins ip_18_gpio/irq]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_3] [get_bd_pins ip_6_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_4] [get_bd_pins ip_7_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_5] [get_bd_pins ip_9_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_24_intc/irq_6] [get_bd_pins ip_10_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_7] [get_bd_pins ip_18_gpio/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_microblaze/INTERRUPT] [get_bd_intf_pins ip_24_intc/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_25_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_25_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_microblaze/M_AXI_DP] [get_bd_intf_pins ip_25_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_timer/S_AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_timer/S_AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_iic/AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_iic/AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_gpio/AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_intc/AXI] [get_bd_intf_pins ip_25_axi_legacy/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_35_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_cordic/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_1] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_17_dft/SIZE]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_0] [get_bd_pins ip_6_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_1] [get_bd_pins ip_9_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_2] [get_bd_pins ip_9_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_3] [get_bd_pins ip_9_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_4] [get_bd_pins ip_13_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_1] [get_bd_pins ip_15_dft/RFFD]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_2] [get_bd_pins ip_15_dft/XK_RE]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_3] [get_bd_pins ip_15_dft/XK_IM]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_4] [get_bd_pins ip_15_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_5] [get_bd_pins ip_15_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_6] [get_bd_pins ip_15_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_48_slice_and_concat/in_4] [get_bd_pins ip_19_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_53_slice_and_concat/out0] [get_bd_pins ip_15_dft/CE]
connect_bd_net [get_bd_pins ip_54_slice_and_concat/out0] [get_bd_pins ip_15_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_16_cordic/aclken]
connect_bd_net [get_bd_pins ip_56_slice_and_concat/out0] [get_bd_pins ip_9_xadc_wiz/convst_in]
connect_bd_net [get_bd_pins ip_57_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_58_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/C_IN]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_19_accumulator/SCLR]
...
connect_bd_net [get_bd_pins ip_63_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_65_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_71_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vccint_alarm_out]
