...
set_property -dict "CONFIG.C_ADDR_WIDTH 47 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MASK 0x9053ecffc94ba65 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x95d5f18ff326aa CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_SPI_MEMORY 1 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_6_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_16_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_18_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_19_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_20_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_13_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_uartlite/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_uartlite/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S4]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_2] [get_bd_pins ip_7_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_3] [get_bd_pins ip_7_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_4] [get_bd_pins ip_7_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_5] [get_bd_pins ip_7_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_7_xadc_wiz/convst_in]
