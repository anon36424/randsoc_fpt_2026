...
create_bd_pin -dir O -from 218 -to 0 ip_1_accumulator/Q
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 12 CONFIG.aresetn 1 CONFIG.atuserwidth 227 CONFIG.bportwidth 28 CONFIG.btuserwidth 211 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 8 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x69 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 74 CONFIG.C_SDA_INERTIAL_DELAY 89 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 541.4282291491434 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 41 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 218 -to 0 ip_22_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 219 " [get_bd_cells ip_22_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 219 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 219 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 219 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 219 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 215 -to 0 ip_27_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 218 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 219 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_1] [get_bd_pins ip_8_uartlite/irq]
connect_bd_net [get_bd_pins ip_12_intc/irq_2] [get_bd_pins ip_9_axi_iic/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_uartlite/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_iic/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_2] [get_bd_pins ip_2_dft/XK_RE]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_3] [get_bd_pins ip_2_dft/XK_IM]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_4] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_5] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_6] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_7] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_8] [get_bd_pins ip_7_dft/XK_RE]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_9] [get_bd_pins ip_7_dft/XK_IM]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_10] [get_bd_pins ip_7_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_11] [get_bd_pins ip_7_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_12] [get_bd_pins ip_7_dft/DATA_VALID]
