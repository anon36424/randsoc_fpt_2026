...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 12 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_0_dft/dft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 33 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 4 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 27 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_BAUDRATE 1200 CONFIG.C_DATA_BITS 8 CONFIG.PARITY No_Parity " [get_bd_cells ip_6_uartlite/uart_0]
...
set_property -dict "CONFIG.NUM_MI 7 CONFIG.NUM_SI 1 " [get_bd_cells ip_11_axi_legacy/axi_0]
...
create_bd_pin -dir I -from 55 -to 0 ip_12_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 56 " [get_bd_cells ip_12_reduce/slice_31]
...
create_bd_pin -dir I -from 11 -to 0 ip_13_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_13_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 11 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_14_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_14_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 11 -to 0 ip_15_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 26 -to 0 ip_16_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 27 " [get_bd_cells ip_16_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 3 -to 0 ip_17_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 27 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 55 -to 0 ip_18_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 27 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 40 -to 0 ip_18_slice_and_concat/in_1
...
connect_bd_net [get_bd_pins ip_8_reset/peripheral_areset_n] [get_bd_pins ip_2_axi_quad_spi/reset4]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_2_axi_quad_spi/clk4]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_0] [get_bd_pins ip_1_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_11_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_11_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_11_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_11_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_uartlite/AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_intc/AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_S6]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_IM]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_0] [get_bd_pins ip_0_dft/RFFD]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_1] [get_bd_pins ip_0_dft/XK_RE]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_0_dft/SIZE]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_RE]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_1] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_0_dft/XN_RE]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_0_dft/XK_IM]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_1] [get_bd_pins ip_0_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_2] [get_bd_pins ip_0_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/B]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_0] [get_bd_pins ip_0_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_12_reduce/in0]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/ADD]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/SCLR]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/ADD]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_0_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_0_dft/FD_IN]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/SCLR]
