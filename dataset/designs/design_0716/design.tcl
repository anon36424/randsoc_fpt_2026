...
set_property -dict "CONFIG.C_ADDR_WIDTH 34 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 256 CONFIG.Latency 11 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 257 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 255 -to 0 ip_2_accumulator/B
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x2ff1e7 CONFIG.C_GPIO_WIDTH 25 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x6e3183 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 64 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_SYNCH_PIPEDELAY_0 2 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_1 15900 CONFIG.C_TAVDV_PS_MEM_2 15685 CONFIG.C_TCEDV_PS_MEM_1 15040 CONFIG.C_TCEDV_PS_MEM_2 16191 CONFIG.C_THZCE_PS_MEM_1 7574 CONFIG.C_THZCE_PS_MEM_2 6777 CONFIG.C_THZOE_PS_MEM_1 6697 CONFIG.C_THZOE_PS_MEM_2 7658 CONFIG.C_TLZWE_PS_MEM_1 1464 CONFIG.C_TLZWE_PS_MEM_2 6276 CONFIG.C_TWC_PS_MEM_1 15676 CONFIG.C_TWC_PS_MEM_2 14519 CONFIG.C_TWPH_PS_MEM_1 11330 CONFIG.C_TWPH_PS_MEM_2 11493 CONFIG.C_TWP_PS_MEM_1 11744 CONFIG.C_TWP_PS_MEM_2 13031 CONFIG.C_WR_REC_TIME_MEM_1 27929 CONFIG.C_WR_REC_TIME_MEM_2 28686 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 9 CONFIG.aresetn 1 CONFIG.atuserwidth 70 CONFIG.bportwidth 58 CONFIG.btuserwidth 195 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 28 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_11_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x8b3 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 31 CONFIG.C_GPIO_WIDTH 12 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_12_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_MI 12 CONFIG.NUM_SI 6 " [get_bd_cells ip_16_axi/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 255 -to 0 ip_28_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_5] [get_bd_pins ip_8_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_6] [get_bd_pins ip_8_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_7] [get_bd_pins ip_10_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_8] [get_bd_pins ip_10_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_cdma/M_AXI] [get_bd_intf_pins ip_16_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_16_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI] [get_bd_intf_pins ip_16_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_16_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_16_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_16_axi/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_16_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_16_axi/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_16_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_emc/AXI] [get_bd_intf_pins ip_16_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_gpio/AXI] [get_bd_intf_pins ip_16_axi/AXI_S10]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_1] [get_bd_pins ip_7_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_2] [get_bd_pins ip_7_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_3] [get_bd_pins ip_7_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_7_xadc_wiz/convst_in]
