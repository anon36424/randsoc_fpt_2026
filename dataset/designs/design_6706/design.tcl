...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 38 CONFIG.aresetn 1 CONFIG.atuserwidth 167 CONFIG.bportwidth 60 CONFIG.btuserwidth 95 CONFIG.ctrltuserwidth 210 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 80 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x1eb CONFIG.C_DOUT_DEFAULT_2 0x1ff CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_26_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_0] [get_bd_pins ip_4_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_gpio/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_gpio/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_4] [get_bd_pins ip_2_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_5] [get_bd_pins ip_2_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_6] [get_bd_pins ip_2_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_7] [get_bd_pins ip_2_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_8] [get_bd_pins ip_2_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_9] [get_bd_pins ip_2_xadc_wiz/jtagbusy_out]
