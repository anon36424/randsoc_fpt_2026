...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 17 CONFIG.Latency 9 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 155 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 129 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 191 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 64 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 2 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 3 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 2 -to 0 ip_8_accumulator/Q
...
create_bd_pin -dir I -from 200 -to 0 ip_17_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 86 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 87 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 110 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 116 CONFIG.DIN_TO 111 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 122 CONFIG.DIN_TO 117 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 123 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 140 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 141 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 152 CONFIG.DIN_TO 147 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 158 CONFIG.DIN_TO 153 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 164 CONFIG.DIN_TO 159 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 165 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 176 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 182 CONFIG.DIN_TO 177 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 188 CONFIG.DIN_TO 183 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 194 CONFIG.DIN_TO 189 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 200 CONFIG.DIN_TO 195 CONFIG.DIN_WIDTH 201 " [get_bd_cells ip_17_reduce/slice_31]
...
create_bd_pin -dir I -from 154 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 200 -to 0 ip_19_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 154 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 154 CONFIG.DIN_TO 17 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 190 -to 0 ip_19_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 190 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 191 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 2 -to 0 ip_21_slice_and_concat/in_1
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_14_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_3_conv_encoder/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_DATA] [get_bd_intf_pins ip_16_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_13_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/ADD]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/SCLR]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/ADD]
