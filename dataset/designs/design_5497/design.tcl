...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6f CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 245 CONFIG.C_SDA_INERTIAL_DELAY 188 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 559.4013702174716 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 8 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_4_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x34 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 167 CONFIG.C_SDA_INERTIAL_DELAY 111 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 744.9127251281772 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x318246891e6a06e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe2a7eaefec4f41a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_PORTS 10 " [get_bd_cells ip_13_slice_and_concat/concat]
...
create_bd_pin -dir I -from 11 -to 0 ip_13_slice_and_concat/in_3
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_iic/AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/temp_out]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_7] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_8] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_9] [get_bd_pins ip_4_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vbram_alarm_out]
