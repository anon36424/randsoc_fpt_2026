...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 49 CONFIG.Latency 30 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 62 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 61 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.C_MASK 0x7c18a6c9d3cae4e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x54978e45f85df0c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 61 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 62 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 61 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 62 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 61 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 62 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 61 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 61 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 62 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_13_slice_and_concat/in_2
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_13_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_2] [get_bd_pins ip_2_dft/XK_RE]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_3] [get_bd_pins ip_2_dft/XK_IM]
