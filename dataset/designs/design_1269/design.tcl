...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 8 CONFIG.convolution_code0 104 CONFIG.convolution_code1 175 CONFIG.convolution_code2 202 CONFIG.convolution_code3 195 CONFIG.convolution_code4 152 CONFIG.convolution_code5 33 CONFIG.convolution_code6 78 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 6 CONFIG.output_rate 8 CONFIG.puncture_code0 010111 CONFIG.puncture_code1 101110 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_6_axi/AXI_S0]
