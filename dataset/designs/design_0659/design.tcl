...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 19 CONFIG.aresetn 0 CONFIG.atuserwidth 59 CONFIG.bportwidth 8 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 48 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 18 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 34 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 8 CONFIG.aresetn 0 CONFIG.bportwidth 53 CONFIG.btuserwidth 159 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 17 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_5_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 60 CONFIG.aresetn 1 CONFIG.atuserwidth 123 CONFIG.bportwidth 11 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 57 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_8_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 7 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 7 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_12_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 6 -to 0 ip_12_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 138 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 152 CONFIG.SCLR 0 CONFIG.SINIT 1 CONFIG.SINIT_Value ffffffffffffffffffffffffffffffffffffff CONFIG.SSET 0 CONFIG.Scale 7 " [get_bd_cells ip_13_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_13_accumulator/SINIT
connect_bd_net [get_bd_pins ip_13_accumulator/SINIT] [get_bd_pins ip_13_accumulator/accumulator_0/SINIT]
...
set_property -dict "CONFIG.C_BAUDRATE 19200 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Odd " [get_bd_cells ip_15_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_16_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 8 CONFIG.S_TDATA_NUM_BYTES 48 " [get_bd_cells ip_28_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 7 " [get_bd_cells ip_29_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 48 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_36_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 6 -to 0 ip_37_slice_and_concat/in_9
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_9] [get_bd_pins ip_37_slice_and_concat/concat/In9]
create_bd_pin -dir I -from 151 -to 0 ip_37_slice_and_concat/in_10
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_10
move_bd_cells [get_bd_cells ip_37_slice_and_concat] [get_bd_cells slice_10]
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 152 " [get_bd_cells ip_37_slice_and_concat/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 152 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 151 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 152 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_uartlite/AXI] [get_bd_intf_pins ip_20_axi_legacy/AXI_S7]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_6] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_7] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_8] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_9] [get_bd_pins ip_12_accumulator/Q]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_10] [get_bd_pins ip_13_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_44_slice_and_concat/out0] [get_bd_pins ip_13_accumulator/SINIT]
...
if {[catch {
  ...
  set __s [expr {$__aw == 56 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_32_axis_combiner/S_AXIS_0 declared=56 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_32_axis_combiner/S_AXIS_0 declared=56 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 384 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_dwidth_converter/M_AXIS declared=384 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_dwidth_converter/M_AXIS declared=384 actual=ERR $__err" }
