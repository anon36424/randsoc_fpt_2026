...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 1024 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_1_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 2 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 14539 CONFIG.C_TAVDV_PS_MEM_1 15572 CONFIG.C_TCEDV_PS_MEM_0 13675 CONFIG.C_TCEDV_PS_MEM_1 13906 CONFIG.C_THZCE_PS_MEM_0 7242 CONFIG.C_THZCE_PS_MEM_1 6467 CONFIG.C_THZOE_PS_MEM_0 7678 CONFIG.C_THZOE_PS_MEM_1 6836 CONFIG.C_TLZWE_PS_MEM_0 4238 CONFIG.C_TLZWE_PS_MEM_1 7969 CONFIG.C_TWC_PS_MEM_0 14740 CONFIG.C_TWC_PS_MEM_1 15914 CONFIG.C_TWPH_PS_MEM_0 12542 CONFIG.C_TWPH_PS_MEM_1 12244 CONFIG.C_TWP_PS_MEM_0 11692 CONFIG.C_TWP_PS_MEM_1 13091 CONFIG.C_WR_REC_TIME_MEM_0 25881 CONFIG.C_WR_REC_TIME_MEM_1 25944 " [get_bd_cells ip_3_emc/emc_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 2048 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 3 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_14_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_0_fft/M_AXIS_DATA]
...
if {[catch {
  ...
  set __s [expr {$__aw == 27 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/M_AXIS declared=27 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_13_axis_dwidth_converter/M_AXIS declared=27 actual=ERR $__err" }
if {[catch {
