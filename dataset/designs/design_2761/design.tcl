...
create_bd_pin -dir I -from 9 -to 0 ip_10_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_10_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_11_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 6 -to 0 ip_12_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_3] [get_bd_pins ip_4_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_uartlite/AXI] [get_bd_intf_pins ip_9_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_timer/S_AXI] [get_bd_intf_pins ip_9_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_intc/AXI] [get_bd_intf_pins ip_9_axi/AXI_S4]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_5_dft/XN_IM]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_1] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_2] [get_bd_pins ip_3_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_3] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_4] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_5] [get_bd_pins ip_4_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_6] [get_bd_pins ip_5_dft/RFFD]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_7] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/out0] [get_bd_pins ip_5_dft/XN_RE]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_5_dft/XK_RE]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_5_dft/XK_IM]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_0] [get_bd_pins ip_5_dft/XK_IM]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_5_dft/SIZE]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_0] [get_bd_pins ip_5_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_1] [get_bd_pins ip_5_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_2] [get_bd_pins ip_5_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_5_dft/FD_IN]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_5_dft/FWD_INV]
