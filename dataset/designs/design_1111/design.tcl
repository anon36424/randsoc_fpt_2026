...
set_property -dict "CONFIG.C_MASK 0x1631774e3328ec CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe9eee739a8c2a74 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 48 CONFIG.C_SDA_INERTIAL_DELAY 19 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 412.993849867764 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.AINIT_Value fffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 200 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 204 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 203 -to 0 ip_4_accumulator/Q
...
set_property -dict "CONFIG.C_ADDR_WIDTH 47 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 21 CONFIG.aresetn 0 CONFIG.bportwidth 41 CONFIG.btuserwidth 34 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 38 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_10_dft/dft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 17 CONFIG.aresetn 1 CONFIG.atuserwidth 68 CONFIG.bportwidth 22 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 23 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 22 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_11_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_24_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 203 -to 0 ip_34_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 204 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 204 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 204 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 204 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 204 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 199 -to 0 ip_39_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 203 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 204 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_39_slice_and_concat/in_3
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_iic/AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S1]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_3] [get_bd_pins ip_10_dft/XK_IM]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_4] [get_bd_pins ip_10_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_5] [get_bd_pins ip_10_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_6] [get_bd_pins ip_10_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_7] [get_bd_pins ip_13_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_8] [get_bd_pins ip_13_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_9] [get_bd_pins ip_13_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_10] [get_bd_pins ip_13_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_11] [get_bd_pins ip_13_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_12] [get_bd_pins ip_13_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_10_dft/CE]
