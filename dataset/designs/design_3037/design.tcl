...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 177 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 177 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 195 CONFIG.Latency 5 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 200 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 194 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 64 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 242 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 39 CONFIG.Iterations 30 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 10 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 12 CONFIG.Round_Mode Truncate " [get_bd_cells ip_3_cordic/cordic_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 41 CONFIG.Iterations 32 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 8 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 29 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_4_cordic/cordic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 33 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 43 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 192 -to 0 ip_21_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 78 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 79 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 96 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 102 CONFIG.DIN_TO 97 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 108 CONFIG.DIN_TO 103 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 109 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 126 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 132 CONFIG.DIN_TO 127 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 138 CONFIG.DIN_TO 133 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 144 CONFIG.DIN_TO 139 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 150 CONFIG.DIN_TO 145 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 156 CONFIG.DIN_TO 151 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 162 CONFIG.DIN_TO 157 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 168 CONFIG.DIN_TO 163 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 174 CONFIG.DIN_TO 169 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 180 CONFIG.DIN_TO 175 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 186 CONFIG.DIN_TO 181 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 192 CONFIG.DIN_TO 187 CONFIG.DIN_WIDTH 193 " [get_bd_cells ip_21_reduce/slice_31]
...
create_bd_pin -dir O -from 192 -to 0 ip_22_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 176 -to 0 ip_22_slice_and_concat/in_0
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_0] [get_bd_pins ip_22_slice_and_concat/concat/In0]
create_bd_pin -dir I -from 199 -to 0 ip_22_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 200 " [get_bd_cells ip_22_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 199 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 200 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 194 -to 0 ip_24_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 199 -to 0 ip_24_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 199 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 200 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 241 -to 0 ip_24_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_24_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_24_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 87 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 241 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 88 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 121 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 122 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 176 -to 0 ip_29_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 241 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 42 -to 0 ip_29_slice_and_concat/in_1
...
connect_bd_net [get_bd_pins ip_15_intc/irq_0] [get_bd_pins ip_8_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_1] [get_bd_pins ip_8_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_15_intc/irq_2] [get_bd_pins ip_9_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_15_intc/irq_3] [get_bd_pins ip_10_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_16_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_16_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_16_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_16_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_2_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_2] [get_bd_pins ip_7_dft/RFFD]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_3] [get_bd_pins ip_7_dft/XK_RE]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_4] [get_bd_pins ip_7_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/SCLR]
