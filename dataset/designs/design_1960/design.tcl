...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x72 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 194 CONFIG.C_SDA_INERTIAL_DELAY 204 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 970.9348343871358 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 194 CONFIG.Latency 28 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 225 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 193 -to 0 ip_3_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x3f5db27a386cdc2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x80d9d04d870932a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 224 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 225 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 193 -to 0 ip_11_slice_and_concat/out0
create_bd_pin -dir I -from 224 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 194 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 225 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 29 -to 0 ip_12_slice_and_concat/out0
create_bd_pin -dir I -from 224 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 224 CONFIG.DIN_TO 195 CONFIG.DIN_WIDTH 225 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/ADD]
