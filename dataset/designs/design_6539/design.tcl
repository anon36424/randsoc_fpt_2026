...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 15067 CONFIG.C_TAVDV_PS_MEM_1 15582 CONFIG.C_TCEDV_PS_MEM_0 14115 CONFIG.C_TCEDV_PS_MEM_1 16260 CONFIG.C_THZCE_PS_MEM_0 7210 CONFIG.C_THZCE_PS_MEM_1 7187 CONFIG.C_THZOE_PS_MEM_0 7554 CONFIG.C_THZOE_PS_MEM_1 7618 CONFIG.C_TLZWE_PS_MEM_0 9933 CONFIG.C_TLZWE_PS_MEM_1 3913 CONFIG.C_TWC_PS_MEM_0 15341 CONFIG.C_TWC_PS_MEM_1 16213 CONFIG.C_TWPH_PS_MEM_0 12149 CONFIG.C_TWPH_PS_MEM_1 12032 CONFIG.C_TWP_PS_MEM_0 10913 CONFIG.C_TWP_PS_MEM_1 13165 CONFIG.C_WR_REC_TIME_MEM_0 28286 CONFIG.C_WR_REC_TIME_MEM_1 27386 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5d CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 220 CONFIG.C_SDA_INERTIAL_DELAY 235 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 700.8721764346495 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 2048 " [get_bd_cells ip_5_fft/fft_0]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_6] [get_bd_pins ip_7_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_11_axi_legacy/AXI_M0]
...
if {[catch {
  ...
  set __s [expr {$__aw == 31 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_14_axis_dwidth_converter/M_AXIS declared=31 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_axis_dwidth_converter/M_AXIS declared=31 actual=ERR $__err" }
if {[catch {
