...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 43 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 44 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 43 -to 0 ip_11_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_11_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_9_axi/AXI_S0]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_6] [get_bd_pins ip_1_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vccint_alarm_out]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vccaux_alarm_out]
