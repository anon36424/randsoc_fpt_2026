...
set_property -dict "CONFIG.C_MASK 0x128c9fee6483b6d CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x9a66d2b93571507 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BAUDRATE 128000 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Odd " [get_bd_cells ip_2_uartlite/uart_0]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/capturetrig1]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_0_xadc_wiz/convst_in]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vbram_alarm_out]
