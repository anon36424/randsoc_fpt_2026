...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 170 CONFIG.Latency 29 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 244 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 169 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 6 CONFIG.C_TAVDV_PS_MEM_0 15751 CONFIG.C_TAVDV_PS_MEM_1 14522 CONFIG.C_TAVDV_PS_MEM_2 15335 CONFIG.C_TCEDV_PS_MEM_0 14275 CONFIG.C_TCEDV_PS_MEM_1 14697 CONFIG.C_TCEDV_PS_MEM_2 15785 CONFIG.C_THZCE_PS_MEM_0 7542 CONFIG.C_THZCE_PS_MEM_1 6485 CONFIG.C_THZCE_PS_MEM_2 7114 CONFIG.C_THZOE_PS_MEM_0 7654 CONFIG.C_THZOE_PS_MEM_1 6511 CONFIG.C_THZOE_PS_MEM_2 6710 CONFIG.C_TLZWE_PS_MEM_0 2874 CONFIG.C_TLZWE_PS_MEM_1 1176 CONFIG.C_TLZWE_PS_MEM_2 7738 CONFIG.C_TWC_PS_MEM_0 15574 CONFIG.C_TWC_PS_MEM_1 15698 CONFIG.C_TWC_PS_MEM_2 15246 CONFIG.C_TWPH_PS_MEM_0 12360 CONFIG.C_TWPH_PS_MEM_1 12268 CONFIG.C_TWPH_PS_MEM_2 10987 CONFIG.C_TWP_PS_MEM_0 12087 CONFIG.C_TWP_PS_MEM_1 12000 CONFIG.C_TWP_PS_MEM_2 11996 CONFIG.C_WR_REC_TIME_MEM_0 24416 CONFIG.C_WR_REC_TIME_MEM_1 26329 CONFIG.C_WR_REC_TIME_MEM_2 29272 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.NUM_MI 8 CONFIG.NUM_SI 1 " [get_bd_cells ip_11_axi/axi_0]
...
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 ip_11_axi/AXI_S7
connect_bd_intf_net [get_bd_intf_pins ip_11_axi/AXI_S7] [get_bd_intf_pins ip_11_axi/axi_0/M07_AXI]
...
create_bd_pin -dir O -from 169 -to 0 ip_14_slice_and_concat/out0
create_bd_pin -dir I -from 243 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 244 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 76 -to 0 ip_15_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 243 -to 0 ip_15_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 243 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 244 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_reset/peripheral_areset_n] [get_bd_pins ip_3_axi_quad_spi/reset4]
...
connect_bd_net [get_bd_pins ip_8_reset/peripheral_areset_n] [get_bd_pins ip_6_emc/rst]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_3_axi_quad_spi/clk4]
...
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_6_emc/clk]
connect_bd_net [get_bd_pins ip_9_clk_wiz/clk_out] [get_bd_pins ip_6_emc/rdclk]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_2] [get_bd_pins ip_4_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_10_intc/irq_3] [get_bd_pins ip_7_axi_quad_spi/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_11_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_11_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_11_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_timer/S_AXI] [get_bd_intf_pins ip_11_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_emc/AXI] [get_bd_intf_pins ip_11_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_emc/AXI] [get_bd_intf_pins ip_11_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_11_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_intc/AXI] [get_bd_intf_pins ip_11_axi/AXI_S7]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_3] [get_bd_pins ip_4_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_4_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_4_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/CE]
