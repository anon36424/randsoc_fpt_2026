...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x60 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 179 CONFIG.C_SDA_INERTIAL_DELAY 249 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 879.0594395727212 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x7d8b4b2c190f847 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xa1a9c1bb62f576e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x36 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 164 CONFIG.C_SDA_INERTIAL_DELAY 14 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 633.2569500559315 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 19 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 46 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3e CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 110 CONFIG.C_SDA_INERTIAL_DELAY 27 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 858.5242134520735 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xb CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 183 CONFIG.C_SDA_INERTIAL_DELAY 49 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 461.4805625577487 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_7] [get_bd_pins ip_11_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S6]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_9_conv_encoder/aclken]
