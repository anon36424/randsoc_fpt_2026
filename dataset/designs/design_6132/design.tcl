...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 24 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_3_dft/dft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x666 CONFIG.C_DOUT_DEFAULT_2 0x982 CONFIG.C_GPIO2_WIDTH 19 CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x1fff CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 4 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 26 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x71 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 178 CONFIG.C_SDA_INERTIAL_DELAY 57 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 743.6135156562436 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 41 CONFIG.aresetn 1 CONFIG.atuserwidth 185 CONFIG.bportwidth 45 CONFIG.btuserwidth 94 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 37 CONFIG.roundmode Truncate " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_9_fft/fft_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 25 CONFIG.Iterations 33 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 37 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 46 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_10_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x7ffffff CONFIG.C_GPIO_WIDTH 27 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x745815d " [get_bd_cells ip_11_gpio/gpio_0]
...
set_property -dict "CONFIG.C_BAUDRATE 57600 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Odd " [get_bd_cells ip_14_uartlite/uart_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Arc_Tanh CONFIG.Input_Width 32 CONFIG.Iterations 24 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 39 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 47 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_15_cordic/cordic_0]
...
create_bd_pin -dir I -from 25 -to 0 ip_39_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_39_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 26 " [get_bd_cells ip_39_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 26 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 25 -to 0 ip_41_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_41_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 26 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 26 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_6] [get_bd_pins ip_14_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_jtag_axi/M_AXI] [get_bd_intf_pins ip_23_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_23_axi/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_23_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_8_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_1] [get_bd_pins ip_18_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_2] [get_bd_pins ip_18_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/in_3] [get_bd_pins ip_18_axi_timer/pwm0]
...
if {[catch {
  ...
  set __s [expr {$__aw == 352 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_36_axis_combiner/S_AXIS_2 declared=352 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_36_axis_combiner/S_AXIS_2 declared=352 actual=ERR $__err" }
if {[catch {
