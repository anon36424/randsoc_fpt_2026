...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 36 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 48 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 35 -to 0 ip_11_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 48 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_emc/AXI] [get_bd_intf_pins ip_9_axi/AXI_S3]
