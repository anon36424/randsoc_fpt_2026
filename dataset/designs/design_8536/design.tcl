...
set_property -dict "CONFIG.C_MASK 0x518cd309d5ccabe CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xb642a27007a48cf CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_4] [get_bd_pins ip_0_xadc_wiz/alarm_out]
