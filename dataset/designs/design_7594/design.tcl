...
set_property -dict "CONFIG.C_MASK 0xfc65750cdb7e9de CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x7df927fcf68e3ed CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 50 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_4_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 8 CONFIG.aresetn 1 CONFIG.bportwidth 59 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 29 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 29 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_5_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 14 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_8_dft/dft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 28 CONFIG.aresetn 1 CONFIG.atuserwidth 38 CONFIG.bportwidth 40 CONFIG.ctrltuserwidth 56 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 66 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_11_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x58 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 211 CONFIG.C_SDA_INERTIAL_DELAY 80 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 91.0576302615101 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_14_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 45 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_15_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3c CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 74 CONFIG.C_SDA_INERTIAL_DELAY 75 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 143.7121833405312 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_19_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.a_precision_type Uint32 CONFIG.add_sub_value Both CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 1 CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Fixed_to_float CONFIG.result_precision_type Double CONFIG.result_tlast_behv Pass_A_TLAST " [get_bd_cells ip_21_floating_point/floating_point_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_44_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_48_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_48_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_48_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_49_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_22_reset/peripheral_areset_n] [get_bd_pins ip_20_xadc_wiz/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_20_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_11] [get_bd_pins ip_19_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_12] [get_bd_pins ip_20_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_cdma/M_AXI] [get_bd_intf_pins ip_25_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_uartlite/AXI] [get_bd_intf_pins ip_25_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_iic/AXI] [get_bd_intf_pins ip_25_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_25_axi/AXI_S11]
...
connect_bd_net [get_bd_pins ip_48_slice_and_concat/in_2] [get_bd_pins ip_17_dft/RFFD]
connect_bd_net [get_bd_pins ip_48_slice_and_concat/in_3] [get_bd_pins ip_17_dft/XK_RE]
connect_bd_net [get_bd_pins ip_48_slice_and_concat/in_4] [get_bd_pins ip_17_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_50_slice_and_concat/in_0] [get_bd_pins ip_17_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_53_slice_and_concat/in_0] [get_bd_pins ip_20_xadc_wiz/vccaux_alarm_out]
...
connect_bd_net [get_bd_pins ip_54_slice_and_concat/in_0] [get_bd_pins ip_20_xadc_wiz/ot_out]
...
connect_bd_net [get_bd_pins ip_57_slice_and_concat/out0] [get_bd_pins ip_6_conv_encoder/aclken]
