...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4f CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 104 CONFIG.C_SDA_INERTIAL_DELAY 71 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 131.3320829744066 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 63 CONFIG.aresetn 0 CONFIG.atuserwidth 161 CONFIG.bportwidth 37 CONFIG.btuserwidth 2 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 38 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 87 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 3 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 14862 CONFIG.C_TAVDV_PS_MEM_1 14795 CONFIG.C_TAVDV_PS_MEM_2 15876 CONFIG.C_TCEDV_PS_MEM_0 14976 CONFIG.C_TCEDV_PS_MEM_1 14548 CONFIG.C_TCEDV_PS_MEM_2 16257 CONFIG.C_THZCE_PS_MEM_0 7022 CONFIG.C_THZCE_PS_MEM_1 7658 CONFIG.C_THZCE_PS_MEM_2 7210 CONFIG.C_THZOE_PS_MEM_0 6843 CONFIG.C_THZOE_PS_MEM_1 6326 CONFIG.C_THZOE_PS_MEM_2 7039 CONFIG.C_TLZWE_PS_MEM_0 6969 CONFIG.C_TLZWE_PS_MEM_1 5493 CONFIG.C_TLZWE_PS_MEM_2 4981 CONFIG.C_TWC_PS_MEM_0 13905 CONFIG.C_TWC_PS_MEM_1 14178 CONFIG.C_TWC_PS_MEM_2 13965 CONFIG.C_TWPH_PS_MEM_0 11577 CONFIG.C_TWPH_PS_MEM_1 12142 CONFIG.C_TWPH_PS_MEM_2 11695 CONFIG.C_TWP_PS_MEM_0 12154 CONFIG.C_TWP_PS_MEM_1 10866 CONFIG.C_TWP_PS_MEM_2 12431 CONFIG.C_WR_REC_TIME_MEM_0 27299 CONFIG.C_WR_REC_TIME_MEM_1 28930 CONFIG.C_WR_REC_TIME_MEM_2 29335 " [get_bd_cells ip_4_emc/emc_0]
...
set_property -dict "CONFIG.NUM_MI 6 CONFIG.NUM_SI 1 " [get_bd_cells ip_8_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 22 " [get_bd_cells ip_11_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_8_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_8_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_emc/AXI] [get_bd_intf_pins ip_8_axi/AXI_S4]
...
if {[catch {
  ...
  set __s [expr {$__aw == 176 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_11_axis_dwidth_converter/S_AXIS declared=176 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_11_axis_dwidth_converter/S_AXIS declared=176 actual=ERR $__err" }
if {[catch {
