...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 40 CONFIG.aresetn 0 CONFIG.atuserwidth 119 CONFIG.bportwidth 29 CONFIG.btuserwidth 86 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 66 CONFIG.roundmode Truncate " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x37 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 190 CONFIG.C_SDA_INERTIAL_DELAY 36 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 626.1963618976393 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 41 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 43 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 11 CONFIG.Iterations 13 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour OR_of_TLAST CONFIG.Out_TREADY 0 CONFIG.Output_Width 40 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 46 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_4_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x61 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 7 CONFIG.C_SDA_INERTIAL_DELAY 76 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 73.69176337471472 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xc CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 18 CONFIG.C_SDA_INERTIAL_DELAY 210 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 425.4963580036424 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 3 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 27 CONFIG.C_SDA_INERTIAL_DELAY 174 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 503.76773485886946 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1c7a196 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 23 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xcd35545 CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_11_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 41 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_12_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_23_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 43 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_17_axi/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_17_axi/AXI_S7]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S11]
