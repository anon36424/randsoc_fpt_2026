...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5d CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 174 CONFIG.C_SDA_INERTIAL_DELAY 83 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 687.5428187310351 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_SPI_MEMORY 2 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_1_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x32 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 220 CONFIG.C_SDA_INERTIAL_DELAY 72 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 246.7338259701816 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x15 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 129 CONFIG.C_SDA_INERTIAL_DELAY 66 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 670.7107670435499 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 32 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_6_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.AINIT_Value 7ffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 156 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 203 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_8_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 14 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 27 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_12_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_MASK 0xecd47b6d787641b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x72dc8cff5fd16a9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x32 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 162 CONFIG.C_SDA_INERTIAL_DELAY 200 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 109.3682675724051 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_14_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xe97 CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_15_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 31 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_18_gpio/gpio_0]
...
create_bd_pin -dir O -from 155 -to 0 ip_34_slice_and_concat/out0
create_bd_pin -dir I -from 202 -to 0 ip_34_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_34_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 155 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 202 -to 0 ip_35_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_35_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 156 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 202 -to 0 ip_36_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_36_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 170 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 202 CONFIG.DIN_TO 171 CONFIG.DIN_WIDTH 203 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 26 -to 0 ip_37_slice_and_concat/in_1
...
connect_bd_net [get_bd_pins ip_22_intc/irq_5] [get_bd_pins ip_5_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_22_intc/irq_6] [get_bd_pins ip_6_axi_hwicap/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_22_intc/irq_9] [get_bd_pins ip_15_gpio/irq]
connect_bd_net [get_bd_pins ip_22_intc/irq_10] [get_bd_pins ip_18_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_23_axi_legacy/AXI_M0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_23_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axi_dma/M_AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_23_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_iic/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_gpio/AXI] [get_bd_intf_pins ip_23_axi_legacy/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_28_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_10_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_1] [get_bd_pins ip_12_accumulator/Q]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_8_accumulator/CE]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_10_floating_point/aclken]
