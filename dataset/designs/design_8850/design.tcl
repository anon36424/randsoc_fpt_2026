...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 1 CONFIG.C_SPI_MEMORY 0 CONFIG.C_SPI_MODE 1 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_2_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 34 CONFIG.aresetn 1 CONFIG.atuserwidth 223 CONFIG.bportwidth 16 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 12 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 41 CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 62 CONFIG.aresetn 1 CONFIG.atuserwidth 52 CONFIG.bportwidth 39 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 51 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 56 CONFIG.roundmode Truncate " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3ffffff CONFIG.C_GPIO_WIDTH 26 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x3ffffff " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 64 CONFIG.C_MEM1_TYPE 2 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 9 CONFIG.C_TAVDV_PS_MEM_0 16054 CONFIG.C_TAVDV_PS_MEM_1 15946 CONFIG.C_TAVDV_PS_MEM_2 15375 CONFIG.C_TCEDV_PS_MEM_0 13851 CONFIG.C_TCEDV_PS_MEM_1 15844 CONFIG.C_TCEDV_PS_MEM_2 14643 CONFIG.C_THZCE_PS_MEM_0 6859 CONFIG.C_THZCE_PS_MEM_1 6537 CONFIG.C_THZCE_PS_MEM_2 6509 CONFIG.C_THZOE_PS_MEM_0 6997 CONFIG.C_THZOE_PS_MEM_1 7508 CONFIG.C_THZOE_PS_MEM_2 7308 CONFIG.C_TLZWE_PS_MEM_0 1495 CONFIG.C_TLZWE_PS_MEM_1 8057 CONFIG.C_TLZWE_PS_MEM_2 6892 CONFIG.C_TWC_PS_MEM_0 14446 CONFIG.C_TWC_PS_MEM_1 16412 CONFIG.C_TWC_PS_MEM_2 13781 CONFIG.C_TWPH_PS_MEM_0 11902 CONFIG.C_TWPH_PS_MEM_1 13107 CONFIG.C_TWPH_PS_MEM_2 12894 CONFIG.C_TWP_PS_MEM_0 11993 CONFIG.C_TWP_PS_MEM_1 10979 CONFIG.C_TWP_PS_MEM_2 11797 CONFIG.C_WR_REC_TIME_MEM_0 24526 CONFIG.C_WR_REC_TIME_MEM_1 24684 CONFIG.C_WR_REC_TIME_MEM_2 25239 " [get_bd_cells ip_9_emc/emc_0]
...
set_property -dict "CONFIG.NUM_MI 7 " [get_bd_cells ip_16_axis_broadcaster/axis_broadcaster_0]
...
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ip_16_axis_broadcaster/M_AXIS_5
connect_bd_intf_net [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_5] [get_bd_intf_pins ip_16_axis_broadcaster/axis_broadcaster_0/M05_AXIS]
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ip_16_axis_broadcaster/M_AXIS_6
connect_bd_intf_net [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_6] [get_bd_intf_pins ip_16_axis_broadcaster/axis_broadcaster_0/M06_AXIS]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 14 " [get_bd_cells ip_22_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 16 -to 0 ip_28_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_28_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_10_dft/CLK]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_2_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_2] [get_bd_pins ip_3_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_13_intc/irq_3] [get_bd_pins ip_4_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_13_intc/irq_4] [get_bd_pins ip_8_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_gpio/AXI] [get_bd_intf_pins ip_15_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_6_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_DATA] [get_bd_intf_pins ip_23_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axis_combiner/S_AXIS_2] [get_bd_intf_pins ip_17_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_26_axis_combiner/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_6]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_1] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_2] [get_bd_pins ip_3_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_3] [get_bd_pins ip_3_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_4] [get_bd_pins ip_10_dft/RFFD]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_5] [get_bd_pins ip_10_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_3_xadc_wiz/convst_in]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_10_dft/CE]
...
if {[catch {
  ...
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_4 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_4 declared=16 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_16_axis_broadcaster/axis_broadcaster_0/M05_AXIS]] * 8}]
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_5 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_5 declared=16 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_16_axis_broadcaster/axis_broadcaster_0/M06_AXIS]] * 8}]
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_6 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_6 declared=16 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 112 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_23_axis_combiner/S_AXIS_1 declared=112 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_23_axis_combiner/S_AXIS_1 declared=112 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_26_axis_combiner/S_AXIS_2 declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_26_axis_combiner/S_AXIS_2 declared=128 actual=ERR $__err" }
if {[catch {
