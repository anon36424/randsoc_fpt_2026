...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 32768 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_High CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_4_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x0 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 166 CONFIG.C_SDA_INERTIAL_DELAY 22 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 91.17791295560077 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 36 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.a_precision_type Half CONFIG.a_tuser_width 11 CONFIG.add_sub_value Both CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage Medium_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 1 CONFIG.has_b_tlast 1 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 1 CONFIG.maximum_latency 1 CONFIG.operation_tuser_width 15 CONFIG.operation_type FMA CONFIG.result_tlast_behv AND_all_TLASTs " [get_bd_cells ip_8_floating_point/floating_point_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_9_dft/dft_0]
...
set_property -dict "CONFIG.AINIT_Value 3ffffffffffffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 65 CONFIG.Latency 19 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 210 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 64 -to 0 ip_10_accumulator/B
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_20_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 154 -to 0 ip_23_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 94 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 95 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 5 " [get_bd_cells ip_23_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 138 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 142 CONFIG.DIN_TO 139 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 143 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 150 CONFIG.DIN_TO 147 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 154 CONFIG.DIN_TO 151 CONFIG.DIN_WIDTH 155 " [get_bd_cells ip_23_reduce/slice_31]
...
create_bd_pin -dir O -from 10 -to 0 ip_25_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 10 -to 0 ip_25_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_25_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 64 -to 0 ip_26_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 10 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 209 -to 0 ip_26_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 210 " [get_bd_cells ip_26_slice_and_concat/slice_5]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_5] [get_bd_pins ip_26_slice_and_concat/slice_5/din]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/slice_5/dout] [get_bd_pins ip_26_slice_and_concat/concat/In5]


########## slice_and_concat ##########
create_bd_cell -type hier ip_27_slice_and_concat
create_bd_pin -dir O -from 154 -to 0 ip_27_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 198 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 210 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 209 CONFIG.DIN_TO 199 CONFIG.DIN_WIDTH 210 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_reset/interconnect_aresetn] [get_bd_pins ip_0_floating_point/aresetn]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_3_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_4_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_5_axi_iic/reset]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_6_xadc_wiz/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_11_reset/interconnect_aresetn] [get_bd_pins ip_8_floating_point/aresetn]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_0_floating_point/aclk]
...
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_4_axi_timer/s_axi_aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_5_axi_iic/clk]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_0] [get_bd_pins ip_1_fft/event_frame_started]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_3] [get_bd_pins ip_4_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_13_intc/irq_4] [get_bd_pins ip_5_axi_iic/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_5] [get_bd_pins ip_6_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_13_intc/irq_6] [get_bd_pins ip_7_axi_cdma/cdma_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/M_AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_timer/S_AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_iic/AXI] [get_bd_intf_pins ip_14_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_floating_point/M_AXIS_RESULT] [get_bd_intf_pins ip_15_axis_broadcaster/S_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/M_AXIS_DATA] [get_bd_intf_pins ip_16_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_floating_point/S_AXIS_OPERATION] [get_bd_intf_pins ip_18_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_19_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_8_floating_point/M_AXIS_RESULT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_floating_point/S_AXIS_B] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_22_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_15_axis_broadcaster/M_AXIS_3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_floating_point/S_AXIS_C] [get_bd_intf_pins ip_22_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_fft/S_AXIS_DATA] [get_bd_intf_pins ip_17_axis_broadcaster/M_AXIS_1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_DATA] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_9_dft/SIZE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_3] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_4] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_5] [get_bd_pins ip_4_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_9_dft/XN_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_1] [get_bd_pins ip_6_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_2] [get_bd_pins ip_6_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_3] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_4] [get_bd_pins ip_9_dft/XK_RE]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/B]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_0] [get_bd_pins ip_9_dft/XK_RE]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_1] [get_bd_pins ip_9_dft/XK_IM]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_2] [get_bd_pins ip_9_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_3] [get_bd_pins ip_9_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_4] [get_bd_pins ip_9_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_5] [get_bd_pins ip_10_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/CE]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_10_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_9_dft/FWD_INV]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_4_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_9_dft/FD_IN]
...
if {[catch {
  ...
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/S_AXIS declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/S_AXIS declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_16_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_0 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_0 declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_16_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_1 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_broadcaster/M_AXIS_1 declared=96 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_19_axis_dwidth_converter/M_AXIS declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_19_axis_dwidth_converter/M_AXIS declared=16 actual=ERR $__err" }
if {[catch {
  ...
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_dwidth_converter/S_AXIS declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_dwidth_converter/S_AXIS declared=16 actual=ERR $__err" }
if {[catch {
