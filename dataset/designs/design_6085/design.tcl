...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 5 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 9 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 36 CONFIG.aresetn 1 CONFIG.bportwidth 46 CONFIG.btuserwidth 215 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 11 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x19 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 86 CONFIG.C_SDA_INERTIAL_DELAY 217 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 719.8095554489918 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 70 CONFIG.C_SDA_INERTIAL_DELAY 250 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 409.98001529548077 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 5 CONFIG.convolution_code0 10 CONFIG.convolution_code1 16 CONFIG.convolution_code2 3 CONFIG.convolution_code3 7 CONFIG.convolution_code4 15 CONFIG.convolution_code5 14 CONFIG.convolution_code6 28 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 11 CONFIG.output_rate 19 CONFIG.puncture_code0 01111011111 CONFIG.puncture_code1 11011111111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_9_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir I -from 8 -to 0 ip_18_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_18_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_19_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_5_dft/CE]
