...
set_property -dict "CONFIG.C_MASK 0x4b2bd5aaf5dfb02 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x111ad47208ba6f4 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 254 CONFIG.Latency 30 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 255 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 33 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 41 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_5_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_MASK 0x1b7d9dffb905be2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe6985659b822ffe CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 42 CONFIG.aresetn 1 CONFIG.bportwidth 42 CONFIG.btuserwidth 228 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 76 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.NUM_MI 4 CONFIG.NUM_SI 2 " [get_bd_cells ip_16_axi/axi_0]
...
create_bd_pin -dir O -from 253 -to 0 ip_25_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 214 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_25_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 230 CONFIG.DIN_TO 215 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 246 CONFIG.DIN_TO 231 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 254 CONFIG.DIN_TO 247 CONFIG.DIN_WIDTH 255 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 40 -to 0 ip_28_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_28_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 41 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_1] [get_bd_pins ip_11_axi_timer/interrupt]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_1] [get_bd_pins ip_11_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_16_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_timer/S_AXI] [get_bd_intf_pins ip_16_axi/AXI_S1]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_2] [get_bd_pins ip_1_dft/XK_IM]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_3] [get_bd_pins ip_1_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_4] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_6] [get_bd_pins ip_4_accumulator/Q]
