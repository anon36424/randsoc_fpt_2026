...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 119 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 139 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 10 " [get_bd_cells ip_16_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir O -from 118 -to 0 ip_19_slice_and_concat/out0
...
create_bd_pin -dir I -from 138 -to 0 ip_19_slice_and_concat/in_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_9
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_9]
set_property -dict "CONFIG.DIN_FROM 88 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 139 " [get_bd_cells ip_19_slice_and_concat/slice_9]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_9] [get_bd_pins ip_19_slice_and_concat/slice_9/din]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/slice_9/dout] [get_bd_pins ip_19_slice_and_concat/concat/In9]


########## slice_and_concat ##########
create_bd_cell -type hier ip_20_slice_and_concat
create_bd_pin -dir O -from 9 -to 0 ip_20_slice_and_concat/out0
create_bd_pin -dir I -from 138 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 89 CONFIG.DIN_WIDTH 139 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 128 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 139 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 134 CONFIG.DIN_TO 129 CONFIG.DIN_WIDTH 139 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 138 -to 0 ip_23_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_23_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 138 CONFIG.DIN_TO 135 CONFIG.DIN_WIDTH 139 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_6] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_7] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_8] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_9] [get_bd_pins ip_4_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_4] [get_bd_pins ip_8_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_5] [get_bd_pins ip_8_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_6] [get_bd_pins ip_8_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_8_xadc_wiz/user_temp_alarm_out]
