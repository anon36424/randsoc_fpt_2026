...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4d CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 129 CONFIG.C_SDA_INERTIAL_DELAY 121 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 96.42992304530416 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x36 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 137 CONFIG.C_SDA_INERTIAL_DELAY 5 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 99.06855374353444 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_1] [get_bd_pins ip_3_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_2] [get_bd_pins ip_3_xadc_wiz/ot_out]
