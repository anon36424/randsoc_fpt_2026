...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 3 CONFIG.C_TAVDV_PS_MEM_0 13931 CONFIG.C_TAVDV_PS_MEM_1 15903 CONFIG.C_TCEDV_PS_MEM_0 13761 CONFIG.C_TCEDV_PS_MEM_1 14215 CONFIG.C_THZCE_PS_MEM_0 6393 CONFIG.C_THZCE_PS_MEM_1 7506 CONFIG.C_THZOE_PS_MEM_0 6840 CONFIG.C_THZOE_PS_MEM_1 6749 CONFIG.C_TLZWE_PS_MEM_0 3502 CONFIG.C_TLZWE_PS_MEM_1 4847 CONFIG.C_TWC_PS_MEM_0 15708 CONFIG.C_TWC_PS_MEM_1 14305 CONFIG.C_TWPH_PS_MEM_0 12677 CONFIG.C_TWPH_PS_MEM_1 12426 CONFIG.C_TWP_PS_MEM_0 11163 CONFIG.C_TWP_PS_MEM_1 10921 CONFIG.C_WR_REC_TIME_MEM_0 25424 CONFIG.C_WR_REC_TIME_MEM_1 28802 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 34 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 36 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SPI_MEMORY 2 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_3_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 61 CONFIG.aresetn 0 CONFIG.bportwidth 58 CONFIG.btuserwidth 228 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 49 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 40 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 36 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 35 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 36 " [get_bd_cells ip_14_slice_and_concat/slice_0]
