...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x76 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 141 CONFIG.C_SDA_INERTIAL_DELAY 44 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 856.0889683338439 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 108 CONFIG.convolution_code1 90 CONFIG.convolution_code2 97 CONFIG.convolution_code3 101 CONFIG.convolution_code4 112 CONFIG.convolution_code5 4 CONFIG.convolution_code6 36 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 11 CONFIG.output_rate 12 CONFIG.puncture_code0 01010111011 CONFIG.puncture_code1 01000110101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_1_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.AINIT_Value ffffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 119 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 168 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 118 -to 0 ip_2_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x4edf852ef64d7de CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x8dea5fa7f69fbed CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 59 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_5_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4a CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 17 CONFIG.C_SDA_INERTIAL_DELAY 58 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 401.8243249461387 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3d CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 108 CONFIG.C_SDA_INERTIAL_DELAY 107 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 356.4309110587896 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_14_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 51 -to 0 ip_25_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 52 " [get_bd_cells ip_25_reduce/slice_31]
...
create_bd_pin -dir O -from 118 -to 0 ip_26_slice_and_concat/out0
create_bd_pin -dir I -from 167 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 118 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 167 -to 0 ip_27_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 160 CONFIG.DIN_TO 119 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 167 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 167 CONFIG.DIN_TO 161 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 43 -to 0 ip_28_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_28_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_18_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_iic/AXI] [get_bd_intf_pins ip_18_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_iic/AXI] [get_bd_intf_pins ip_18_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_18_axi/AXI_S5]
...
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_3] [get_bd_pins ip_8_dft/XK_IM]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_4] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_5] [get_bd_pins ip_8_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_6] [get_bd_pins ip_8_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_28_slice_and_concat/in_7] [get_bd_pins ip_13_accumulator/Q]
