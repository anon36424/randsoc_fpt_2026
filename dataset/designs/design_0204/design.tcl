...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4b CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 184 CONFIG.C_SDA_INERTIAL_DELAY 248 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 914.9552996823619 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 222 CONFIG.convolution_code1 16 CONFIG.convolution_code2 436 CONFIG.convolution_code3 400 CONFIG.convolution_code4 444 CONFIG.convolution_code5 317 CONFIG.convolution_code6 277 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 2 CONFIG.output_rate 3 CONFIG.puncture_code0 01 CONFIG.puncture_code1 11 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_4_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 197 CONFIG.Latency 28 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 252 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 7 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 10 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_11_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 9 -to 0 ip_11_accumulator/Q
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 196 -to 0 ip_25_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 251 -to 0 ip_25_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 167 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_25_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 173 CONFIG.DIN_TO 168 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 188 CONFIG.DIN_TO 174 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 203 CONFIG.DIN_TO 189 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 251 CONFIG.DIN_TO 204 CONFIG.DIN_WIDTH 252 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_3] [get_bd_pins ip_8_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_1_conv_encoder/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_2] [get_bd_pins ip_5_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_3] [get_bd_pins ip_5_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_4] [get_bd_pins ip_5_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_5] [get_bd_pins ip_7_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_22_reduce/in0]
