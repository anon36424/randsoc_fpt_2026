...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x23 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 81 CONFIG.C_SDA_INERTIAL_DELAY 212 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 970.4126937564334 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 8192 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_Low CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_5_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 5 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 224 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 223 -to 0 ip_6_accumulator/Q
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 1 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 256 CONFIG.C_SHARED_STARTUP 0 " [get_bd_cells ip_10_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sin_and_Cos CONFIG.Input_Width 23 CONFIG.Iterations 16 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 12 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 28 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_12_cordic/cordic_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 8 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_13_dft/dft_0]
...
set_property -dict "CONFIG.NUM_MI 6 CONFIG.NUM_SI 1 " [get_bd_cells ip_17_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 5 " [get_bd_cells ip_24_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 231 -to 0 ip_26_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 84 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 91 CONFIG.DIN_TO 85 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 92 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 105 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 112 CONFIG.DIN_TO 106 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 113 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 126 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 133 CONFIG.DIN_TO 127 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 140 CONFIG.DIN_TO 134 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 147 CONFIG.DIN_TO 141 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 154 CONFIG.DIN_TO 148 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 161 CONFIG.DIN_TO 155 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 168 CONFIG.DIN_TO 162 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 175 CONFIG.DIN_TO 169 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 182 CONFIG.DIN_TO 176 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 189 CONFIG.DIN_TO 183 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 196 CONFIG.DIN_TO 190 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 203 CONFIG.DIN_TO 197 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 210 CONFIG.DIN_TO 204 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 217 CONFIG.DIN_TO 211 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 224 CONFIG.DIN_TO 218 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 231 CONFIG.DIN_TO 225 CONFIG.DIN_WIDTH 232 " [get_bd_cells ip_26_reduce/slice_31]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 4 -to 0 ip_29_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 39 -to 0 ip_30_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 39 -to 0 ip_31_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_31_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 29 -to 0 ip_32_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 40 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 223 -to 0 ip_32_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_32_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 224 " [get_bd_cells ip_32_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 231 -to 0 ip_33_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 223 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 224 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 7 -to 0 ip_33_slice_and_concat/in_3
...
connect_bd_net [get_bd_pins ip_14_reset/peripheral_areset_n] [get_bd_pins ip_3_gpio/rst]
connect_bd_net [get_bd_pins ip_14_reset/peripheral_areset_n] [get_bd_pins ip_5_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_14_reset/interconnect_aresetn] [get_bd_pins ip_8_floating_point/aresetn]
...
connect_bd_net [get_bd_pins ip_15_clk_wiz/clk_out] [get_bd_pins ip_3_gpio/clk]
...
connect_bd_net [get_bd_pins ip_15_clk_wiz/clk_out] [get_bd_pins ip_12_cordic/aclk]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_1] [get_bd_pins ip_3_gpio/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_2] [get_bd_pins ip_4_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_16_intc/irq_3] [get_bd_pins ip_5_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/M_AXI] [get_bd_intf_pins ip_17_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_iic/AXI] [get_bd_intf_pins ip_17_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_gpio/AXI] [get_bd_intf_pins ip_17_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_17_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_17_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_intc/AXI] [get_bd_intf_pins ip_17_axi/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_floating_point/M_AXIS_RESULT] [get_bd_intf_pins ip_19_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_floating_point/S_AXIS_A] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_22_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_23_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_12_cordic/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_11_cordic/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_fft/S_AXIS_DATA] [get_bd_intf_pins ip_25_axis_combiner/M_AXIS]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_10_axi_hwicap/eos_in]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/out0] [get_bd_pins ip_13_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_1] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_4] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_3] [get_bd_pins ip_13_dft/XK_IM]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_4] [get_bd_pins ip_13_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_5] [get_bd_pins ip_13_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_6] [get_bd_pins ip_13_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_13_dft/FD_IN]
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/ADD]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_13_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/CE]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/CE]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_13_dft/CE]
