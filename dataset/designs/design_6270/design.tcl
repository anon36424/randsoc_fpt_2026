...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 1024 " [get_bd_cells ip_0_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0xe1e2fa41485d7c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x487abdba86e22e7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 274 CONFIG.convolution_code1 318 CONFIG.convolution_code2 361 CONFIG.convolution_code3 177 CONFIG.convolution_code4 208 CONFIG.convolution_code5 247 CONFIG.convolution_code6 96 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 1 " [get_bd_cells ip_8_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xb CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 191 CONFIG.C_SDA_INERTIAL_DELAY 75 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 740.0115411082834 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 55 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_13_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MASK 0xc2eb2c0854add7e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xeb6798302fff540 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_14_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x48 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 191 CONFIG.C_SDA_INERTIAL_DELAY 64 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 270.9326071553478 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_15_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 5 CONFIG.S_TDATA_NUM_BYTES 28 " [get_bd_cells ip_28_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_3] [get_bd_pins ip_2_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_19_intc/irq_9] [get_bd_pins ip_13_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI] [get_bd_intf_pins ip_21_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_21_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_21_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_microblaze/M_AXI_DP] [get_bd_intf_pins ip_21_axi/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_cdma/M_AXI] [get_bd_intf_pins ip_21_axi/AXI_M5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_microblaze/M_AXI_DP] [get_bd_intf_pins ip_21_axi/AXI_M6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_iic/AXI] [get_bd_intf_pins ip_21_axi/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_21_axi/AXI_S6]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_3_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_1] [get_bd_pins ip_3_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_2] [get_bd_pins ip_3_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_3] [get_bd_pins ip_3_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_4] [get_bd_pins ip_3_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_5] [get_bd_pins ip_11_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_6] [get_bd_pins ip_11_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_7] [get_bd_pins ip_11_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_8] [get_bd_pins ip_12_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_9] [get_bd_pins ip_12_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_10] [get_bd_pins ip_12_axi_timer/pwm0]
