...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 25 CONFIG.aresetn 1 CONFIG.bportwidth 49 CONFIG.btuserwidth 57 CONFIG.ctrltuserwidth 181 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 2 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xd35ed5 CONFIG.C_GPIO_WIDTH 25 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x4cdcb2 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x53 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 218 CONFIG.C_SDA_INERTIAL_DELAY 93 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 262.0041237051214 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xf045d676941a89b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x69564c7e76d2f20 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_12_microblaze/lmb_ctrl_i]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_2] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_3] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_4] [get_bd_pins ip_3_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_5] [get_bd_pins ip_8_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_6] [get_bd_pins ip_8_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_7] [get_bd_pins ip_8_xadc_wiz/busy_out]
