...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 1 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4 CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_0_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x7 CONFIG.C_GPIO2_WIDTH 22 CONFIG.C_GPIO_WIDTH 3 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 35 CONFIG.aresetn 1 CONFIG.bportwidth 37 CONFIG.btuserwidth 20 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 4 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 4 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 1 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options pipelined_streaming_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16 " [get_bd_cells ip_8_fft/fft_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1a2c CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x3fff CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_9_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_11_fft/fft_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_timer/S_AXI] [get_bd_intf_pins ip_19_axi_legacy/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_7_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_5] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_6] [get_bd_pins ip_10_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_7] [get_bd_pins ip_10_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_8] [get_bd_pins ip_10_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_9] [get_bd_pins ip_13_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_10] [get_bd_pins ip_13_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_11] [get_bd_pins ip_13_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_1_conv_encoder/aclken]
