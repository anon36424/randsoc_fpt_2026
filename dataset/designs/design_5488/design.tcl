...
set_property -dict "CONFIG.NUM_MI 3 CONFIG.NUM_SI 3 " [get_bd_cells ip_5_axi_legacy/axi_0]
...
connect_bd_net [get_bd_pins data_I] [get_bd_pins ip_8_slice_and_concat/in_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ip_6_axis_dwidth_converter/M_AXIS]
