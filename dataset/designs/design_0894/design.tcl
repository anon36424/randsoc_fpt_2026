...
set_property -dict "CONFIG.C_ADDR_WIDTH 60 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 CONFIG.C_TAVDV_PS_MEM_0 13555 CONFIG.C_TCEDV_PS_MEM_0 14985 CONFIG.C_THZCE_PS_MEM_0 7570 CONFIG.C_THZOE_PS_MEM_0 7578 CONFIG.C_TLZWE_PS_MEM_0 6891 CONFIG.C_TWC_PS_MEM_0 16316 CONFIG.C_TWPH_PS_MEM_0 11224 CONFIG.C_TWP_PS_MEM_0 11714 CONFIG.C_WR_REC_TIME_MEM_0 26699 " [get_bd_cells ip_8_emc/emc_0]
...
set_property -dict "CONFIG.C_MASK 0x18480bf7586ae4c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xebc3bbc56f6a84a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_10_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 10 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_16_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 3 " [get_bd_cells ip_17_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.NUM_PORTS 11 " [get_bd_cells ip_18_slice_and_concat/concat]
...
create_bd_pin -dir I -from 12 -to 0 ip_18_slice_and_concat/in_10
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_10
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_10]
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_18_slice_and_concat/slice_10]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_10] [get_bd_pins ip_18_slice_and_concat/slice_10/din]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/slice_10/dout] [get_bd_pins ip_18_slice_and_concat/concat/In10]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_20_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_15_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_15_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_microblaze/M_AXI_DP] [get_bd_intf_pins ip_15_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_uartlite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_emc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_intc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_1_axi_dma/M_AXIS_MM2S]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_2_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_2_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_6] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_7] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_8] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_9] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_10] [get_bd_pins ip_9_dft/XK_RE]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_9_dft/SIZE]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_9_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_1] [get_bd_pins ip_9_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_2] [get_bd_pins ip_9_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_3] [get_bd_pins ip_9_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_11_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_11_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_6] [get_bd_pins ip_11_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_9_dft/CE]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig1]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_5_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_9_dft/FWD_INV]
