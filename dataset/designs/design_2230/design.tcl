...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 33 CONFIG.aresetn 1 CONFIG.atuserwidth 53 CONFIG.bportwidth 54 CONFIG.btuserwidth 82 CONFIG.ctrltuserwidth 54 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 2 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 26 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x23 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 178 CONFIG.C_SDA_INERTIAL_DELAY 115 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 260.307132762374 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.C_MASK 0x91fd3090a0b52d4 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x1f89bb6fdd3acf9 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_8_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x23 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 246 CONFIG.C_SDA_INERTIAL_DELAY 8 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 652.9760350381783 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_11_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 23 -to 0 ip_27_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 24 " [get_bd_cells ip_27_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 24 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 24 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_3] [get_bd_pins ip_4_xadc_wiz/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_14_intc/irq_4] [get_bd_pins ip_6_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_14_intc/irq_5] [get_bd_pins ip_8_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_14_intc/irq_6] [get_bd_pins ip_11_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_iic/AXI] [get_bd_intf_pins ip_15_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_15_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_iic/AXI] [get_bd_intf_pins ip_15_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_intc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_fft/M_AXIS_DATA] [get_bd_intf_pins ip_17_axis_broadcaster/S_AXIS]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_6] [get_bd_pins ip_6_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_7] [get_bd_pins ip_7_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_0_complex_multiplier/aclken]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vbram_alarm_out]
