...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 8 CONFIG.C_GPIO_WIDTH 15 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x93c CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x57 CONFIG.C_GPIO_WIDTH 8 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MASK 0x703a799ed06cac8 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xe34ba95797e3a08 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_floating_point/S_AXIS_C] [get_bd_intf_pins ip_16_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_5] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_6] [get_bd_pins ip_5_axi_timer/pwm0]
