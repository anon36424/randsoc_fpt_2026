...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 24 CONFIG.C_GPIO_WIDTH 32 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1f CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 221 CONFIG.C_SDA_INERTIAL_DELAY 11 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 783.8056524322897 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 50 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 40 CONFIG.convolution_code1 49 CONFIG.convolution_code2 84 CONFIG.convolution_code3 63 CONFIG.convolution_code4 96 CONFIG.convolution_code5 8 CONFIG.convolution_code6 57 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 1 " [get_bd_cells ip_7_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6b CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 95 CONFIG.C_SDA_INERTIAL_DELAY 217 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 348.01597835046573 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x1 CONFIG.C_GPIO_WIDTH 1 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_9_gpio/gpio_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sin_and_Cos CONFIG.Input_Width 43 CONFIG.Iterations 8 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 11 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 13 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_10_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x3fff CONFIG.C_GPIO_WIDTH 14 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x3fd5 " [get_bd_cells ip_11_gpio/gpio_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 28 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_7_conv_encoder/M_AXIS_DATA]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_12_dft/SIZE]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_0] [get_bd_pins ip_12_dft/RFFD]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_1] [get_bd_pins ip_12_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_1] [get_bd_pins ip_12_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_1] [get_bd_pins ip_12_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_2] [get_bd_pins ip_12_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_1_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_12_dft/DATA_VALID]
