...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x8e1 CONFIG.C_DOUT_DEFAULT_2 0x86d CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 12 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 8 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_MI 2 CONFIG.NUM_SI 1 " [get_bd_cells ip_4_axi_legacy/axi_0]
...
create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 ip_4_axi_legacy/AXI_S1
connect_bd_intf_net [get_bd_intf_pins ip_4_axi_legacy/AXI_S1] [get_bd_intf_pins ip_4_axi_legacy/axi_0/M01_AXI]
connect_bd_net [get_bd_pins ip_4_axi_legacy/clk] [get_bd_pins ip_4_axi_legacy/axi_0/M01_ACLK]
connect_bd_net [get_bd_pins ip_4_axi_legacy/reset] [get_bd_pins ip_4_axi_legacy/axi_0/M01_ARESETN]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_gpio/AXI] [get_bd_intf_pins ip_4_axi_legacy/AXI_S1]
