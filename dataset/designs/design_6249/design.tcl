...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x25 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 57 CONFIG.C_SDA_INERTIAL_DELAY 143 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 203.43889839309344 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_0] [get_bd_pins ip_4_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_10_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_10_axi/AXI_S1]
