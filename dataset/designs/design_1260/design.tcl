...
set_property -dict "CONFIG.C_MASK 0xdbc79ce612e0638 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x41a962801f048d2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_1] [get_bd_pins ip_2_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_2] [get_bd_pins ip_2_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_2_xadc_wiz/alarm_out]
