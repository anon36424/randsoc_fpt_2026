...
set_property -dict "CONFIG.a_precision_type Custom CONFIG.add_sub_value Both CONFIG.b_tuser_width 58 CONFIG.c_a_exponent_width 8 CONFIG.c_a_fraction_width 61 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Equal CONFIG.c_has_invalid_op 0 CONFIG.c_mult_usage No_Usage CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 0 CONFIG.has_aclken 1 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Compare " [get_bd_cells ip_0_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 1 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.PROTOCOL AXI4 " [get_bd_cells ip_4_jtag_axi/jtag_axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 9 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_7_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 9 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_8_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_floating_point/S_AXIS_B] [get_bd_intf_pins ip_8_axis_dwidth_converter/M_AXIS]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_0_floating_point/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_7_axis_dwidth_converter/M_AXIS declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_7_axis_dwidth_converter/M_AXIS declared=72 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 72 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_8_axis_dwidth_converter/M_AXIS declared=72 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_8_axis_dwidth_converter/M_AXIS declared=72 actual=ERR $__err" }
