...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 11 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 4 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 4 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 8 CONFIG.C_TAVDV_PS_MEM_0 13865 CONFIG.C_TAVDV_PS_MEM_1 15476 CONFIG.C_TAVDV_PS_MEM_2 14141 CONFIG.C_TCEDV_PS_MEM_0 16359 CONFIG.C_TCEDV_PS_MEM_1 15644 CONFIG.C_TCEDV_PS_MEM_2 15023 CONFIG.C_THZCE_PS_MEM_0 6594 CONFIG.C_THZCE_PS_MEM_1 7307 CONFIG.C_THZCE_PS_MEM_2 6322 CONFIG.C_THZOE_PS_MEM_0 7044 CONFIG.C_THZOE_PS_MEM_1 7212 CONFIG.C_THZOE_PS_MEM_2 7150 CONFIG.C_TLZWE_PS_MEM_0 2931 CONFIG.C_TLZWE_PS_MEM_1 809 CONFIG.C_TLZWE_PS_MEM_2 544 CONFIG.C_TWC_PS_MEM_0 14536 CONFIG.C_TWC_PS_MEM_1 13522 CONFIG.C_TWC_PS_MEM_2 15541 CONFIG.C_TWPH_PS_MEM_0 12599 CONFIG.C_TWPH_PS_MEM_1 10999 CONFIG.C_TWPH_PS_MEM_2 12087 CONFIG.C_TWP_PS_MEM_0 12386 CONFIG.C_TWP_PS_MEM_1 11518 CONFIG.C_TWP_PS_MEM_2 11687 CONFIG.C_WR_REC_TIME_MEM_0 24480 CONFIG.C_WR_REC_TIME_MEM_1 29227 CONFIG.C_WR_REC_TIME_MEM_2 28042 " [get_bd_cells ip_3_emc/emc_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 12 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_10_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_emc/AXI] [get_bd_intf_pins ip_10_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_1_floating_point/M_AXIS_RESULT]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_2_axi_dma/M_AXIS_MM2S]
...
connect_bd_net [get_bd_pins ip_7_reset/interconnect_aresetn] [get_bd_pins ip_12_axis_combiner/aresetn]
...
connect_bd_net [get_bd_pins ip_8_clk_wiz/clk_out] [get_bd_pins ip_12_axis_combiner/aclk]
...
if {[catch {
  ...
  set __s [expr {$__aw == 64 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_combiner/S_AXIS_0 declared=64 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_combiner/S_AXIS_0 declared=64 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_12_axis_combiner/axis_combiner_0/S01_AXIS]] * 8}]
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_combiner/S_AXIS_1 declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_combiner/S_AXIS_1 declared=32 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_12_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_12_axis_combiner/M_AXIS declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_12_axis_combiner/M_AXIS declared=96 actual=ERR $__err" }
if {[catch {
