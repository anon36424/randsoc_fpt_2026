...
create_bd_pin -dir O -from 6 -to 0 ip_5_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 37 " [get_bd_cells ip_5_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 29 -to 0 ip_6_slice_and_concat/out0
create_bd_pin -dir I -from 36 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 37 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_floating_point/S_AXIS_A] [get_bd_intf_pins ip_4_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_7_slice_and_concat/out0] [get_bd_pins ip_0_accumulator/SCLR]
