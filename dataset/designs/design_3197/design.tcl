...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 16384 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 23 CONFIG.aresetn 1 CONFIG.bportwidth 52 CONFIG.btuserwidth 169 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 39 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 31 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_SYNCH_PIPEDELAY_1 2 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 15894 CONFIG.C_TCEDV_PS_MEM_0 14936 CONFIG.C_THZCE_PS_MEM_0 6589 CONFIG.C_THZOE_PS_MEM_0 7293 CONFIG.C_TLZWE_PS_MEM_0 9642 CONFIG.C_TWC_PS_MEM_0 13959 CONFIG.C_TWPH_PS_MEM_0 11035 CONFIG.C_TWP_PS_MEM_0 12304 CONFIG.C_WR_REC_TIME_MEM_0 29227 " [get_bd_cells ip_6_emc/emc_0]
...
set_property -dict "CONFIG.C_MASK 0xd161329b4824e3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x31bd6bf4effef7b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 17 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_9_dft/dft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 48 CONFIG.aresetn 0 CONFIG.atuserwidth 182 CONFIG.bportwidth 40 CONFIG.btuserwidth 181 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 34 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 58 CONFIG.roundmode Truncate " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0x9bcd83515f9d398 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x664d85639aa9d8e CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x41 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 251 CONFIG.C_SDA_INERTIAL_DELAY 249 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 927.4824802874308 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 14 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_25_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 16 -to 0 ip_27_slice_and_concat/in_10
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_10
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_10]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_27_slice_and_concat/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_29_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_intc/irq_5] [get_bd_pins ip_12_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_iic/AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S6]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_21_axis_broadcaster/M_AXIS_1]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_6] [get_bd_pins ip_4_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_7] [get_bd_pins ip_4_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_8] [get_bd_pins ip_4_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_9] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_10] [get_bd_pins ip_9_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_9_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_3] [get_bd_pins ip_9_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_4] [get_bd_pins ip_12_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_5] [get_bd_pins ip_12_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_6] [get_bd_pins ip_12_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_9_dft/FD_IN]
connect_bd_net [get_bd_pins ip_32_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/capturetrig1]
...
connect_bd_net [get_bd_pins ip_40_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/ot_out]
