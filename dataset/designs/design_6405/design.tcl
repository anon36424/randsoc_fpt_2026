...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 1024 " [get_bd_cells ip_2_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 51 CONFIG.aresetn 1 CONFIG.atuserwidth 104 CONFIG.bportwidth 26 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 45 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1f CONFIG.C_GPIO_WIDTH 5 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x14 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 55 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.AINIT_Value 3ffffffffffffffffffff CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 62 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 82 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 61 -to 0 ip_10_accumulator/B
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 23 CONFIG.aresetn 0 CONFIG.atuserwidth 221 CONFIG.bportwidth 37 CONFIG.btuserwidth 37 CONFIG.ctrltuserwidth 48 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 35 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 3 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_35_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 61 -to 0 ip_37_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 81 -to 0 ip_37_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_37_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 82 " [get_bd_cells ip_37_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 82 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 82 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 74 CONFIG.DIN_WIDTH 82 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 81 -to 0 ip_41_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_41_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 81 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 82 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_41_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_intc/irq_4] [get_bd_pins ip_9_axi_dma/s2mm_introut]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/M_AXI] [get_bd_intf_pins ip_16_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI] [get_bd_intf_pins ip_16_axi/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_timer/S_AXI] [get_bd_intf_pins ip_16_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_16_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_16_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_intc/AXI] [get_bd_intf_pins ip_16_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_complex_multiplier/M_AXIS_DOUT] [get_bd_intf_pins ip_18_axis_broadcaster/S_AXIS]
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_3 declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_20_axis_broadcaster/M_AXIS_3 declared=40 actual=ERR $__err" }
if {[catch {
