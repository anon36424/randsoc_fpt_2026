...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1ff CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_0_gpio/gpio_0]
