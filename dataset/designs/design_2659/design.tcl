...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 6 CONFIG.convolution_code0 28 CONFIG.convolution_code1 31 CONFIG.convolution_code2 29 CONFIG.convolution_code3 35 CONFIG.convolution_code4 28 CONFIG.convolution_code5 33 CONFIG.convolution_code6 41 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 1 " [get_bd_cells ip_2_conv_encoder/conv_encoder_0]
