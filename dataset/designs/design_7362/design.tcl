...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 103 CONFIG.C_SDA_INERTIAL_DELAY 227 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 438.9719448558708 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SPI_MEMORY 4 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_4_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 213 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 258 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 212 -to 0 ip_7_accumulator/B
connect_bd_net [get_bd_pins ip_7_accumulator/B] [get_bd_pins ip_7_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 257 -to 0 ip_7_accumulator/Q
...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SPI_MEMORY 0 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 0 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_8_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 8 " [get_bd_cells ip_13_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_14_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 54 -to 0 ip_15_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_15_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 55 " [get_bd_cells ip_15_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 1 " [get_bd_cells ip_15_reduce/reduce_31]
...
create_bd_pin -dir O -from 54 -to 0 ip_16_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells concat]
set_property -dict "CONFIG.NUM_PORTS 16 " [get_bd_cells ip_16_slice_and_concat/concat]
...
create_bd_pin -dir I -from 8 -to 0 ip_16_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_4] [get_bd_pins ip_16_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 8 -to 0 ip_16_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_5] [get_bd_pins ip_16_slice_and_concat/concat/In5]
create_bd_pin -dir I -from 3 -to 0 ip_16_slice_and_concat/in_6
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_6] [get_bd_pins ip_16_slice_and_concat/concat/In6]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_7
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_7] [get_bd_pins ip_16_slice_and_concat/concat/In7]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_8
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_8] [get_bd_pins ip_16_slice_and_concat/concat/In8]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_9
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_9] [get_bd_pins ip_16_slice_and_concat/concat/In9]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_10] [get_bd_pins ip_16_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_11
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_11] [get_bd_pins ip_16_slice_and_concat/concat/In11]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_12
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_12] [get_bd_pins ip_16_slice_and_concat/concat/In12]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_13
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_13] [get_bd_pins ip_16_slice_and_concat/concat/In13]
create_bd_pin -dir I -from 0 -to 0 ip_16_slice_and_concat/in_14
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_14] [get_bd_pins ip_16_slice_and_concat/concat/In14]
create_bd_pin -dir I -from 257 -to 0 ip_16_slice_and_concat/in_15
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_15
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells slice_15]
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_16_slice_and_concat/slice_15]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_15] [get_bd_pins ip_16_slice_and_concat/slice_15/din]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/slice_15/dout] [get_bd_pins ip_16_slice_and_concat/concat/In15]


########## slice_and_concat ##########
create_bd_cell -type hier ip_17_slice_and_concat
create_bd_pin -dir O -from 8 -to 0 ip_17_slice_and_concat/out0
create_bd_pin -dir I -from 257 -to 0 ip_17_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_17_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 257 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 212 -to 0 ip_19_slice_and_concat/out0
create_bd_pin -dir I -from 257 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 248 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 8 -to 0 ip_20_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 257 CONFIG.DIN_TO 249 CONFIG.DIN_WIDTH 258 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_9_reset/peripheral_areset_n] [get_bd_pins ip_1_axi_timer/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_1_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_10_clk_wiz/clk_out] [get_bd_pins ip_5_axi_dma/m_axi_mm2s_aclk]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_1] [get_bd_pins ip_1_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_11_intc/irq_2] [get_bd_pins ip_4_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_11_intc/irq_3] [get_bd_pins ip_5_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_11_intc/irq_4] [get_bd_pins ip_8_axi_quad_spi/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_12_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_iic/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_5_axi_dma/M_AXIS_MM2S]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_3] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_4] [get_bd_pins ip_2_dft/XK_RE]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_5] [get_bd_pins ip_2_dft/XK_IM]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_6] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_7] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_8] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_9] [get_bd_pins ip_6_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_10] [get_bd_pins ip_6_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_11] [get_bd_pins ip_6_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_12] [get_bd_pins ip_6_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_13] [get_bd_pins ip_6_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_14] [get_bd_pins ip_6_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/in_15] [get_bd_pins ip_7_accumulator/Q]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_IM]
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_7_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/B]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_6_xadc_wiz/convst_in]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/out0] [get_bd_pins ip_23_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_2_dft/CE]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_24_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_2_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_25_slice_and_concat/in_0] [get_bd_pins ip_6_xadc_wiz/vbram_alarm_out]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_7_accumulator/ADD]
