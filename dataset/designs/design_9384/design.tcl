...
set_property -dict "CONFIG.AINIT_Value 1710e3ba6135213f251e8c6f94b7db5 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 29 CONFIG.Latency 19 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 121 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 120 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 209 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 225 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 62 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 32 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_5_gpio/gpio_0]
...
create_bd_pin -dir I -from 110 -to 0 ip_10_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 77 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 78 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 86 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 87 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 92 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 93 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 98 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 101 CONFIG.DIN_TO 99 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 102 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 107 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 110 CONFIG.DIN_TO 108 CONFIG.DIN_WIDTH 111 " [get_bd_cells ip_10_reduce/slice_31]
...
create_bd_pin -dir O -from 28 -to 0 ip_11_slice_and_concat/out0
create_bd_pin -dir I -from 120 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 121 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 110 -to 0 ip_12_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 120 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 121 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 224 -to 0 ip_12_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 225 " [get_bd_cells ip_12_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 208 -to 0 ip_13_slice_and_concat/out0
create_bd_pin -dir I -from 224 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 224 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 225 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_2] [get_bd_pins ip_4_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_9_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_9_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_1] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_2] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_3] [get_bd_pins ip_1_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_4] [get_bd_pins ip_3_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_1_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/C_IN]
