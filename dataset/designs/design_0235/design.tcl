...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 62 CONFIG.aresetn 1 CONFIG.atuserwidth 22 CONFIG.bportwidth 18 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 71 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x3a CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 67 CONFIG.C_SDA_INERTIAL_DELAY 6 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 67.7597247418353 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 2 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_10_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_11_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_5_intc/irq_0] [get_bd_pins ip_2_axi_iic/irq]
