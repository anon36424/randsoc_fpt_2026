...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4d CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 126 CONFIG.C_SDA_INERTIAL_DELAY 86 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 122.97028631228923 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_4] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_5] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_6] [get_bd_pins ip_3_axi_timer/pwm0]
