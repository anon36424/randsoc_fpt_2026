...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x29 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 32 CONFIG.C_SDA_INERTIAL_DELAY 163 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 911.363781223189 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x5c41866a12bc86a CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6a403f6632ba905 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x8 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 28 CONFIG.C_SDA_INERTIAL_DELAY 162 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 813.9623973133089 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 44 CONFIG.convolution_code1 98 CONFIG.convolution_code2 260 CONFIG.convolution_code3 269 CONFIG.convolution_code4 509 CONFIG.convolution_code5 498 CONFIG.convolution_code6 203 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 8 CONFIG.output_rate 14 CONFIG.puncture_code0 11101111 CONFIG.puncture_code1 11110111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_8_conv_encoder/conv_encoder_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_5] [get_bd_pins ip_7_axi_iic/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_M1]
