...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 235 CONFIG.Latency 28 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 257 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 234 -to 0 ip_1_accumulator/B
...
create_bd_pin -dir O -from 234 -to 0 ip_11_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 234 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 20 -to 0 ip_12_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 255 CONFIG.DIN_TO 235 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 256 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/SCLR]
