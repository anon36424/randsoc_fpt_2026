...
set_property -dict "CONFIG.C_MASK 0x99155cc36166cd2 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x947ab2a4e44dcb4 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 184 CONFIG.Latency 26 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 209 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 56 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 3 CONFIG.C_TAVDV_PS_MEM_0 14020 CONFIG.C_TCEDV_PS_MEM_0 13528 CONFIG.C_THZCE_PS_MEM_0 6429 CONFIG.C_THZOE_PS_MEM_0 6743 CONFIG.C_TLZWE_PS_MEM_0 8645 CONFIG.C_TWC_PS_MEM_0 15763 CONFIG.C_TWPH_PS_MEM_0 11526 CONFIG.C_TWP_PS_MEM_0 12007 CONFIG.C_WR_REC_TIME_MEM_0 28308 " [get_bd_cells ip_9_emc/emc_0]
...
create_bd_pin -dir O -from 183 -to 0 ip_16_slice_and_concat/out0
create_bd_pin -dir I -from 208 -to 0 ip_16_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_16_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 183 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 209 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 208 CONFIG.DIN_TO 184 CONFIG.DIN_WIDTH 209 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_S1]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_2_conv_encoder/aclken]
