...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 2048 " [get_bd_cells ip_4_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 5 CONFIG.convolution_code0 21 CONFIG.convolution_code1 27 CONFIG.convolution_code2 3 CONFIG.convolution_code3 30 CONFIG.convolution_code4 25 CONFIG.convolution_code5 18 CONFIG.convolution_code6 24 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 10 CONFIG.output_rate 18 CONFIG.puncture_code0 1111111110 CONFIG.puncture_code1 1111101111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x76 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 116 CONFIG.C_SDA_INERTIAL_DELAY 87 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 169.76595291736425 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x23 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 30 CONFIG.C_SDA_INERTIAL_DELAY 102 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 145.3993146062386 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
create_bd_pin -dir I -from 41 -to 0 ip_27_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_27_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_16_axi/AXI_S2]
