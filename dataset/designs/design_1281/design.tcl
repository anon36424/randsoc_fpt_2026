...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x69 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 218 CONFIG.C_SDA_INERTIAL_DELAY 86 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 625.0156816154849 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 51 CONFIG.aresetn 0 CONFIG.atuserwidth 219 CONFIG.bportwidth 16 CONFIG.btuserwidth 71 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 47 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 56 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 7 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 25 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 35 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 44 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 6 CONFIG.convolution_code0 6 CONFIG.convolution_code1 2 CONFIG.convolution_code2 54 CONFIG.convolution_code3 16 CONFIG.convolution_code4 31 CONFIG.convolution_code5 36 CONFIG.convolution_code6 54 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 12 CONFIG.output_rate 20 CONFIG.puncture_code0 111101011111 CONFIG.puncture_code1 011111011111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_7_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 14 " [get_bd_cells ip_15_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 52 -to 0 ip_18_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 53 " [get_bd_cells ip_18_reduce/slice_31]
...
create_bd_pin -dir O -from 52 -to 0 ip_19_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 43 -to 0 ip_19_slice_and_concat/in_0
...
create_bd_pin -dir I -from 24 -to 0 ip_19_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 25 " [get_bd_cells ip_19_slice_and_concat/slice_4]
...
create_bd_pin -dir I -from 24 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 25 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 34 -to 0 ip_21_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 24 -to 0 ip_21_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 25 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 43 -to 0 ip_21_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_21_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 20 -to 0 ip_22_slice_and_concat/out0
create_bd_pin -dir I -from 43 -to 0 ip_22_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_22_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 8 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_1_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_16_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_complex_multiplier/S_AXIS_A] [get_bd_intf_pins ip_17_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_3_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_3_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_3] [get_bd_pins ip_3_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_1] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_25_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/CE]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/out0] [get_bd_pins ip_3_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/SCLR]
...
if {[catch {
  ...
  set __s [expr {$__aw == 112 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_dwidth_converter/S_AXIS declared=112 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_dwidth_converter/S_AXIS declared=112 actual=ERR $__err" }
if {[catch {
