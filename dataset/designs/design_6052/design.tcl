...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5a CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 171 CONFIG.C_SDA_INERTIAL_DELAY 76 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 756.9954706264297 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 54 CONFIG.aresetn 0 CONFIG.bportwidth 16 CONFIG.btuserwidth 91 CONFIG.ctrltuserwidth 71 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 14 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 27 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 3 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_MEM3_TYPE 3 CONFIG.C_MEM3_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 4 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_PARITY_TYPE_MEM_3 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 CONFIG.C_TAVDV_PS_MEM_0 15579 CONFIG.C_TAVDV_PS_MEM_1 14653 CONFIG.C_TAVDV_PS_MEM_2 15970 CONFIG.C_TAVDV_PS_MEM_3 14850 CONFIG.C_TCEDV_PS_MEM_0 16117 CONFIG.C_TCEDV_PS_MEM_1 14715 CONFIG.C_TCEDV_PS_MEM_2 15253 CONFIG.C_TCEDV_PS_MEM_3 16304 CONFIG.C_THZCE_PS_MEM_0 7248 CONFIG.C_THZCE_PS_MEM_1 7210 CONFIG.C_THZCE_PS_MEM_2 7061 CONFIG.C_THZCE_PS_MEM_3 6600 CONFIG.C_THZOE_PS_MEM_0 7616 CONFIG.C_THZOE_PS_MEM_1 6699 CONFIG.C_THZOE_PS_MEM_2 7093 CONFIG.C_THZOE_PS_MEM_3 7222 CONFIG.C_TLZWE_PS_MEM_0 8110 CONFIG.C_TLZWE_PS_MEM_1 1570 CONFIG.C_TLZWE_PS_MEM_2 4780 CONFIG.C_TLZWE_PS_MEM_3 7693 CONFIG.C_TWC_PS_MEM_0 14349 CONFIG.C_TWC_PS_MEM_1 14062 CONFIG.C_TWC_PS_MEM_2 14293 CONFIG.C_TWC_PS_MEM_3 14583 CONFIG.C_TWPH_PS_MEM_0 12440 CONFIG.C_TWPH_PS_MEM_1 11635 CONFIG.C_TWPH_PS_MEM_2 13058 CONFIG.C_TWPH_PS_MEM_3 10977 CONFIG.C_TWP_PS_MEM_0 12923 CONFIG.C_TWP_PS_MEM_1 12960 CONFIG.C_TWP_PS_MEM_2 10813 CONFIG.C_TWP_PS_MEM_3 12373 CONFIG.C_WR_REC_TIME_MEM_0 29178 CONFIG.C_WR_REC_TIME_MEM_1 29568 CONFIG.C_WR_REC_TIME_MEM_2 26118 CONFIG.C_WR_REC_TIME_MEM_3 27943 " [get_bd_cells ip_2_emc/emc_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_emc/AXI] [get_bd_intf_pins ip_9_axi_legacy/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axis_combiner/S_AXIS_1] [get_bd_intf_pins ip_10_axis_broadcaster/M_AXIS_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_10_axis_broadcaster/M_AXIS_3]
...
if {[catch {
  ...
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_2 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_2 declared=16 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_10_axis_broadcaster/axis_broadcaster_0/M03_AXIS]] * 8}]
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_3 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_broadcaster/M_AXIS_3 declared=16 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 16 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_combiner/S_AXIS_0 declared=16 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_combiner/S_AXIS_0 declared=16 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 32 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_15_axis_combiner/M_AXIS declared=32 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_15_axis_combiner/M_AXIS declared=32 actual=ERR $__err" }
if {[catch {
