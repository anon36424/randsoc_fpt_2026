...
set_property -dict "CONFIG.C_MASK 0x776172d9018e334 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x8bf828583c13af1 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 167 -to 0 ip_3_accumulator/B
connect_bd_net [get_bd_pins ip_3_accumulator/B] [get_bd_pins ip_3_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 241 -to 0 ip_3_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 8 CONFIG.convolution_code0 247 CONFIG.convolution_code1 134 CONFIG.convolution_code2 142 CONFIG.convolution_code3 95 CONFIG.convolution_code4 121 CONFIG.convolution_code5 117 CONFIG.convolution_code6 67 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 11 CONFIG.output_rate 14 CONFIG.puncture_code0 10100110111 CONFIG.puncture_code1 11110010110 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_4_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir I -from 76 -to 0 ip_11_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 48 CONFIG.DIN_TO 47 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 49 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 52 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 54 CONFIG.DIN_TO 53 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 56 CONFIG.DIN_TO 55 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 58 CONFIG.DIN_TO 57 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 59 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 62 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 64 CONFIG.DIN_TO 63 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 66 CONFIG.DIN_TO 65 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 68 CONFIG.DIN_TO 67 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 69 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 72 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 74 CONFIG.DIN_TO 73 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 76 CONFIG.DIN_TO 75 CONFIG.DIN_WIDTH 77 " [get_bd_cells ip_11_reduce/slice_31]
...
create_bd_pin -dir O -from 167 -to 0 ip_12_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 241 -to 0 ip_12_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 164 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_12_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 76 -to 0 ip_13_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 241 CONFIG.DIN_TO 165 CONFIG.DIN_WIDTH 242 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_1] [get_bd_pins ip_5_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_9_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_intc/AXI] [get_bd_intf_pins ip_9_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_10_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_3] [get_bd_pins ip_3_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/Bypass]
