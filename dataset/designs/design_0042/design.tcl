...
set_property -dict "CONFIG.NUM_PORTS 5 " [get_bd_cells ip_7_slice_and_concat/concat]
...
create_bd_pin -dir I -from 14 -to 0 ip_7_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_7_slice_and_concat/slice_4]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_4] [get_bd_pins ip_7_slice_and_concat/slice_4/din]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/slice_4/dout] [get_bd_pins ip_7_slice_and_concat/concat/In4]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_8_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_timer/S_AXI] [get_bd_intf_pins ip_6_axi_legacy/AXI_S0]
...
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_0] [get_bd_pins ip_0_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_1] [get_bd_pins ip_0_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_2] [get_bd_pins ip_0_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_3] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_4] [get_bd_pins ip_1_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/capturetrig0]
