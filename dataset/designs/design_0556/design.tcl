...
set_property -dict "CONFIG.AINIT_Value 7fffffffffffffffffffffffffffffffffffffffff CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 142 CONFIG.Latency 8 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 167 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 141 -to 0 ip_1_accumulator/B
connect_bd_net [get_bd_pins ip_1_accumulator/B] [get_bd_pins ip_1_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 166 -to 0 ip_1_accumulator/Q
...
set_property -dict "CONFIG.C_MEM0_TYPE 2 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_MEM2_TYPE 2 CONFIG.C_MEM2_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 15057 CONFIG.C_TAVDV_PS_MEM_1 13975 CONFIG.C_TAVDV_PS_MEM_2 15500 CONFIG.C_TCEDV_PS_MEM_0 15857 CONFIG.C_TCEDV_PS_MEM_1 13811 CONFIG.C_TCEDV_PS_MEM_2 14850 CONFIG.C_THZCE_PS_MEM_0 6520 CONFIG.C_THZCE_PS_MEM_1 7297 CONFIG.C_THZCE_PS_MEM_2 6765 CONFIG.C_THZOE_PS_MEM_0 6357 CONFIG.C_THZOE_PS_MEM_1 6998 CONFIG.C_THZOE_PS_MEM_2 7059 CONFIG.C_TLZWE_PS_MEM_0 8294 CONFIG.C_TLZWE_PS_MEM_1 9709 CONFIG.C_TLZWE_PS_MEM_2 7670 CONFIG.C_TWC_PS_MEM_0 15465 CONFIG.C_TWC_PS_MEM_1 14766 CONFIG.C_TWC_PS_MEM_2 14602 CONFIG.C_TWPH_PS_MEM_0 12684 CONFIG.C_TWPH_PS_MEM_1 12464 CONFIG.C_TWPH_PS_MEM_2 12661 CONFIG.C_TWP_PS_MEM_0 10986 CONFIG.C_TWP_PS_MEM_1 11584 CONFIG.C_TWP_PS_MEM_2 12096 CONFIG.C_WR_REC_TIME_MEM_0 26965 CONFIG.C_WR_REC_TIME_MEM_1 28848 CONFIG.C_WR_REC_TIME_MEM_2 28728 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.a_precision_type Single CONFIG.a_tuser_width 5 CONFIG.add_sub_value Both CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_invalid_op 1 CONFIG.c_has_overflow 0 CONFIG.c_has_underflow 0 CONFIG.c_mult_usage No_Usage CONFIG.c_result_exponent_width 7 CONFIG.c_result_fraction_width 48 CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 0 CONFIG.has_a_tuser 1 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 0 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 0 CONFIG.has_operation_tlast 0 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type Float_to_float CONFIG.result_precision_type Custom " [get_bd_cells ip_4_floating_point/floating_point_0]
...
set_property -dict "CONFIG.NUM_MI 3 CONFIG.NUM_SI 2 " [get_bd_cells ip_8_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 1 CONFIG.S_TDATA_NUM_BYTES 7 " [get_bd_cells ip_10_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir O -from 11 -to 0 ip_11_slice_and_concat/out0
create_bd_pin -dir I -from 166 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 167 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 141 -to 0 ip_12_slice_and_concat/out0
create_bd_pin -dir I -from 166 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 153 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 167 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 166 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 159 CONFIG.DIN_TO 154 CONFIG.DIN_WIDTH 167 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 25 -to 0 ip_14_slice_and_concat/out0
...
create_bd_pin -dir I -from 166 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 166 CONFIG.DIN_TO 160 CONFIG.DIN_WIDTH 167 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_14_slice_and_concat/slice_3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_8_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_8_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_floating_point/S_AXIS_A] [get_bd_intf_pins ip_9_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_4_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_3] [get_bd_pins ip_3_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_3_dft/CE]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_3_dft/FWD_INV]
...
if {[catch {
  ...
  set __s [expr {$__aw == 56 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_10_axis_dwidth_converter/S_AXIS declared=56 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_10_axis_dwidth_converter/S_AXIS declared=56 actual=ERR $__err" }
if {[catch {
