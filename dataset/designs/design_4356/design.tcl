...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1ffffff CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 25 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x1ffffff CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 13 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_8_dft/dft_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x7fffffff CONFIG.C_DOUT_DEFAULT_2 0x2ed0d7b5 CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 31 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_11_gpio/gpio_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_7] [get_bd_pins ip_11_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S6]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_6] [get_bd_pins ip_10_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/out0] [get_bd_pins ip_7_cordic/aclken]
