...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 136 CONFIG.convolution_code1 363 CONFIG.convolution_code2 271 CONFIG.convolution_code3 1 CONFIG.convolution_code4 160 CONFIG.convolution_code5 301 CONFIG.convolution_code6 331 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 10 CONFIG.output_rate 11 CONFIG.puncture_code0 0110010101 CONFIG.puncture_code1 1011010110 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_0_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 17 CONFIG.aresetn 0 CONFIG.bportwidth 23 CONFIG.btuserwidth 38 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 10 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1ff CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 11 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x1ff CONFIG.C_TRI_DEFAULT_2 0x1ff " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 35 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 47 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x26 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 46 CONFIG.C_SDA_INERTIAL_DELAY 161 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 500.2453824697977 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 13 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_7_dft/dft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 48 CONFIG.aresetn 1 CONFIG.bportwidth 56 CONFIG.btuserwidth 95 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 47 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 10 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 1 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 0 CONFIG.C_READ_FIFO_DEPTH 128 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_9_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 13 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 46 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 47 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_34_slice_and_concat/slice_3]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_0] [get_bd_pins ip_2_gpio/irq]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_4] [get_bd_pins ip_10_xadc_wiz/ip2intc_irpt]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_gpio/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S0]
