...
set_property -dict "CONFIG.AINIT_Value 1469d569351978dbf6d378105f1778ddd6e10 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 131 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 146 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 145 -to 0 ip_6_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_6_slice_and_concat/slice_3]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_3] [get_bd_pins ip_6_slice_and_concat/slice_3/din]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/slice_3/dout] [get_bd_pins ip_6_slice_and_concat/concat/In3]


########## slice_and_concat ##########
create_bd_cell -type hier ip_7_slice_and_concat
create_bd_pin -dir O -from 130 -to 0 ip_7_slice_and_concat/out0
create_bd_pin -dir I -from 145 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_3] [get_bd_pins ip_2_accumulator/Q]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/B]
connect_bd_net [get_bd_pins ip_7_slice_and_concat/in_0] [get_bd_pins ip_2_accumulator/Q]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/C_IN]
...
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_0] [get_bd_pins ip_0_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_1] [get_bd_pins ip_0_xadc_wiz/vbram_alarm_out]
