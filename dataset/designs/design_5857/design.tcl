...
set_property -dict "CONFIG.C_MASK 0x7ad305406de7bac CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6d13f3dd1e0c983 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 44 CONFIG.aresetn 0 CONFIG.bportwidth 58 CONFIG.btuserwidth 58 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 59 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 113 CONFIG.Latency 26 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 146 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 112 -to 0 ip_6_accumulator/B
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 5 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 4 CONFIG.C_TAVDV_PS_MEM_0 13661 CONFIG.C_TAVDV_PS_MEM_1 15374 CONFIG.C_TCEDV_PS_MEM_0 13942 CONFIG.C_TCEDV_PS_MEM_1 14506 CONFIG.C_THZCE_PS_MEM_0 7285 CONFIG.C_THZCE_PS_MEM_1 7241 CONFIG.C_THZOE_PS_MEM_0 6351 CONFIG.C_THZOE_PS_MEM_1 6500 CONFIG.C_TLZWE_PS_MEM_0 3 CONFIG.C_TLZWE_PS_MEM_1 8813 CONFIG.C_TWC_PS_MEM_0 14100 CONFIG.C_TWC_PS_MEM_1 13712 CONFIG.C_TWPH_PS_MEM_0 13006 CONFIG.C_TWPH_PS_MEM_1 12012 CONFIG.C_TWP_PS_MEM_0 13023 CONFIG.C_TWP_PS_MEM_1 10899 CONFIG.C_WR_REC_TIME_MEM_0 29015 CONFIG.C_WR_REC_TIME_MEM_1 28386 " [get_bd_cells ip_10_emc/emc_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 17 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_11_dft/dft_0]
...
create_bd_pin -dir O -from 112 -to 0 ip_28_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 145 -to 0 ip_28_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_28_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 146 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_2] [get_bd_pins ip_2_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_14_intc/irq_3] [get_bd_pins ip_8_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_microblaze/M_AXI_DP] [get_bd_intf_pins ip_15_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_uartlite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/out0] [get_bd_pins ip_11_dft/FD_IN]
