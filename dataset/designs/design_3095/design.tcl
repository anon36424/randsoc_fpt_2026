...
set_property -dict "CONFIG.C_MASK 0x2bdaabf51bc8851 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x37bee4c2fa511c5 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_3_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 252 -to 0 ip_5_accumulator/B
...
set_property -dict "CONFIG.C_ADDR_WIDTH 39 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_7_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x2868c21c CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 13 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x26aecefc CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 39 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_10_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_BAUDRATE 110 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Even " [get_bd_cells ip_12_uartlite/uart_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 34 CONFIG.aresetn 1 CONFIG.bportwidth 51 CONFIG.btuserwidth 112 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 50 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 29 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_14_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 16 " [get_bd_cells ip_15_fft/fft_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_38_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 252 -to 0 ip_39_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 256 -to 0 ip_39_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_39_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 221 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_39_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 227 CONFIG.DIN_TO 222 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_40_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 237 CONFIG.DIN_TO 228 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 254 CONFIG.DIN_TO 238 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_42_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 255 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_43_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_43_slice_and_concat/slice_2]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_2] [get_bd_pins ip_1_axi_quad_spi/irq]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_5] [get_bd_pins ip_10_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_21_intc/irq_6] [get_bd_pins ip_12_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_22_axi_legacy/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_22_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_22_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_microblaze/M_AXI_DP] [get_bd_intf_pins ip_22_axi_legacy/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/M_AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_M4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_cdma/M_AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_gpio/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_uartlite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S8]
...
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_2] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_3] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_4] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_5] [get_bd_pins ip_5_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_1] [get_bd_pins ip_13_dft/RFFD]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/in_2] [get_bd_pins ip_13_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_13_dft/FD_IN]
