...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 61 CONFIG.aresetn 0 CONFIG.bportwidth 45 CONFIG.ctrltuserwidth 74 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 28 CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 17 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_0_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 24 CONFIG.Latency 13 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 205 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 23 -to 0 ip_1_accumulator/B
...
set_property -dict "CONFIG.AINIT_Value da8c6144e1a4a63a382f32f8d93b5b1e4e508ad6c60f857e37eb64a CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 148 CONFIG.Latency 30 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 227 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 147 -to 0 ip_4_accumulator/B
connect_bd_net [get_bd_pins ip_4_accumulator/B] [get_bd_pins ip_4_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 226 -to 0 ip_4_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 81 CONFIG.Latency 23 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 248 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 247 -to 0 ip_6_accumulator/Q
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 4096 " [get_bd_cells ip_7_fft/fft_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Arc_Tan CONFIG.Input_Width 9 CONFIG.Iterations 4 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 35 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 37 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_8_cordic/cordic_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_9_dft/dft_0]
...
set_property -dict "CONFIG.channels 11 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 16 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.NUM_MI 4 CONFIG.NUM_SI 1 " [get_bd_cells ip_15_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_20_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 36 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_21_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 5 " [get_bd_cells ip_22_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 5 " [get_bd_cells ip_23_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 429 -to 0 ip_24_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_0]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_0]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_1]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_1]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_2]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_2]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_3]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_3]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_4]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_4]
...
set_property -dict "CONFIG.DIN_FROM 83 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 97 CONFIG.DIN_TO 84 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 111 CONFIG.DIN_TO 98 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 112 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 153 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 167 CONFIG.DIN_TO 154 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 181 CONFIG.DIN_TO 168 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 195 CONFIG.DIN_TO 182 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 14 " [get_bd_cells ip_24_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 208 CONFIG.DIN_TO 196 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 221 CONFIG.DIN_TO 209 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 234 CONFIG.DIN_TO 222 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 247 CONFIG.DIN_TO 235 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 260 CONFIG.DIN_TO 248 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 273 CONFIG.DIN_TO 261 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 286 CONFIG.DIN_TO 274 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 299 CONFIG.DIN_TO 287 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 312 CONFIG.DIN_TO 300 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 325 CONFIG.DIN_TO 313 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 338 CONFIG.DIN_TO 326 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 351 CONFIG.DIN_TO 339 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 364 CONFIG.DIN_TO 352 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 377 CONFIG.DIN_TO 365 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 390 CONFIG.DIN_TO 378 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_28]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_28]
...
set_property -dict "CONFIG.DIN_FROM 403 CONFIG.DIN_TO 391 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_29]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_29]
...
set_property -dict "CONFIG.DIN_FROM 416 CONFIG.DIN_TO 404 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_30]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_30]
...
set_property -dict "CONFIG.DIN_FROM 429 CONFIG.DIN_TO 417 CONFIG.DIN_WIDTH 430 " [get_bd_cells ip_24_reduce/slice_31]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 13 " [get_bd_cells ip_24_reduce/reduce_31]
...
create_bd_pin -dir O -from 23 -to 0 ip_25_slice_and_concat/out0
create_bd_pin -dir I -from 204 -to 0 ip_25_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_25_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 204 -to 0 ip_26_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_26_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 204 -to 0 ip_27_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_27_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_27_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 80 -to 0 ip_28_slice_and_concat/out0
create_bd_pin -dir I -from 204 -to 0 ip_28_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 114 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_28_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 429 -to 0 ip_29_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 204 CONFIG.DIN_TO 115 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_29_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 226 -to 0 ip_29_slice_and_concat/in_1
...
create_bd_pin -dir I -from 247 -to 0 ip_29_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_29_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_29_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 118 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 124 CONFIG.DIN_TO 119 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 147 -to 0 ip_32_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 247 CONFIG.DIN_TO 125 CONFIG.DIN_WIDTH 248 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_3_axi_hwicap/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset_n] [get_bd_pins ip_5_axi_timer/s_axi_aresetn]
connect_bd_net [get_bd_pins ip_11_reset/peripheral_areset] [get_bd_pins ip_9_dft/SCLR]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_0_complex_multiplier/aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_1_accumulator/clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_2_axi_ethernet_lite/clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_3_axi_hwicap/icap_clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_3_axi_hwicap/s_axi_aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_4_accumulator/clk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_5_axi_timer/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_8_cordic/aclk]
connect_bd_net [get_bd_pins ip_12_clk_wiz/clk_out] [get_bd_pins ip_9_dft/CLK]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_0] [get_bd_pins ip_2_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_3_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_13_intc/irq_2] [get_bd_pins ip_5_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_15_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_intc/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_cordic/M_AXIS_DOUT] [get_bd_intf_pins ip_18_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_cordic/S_AXIS_CARTESIAN] [get_bd_intf_pins ip_20_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_DATA] [get_bd_intf_pins ip_18_axis_broadcaster/M_AXIS_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_fft/S_AXIS_DATA] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_22_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_29_slice_and_concat/out0] [get_bd_pins ip_24_reduce/in0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_0] [get_bd_pins ip_1_accumulator/Q]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_1] [get_bd_pins ip_4_accumulator/Q]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_2] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_29_slice_and_concat/in_5] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/out0] [get_bd_pins ip_9_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/C_IN]
...
connect_bd_net [get_bd_pins ip_47_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/ADD]
...
if {[catch {
  ...
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_broadcaster/S_AXIS declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_broadcaster/S_AXIS declared=48 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_17_axis_broadcaster/axis_broadcaster_0/M00_AXIS]] * 8}]
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_broadcaster/M_AXIS_0 declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_broadcaster/M_AXIS_0 declared=48 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_17_axis_broadcaster/axis_broadcaster_0/M01_AXIS]] * 8}]
  set __s [expr {$__aw == 48 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_17_axis_broadcaster/M_AXIS_1 declared=48 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_17_axis_broadcaster/M_AXIS_1 declared=48 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 40 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_18_axis_broadcaster/M_AXIS_2 declared=40 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_18_axis_broadcaster/M_AXIS_2 declared=40 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_21_axis_dwidth_converter/M_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_21_axis_dwidth_converter/M_AXIS declared=288 actual=ERR $__err" }
if {[catch {
