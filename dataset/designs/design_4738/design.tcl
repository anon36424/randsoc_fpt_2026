...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 3 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 21 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 18 -to 0 ip_4_slice_and_concat/out0
create_bd_pin -dir I -from 20 -to 0 ip_4_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_4_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 21 " [get_bd_cells ip_4_slice_and_concat/slice_0]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_0] [get_bd_pins ip_4_slice_and_concat/slice_0/din]
connect_bd_net [get_bd_pins ip_4_slice_and_concat/out0] [get_bd_pins ip_4_slice_and_concat/slice_0/dout]


########## slice_and_concat ##########
create_bd_cell -type hier ip_5_slice_and_concat
create_bd_pin -dir O -from 9 -to 0 ip_5_slice_and_concat/out0
...
create_bd_pin -dir I -from 20 -to 0 ip_5_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 21 " [get_bd_cells ip_5_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_5_slice_and_concat/in_2
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_2
move_bd_cells [get_bd_cells ip_5_slice_and_concat] [get_bd_cells slice_2]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_5_slice_and_concat/slice_2]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_2] [get_bd_pins ip_5_slice_and_concat/slice_2/din]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/slice_2/dout] [get_bd_pins ip_5_slice_and_concat/concat/In2]
...
create_bd_pin -dir I -from 9 -to 0 ip_6_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_6_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_6_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_6_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins data_O] [get_bd_pins ip_4_slice_and_concat/out0]
...
connect_bd_net [get_bd_pins ip_4_slice_and_concat/in_0] [get_bd_pins ip_0_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_1] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_2] [get_bd_pins ip_1_dft/XK_RE]
