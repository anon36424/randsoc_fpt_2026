...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 50 CONFIG.aresetn 1 CONFIG.bportwidth 56 CONFIG.btuserwidth 45 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 4 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 4 CONFIG.roundmode Random_Rounding " [get_bd_cells ip_2_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 10 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_3_dft/dft_0]
...
set_property -dict "CONFIG.C_BAUDRATE 2400 CONFIG.C_DATA_BITS 7 CONFIG.PARITY No_Parity " [get_bd_cells ip_5_uartlite/uart_0]
...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_9_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x30 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 220 CONFIG.C_SDA_INERTIAL_DELAY 254 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 824.4542532552749 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_10_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 35 CONFIG.aresetn 1 CONFIG.atuserwidth 149 CONFIG.bportwidth 15 CONFIG.btuserwidth 196 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 46 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_11_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.NUM_MI 5 CONFIG.NUM_SI 1 " [get_bd_cells ip_15_axi/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 14 CONFIG.S_TDATA_NUM_BYTES 14 " [get_bd_cells ip_24_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 9 -to 0 ip_28_slice_and_concat/in_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_7
move_bd_cells [get_bd_cells ip_28_slice_and_concat] [get_bd_cells slice_7]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_28_slice_and_concat/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_29_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 10 " [get_bd_cells ip_30_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_30_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_32_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 15 -to 0 ip_33_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_33_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_35_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_38_slice_and_concat/slice_7]
...
connect_bd_net [get_bd_pins ip_13_clk_wiz/clk_out] [get_bd_pins ip_9_dft/CLK]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_0] [get_bd_pins ip_5_uartlite/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_1] [get_bd_pins ip_7_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_2] [get_bd_pins ip_8_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_14_intc/irq_3] [get_bd_pins ip_10_axi_iic/irq]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_uartlite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_timer/S_AXI] [get_bd_intf_pins ip_15_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_iic/AXI] [get_bd_intf_pins ip_15_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_intc/AXI] [get_bd_intf_pins ip_15_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_1_conv_encoder/M_AXIS_DATA] [get_bd_intf_pins ip_17_axis_broadcaster/S_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_complex_multiplier/S_AXIS_B] [get_bd_intf_pins ip_21_axis_dwidth_converter/M_AXIS]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_27_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_16_axis_broadcaster/M_AXIS_3]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_4] [get_bd_pins ip_4_dft/RFFD]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_5] [get_bd_pins ip_4_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_32_slice_and_concat/in_0] [get_bd_pins ip_4_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_42_slice_and_concat/out0] [get_bd_pins ip_0_xadc_wiz/convst_in]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_2_complex_multiplier/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_18_axis_broadcaster/M_AXIS_2 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_18_axis_broadcaster/M_AXIS_2 declared=96 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 96 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_23_axis_combiner/S_AXIS_2 declared=96 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_23_axis_combiner/S_AXIS_2 declared=96 actual=ERR $__err" }
if {[catch {
  set __aw [expr {[get_property CONFIG.TDATA_NUM_BYTES [get_bd_intf_pins ip_23_axis_combiner/axis_combiner_0/M_AXIS]] * 8}]
  set __s [expr {$__aw == 112 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_23_axis_combiner/M_AXIS declared=112 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_23_axis_combiner/M_AXIS declared=112 actual=ERR $__err" }
if {[catch {
