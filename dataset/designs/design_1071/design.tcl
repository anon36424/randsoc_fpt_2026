...
set_property -dict "CONFIG.C_ADDR_WIDTH 36 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MASK 0x4de04e022d058d7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x8d7aeb768d9d58c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_5_microblaze/lmb_ctrl_i]
...
create_bd_pin -dir I -from 203 -to 0 ip_6_accumulator/B
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 6 CONFIG.convolution_code0 1 CONFIG.convolution_code1 50 CONFIG.convolution_code2 47 CONFIG.convolution_code3 45 CONFIG.convolution_code4 61 CONFIG.convolution_code5 63 CONFIG.convolution_code6 53 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 5 CONFIG.output_rate 8 CONFIG.puncture_code0 11110 CONFIG.puncture_code1 11011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_7_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x55 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 16 CONFIG.C_SDA_INERTIAL_DELAY 23 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 806.3708826387702 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x70 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 77 CONFIG.C_SDA_INERTIAL_DELAY 231 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 288.8698129406783 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
create_bd_pin -dir O -from 203 -to 0 ip_15_slice_and_concat/out0
...
create_bd_pin -dir I -from 219 -to 0 ip_15_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 197 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_15_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 219 CONFIG.DIN_TO 198 CONFIG.DIN_WIDTH 220 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_4] [get_bd_pins ip_4_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_13_axi/AXI_S3]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_3] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_4] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_5] [get_bd_pins ip_4_xadc_wiz/busy_out]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vbram_alarm_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_19_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/out0] [get_bd_pins ip_4_xadc_wiz/convst_in]
connect_bd_net [get_bd_pins ip_20_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/vbram_alarm_out]
