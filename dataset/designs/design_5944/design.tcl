...
set_property -dict "CONFIG.C_BAUDRATE 110 CONFIG.C_DATA_BITS 7 CONFIG.PARITY Even " [get_bd_cells ip_0_uartlite/uart_0]
...
set_property -dict "CONFIG.AINIT_Value d97808bcb8902c0d18783c6e7f CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 30 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 104 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 73 -to 0 ip_12_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 20 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 21 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 26 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 27 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 47 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 48 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 51 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 53 CONFIG.DIN_TO 52 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 54 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 57 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 58 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 61 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 62 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 67 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 68 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 71 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 73 CONFIG.DIN_TO 72 CONFIG.DIN_WIDTH 74 " [get_bd_cells ip_12_reduce/slice_31]
...
create_bd_pin -dir O -from 29 -to 0 ip_13_slice_and_concat/out0
create_bd_pin -dir I -from 103 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 103 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 103 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 104 " [get_bd_cells ip_14_slice_and_concat/slice_0]
