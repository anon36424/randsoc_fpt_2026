...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 27 CONFIG.C_GPIO_WIDTH 22 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x3fffff CONFIG.C_TRI_DEFAULT_2 0x0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_PORTS 6 " [get_bd_cells ip_5_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_5_slice_and_concat/in_3
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_3] [get_bd_pins ip_5_slice_and_concat/concat/In3]
create_bd_pin -dir I -from 0 -to 0 ip_5_slice_and_concat/in_4
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_4] [get_bd_pins ip_5_slice_and_concat/concat/In4]
create_bd_pin -dir I -from 0 -to 0 ip_5_slice_and_concat/in_5
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_5] [get_bd_pins ip_5_slice_and_concat/concat/In5]


########## slice_and_concat ##########
create_bd_cell -type hier ip_6_slice_and_concat
create_bd_pin -dir O -from 3 -to 0 ip_6_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_gpio/AXI] [get_bd_intf_pins ip_4_axi/AXI_S0]
...
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_4] [get_bd_pins ip_1_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_5_slice_and_concat/in_5] [get_bd_pins ip_1_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/user_temp_alarm_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_2] [get_bd_pins ip_1_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/alarm_out]
