...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x19 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 165 CONFIG.C_SDA_INERTIAL_DELAY 249 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 986.2077267967749 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1fffffff CONFIG.C_DOUT_DEFAULT_2 0x1fffffff CONFIG.C_GPIO2_WIDTH 1 CONFIG.C_GPIO_WIDTH 29 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xc79112e CONFIG.C_TRI_DEFAULT_2 0x1fffffff " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1e CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 77 CONFIG.C_SDA_INERTIAL_DELAY 234 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 612.4853438953829 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_8_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.a_precision_type Half CONFIG.add_sub_value Both CONFIG.b_tuser_width 15 CONFIG.c_bram_usage No_Usage CONFIG.c_compare_operation Programmable CONFIG.c_has_overflow 1 CONFIG.c_has_underflow 1 CONFIG.c_mult_usage Medium_Usage CONFIG.c_tuser_width 16 CONFIG.flow_control NonBlocking CONFIG.has_a_tlast 1 CONFIG.has_a_tuser 0 CONFIG.has_aclken 0 CONFIG.has_aresetn 0 CONFIG.has_b_tlast 0 CONFIG.has_b_tuser 1 CONFIG.has_c_tlast 0 CONFIG.has_c_tuser 1 CONFIG.has_operation_tlast 1 CONFIG.has_operation_tuser 0 CONFIG.maximum_latency 1 CONFIG.operation_type FMA CONFIG.result_tlast_behv Pass_A_TLAST " [get_bd_cells ip_9_floating_point/floating_point_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x41 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 89 CONFIG.C_SDA_INERTIAL_DELAY 174 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 960.9741629094273 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_11_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_3] [get_bd_pins ip_3_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_14_intc/irq_4] [get_bd_pins ip_4_gpio/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_5] [get_bd_pins ip_5_axi_ethernet_lite/irq]
connect_bd_net [get_bd_pins ip_14_intc/irq_6] [get_bd_pins ip_7_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_gpio/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_iic/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_emc/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_axi_iic/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S9]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_floating_point/S_AXIS_C] [get_bd_intf_pins ip_23_axis_dwidth_converter/M_AXIS]
