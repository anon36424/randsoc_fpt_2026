...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 32 CONFIG.C_MEM1_TYPE 1 CONFIG.C_MEM1_WIDTH 32 CONFIG.C_MEM2_TYPE 1 CONFIG.C_MEM2_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 3 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_PARITY_TYPE_MEM_2 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 15861 CONFIG.C_TAVDV_PS_MEM_1 15357 CONFIG.C_TAVDV_PS_MEM_2 14000 CONFIG.C_TCEDV_PS_MEM_0 16190 CONFIG.C_TCEDV_PS_MEM_1 14238 CONFIG.C_TCEDV_PS_MEM_2 15582 CONFIG.C_THZCE_PS_MEM_0 6634 CONFIG.C_THZCE_PS_MEM_1 7669 CONFIG.C_THZCE_PS_MEM_2 6474 CONFIG.C_THZOE_PS_MEM_0 6947 CONFIG.C_THZOE_PS_MEM_1 7045 CONFIG.C_THZOE_PS_MEM_2 7277 CONFIG.C_TLZWE_PS_MEM_0 9107 CONFIG.C_TLZWE_PS_MEM_1 421 CONFIG.C_TLZWE_PS_MEM_2 9167 CONFIG.C_TWC_PS_MEM_0 14415 CONFIG.C_TWC_PS_MEM_1 14785 CONFIG.C_TWC_PS_MEM_2 14605 CONFIG.C_TWPH_PS_MEM_0 11754 CONFIG.C_TWPH_PS_MEM_1 11171 CONFIG.C_TWPH_PS_MEM_2 11410 CONFIG.C_TWP_PS_MEM_0 11861 CONFIG.C_TWP_PS_MEM_1 12585 CONFIG.C_TWP_PS_MEM_2 11153 CONFIG.C_WR_REC_TIME_MEM_0 24955 CONFIG.C_WR_REC_TIME_MEM_1 26344 CONFIG.C_WR_REC_TIME_MEM_2 27207 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.NUM_PORTS 5 " [get_bd_cells ip_8_slice_and_concat/concat]
...
create_bd_pin -dir I -from 11 -to 0 ip_8_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_8_slice_and_concat/slice_4]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_4] [get_bd_pins ip_8_slice_and_concat/slice_4/din]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/slice_4/dout] [get_bd_pins ip_8_slice_and_concat/concat/In4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_9_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_9_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_9_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 11 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 12 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_10_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 4 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_7_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_intc/AXI] [get_bd_intf_pins ip_7_axi_legacy/AXI_S3]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_3_dft/XN_RE]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_0_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_1] [get_bd_pins ip_0_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_2] [get_bd_pins ip_0_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_3_dft/RFFD]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_4] [get_bd_pins ip_3_dft/XK_RE]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/out0] [get_bd_pins ip_3_dft/XN_IM]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_0] [get_bd_pins ip_3_dft/XK_RE]
connect_bd_net [get_bd_pins ip_9_slice_and_concat/in_1] [get_bd_pins ip_3_dft/XK_IM]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/out0] [get_bd_pins ip_3_dft/SIZE]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_0] [get_bd_pins ip_3_dft/XK_IM]
connect_bd_net [get_bd_pins ip_10_slice_and_concat/in_1] [get_bd_pins ip_3_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/out0] [get_bd_pins ip_2_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_3_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_0] [get_bd_pins ip_3_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_1] [get_bd_pins ip_3_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_2] [get_bd_pins ip_3_dft/DATA_VALID]
