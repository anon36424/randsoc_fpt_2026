...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 8 CONFIG.C_TAVDV_PS_MEM_0 14687 CONFIG.C_TCEDV_PS_MEM_0 14673 CONFIG.C_THZCE_PS_MEM_0 6677 CONFIG.C_THZOE_PS_MEM_0 7111 CONFIG.C_TLZWE_PS_MEM_0 7754 CONFIG.C_TWC_PS_MEM_0 16157 CONFIG.C_TWPH_PS_MEM_0 11635 CONFIG.C_TWP_PS_MEM_0 12764 CONFIG.C_WR_REC_TIME_MEM_0 27201 " [get_bd_cells ip_3_emc/emc_0]
...
set_property -dict "CONFIG.C_MASK 0x22d800d4510035b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x9d1c744fb0196f7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 21 CONFIG.aresetn 0 CONFIG.atuserwidth 158 CONFIG.bportwidth 36 CONFIG.btuserwidth 74 CONFIG.ctrltuserwidth 49 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 51 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 44 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_10_intc/irq_0] [get_bd_pins ip_1_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI] [get_bd_intf_pins ip_11_axi_legacy/AXI_M1]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/out0] [get_bd_pins ip_7_complex_multiplier/aclken]
