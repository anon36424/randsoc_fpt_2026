...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 1 CONFIG.C_INCLUDE_MDIO 0 CONFIG.C_RX_PING_PONG 1 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_0_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 29 CONFIG.C_GPIO_WIDTH 27 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 19 CONFIG.Iterations 34 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 21 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 23 CONFIG.Round_Mode Nearest_Even " [get_bd_cells ip_3_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 512 " [get_bd_cells ip_5_fft/fft_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 158 CONFIG.convolution_code1 466 CONFIG.convolution_code2 197 CONFIG.convolution_code3 69 CONFIG.convolution_code4 78 CONFIG.convolution_code5 237 CONFIG.convolution_code6 348 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 11 CONFIG.output_rate 12 CONFIG.puncture_code0 11110100101 CONFIG.puncture_code1 10000011011 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MASK 0xf8b921cafaf5bf7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x670059e9380544b CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_11_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x4c CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 134 CONFIG.C_SDA_INERTIAL_DELAY 162 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 358.46141044677177 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_13_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x10b CONFIG.C_DOUT_DEFAULT_2 0x0 CONFIG.C_GPIO2_WIDTH 16 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_14_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DUPLEX 1 CONFIG.C_INCLUDE_GLOBAL_BUFFERS 0 CONFIG.C_INCLUDE_INTERNAL_LOOPBACK 0 CONFIG.C_INCLUDE_MDIO 1 CONFIG.C_RX_PING_PONG 0 CONFIG.C_S_AXI_PROTOCOL AXI4LITE CONFIG.C_TX_PING_PONG 0 " [get_bd_cells ip_15_axi_ethernet_lite/axi_ethernetlite_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 48 CONFIG.S_TDATA_NUM_BYTES 6 " [get_bd_cells ip_27_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_33_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 14 -to 0 ip_37_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_37_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_37_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_38_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_39_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_39_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_41_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_18_intc/irq_3] [get_bd_pins ip_12_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_19_axi/AXI_S2]
...
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_0] [get_bd_pins ip_4_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_1] [get_bd_pins ip_4_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_37_slice_and_concat/in_2] [get_bd_pins ip_4_dft/DATA_VALID]
...
if {[catch {
  ...
  set __s [expr {$__aw == 35 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_31_axis_dwidth_converter/M_AXIS declared=35 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_31_axis_dwidth_converter/M_AXIS declared=35 actual=ERR $__err" }
