...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 13853 CONFIG.C_TCEDV_PS_MEM_0 16431 CONFIG.C_THZCE_PS_MEM_0 7401 CONFIG.C_THZOE_PS_MEM_0 6921 CONFIG.C_TLZWE_PS_MEM_0 1157 CONFIG.C_TWC_PS_MEM_0 14359 CONFIG.C_TWPH_PS_MEM_0 12921 CONFIG.C_TWP_PS_MEM_0 11296 CONFIG.C_WR_REC_TIME_MEM_0 26845 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 32 CONFIG.C_GPIO_WIDTH 3 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5c CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 104 CONFIG.C_SDA_INERTIAL_DELAY 22 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 14.630451853058055 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2e CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 121 CONFIG.C_SDA_INERTIAL_DELAY 58 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 586.2341682883142 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_9_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 1 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 5 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_10_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 0 -to 0 ip_10_accumulator/B
connect_bd_net [get_bd_pins ip_10_accumulator/B] [get_bd_pins ip_10_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 4 -to 0 ip_10_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 24 CONFIG.aresetn 0 CONFIG.bportwidth 47 CONFIG.btuserwidth 75 CONFIG.ctrltuserwidth 189 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 53 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_12_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0xbc585fd9b9328ba CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xafbec0ddef44cfb CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_15_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 6 CONFIG.S_TDATA_NUM_BYTES 14 " [get_bd_cells ip_26_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 5 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_20_axi/AXI_S9]
