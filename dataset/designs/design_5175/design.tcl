...
set_property -dict "CONFIG.C_MASK 0xca1ec7db4464964 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x81a56fd7bca3429 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_ALL_INPUTS_2 1 CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 32 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 30 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 30 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control NonBlocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 34 CONFIG.Iterations 11 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 41 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 1 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode No_Pipelining CONFIG.Precision 47 CONFIG.Round_Mode Truncate " [get_bd_cells ip_3_cordic/cordic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_MEM1_TYPE 3 CONFIG.C_MEM1_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 13 CONFIG.C_TAVDV_PS_MEM_0 15410 CONFIG.C_TAVDV_PS_MEM_1 13580 CONFIG.C_TCEDV_PS_MEM_0 14616 CONFIG.C_TCEDV_PS_MEM_1 15014 CONFIG.C_THZCE_PS_MEM_0 7091 CONFIG.C_THZCE_PS_MEM_1 7188 CONFIG.C_THZOE_PS_MEM_0 7516 CONFIG.C_THZOE_PS_MEM_1 6846 CONFIG.C_TLZWE_PS_MEM_0 2279 CONFIG.C_TLZWE_PS_MEM_1 3173 CONFIG.C_TWC_PS_MEM_0 15508 CONFIG.C_TWC_PS_MEM_1 13565 CONFIG.C_TWPH_PS_MEM_0 12792 CONFIG.C_TWPH_PS_MEM_1 11943 CONFIG.C_TWP_PS_MEM_0 12664 CONFIG.C_TWP_PS_MEM_1 11456 CONFIG.C_WR_REC_TIME_MEM_0 26583 CONFIG.C_WR_REC_TIME_MEM_1 27084 " [get_bd_cells ip_5_emc/emc_0]
...
create_bd_pin -dir I -from 29 -to 0 ip_11_slice_and_concat/in_0
...
connect_bd_net [get_bd_pins ip_8_intc/irq_1] [get_bd_pins ip_4_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_1] [get_bd_pins ip_4_xadc_wiz/vccaux_alarm_out]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_4_xadc_wiz/alarm_out]
