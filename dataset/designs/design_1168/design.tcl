...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 7 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_1_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 32 CONFIG.aresetn 1 CONFIG.bportwidth 55 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 61 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 41 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_8_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 26 CONFIG.aresetn 1 CONFIG.atuserwidth 186 CONFIG.bportwidth 41 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 40 CONFIG.multtype Use_Mults CONFIG.optimizegoal Resources CONFIG.outputwidth 28 CONFIG.outtlastbehv AND_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_9_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 0 CONFIG.C_MEM0_WIDTH 32 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 2 CONFIG.C_SYNCH_PIPEDELAY_0 1 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 6 " [get_bd_cells ip_10_emc/emc_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 9 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_11_dft/dft_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 16 " [get_bd_cells ip_20_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_25_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_27_slice_and_concat/slice_2]
...
connect_bd_net [get_bd_pins ip_14_intc/irq_1] [get_bd_pins ip_2_xadc_wiz/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_emc/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S6]
...
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_3] [get_bd_pins ip_5_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_4] [get_bd_pins ip_5_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_5] [get_bd_pins ip_5_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/in_2] [get_bd_pins ip_7_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/out0] [get_bd_pins ip_11_dft/XN_RE]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_0] [get_bd_pins ip_7_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_2_xadc_wiz/user_temp_alarm_out]
