...
set_property -dict "CONFIG.C_ADDR_WIDTH 50 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0xc CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 151 CONFIG.C_SDA_INERTIAL_DELAY 31 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 857.7516878152061 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 53 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x44 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 206 CONFIG.C_SDA_INERTIAL_DELAY 132 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 761.3821997839632 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x59 CONFIG.C_GPO_WIDTH 4 CONFIG.C_SCL_INERTIAL_DELAY 53 CONFIG.C_SDA_INERTIAL_DELAY 134 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 708.9320516624954 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x7e962c80b397315 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6787f9907986e0d CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.COUNT_WIDTH 8 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_High CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_7_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_GPIO_WIDTH 23 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x768045 " [get_bd_cells ip_9_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 52 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_13_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 16 CONFIG.Speed_Optimization Area CONFIG.Support_Size_5G 1 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_20_dft/dft_0]
...
create_bd_pin -dir I -from 12 -to 0 ip_30_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_30_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_30_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 12 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 13 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_33_slice_and_concat/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_34_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 15 -to 0 ip_36_slice_and_concat/in_8
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_8
move_bd_cells [get_bd_cells ip_36_slice_and_concat] [get_bd_cells slice_8]
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_36_slice_and_concat/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 2 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_37_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 3 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_38_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_4] [get_bd_pins ip_4_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_5] [get_bd_pins ip_5_axi_iic/irq]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_8] [get_bd_pins ip_10_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_11] [get_bd_pins ip_15_uartlite/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_12] [get_bd_pins ip_16_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_24_intc/irq_13] [get_bd_pins ip_17_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_25_axi/AXI_M5]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_timer/S_AXI] [get_bd_intf_pins ip_25_axi/AXI_S10]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi/AXI_S13]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_21_axi_timer/S_AXI] [get_bd_intf_pins ip_25_axi/AXI_S14]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_24_intc/AXI] [get_bd_intf_pins ip_25_axi/AXI_S15]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_26_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_17_axi_dma/M_AXIS_MM2S]
...
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_0] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_1] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_30_slice_and_concat/in_2] [get_bd_pins ip_7_axi_timer/pwm0]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_8_dft/XK_RE]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_1] [get_bd_pins ip_8_dft/XK_IM]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_0] [get_bd_pins ip_8_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/out0] [get_bd_pins ip_20_dft/XN_RE]
...
connect_bd_net [get_bd_pins ip_35_slice_and_concat/in_2] [get_bd_pins ip_11_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/out0] [get_bd_pins ip_11_dft/XN_IM]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_0] [get_bd_pins ip_11_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_1] [get_bd_pins ip_14_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_2] [get_bd_pins ip_14_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_3] [get_bd_pins ip_14_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_4] [get_bd_pins ip_16_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_5] [get_bd_pins ip_16_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_6] [get_bd_pins ip_16_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_7] [get_bd_pins ip_20_dft/RFFD]
connect_bd_net [get_bd_pins ip_36_slice_and_concat/in_8] [get_bd_pins ip_20_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_0] [get_bd_pins ip_20_dft/XK_IM]
connect_bd_net [get_bd_pins ip_38_slice_and_concat/in_1] [get_bd_pins ip_20_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/out0] [get_bd_pins ip_8_dft/SIZE]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_0] [get_bd_pins ip_20_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_1] [get_bd_pins ip_20_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_2] [get_bd_pins ip_20_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_3] [get_bd_pins ip_21_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_4] [get_bd_pins ip_21_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_39_slice_and_concat/in_5] [get_bd_pins ip_21_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_40_slice_and_concat/out0] [get_bd_pins ip_16_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_41_slice_and_concat/out0] [get_bd_pins ip_20_dft/FWD_INV]
connect_bd_net [get_bd_pins ip_42_slice_and_concat/out0] [get_bd_pins ip_19_conv_encoder/aclken]
connect_bd_net [get_bd_pins ip_43_slice_and_concat/out0] [get_bd_pins ip_16_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_44_slice_and_concat/out0] [get_bd_pins ip_12_floating_point/aclken]
connect_bd_net [get_bd_pins ip_45_slice_and_concat/out0] [get_bd_pins ip_8_dft/FWD_INV]
...
connect_bd_net [get_bd_pins ip_51_slice_and_concat/out0] [get_bd_pins ip_18_conv_encoder/aclken]
