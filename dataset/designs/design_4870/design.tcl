...
set_property -dict "CONFIG.C_ADDR_WIDTH 33 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_1_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.ACLKEN 0 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling No_Scale_Compensation CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sin_and_Cos CONFIG.Input_Width 42 CONFIG.Iterations 46 CONFIG.Optimize_Goal Performance CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 19 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Optimal CONFIG.Precision 37 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_3_cordic/cordic_0]
...
set_property -dict "CONFIG.NUM_PORTS 12 " [get_bd_cells ip_12_slice_and_concat/concat]
...
create_bd_pin -dir I -from 0 -to 0 ip_12_slice_and_concat/in_7
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_7] [get_bd_pins ip_12_slice_and_concat/concat/In7]
create_bd_pin -dir I -from 0 -to 0 ip_12_slice_and_concat/in_8
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_8] [get_bd_pins ip_12_slice_and_concat/concat/In8]
create_bd_pin -dir I -from 0 -to 0 ip_12_slice_and_concat/in_9
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_9] [get_bd_pins ip_12_slice_and_concat/concat/In9]
create_bd_pin -dir I -from 0 -to 0 ip_12_slice_and_concat/in_10
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_10] [get_bd_pins ip_12_slice_and_concat/concat/In10]
create_bd_pin -dir I -from 0 -to 0 ip_12_slice_and_concat/in_11
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_11] [get_bd_pins ip_12_slice_and_concat/concat/In11]
...
connect_bd_net [get_bd_pins ip_8_intc/irq_3] [get_bd_pins ip_5_axi_quad_spi/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_9_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_6] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_7] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_8] [get_bd_pins ip_4_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_9] [get_bd_pins ip_4_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_10] [get_bd_pins ip_4_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_11] [get_bd_pins ip_4_xadc_wiz/jtagbusy_out]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_2_axi_timer/freeze]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_4_xadc_wiz/convst_in]
