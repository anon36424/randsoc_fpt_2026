...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6d CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 191 CONFIG.C_SDA_INERTIAL_DELAY 172 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 212.60885906024123 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 35 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_6_axi_cdma/axi_cdma_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_10_axi_legacy/AXI_S5]
