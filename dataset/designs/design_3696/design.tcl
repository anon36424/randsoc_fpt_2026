...
set_property -dict "CONFIG.channels 10 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 256 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.C_BAUDRATE 128000 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Even " [get_bd_cells ip_6_uartlite/uart_0]
...
set_property -dict "CONFIG.C_MASK 0x45f0f2533709df3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xfd179dec8094714 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 40 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_15_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_4] [get_bd_pins ip_4_axi_dma/mm2s_introut]
connect_bd_net [get_bd_pins ip_11_intc/irq_5] [get_bd_pins ip_4_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_11_intc/irq_6] [get_bd_pins ip_5_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_11_intc/irq_7] [get_bd_pins ip_6_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_microblaze/M_AXI_DP] [get_bd_intf_pins ip_12_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_hwicap/S_AXI_LITE] [get_bd_intf_pins ip_12_axi_legacy/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_uartlite/AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_1_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_3] [get_bd_pins ip_1_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_4] [get_bd_pins ip_1_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_5] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_6] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_7] [get_bd_pins ip_2_axi_timer/pwm0]
