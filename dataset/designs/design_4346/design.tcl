...
set_property -dict "CONFIG.C_BAUDRATE 4800 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Odd " [get_bd_cells ip_1_uartlite/uart_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 32 CONFIG.aresetn 0 CONFIG.atuserwidth 34 CONFIG.bportwidth 54 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 35 CONFIG.outtlastbehv Pass_A_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_3_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x1 CONFIG.C_GPIO2_WIDTH 25 CONFIG.C_GPIO_WIDTH 1 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0xf CONFIG.C_GPIO_WIDTH 4 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_8_gpio/gpio_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_14_fft/fft_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 24 CONFIG.aresetn 1 CONFIG.atuserwidth 170 CONFIG.bportwidth 33 CONFIG.btuserwidth 20 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 20 CONFIG.roundmode Truncate " [get_bd_cells ip_16_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 14 CONFIG.Iterations 19 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 0 CONFIG.Output_Width 12 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 28 CONFIG.Round_Mode Truncate " [get_bd_cells ip_17_cordic/cordic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x44 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 81 CONFIG.C_SDA_INERTIAL_DELAY 98 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 280.0972192109231 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_18_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x7e CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 240 CONFIG.C_SDA_INERTIAL_DELAY 239 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 343.17162292379356 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_19_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_BAUDRATE 19200 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Even " [get_bd_cells ip_20_uartlite/uart_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 18 " [get_bd_cells ip_37_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 13 -to 0 ip_51_slice_and_concat/in_10
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_10
move_bd_cells [get_bd_cells ip_51_slice_and_concat] [get_bd_cells slice_10]
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_51_slice_and_concat/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_52_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_53_slice_and_concat/slice_1]
...
connect_bd_net [get_bd_pins ip_21_reset/interconnect_aresetn] [get_bd_pins ip_15_cordic/aresetn]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_4] [get_bd_pins ip_10_axi_dma/s2mm_introut]
...
connect_bd_net [get_bd_pins ip_23_intc/irq_7] [get_bd_pins ip_13_axi_dma/s2mm_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_24_axi/AXI_M0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_axi_dma/M_AXI] [get_bd_intf_pins ip_24_axi/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_24_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_uartlite/AXI] [get_bd_intf_pins ip_24_axi/AXI_S10]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_floating_point/S_AXIS_B] [get_bd_intf_pins ip_48_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_6] [get_bd_pins ip_2_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_7] [get_bd_pins ip_2_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_8] [get_bd_pins ip_2_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_9] [get_bd_pins ip_6_dft/RFFD]
connect_bd_net [get_bd_pins ip_51_slice_and_concat/in_10] [get_bd_pins ip_6_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_55_slice_and_concat/out0] [get_bd_pins ip_17_cordic/aclken]
...
connect_bd_net [get_bd_pins ip_59_slice_and_concat/out0] [get_bd_pins ip_11_conv_encoder/aclken]
...
if {[catch {
  ...
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_28_axis_broadcaster/M_AXIS_2 declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_28_axis_broadcaster/M_AXIS_2 declared=144 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 144 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_50_axis_combiner/S_AXIS_1 declared=144 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_50_axis_combiner/S_AXIS_1 declared=144 actual=ERR $__err" }
if {[catch {
