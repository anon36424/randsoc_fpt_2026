...
set_property -dict "CONFIG.C_MASK 0x23d4145bf83ad64 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x14f3ca015766420 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_4_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x53 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 42 CONFIG.C_SDA_INERTIAL_DELAY 167 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 249.5884680138064 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
connect_bd_net [get_bd_pins ip_12_intc/irq_5] [get_bd_pins ip_9_axi_dma/mm2s_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_dma/M_AXI] [get_bd_intf_pins ip_13_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_13_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_13_axi_legacy/AXI_S2]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_3] [get_bd_pins ip_0_xadc_wiz/temp_out]
