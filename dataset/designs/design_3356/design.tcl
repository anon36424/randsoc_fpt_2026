...
set_property -dict "CONFIG.C_ADDR_WIDTH 64 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_0_axi_cdma/axi_cdma_0]
...
create_bd_pin -dir I -from 13 -to 0 ip_8_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_8_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_3] [get_bd_pins ip_2_dft/RFFD]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_4] [get_bd_pins ip_2_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_2_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_2] [get_bd_pins ip_2_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/out0] [get_bd_pins ip_2_dft/FWD_INV]
