...
set_property -dict "CONFIG.COUNT_WIDTH 32 CONFIG.GEN0_ASSERT Active_High CONFIG.GEN1_ASSERT Active_Low CONFIG.TRIG0_ASSERT Active_High CONFIG.TRIG1_ASSERT Active_Low CONFIG.enable_timer2 1 CONFIG.mode_64bit 0 " [get_bd_cells ip_0_axi_timer/axi_timer_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x1e CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 24 CONFIG.C_SDA_INERTIAL_DELAY 200 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 455.2588080909599 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 18 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_8_dft/dft_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_16_slice_and_concat/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 9 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_18_slice_and_concat/in_8
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_8
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_8]
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_18_slice_and_concat/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_20_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_intc/irq_4] [get_bd_pins ip_5_axi_dma/s2mm_introut]
connect_bd_net [get_bd_pins ip_11_intc/irq_5] [get_bd_pins ip_6_axi_iic/irq]
connect_bd_net [get_bd_pins ip_11_intc/irq_6] [get_bd_pins ip_7_axi_timer/interrupt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_12_axi_legacy/AXI_M1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_dma/M_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_timer/S_AXI] [get_bd_intf_pins ip_12_axi_legacy/AXI_S5]
...
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_2_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_8_dft/XN_IM]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_3] [get_bd_pins ip_2_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/out0] [get_bd_pins ip_8_dft/XN_RE]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_0] [get_bd_pins ip_2_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_7_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_7_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_6] [get_bd_pins ip_7_axi_timer/pwm0]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_7] [get_bd_pins ip_8_dft/RFFD]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_8] [get_bd_pins ip_8_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_0] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_1] [get_bd_pins ip_8_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_2] [get_bd_pins ip_8_dft/DATA_VALID]
