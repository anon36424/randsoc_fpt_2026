...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1ffff CONFIG.C_DOUT_DEFAULT_2 0x142a9 CONFIG.C_GPIO2_WIDTH 3 CONFIG.C_GPIO_WIDTH 17 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x4aa5 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 34 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 128 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_2_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_MASK 0xb36bbc2425a31ec CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x49c44fd394b9219 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_6_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 64 " [get_bd_cells ip_7_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 55 CONFIG.aresetn 1 CONFIG.atuserwidth 94 CONFIG.bportwidth 28 CONFIG.ctrltuserwidth 164 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 41 CONFIG.multtype Use_Mults CONFIG.optimizegoal Performance CONFIG.outputwidth 6 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 4 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_15_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 14 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_18_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_20_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 14 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_microblaze/M_AXI_DP] [get_bd_intf_pins ip_12_axi/AXI_M2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_12_axi/AXI_S3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_complex_multiplier/S_AXIS_CTRL] [get_bd_intf_pins ip_14_axis_dwidth_converter/M_AXIS]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_8_complex_multiplier/M_AXIS_DOUT]
...
connect_bd_net [get_bd_pins ip_26_slice_and_concat/out0] [get_bd_pins ip_8_complex_multiplier/aclken]
