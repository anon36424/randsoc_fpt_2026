...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_SPI_MEMORY 2 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 1 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_0_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 2048 " [get_bd_cells ip_1_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 53 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 33 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 256 CONFIG.C_M_AXI_MAX_BURST_LEN 2 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 27 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 32 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_7_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 26 -to 0 ip_7_accumulator/B
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 17 CONFIG.aresetn 1 CONFIG.atuserwidth 191 CONFIG.bportwidth 8 CONFIG.btuserwidth 115 CONFIG.ctrltuserwidth 10 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Manual CONFIG.minimumlatency 41 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 2 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_8_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 256 " [get_bd_cells ip_9_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.channels 4 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 256 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 230 CONFIG.Latency 14 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 237 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_11_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 229 -to 0 ip_11_accumulator/B
...
set_property -dict "CONFIG.C_MASK 0x4fbb2b5e4602b2c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xd215efea9aab899 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_13_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.NUM_MI 7 CONFIG.NUM_SI 4 " [get_bd_cells ip_17_axi_legacy/axi_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 16 CONFIG.S_TDATA_NUM_BYTES 2 " [get_bd_cells ip_25_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir O -from 229 -to 0 ip_33_slice_and_concat/out0
...
create_bd_pin -dir I -from 31 -to 0 ip_33_slice_and_concat/in_7
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_7] [get_bd_pins ip_33_slice_and_concat/concat/In7]
create_bd_pin -dir I -from 236 -to 0 ip_33_slice_and_concat/in_8
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_8
move_bd_cells [get_bd_cells ip_33_slice_and_concat] [get_bd_cells slice_8]
set_property -dict "CONFIG.DIN_FROM 180 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 237 " [get_bd_cells ip_33_slice_and_concat/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 186 CONFIG.DIN_TO 181 CONFIG.DIN_WIDTH 237 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 201 CONFIG.DIN_TO 187 CONFIG.DIN_WIDTH 237 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 228 CONFIG.DIN_TO 202 CONFIG.DIN_WIDTH 237 " [get_bd_cells ip_36_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 236 CONFIG.DIN_TO 229 CONFIG.DIN_WIDTH 237 " [get_bd_cells ip_37_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_3] [get_bd_pins ip_4_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_16_intc/irq_4] [get_bd_pins ip_6_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_16_intc/irq_5] [get_bd_pins ip_9_axi_hwicap/ip2intc_irpt]
connect_bd_net [get_bd_pins ip_16_intc/irq_6] [get_bd_pins ip_10_fft/event_frame_started]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/M_AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_M1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi_legacy/AXI_S2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_timer/S_AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_S3]
...
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_7] [get_bd_pins ip_7_accumulator/Q]
connect_bd_net [get_bd_pins ip_33_slice_and_concat/in_8] [get_bd_pins ip_11_accumulator/Q]
...
if {[catch {
  ...
  set __s [expr {$__aw == 128 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_28_axis_combiner/S_AXIS_2 declared=128 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_28_axis_combiner/S_AXIS_2 declared=128 actual=ERR $__err" }
if {[catch {
