...
set_property -dict "CONFIG.C_MASK 0xd827ecc62eb02e3 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x6ebf2d295a3bccd CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_1_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.AINIT_Value 3eaa90db50a540e7706e93d5b8997da1fb8372518ea4849f744e8d178cb8dad CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 241 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 253 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 240 -to 0 ip_2_accumulator/B
...
set_property -dict "CONFIG.channels 2 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 128 " [get_bd_cells ip_3_fft/fft_0]
...
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 240 -to 0 ip_11_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 241 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_11_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 252 CONFIG.DIN_TO 242 CONFIG.DIN_WIDTH 253 " [get_bd_cells ip_12_slice_and_concat/slice_0]
