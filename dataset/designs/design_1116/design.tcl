...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x48 CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 227 CONFIG.C_SDA_INERTIAL_DELAY 2 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 210.6421883062402 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 176 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 205 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 175 -to 0 ip_8_slice_and_concat/out0
create_bd_pin -dir I -from 204 -to 0 ip_8_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_8_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 175 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_8_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 28 -to 0 ip_9_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 204 CONFIG.DIN_TO 176 CONFIG.DIN_WIDTH 205 " [get_bd_cells ip_9_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/out0] [get_bd_pins ip_2_accumulator/ADD]
