...
set_property -dict "CONFIG.C_FIFO_DEPTH 16 CONFIG.C_SHARED_STARTUP 0 CONFIG.C_SPI_MEMORY 2 CONFIG.C_SPI_MODE 2 CONFIG.C_TYPE_OF_AXI4_INTERFACE 0 CONFIG.C_USE_STARTUP 1 CONFIG.C_XIP_MODE 0 CONFIG.C_XIP_PERF_MODE 0 CONFIG.FIFO_INCLUDED 1 CONFIG.Master_mode 1 " [get_bd_cells ip_1_axi_quad_spi/axi_quad_spi_0]
...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 28 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_2_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x13 CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 131 CONFIG.C_SDA_INERTIAL_DELAY 168 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 874.8847211168686 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 39 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 16 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_4_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 7 CONFIG.convolution_code0 47 CONFIG.convolution_code1 4 CONFIG.convolution_code2 7 CONFIG.convolution_code3 32 CONFIG.convolution_code4 64 CONFIG.convolution_code5 39 CONFIG.convolution_code6 93 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 14 CONFIG.puncture_code0 11111111 CONFIG.puncture_code1 11110101 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_6_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 4 CONFIG.convolution_code0 7 CONFIG.convolution_code1 3 CONFIG.convolution_code2 11 CONFIG.convolution_code3 13 CONFIG.convolution_code4 1 CONFIG.convolution_code5 2 CONFIG.convolution_code6 15 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 8 CONFIG.output_rate 13 CONFIG.puncture_code0 11110111 CONFIG.puncture_code1 11010111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_7_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.channels 12 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_4_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 8192 " [get_bd_cells ip_13_fft/fft_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_18_axi_legacy/AXI_S6]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_0] [get_bd_pins ip_5_dft/DATA_VALID]
...
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_7] [get_bd_pins ip_12_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_8] [get_bd_pins ip_12_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_31_slice_and_concat/in_9] [get_bd_pins ip_12_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_34_slice_and_concat/in_0] [get_bd_pins ip_12_xadc_wiz/vccaux_alarm_out]
...
if {[catch {
  ...
  set __s [expr {$__aw == 7 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_27_axis_dwidth_converter/M_AXIS declared=7 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_27_axis_dwidth_converter/M_AXIS declared=7 actual=ERR $__err" }
