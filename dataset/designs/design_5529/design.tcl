...
set_property -dict "CONFIG.C_MASK 0x48fa26bb2a4dbf0 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x2dc4a48f9ed3592 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_0_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 339 CONFIG.convolution_code1 57 CONFIG.convolution_code2 154 CONFIG.convolution_code3 473 CONFIG.convolution_code4 114 CONFIG.convolution_code5 203 CONFIG.convolution_code6 365 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 7 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_2_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 477 CONFIG.convolution_code1 509 CONFIG.convolution_code2 9 CONFIG.convolution_code3 189 CONFIG.convolution_code4 173 CONFIG.convolution_code5 170 CONFIG.convolution_code6 244 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 3 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_3_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 15 CONFIG.C_TAVDV_PS_MEM_0 14179 CONFIG.C_TCEDV_PS_MEM_0 14782 CONFIG.C_THZCE_PS_MEM_0 7036 CONFIG.C_THZOE_PS_MEM_0 7337 CONFIG.C_TLZWE_PS_MEM_0 3673 CONFIG.C_TWC_PS_MEM_0 15326 CONFIG.C_TWPH_PS_MEM_0 12006 CONFIG.C_TWP_PS_MEM_0 11411 CONFIG.C_WR_REC_TIME_MEM_0 25134 " [get_bd_cells ip_5_emc/emc_0]
...
set_property -dict "CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 1 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 0 CONFIG.C_NOREAD 1 CONFIG.C_OPERATION 0 CONFIG.C_WRITE_FIFO_DEPTH 128 " [get_bd_cells ip_8_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 12 CONFIG.S_TDATA_NUM_BYTES 32 " [get_bd_cells ip_19_axis_dwidth_converter/axis_dwidth_converter_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_6_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_4] [get_bd_pins ip_8_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_14_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_14_axi/AXI_M3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_14_axi/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_emc/AXI] [get_bd_intf_pins ip_14_axi/AXI_S1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_6_axi_dma/M_AXIS_MM2S] [get_bd_intf_pins ip_15_axis_broadcaster/S_AXIS]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_22_slice_and_concat/in_0]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_23_slice_and_concat/in_1] [get_bd_pins ip_9_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_0] [get_bd_pins ip_9_xadc_wiz/vccint_alarm_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_1] [get_bd_pins ip_9_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_24_slice_and_concat/in_2] [get_bd_pins ip_9_xadc_wiz/alarm_out]
