...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 64 CONFIG.Latency 15 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 71 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 63 -to 0 ip_0_accumulator/B
connect_bd_net [get_bd_pins ip_0_accumulator/B] [get_bd_pins ip_0_accumulator/accumulator_0/B]
create_bd_pin -dir O -from 70 -to 0 ip_0_accumulator/Q
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 1 CONFIG.C_TAVDV_PS_MEM_0 15093 CONFIG.C_TCEDV_PS_MEM_0 14152 CONFIG.C_THZCE_PS_MEM_0 6453 CONFIG.C_THZOE_PS_MEM_0 6626 CONFIG.C_TLZWE_PS_MEM_0 1446 CONFIG.C_TWC_PS_MEM_0 13938 CONFIG.C_TWPH_PS_MEM_0 11186 CONFIG.C_TWP_PS_MEM_0 10856 CONFIG.C_WR_REC_TIME_MEM_0 27074 " [get_bd_cells ip_8_emc/emc_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 5 CONFIG.convolution_code0 30 CONFIG.convolution_code1 20 CONFIG.convolution_code2 17 CONFIG.convolution_code3 23 CONFIG.convolution_code4 16 CONFIG.convolution_code5 28 CONFIG.convolution_code6 15 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 7 CONFIG.output_rate 9 CONFIG.puncture_code0 0101011 CONFIG.puncture_code1 0011111 CONFIG.punctured 1 CONFIG.tready 0 " [get_bd_cells ip_9_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir O -from 63 -to 0 ip_18_slice_and_concat/out0
create_bd_pin -dir I -from 70 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 63 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 71 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 70 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 64 CONFIG.DIN_WIDTH 71 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_uartlite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_15_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_15_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_emc/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_intc/AXI] [get_bd_intf_pins ip_15_axi_legacy/AXI_S10]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_1] [get_bd_pins ip_6_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_2] [get_bd_pins ip_6_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_3] [get_bd_pins ip_6_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_4] [get_bd_pins ip_6_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_5] [get_bd_pins ip_6_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_6] [get_bd_pins ip_6_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_10_conv_encoder/aclken]
