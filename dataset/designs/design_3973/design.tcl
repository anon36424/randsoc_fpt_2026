...
set_property -dict "CONFIG.C_MEM0_TYPE 3 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 16 CONFIG.C_TAVDV_PS_MEM_0 13819 CONFIG.C_TCEDV_PS_MEM_0 15128 CONFIG.C_THZCE_PS_MEM_0 6511 CONFIG.C_THZOE_PS_MEM_0 7422 CONFIG.C_TLZWE_PS_MEM_0 1994 CONFIG.C_TWC_PS_MEM_0 16386 CONFIG.C_TWPH_PS_MEM_0 11953 CONFIG.C_TWP_PS_MEM_0 11190 CONFIG.C_WR_REC_TIME_MEM_0 26772 " [get_bd_cells ip_0_emc/emc_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x2 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 161 CONFIG.C_SDA_INERTIAL_DELAY 147 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 275.7916195706678 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 87 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 147 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 146 -to 0 ip_3_accumulator/Q
...
create_bd_pin -dir O -from 86 -to 0 ip_11_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 43 -to 0 ip_11_slice_and_concat/in_0
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_0] [get_bd_pins ip_11_slice_and_concat/concat/In0]
create_bd_pin -dir I -from 146 -to 0 ip_11_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 147 " [get_bd_cells ip_11_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 146 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 108 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 147 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 146 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 146 CONFIG.DIN_TO 109 CONFIG.DIN_WIDTH 147 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_1] [get_bd_pins ip_3_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_1] [get_bd_pins ip_4_axi_timer/generateout0]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_2] [get_bd_pins ip_4_axi_timer/generateout1]
connect_bd_net [get_bd_pins ip_13_slice_and_concat/in_3] [get_bd_pins ip_4_axi_timer/pwm0]
