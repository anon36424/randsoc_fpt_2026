...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 155 CONFIG.Latency 20 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 188 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_1_accumulator/accumulator_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 45 CONFIG.Latency 18 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 175 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 44 -to 0 ip_3_accumulator/B
...
create_bd_pin -dir I -from 165 -to 0 ip_10_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 50 CONFIG.DIN_TO 46 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 55 CONFIG.DIN_TO 51 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 60 CONFIG.DIN_TO 56 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 65 CONFIG.DIN_TO 61 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 70 CONFIG.DIN_TO 66 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 75 CONFIG.DIN_TO 71 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 80 CONFIG.DIN_TO 76 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 85 CONFIG.DIN_TO 81 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 90 CONFIG.DIN_TO 86 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 95 CONFIG.DIN_TO 91 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 100 CONFIG.DIN_TO 96 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 105 CONFIG.DIN_TO 101 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 110 CONFIG.DIN_TO 106 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 115 CONFIG.DIN_TO 111 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 120 CONFIG.DIN_TO 116 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 125 CONFIG.DIN_TO 121 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 130 CONFIG.DIN_TO 126 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 135 CONFIG.DIN_TO 131 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 140 CONFIG.DIN_TO 136 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 145 CONFIG.DIN_TO 141 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 150 CONFIG.DIN_TO 146 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 155 CONFIG.DIN_TO 151 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 160 CONFIG.DIN_TO 156 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 165 CONFIG.DIN_TO 161 CONFIG.DIN_WIDTH 166 " [get_bd_cells ip_10_reduce/slice_31]
...
create_bd_pin -dir O -from 44 -to 0 ip_11_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 187 -to 0 ip_11_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 188 " [get_bd_cells ip_11_slice_and_concat/slice_3]
...
create_bd_pin -dir O -from 154 -to 0 ip_12_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 187 -to 0 ip_12_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 187 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 188 " [get_bd_cells ip_12_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 174 -to 0 ip_12_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_12_slice_and_concat/slice_1]
...
create_bd_pin -dir O -from 165 -to 0 ip_13_slice_and_concat/out0
create_bd_pin -dir I -from 174 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 174 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 175 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_4_reset/interconnect_aresetn] [get_bd_pins ip_2_conv_encoder/aresetn]
...
connect_bd_net [get_bd_pins ip_5_clk_wiz/clk_out] [get_bd_pins ip_2_conv_encoder/aclk]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_conv_encoder/S_AXIS_DATA] [get_bd_intf_pins ip_9_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_11_slice_and_concat/in_3] [get_bd_pins ip_1_accumulator/Q]
connect_bd_net [get_bd_pins ip_12_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/B]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/C_IN]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/capturetrig0]
connect_bd_net [get_bd_pins ip_16_slice_and_concat/out0] [get_bd_pins ip_0_axi_timer/freeze]
...
connect_bd_net [get_bd_pins ip_20_slice_and_concat/out0] [get_bd_pins ip_1_accumulator/Bypass]
