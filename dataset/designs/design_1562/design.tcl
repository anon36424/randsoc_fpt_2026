...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x21 CONFIG.C_GPO_WIDTH 6 CONFIG.C_SCL_INERTIAL_DELAY 66 CONFIG.C_SDA_INERTIAL_DELAY 217 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 960.4968258980892 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_0_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 1 CONFIG.C_S_AXI_MEM_DATA_WIDTH 64 CONFIG.C_S_AXI_MEM_ID_WIDTH 6 CONFIG.C_TAVDV_PS_MEM_0 15717 CONFIG.C_TCEDV_PS_MEM_0 13855 CONFIG.C_THZCE_PS_MEM_0 7270 CONFIG.C_THZOE_PS_MEM_0 7341 CONFIG.C_TLZWE_PS_MEM_0 6062 CONFIG.C_TWC_PS_MEM_0 14648 CONFIG.C_TWPH_PS_MEM_0 13085 CONFIG.C_TWP_PS_MEM_0 11612 CONFIG.C_WR_REC_TIME_MEM_0 28902 " [get_bd_cells ip_1_emc/emc_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.constraint_length 9 CONFIG.convolution_code0 412 CONFIG.convolution_code1 500 CONFIG.convolution_code2 386 CONFIG.convolution_code3 171 CONFIG.convolution_code4 145 CONFIG.convolution_code5 373 CONFIG.convolution_code6 141 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 2 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_4_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir O -from 22 -to 0 ip_10_slice_and_concat/out0
create_bd_pin -dir I -from 24 -to 0 ip_10_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_10_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 25 " [get_bd_cells ip_10_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 24 -to 0 ip_11_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_11_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 25 " [get_bd_cells ip_11_slice_and_concat/slice_0]
