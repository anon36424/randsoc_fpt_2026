...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 27 CONFIG.aresetn 0 CONFIG.bportwidth 51 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 0 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 30 CONFIG.outtlastbehv Pass_CTRL_TLAST CONFIG.roundmode Random_Rounding " [get_bd_cells ip_1_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5d CONFIG.C_GPO_WIDTH 3 CONFIG.C_SCL_INERTIAL_DELAY 84 CONFIG.C_SDA_INERTIAL_DELAY 115 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 353.078962334035 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_4_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 1 CONFIG.C_MEM0_WIDTH 8 CONFIG.C_MEM1_TYPE 0 CONFIG.C_MEM1_WIDTH 8 CONFIG.C_NUM_BANKS_MEM 2 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_PARITY_TYPE_MEM_1 0 CONFIG.C_SYNCH_PIPEDELAY_1 1 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 3 CONFIG.C_TAVDV_PS_MEM_0 14579 CONFIG.C_TCEDV_PS_MEM_0 16279 CONFIG.C_THZCE_PS_MEM_0 6931 CONFIG.C_THZOE_PS_MEM_0 6966 CONFIG.C_TLZWE_PS_MEM_0 5538 CONFIG.C_TWC_PS_MEM_0 15662 CONFIG.C_TWPH_PS_MEM_0 12523 CONFIG.C_TWP_PS_MEM_0 12742 CONFIG.C_WR_REC_TIME_MEM_0 25575 " [get_bd_cells ip_5_emc/emc_0]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 0 CONFIG.Architectural_Configuration Parallel CONFIG.CARTESIAN_HAS_TLAST 1 CONFIG.CARTESIAN_HAS_TUSER 1 CONFIG.Coarse_Rotation 1 CONFIG.Compensation_Scaling Embedded_Multiplier CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Rotate CONFIG.Input_Width 21 CONFIG.Iterations 38 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour AND_of_TLAST CONFIG.Out_TREADY 0 CONFIG.Output_Width 44 CONFIG.PHASE_HAS_TLAST 1 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 45 CONFIG.Round_Mode Round_Pos_Neg_Inf " [get_bd_cells ip_7_cordic/cordic_0]
...
set_property -dict "CONFIG.channels 7 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 0 CONFIG.transform_length 64 " [get_bd_cells ip_9_fft/fft_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 16 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 256 " [get_bd_cells ip_10_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 25 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 33 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_12_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 24 -to 0 ip_12_accumulator/B
...
set_property -dict "CONFIG.C_BAUDRATE 128000 CONFIG.C_DATA_BITS 6 CONFIG.PARITY Even " [get_bd_cells ip_14_uartlite/uart_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 61 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 32 CONFIG.C_M_AXI_MAX_BURST_LEN 64 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_16_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x55 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 125 CONFIG.C_SDA_INERTIAL_DELAY 31 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 409.5806295431344 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_18_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0x40e35d3b98b0419 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_19_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xa61bc0166750b9f CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_19_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.C_BAUDRATE 19200 CONFIG.C_DATA_BITS 8 CONFIG.PARITY Even " [get_bd_cells ip_20_uartlite/uart_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 28 CONFIG.S_TDATA_NUM_BYTES 4 " [get_bd_cells ip_32_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 32 -to 0 ip_44_slice_and_concat/in_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_3
move_bd_cells [get_bd_cells ip_44_slice_and_concat] [get_bd_cells slice_3]
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_44_slice_and_concat/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 22 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_45_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 23 CONFIG.DIN_WIDTH 33 " [get_bd_cells ip_46_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_23_clk_wiz/clk_out] [get_bd_pins ip_13_xadc_wiz/convstclk_in]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_4] [get_bd_pins ip_8_axi_dma/mm2s_introut]
...
connect_bd_net [get_bd_pins ip_24_intc/irq_11] [get_bd_pins ip_17_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_24_intc/irq_12] [get_bd_pins ip_18_axi_iic/irq]
connect_bd_net [get_bd_pins ip_24_intc/irq_13] [get_bd_pins ip_20_uartlite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_SG] [get_bd_intf_pins ip_25_axi/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_dma/M_AXI_MM2S] [get_bd_intf_pins ip_25_axi/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_iic/AXI] [get_bd_intf_pins ip_25_axi/AXI_S2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_uartlite/AXI] [get_bd_intf_pins ip_25_axi/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axi_dma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi/AXI_S9]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_25_axi/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_iic/AXI] [get_bd_intf_pins ip_25_axi/AXI_S12]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_20_uartlite/AXI] [get_bd_intf_pins ip_25_axi/AXI_S13]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_35_axis_combiner/S_AXIS_0] [get_bd_intf_pins ip_21_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_4] [get_bd_pins ip_13_xadc_wiz/jtaglocked_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_5] [get_bd_pins ip_13_xadc_wiz/jtagmodified_out]
connect_bd_net [get_bd_pins ip_46_slice_and_concat/in_6] [get_bd_pins ip_13_xadc_wiz/jtagbusy_out]
...
connect_bd_net [get_bd_pins ip_49_slice_and_concat/out0] [get_bd_pins ip_12_accumulator/C_IN]
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_21_floating_point/M_AXIS_RESULT declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_21_floating_point/M_AXIS_RESULT declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 224 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_32_axis_dwidth_converter/M_AXIS declared=224 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_32_axis_dwidth_converter/M_AXIS declared=224 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 80 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/S_AXIS_0 declared=80 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/S_AXIS_0 declared=80 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/M_AXIS declared=176 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_35_axis_combiner/M_AXIS declared=176 actual=ERR $__err" }
if {[catch {
