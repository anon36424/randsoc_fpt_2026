...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x13 CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 35 CONFIG.C_SDA_INERTIAL_DELAY 233 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 999.2878828780124 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 58 CONFIG.C_INCLUDE_DRE 1 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 8 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_3_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.Accum_Mode Add_Subtract CONFIG.Bypass 0 CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Signed CONFIG.Input_Width 16 CONFIG.Latency 1 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 17 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 16 -to 0 ip_4_accumulator/Q
...
set_property -dict "CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation DSP48 CONFIG.Input_Type Unsigned CONFIG.Input_Width 14 CONFIG.Latency 2 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 45 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
create_bd_pin -dir I -from 45 -to 0 ip_11_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 1 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 2 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 7 CONFIG.DIN_TO 6 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 8 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 11 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_5]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_11_reduce/reduce_5]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 12 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 2 " [get_bd_cells ip_11_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_7]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_8]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_9]
...
set_property -dict "CONFIG.DIN_FROM 21 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_10]
...
set_property -dict "CONFIG.DIN_FROM 23 CONFIG.DIN_TO 22 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_11]
...
set_property -dict "CONFIG.DIN_FROM 25 CONFIG.DIN_TO 24 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_12]
...
set_property -dict "CONFIG.DIN_FROM 27 CONFIG.DIN_TO 26 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_13]
...
set_property -dict "CONFIG.DIN_FROM 28 CONFIG.DIN_TO 28 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_14]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 29 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_15]
...
set_property -dict "CONFIG.DIN_FROM 30 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_16]
...
set_property -dict "CONFIG.DIN_FROM 31 CONFIG.DIN_TO 31 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_17]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 32 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_18]
...
set_property -dict "CONFIG.DIN_FROM 33 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_19]
...
set_property -dict "CONFIG.DIN_FROM 34 CONFIG.DIN_TO 34 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_20]
...
set_property -dict "CONFIG.DIN_FROM 35 CONFIG.DIN_TO 35 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_21]
...
set_property -dict "CONFIG.DIN_FROM 36 CONFIG.DIN_TO 36 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_22]
...
set_property -dict "CONFIG.DIN_FROM 37 CONFIG.DIN_TO 37 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_23]
...
set_property -dict "CONFIG.DIN_FROM 38 CONFIG.DIN_TO 38 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_24]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 39 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_25]
...
set_property -dict "CONFIG.DIN_FROM 40 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_26]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 41 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_27]
...
set_property -dict "CONFIG.DIN_FROM 42 CONFIG.DIN_TO 42 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 43 CONFIG.DIN_TO 43 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 44 CONFIG.DIN_TO 44 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 45 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_11_reduce/slice_31]
...
create_bd_pin -dir O -from 15 -to 0 ip_12_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 16 -to 0 ip_12_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_12_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 0 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_12_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 13 -to 0 ip_13_slice_and_concat/out0
create_bd_pin -dir I -from 16 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 15 CONFIG.DIN_TO 15 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 45 -to 0 ip_15_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 16 -to 0 ip_15_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 16 CONFIG.DIN_TO 16 CONFIG.DIN_WIDTH 17 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 44 -to 0 ip_15_slice_and_concat/in_1
...
connect_bd_net [get_bd_pins ip_7_reset/peripheral_areset_n] [get_bd_pins ip_1_xadc_wiz/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ip_8_clk_wiz/clk_out] [get_bd_pins ip_1_xadc_wiz/s_axi_aclk]
...
connect_bd_net [get_bd_pins ip_9_intc/irq_1] [get_bd_pins ip_1_xadc_wiz/ip2intc_irpt]
...
connect_bd_net [get_bd_pins ip_9_intc/irq_4] [get_bd_pins ip_5_axi_hwicap/ip2intc_irpt]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_axi_iic/AXI] [get_bd_intf_pins ip_10_axi_legacy/AXI_S1]
...
connect_bd_net [get_bd_pins ip_12_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/temp_out]
...
connect_bd_net [get_bd_pins ip_14_slice_and_concat/out0] [get_bd_pins ip_5_axi_hwicap/eos_in]
connect_bd_net [get_bd_pins ip_14_slice_and_concat/in_0] [get_bd_pins ip_4_accumulator/Q]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/out0] [get_bd_pins ip_11_reduce/in0]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_0] [get_bd_pins ip_4_accumulator/Q]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_1] [get_bd_pins ip_6_accumulator/Q]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/user_temp_alarm_out]
...
connect_bd_net [get_bd_pins ip_19_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/alarm_out]
