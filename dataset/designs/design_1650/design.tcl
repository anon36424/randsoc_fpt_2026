...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 18 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 0 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_1_dft/dft_0]
...
set_property -dict "CONFIG.C_MASK 0x9991c8dc2657604 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0xf2f6d485f761be7 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_2_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.ACLKEN 1 CONFIG.ARESETn 1 CONFIG.Architectural_Configuration Word_Serial CONFIG.CARTESIAN_HAS_TLAST 0 CONFIG.CARTESIAN_HAS_TUSER 0 CONFIG.Coarse_Rotation 0 CONFIG.Compensation_Scaling LUT_based CONFIG.Data_Format SignedFraction CONFIG.Flow_Control Blocking CONFIG.Functional_Selection Sinh_and_Cosh CONFIG.Input_Width 8 CONFIG.Iterations 15 CONFIG.Optimize_Goal Resources CONFIG.Out_TLAST_Behaviour None CONFIG.Out_TREADY 1 CONFIG.Output_Width 25 CONFIG.PHASE_HAS_TLAST 0 CONFIG.PHASE_HAS_TUSER 0 CONFIG.Phase_Format Scaled_Radians CONFIG.Pipelining_Mode Maximum CONFIG.Precision 40 CONFIG.Round_Mode Round_Pos_Inf " [get_bd_cells ip_3_cordic/cordic_0]
...
set_property -dict "CONFIG.DIN_FROM 13 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_12_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 14 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_13_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 14 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 15 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 17 -to 0 ip_15_slice_and_concat/in_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_5
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_5]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_15_slice_and_concat/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 7 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_16_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_16_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 18 " [get_bd_cells ip_17_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 11 -to 0 ip_18_slice_and_concat/in_5
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_4_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_9_axi_legacy/AXI_S0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_intc/AXI] [get_bd_intf_pins ip_9_axi_legacy/AXI_S1]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_cordic/S_AXIS_PHASE] [get_bd_intf_pins ip_10_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_13_slice_and_concat/out0] [get_bd_pins ip_0_dft/SIZE]
...
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_4] [get_bd_pins ip_1_dft/RFFD]
connect_bd_net [get_bd_pins ip_15_slice_and_concat/in_5] [get_bd_pins ip_1_dft/XK_RE]
...
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_0] [get_bd_pins ip_1_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_1] [get_bd_pins ip_1_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_2] [get_bd_pins ip_5_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_3] [get_bd_pins ip_5_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_4] [get_bd_pins ip_5_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_18_slice_and_concat/in_5] [get_bd_pins ip_5_xadc_wiz/temp_out]
connect_bd_net [get_bd_pins ip_19_slice_and_concat/out0] [get_bd_pins ip_3_cordic/aclken]
