...
set_property -dict "CONFIG.Clock_Enable 0 CONFIG.Data_Width 11 CONFIG.Speed_Optimization Speed CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 0 " [get_bd_cells ip_1_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x64 CONFIG.C_GPO_WIDTH 5 CONFIG.C_SCL_INERTIAL_DELAY 185 CONFIG.C_SDA_INERTIAL_DELAY 195 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 967.7656029192415 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_3_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5b CONFIG.C_GPO_WIDTH 8 CONFIG.C_SCL_INERTIAL_DELAY 108 CONFIG.C_SDA_INERTIAL_DELAY 37 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 34.16544335805767 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_7_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_MASK 0xc198e178698ac8c CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x5cd35f6efef9154 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_8_microblaze/lmb_ctrl_i]
...
set_property -dict "CONFIG.channels 3 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 16 " [get_bd_cells ip_10_fft/fft_0]
...
set_property -dict "CONFIG.DIN_FROM 3 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_18_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 4 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 15 -to 0 ip_21_slice_and_concat/in_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_6
move_bd_cells [get_bd_cells ip_21_slice_and_concat] [get_bd_cells slice_6]
set_property -dict "CONFIG.DIN_FROM 4 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_21_slice_and_concat/slice_6]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_13_intc/irq_1] [get_bd_pins ip_5_axi_ethernet_lite/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_10_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_2_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_2] [get_bd_pins ip_4_xadc_wiz/eoc_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_3] [get_bd_pins ip_4_xadc_wiz/eos_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_4] [get_bd_pins ip_4_xadc_wiz/busy_out]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_5] [get_bd_pins ip_9_dft/RFFD]
connect_bd_net [get_bd_pins ip_21_slice_and_concat/in_6] [get_bd_pins ip_9_dft/XK_RE]
