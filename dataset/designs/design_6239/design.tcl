...
set_property -dict "CONFIG.AINIT_Value 1216cfa3ab19fdf4675e3de39b031eb04bec2b4a462cadb2f785ea4dafa759648 CONFIG.Accum_Mode Subtract CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 256 CONFIG.Latency_Configuration Automatic CONFIG.Output_Width 257 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_2_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 255 -to 0 ip_11_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 256 CONFIG.DIN_TO 1 CONFIG.DIN_WIDTH 257 " [get_bd_cells ip_11_slice_and_concat/slice_0]
