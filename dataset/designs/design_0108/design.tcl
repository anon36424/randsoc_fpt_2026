...
set_property -dict "CONFIG.C_ALL_INPUTS 1 CONFIG.C_GPIO_WIDTH 26 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_BRAM_SRL_FIFO_TYPE 0 CONFIG.C_ICAP_DWIDTH 8 CONFIG.C_ICAP_EXTERNAL 0 CONFIG.C_INCLUDE_STARTUP 0 CONFIG.C_MODE 1 CONFIG.C_NOREAD 0 CONFIG.C_OPERATION 1 CONFIG.C_READ_FIFO_DEPTH 128 " [get_bd_cells ip_1_axi_hwicap/axi_hwicap_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x1fffff CONFIG.C_GPIO_WIDTH 21 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 27 CONFIG.aresetn 0 CONFIG.bportwidth 50 CONFIG.btuserwidth 28 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 17 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 4 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_7_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MEM0_TYPE 4 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_EN_REG 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 10 CONFIG.C_TAVDV_PS_MEM_0 15659 CONFIG.C_TCEDV_PS_MEM_0 15667 CONFIG.C_THZCE_PS_MEM_0 7398 CONFIG.C_THZOE_PS_MEM_0 6450 CONFIG.C_TLZWE_PS_MEM_0 4495 CONFIG.C_TWC_PS_MEM_0 13939 CONFIG.C_TWPH_PS_MEM_0 10831 CONFIG.C_TWP_PS_MEM_0 12523 CONFIG.C_WR_REC_TIME_MEM_0 28840 " [get_bd_cells ip_9_emc/emc_0]
...
set_property -dict "CONFIG.DIN_FROM 10 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 18 CONFIG.DIN_TO 11 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_21_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 24 CONFIG.DIN_TO 19 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_22_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 25 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_23_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_24_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 45 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 46 " [get_bd_cells ip_25_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 10 -to 0 ip_26_slice_and_concat/in_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_4
move_bd_cells [get_bd_cells ip_26_slice_and_concat] [get_bd_cells slice_4]
set_property -dict "CONFIG.DIN_FROM 6 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 11 " [get_bd_cells ip_26_slice_and_concat/slice_4]
...
create_bd_pin -dir O -from 42 -to 0 ip_27_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 7 -to 0 ip_27_slice_and_concat/in_6
...
create_bd_pin -dir I -from 3 -to 0 ip_27_slice_and_concat/in_8
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_9_emc/AXI] [get_bd_intf_pins ip_14_axi/AXI_S4]
...
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_2] [get_bd_pins ip_6_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_3] [get_bd_pins ip_6_dft/FD_OUT]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_4] [get_bd_pins ip_6_dft/DATA_VALID]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_5] [get_bd_pins ip_8_dft/RFFD]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_6] [get_bd_pins ip_8_dft/XK_RE]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_7] [get_bd_pins ip_8_dft/XK_IM]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_8] [get_bd_pins ip_8_dft/BLK_EXP]
connect_bd_net [get_bd_pins ip_27_slice_and_concat/in_9] [get_bd_pins ip_8_dft/FD_OUT]
