...
set_property -dict "CONFIG.AINIT_Value 303bbfe218cffbd3bc8651f4dfddcfb1c71a140edd CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 0 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 159 CONFIG.Latency 28 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 168 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 167 -to 0 ip_3_accumulator/Q
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 3 CONFIG.convolution_code0 3 CONFIG.convolution_code1 6 CONFIG.convolution_code2 3 CONFIG.convolution_code3 3 CONFIG.convolution_code4 2 CONFIG.convolution_code5 7 CONFIG.convolution_code6 5 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 1 CONFIG.input_rate 8 CONFIG.output_rate 12 CONFIG.puncture_code0 01101011 CONFIG.puncture_code1 01111111 CONFIG.punctured 1 CONFIG.tready 1 " [get_bd_cells ip_4_conv_encoder/conv_encoder_0]
...
create_bd_pin -dir I -from 167 -to 0 ip_13_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_13_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 8 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_13_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 158 -to 0 ip_14_slice_and_concat/out0
...
set_property -dict "CONFIG.DIN_FROM 167 CONFIG.DIN_TO 9 CONFIG.DIN_WIDTH 168 " [get_bd_cells ip_14_slice_and_concat/slice_0]
