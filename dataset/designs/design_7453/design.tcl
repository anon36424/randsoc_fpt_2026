...
set_property -dict "CONFIG.C_BAUDRATE 300 CONFIG.C_DATA_BITS 7 CONFIG.PARITY Odd " [get_bd_cells ip_0_uartlite/uart_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.aportwidth 12 CONFIG.aresetn 1 CONFIG.atuserwidth 231 CONFIG.bportwidth 15 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 40 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 9 CONFIG.roundmode Truncate " [get_bd_cells ip_4_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_MASK 0xe4f6ef538492518 CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_d]
...
set_property -dict "CONFIG.C_MASK 0x7676e7ab7d41ecd CONFIG.C_NUM_LMB 1 " [get_bd_cells ip_7_microblaze/lmb_ctrl_i]
