...
create_bd_pin -dir O -from 32 -to 0 ip_7_slice_and_concat/out0
create_bd_pin -dir I -from 41 -to 0 ip_7_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_7_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 32 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_7_slice_and_concat/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 41 CONFIG.DIN_TO 33 CONFIG.DIN_WIDTH 42 " [get_bd_cells ip_8_slice_and_concat/slice_0]
