...
set_property -dict "CONFIG.C_MEM0_TYPE 2 CONFIG.C_MEM0_WIDTH 16 CONFIG.C_NUM_BANKS_MEM 1 CONFIG.C_PARITY_TYPE_MEM_0 0 CONFIG.C_S_AXI_MEM_DATA_WIDTH 32 CONFIG.C_S_AXI_MEM_ID_WIDTH 5 CONFIG.C_TAVDV_PS_MEM_0 16295 CONFIG.C_TCEDV_PS_MEM_0 15063 CONFIG.C_THZCE_PS_MEM_0 6673 CONFIG.C_THZOE_PS_MEM_0 6437 CONFIG.C_TLZWE_PS_MEM_0 1094 CONFIG.C_TWC_PS_MEM_0 16150 CONFIG.C_TWPH_PS_MEM_0 11026 CONFIG.C_TWP_PS_MEM_0 11639 CONFIG.C_WR_REC_TIME_MEM_0 26379 " [get_bd_cells ip_2_emc/emc_0]
...
set_property -dict "CONFIG.AINIT_Value 3123b3aaabad76eccc929239c7ade72d8b824ceb7e4aecd10ac776 CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_Low CONFIG.CE 0 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 199 CONFIG.Latency 26 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 214 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_3_accumulator/accumulator_0]
...
create_bd_pin -dir O -from 213 -to 0 ip_3_accumulator/Q
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x768 CONFIG.C_GPIO_WIDTH 12 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_4_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x24 CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 85 CONFIG.C_SDA_INERTIAL_DELAY 58 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 47.576676713094884 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_6_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 63 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_8_axi_cdma/axi_cdma_0]
...
create_bd_pin -dir O -from 198 -to 0 ip_14_slice_and_concat/out0
create_bd_pin -dir I -from 213 -to 0 ip_14_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_14_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 198 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 214 " [get_bd_cells ip_14_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 213 -to 0 ip_15_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_15_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 213 CONFIG.DIN_TO 199 CONFIG.DIN_WIDTH 214 " [get_bd_cells ip_15_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_17_slice_and_concat/out0] [get_bd_pins ip_3_accumulator/Bypass]
