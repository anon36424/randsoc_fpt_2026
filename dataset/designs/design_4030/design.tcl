...
set_property -dict "CONFIG.channels 5 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_2_fft/fft_0]
...
set_property -dict "CONFIG.Clock_Enable 1 CONFIG.Data_Width 16 CONFIG.Speed_Optimization Area CONFIG.Support_Size_1536 1 CONFIG.Support_Size_5G 0 CONFIG.Synchronous_Clear 1 " [get_bd_cells ip_3_dft/dft_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x5a CONFIG.C_GPO_WIDTH 1 CONFIG.C_SCL_INERTIAL_DELAY 236 CONFIG.C_SDA_INERTIAL_DELAY 159 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 799.3630959977047 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_5_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0xa4 CONFIG.C_GPIO_WIDTH 9 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_7_gpio/gpio_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 62 CONFIG.aresetn 0 CONFIG.atuserwidth 196 CONFIG.bportwidth 23 CONFIG.btuserwidth 168 CONFIG.ctrltuserwidth 206 CONFIG.datatype Integer CONFIG.flowcontrol NonBlocking CONFIG.hasatlast 1 CONFIG.hasatuser 1 CONFIG.hasbtlast 0 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 1 CONFIG.hasctrltuser 1 CONFIG.latencyconfig Automatic CONFIG.multtype Use_Luts CONFIG.optimizegoal Resources CONFIG.outputwidth 12 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Random_Rounding " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 58 CONFIG.C_INCLUDE_SF 0 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_12_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x1fff CONFIG.C_GPIO2_WIDTH 4 CONFIG.C_GPIO_WIDTH 13 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0xb13 CONFIG.C_TRI_DEFAULT_2 0x1fff " [get_bd_cells ip_13_gpio/gpio_0]
...
set_property -dict "CONFIG.NUM_MI 11 CONFIG.NUM_SI 4 " [get_bd_cells ip_17_axi_legacy/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 5 CONFIG.DIN_TO 5 CONFIG.DIN_WIDTH 16 " [get_bd_cells ip_31_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_16_intc/irq_3] [get_bd_pins ip_2_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_16_intc/irq_4] [get_bd_pins ip_4_uartlite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_5] [get_bd_pins ip_5_axi_iic/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_6] [get_bd_pins ip_6_uartlite/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_7] [get_bd_pins ip_7_gpio/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_8] [get_bd_pins ip_8_axi_quad_spi/irq]
connect_bd_net [get_bd_pins ip_16_intc/irq_9] [get_bd_pins ip_12_axi_cdma/cdma_introut]
connect_bd_net [get_bd_pins ip_16_intc/irq_10] [get_bd_pins ip_13_gpio/irq]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_0_axi_dma/M_AXI_S2MM] [get_bd_intf_pins ip_17_axi_legacy/AXI_M2]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_cdma/M_AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_gpio/AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_17_axi_legacy/AXI_S6]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_axi_quad_spi/AXI_FULL] [get_bd_intf_pins ip_17_axi_legacy/AXI_S7]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_17_axi_legacy/AXI_S8]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_13_gpio/AXI] [get_bd_intf_pins ip_17_axi_legacy/AXI_S9]
