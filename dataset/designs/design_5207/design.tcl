...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_ALL_OUTPUTS_2 1 CONFIG.C_DOUT_DEFAULT 0x0 CONFIG.C_DOUT_DEFAULT_2 0x1f CONFIG.C_GPIO2_WIDTH 3 CONFIG.C_GPIO_WIDTH 5 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 " [get_bd_cells ip_0_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x6e CONFIG.C_GPO_WIDTH 2 CONFIG.C_SCL_INERTIAL_DELAY 134 CONFIG.C_SDA_INERTIAL_DELAY 95 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 690.1550737912276 CONFIG.TEN_BIT_ADR 10_bit " [get_bd_cells ip_1_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x74 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 5 CONFIG.C_SDA_INERTIAL_DELAY 79 CONFIG.C_SDA_LEVEL 1 CONFIG.IIC_FREQ_KHZ 970.8377276186663 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_2_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Add CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 1 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 105 CONFIG.Latency 3 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 233 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_4_accumulator/accumulator_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 12 CONFIG.aresetn 1 CONFIG.atuserwidth 132 CONFIG.bportwidth 27 CONFIG.btuserwidth 190 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 0 CONFIG.hasatuser 1 CONFIG.hasbtlast 1 CONFIG.hasbtuser 1 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 42 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 36 CONFIG.outtlastbehv Pass_B_TLAST CONFIG.roundmode Truncate " [get_bd_cells ip_6_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.aclken 0 CONFIG.constraint_length 9 CONFIG.convolution_code0 8 CONFIG.convolution_code1 175 CONFIG.convolution_code2 181 CONFIG.convolution_code3 207 CONFIG.convolution_code4 360 CONFIG.convolution_code5 271 CONFIG.convolution_code6 167 CONFIG.convolution_code_radix Decimal CONFIG.dual_output 0 CONFIG.input_rate 1 CONFIG.output_rate 5 CONFIG.puncture_code0 0 CONFIG.puncture_code1 0 CONFIG.punctured 0 CONFIG.tready 0 " [get_bd_cells ip_8_conv_encoder/conv_encoder_0]
...
set_property -dict "CONFIG.aclken 1 CONFIG.aportwidth 14 CONFIG.aresetn 1 CONFIG.bportwidth 34 CONFIG.datatype Integer CONFIG.flowcontrol Blocking CONFIG.hasatlast 1 CONFIG.hasatuser 0 CONFIG.hasbtlast 1 CONFIG.hasbtuser 0 CONFIG.hasctrltlast 0 CONFIG.hasctrltuser 0 CONFIG.latencyconfig Manual CONFIG.minimumlatency 49 CONFIG.multtype Use_Luts CONFIG.optimizegoal Performance CONFIG.outputwidth 26 CONFIG.outtlastbehv OR_all_TLASTs CONFIG.roundmode Truncate " [get_bd_cells ip_10_complex_multiplier/cmpy_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32 " [get_bd_cells ip_12_fft/fft_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 64 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 64 CONFIG.C_M_AXI_MAX_BURST_LEN 32 CONFIG.C_USE_DATAMOVER_LITE 1 " [get_bd_cells ip_15_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x242 CONFIG.C_GPIO_WIDTH 10 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 CONFIG.C_TRI_DEFAULT 0x0 " [get_bd_cells ip_16_gpio/gpio_0]
...
set_property -dict "CONFIG.C_DEFAULT_VALUE 0x42 CONFIG.C_GPO_WIDTH 7 CONFIG.C_SCL_INERTIAL_DELAY 230 CONFIG.C_SDA_INERTIAL_DELAY 93 CONFIG.C_SDA_LEVEL 0 CONFIG.IIC_FREQ_KHZ 370.62416043118554 CONFIG.TEN_BIT_ADR 7_bit " [get_bd_cells ip_17_axi_iic/axi_iic_0]
...
set_property -dict "CONFIG.C_ADDR_WIDTH 58 CONFIG.C_INCLUDE_DRE 0 CONFIG.C_INCLUDE_SF 1 CONFIG.C_INCLUDE_SG 0 CONFIG.C_M_AXI_DATA_WIDTH 512 CONFIG.C_M_AXI_MAX_BURST_LEN 4 CONFIG.C_USE_DATAMOVER_LITE 0 " [get_bd_cells ip_18_axi_cdma/axi_cdma_0]
...
set_property -dict "CONFIG.NUM_MI 14 CONFIG.NUM_SI 4 " [get_bd_cells ip_22_axi_legacy/axi_0]
...
set_property -dict "CONFIG.DIN_FROM 104 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 233 " [get_bd_cells ip_34_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 133 -to 0 ip_35_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
set_property -dict "CONFIG.DIN_FROM 232 CONFIG.DIN_TO 105 CONFIG.DIN_WIDTH 233 " [get_bd_cells ip_35_slice_and_concat/slice_0]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_6] [get_bd_pins ip_12_fft/event_frame_started]
connect_bd_net [get_bd_pins ip_21_intc/irq_7] [get_bd_pins ip_13_axi_timer/interrupt]
connect_bd_net [get_bd_pins ip_21_intc/irq_8] [get_bd_pins ip_14_uartlite/irq]
...
connect_bd_net [get_bd_pins ip_21_intc/irq_11] [get_bd_pins ip_18_axi_cdma/cdma_introut]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_cdma/M_AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_M3]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_3_axi_quad_spi/AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_uartlite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S4]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_uartlite/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S8]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_16_gpio/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S10]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_17_axi_iic/AXI] [get_bd_intf_pins ip_22_axi_legacy/AXI_S11]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_18_axi_cdma/S_AXI_LITE] [get_bd_intf_pins ip_22_axi_legacy/AXI_S12]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_12_fft/S_AXIS_DATA] [get_bd_intf_pins ip_29_axis_dwidth_converter/M_AXIS]
...
connect_bd_net [get_bd_pins ip_38_slice_and_concat/out0] [get_bd_pins ip_4_accumulator/C_IN]
