...
set_property -dict "CONFIG.AINIT_Value 0 CONFIG.Accum_Mode Subtract CONFIG.Bypass 0 CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Unsigned CONFIG.Input_Width 18 CONFIG.Latency 15 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 170 CONFIG.SCLR 0 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_0_accumulator/accumulator_0]
...
set_property -dict "CONFIG.C_BAUDRATE 110 CONFIG.C_DATA_BITS 5 CONFIG.PARITY Even " [get_bd_cells ip_2_uartlite/uart_0]
...
set_property -dict "CONFIG.C_DOUT_DEFAULT 0x32bce107 CONFIG.C_DOUT_DEFAULT_2 0x3fffffff CONFIG.C_GPIO2_WIDTH 28 CONFIG.C_GPIO_WIDTH 30 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 1 CONFIG.C_TRI_DEFAULT 0x0 CONFIG.C_TRI_DEFAULT_2 0x2339a584 " [get_bd_cells ip_3_gpio/gpio_0]
...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x3f CONFIG.C_GPIO_WIDTH 7 CONFIG.C_INTERRUPT_PRESENT 0 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_5_gpio/gpio_0]
...
set_property -dict "CONFIG.Accum_Mode Add CONFIG.Bypass 1 CONFIG.Bypass_Sense Active_High CONFIG.CE 1 CONFIG.C_In 0 CONFIG.Implementation Fabric CONFIG.Input_Type Signed CONFIG.Input_Width 12 CONFIG.Latency 27 CONFIG.Latency_Configuration Manual CONFIG.Output_Width 176 CONFIG.SCLR 1 CONFIG.SINIT 0 CONFIG.SSET 0 " [get_bd_cells ip_6_accumulator/accumulator_0]
...
set_property -dict "CONFIG.channels 9 CONFIG.cyclic_prefix_insertion 0 CONFIG.implementation_options radix_2_lite_burst_io CONFIG.run_time_configurable_transform_length 1 CONFIG.transform_length 32768 " [get_bd_cells ip_8_fft/fft_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 8 CONFIG.S_TDATA_NUM_BYTES 36 " [get_bd_cells ip_14_axis_dwidth_converter/axis_dwidth_converter_0]
...
set_property -dict "CONFIG.M_TDATA_NUM_BYTES 36 CONFIG.S_TDATA_NUM_BYTES 1 " [get_bd_cells ip_16_axis_dwidth_converter/axis_dwidth_converter_0]
...
create_bd_pin -dir I -from 315 -to 0 ip_17_reduce/in0
...
set_property -dict "CONFIG.DIN_FROM 9 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_0]
...
set_property -dict "CONFIG.DIN_FROM 19 CONFIG.DIN_TO 10 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_1]
...
set_property -dict "CONFIG.DIN_FROM 29 CONFIG.DIN_TO 20 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_2]
...
set_property -dict "CONFIG.DIN_FROM 39 CONFIG.DIN_TO 30 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_3]
...
set_property -dict "CONFIG.DIN_FROM 49 CONFIG.DIN_TO 40 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_4]
...
set_property -dict "CONFIG.DIN_FROM 59 CONFIG.DIN_TO 50 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_5]
...
set_property -dict "CONFIG.DIN_FROM 69 CONFIG.DIN_TO 60 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_6]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_6]
...
set_property -dict "CONFIG.DIN_FROM 79 CONFIG.DIN_TO 70 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_7]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_7]
...
set_property -dict "CONFIG.DIN_FROM 89 CONFIG.DIN_TO 80 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_8]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_8]
...
set_property -dict "CONFIG.DIN_FROM 99 CONFIG.DIN_TO 90 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_9]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_9]
...
set_property -dict "CONFIG.DIN_FROM 109 CONFIG.DIN_TO 100 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_10]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_10]
...
set_property -dict "CONFIG.DIN_FROM 119 CONFIG.DIN_TO 110 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_11]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_11]
...
set_property -dict "CONFIG.DIN_FROM 129 CONFIG.DIN_TO 120 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_12]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_12]
...
set_property -dict "CONFIG.DIN_FROM 139 CONFIG.DIN_TO 130 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_13]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_13]
...
set_property -dict "CONFIG.DIN_FROM 149 CONFIG.DIN_TO 140 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_14]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_14]
...
set_property -dict "CONFIG.DIN_FROM 159 CONFIG.DIN_TO 150 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_15]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_15]
...
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 160 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_16]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_16]
...
set_property -dict "CONFIG.DIN_FROM 179 CONFIG.DIN_TO 170 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_17]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_17]
...
set_property -dict "CONFIG.DIN_FROM 189 CONFIG.DIN_TO 180 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_18]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_18]
...
set_property -dict "CONFIG.DIN_FROM 199 CONFIG.DIN_TO 190 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_19]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_19]
...
set_property -dict "CONFIG.DIN_FROM 209 CONFIG.DIN_TO 200 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_20]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_20]
...
set_property -dict "CONFIG.DIN_FROM 219 CONFIG.DIN_TO 210 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_21]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_21]
...
set_property -dict "CONFIG.DIN_FROM 229 CONFIG.DIN_TO 220 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_22]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_22]
...
set_property -dict "CONFIG.DIN_FROM 239 CONFIG.DIN_TO 230 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_23]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_23]
...
set_property -dict "CONFIG.DIN_FROM 249 CONFIG.DIN_TO 240 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_24]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_24]
...
set_property -dict "CONFIG.DIN_FROM 259 CONFIG.DIN_TO 250 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_25]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_25]
...
set_property -dict "CONFIG.DIN_FROM 269 CONFIG.DIN_TO 260 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_26]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_26]
...
set_property -dict "CONFIG.DIN_FROM 279 CONFIG.DIN_TO 270 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_27]
...
set_property -dict "CONFIG.C_OPERATION XOR CONFIG.C_SIZE 10 " [get_bd_cells ip_17_reduce/reduce_27]
...
set_property -dict "CONFIG.DIN_FROM 288 CONFIG.DIN_TO 280 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_28]
...
set_property -dict "CONFIG.DIN_FROM 297 CONFIG.DIN_TO 289 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_29]
...
set_property -dict "CONFIG.DIN_FROM 306 CONFIG.DIN_TO 298 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_30]
...
set_property -dict "CONFIG.DIN_FROM 315 CONFIG.DIN_TO 307 CONFIG.DIN_WIDTH 316 " [get_bd_cells ip_17_reduce/slice_31]
...
create_bd_pin -dir I -from 169 -to 0 ip_18_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_18_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 17 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 170 " [get_bd_cells ip_18_slice_and_concat/slice_0]
...
create_bd_pin -dir O -from 315 -to 0 ip_19_slice_and_concat/out0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat
...
create_bd_pin -dir I -from 169 -to 0 ip_19_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 169 CONFIG.DIN_TO 18 CONFIG.DIN_WIDTH 170 " [get_bd_cells ip_19_slice_and_concat/slice_0]
...
create_bd_pin -dir I -from 175 -to 0 ip_19_slice_and_concat/in_1
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_1
move_bd_cells [get_bd_cells ip_19_slice_and_concat] [get_bd_cells slice_1]
set_property -dict "CONFIG.DIN_FROM 163 CONFIG.DIN_TO 0 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_19_slice_and_concat/slice_1]
...
create_bd_pin -dir I -from 175 -to 0 ip_20_slice_and_concat/in_0
create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_0
move_bd_cells [get_bd_cells ip_20_slice_and_concat] [get_bd_cells slice_0]
set_property -dict "CONFIG.DIN_FROM 175 CONFIG.DIN_TO 164 CONFIG.DIN_WIDTH 176 " [get_bd_cells ip_20_slice_and_concat/slice_0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_2_uartlite/AXI] [get_bd_intf_pins ip_12_axi/AXI_S0]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_5_gpio/AXI] [get_bd_intf_pins ip_12_axi/AXI_S3]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_7_axi_ethernet_lite/AXI] [get_bd_intf_pins ip_12_axi/AXI_S4]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_11_intc/AXI] [get_bd_intf_pins ip_12_axi/AXI_S5]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_8_fft/S_AXIS_CONFIG] [get_bd_intf_pins ip_13_axis_broadcaster/M_AXIS_0]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_14_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_8_fft/M_AXIS_DATA]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ip_15_axis_dwidth_converter/S_AXIS] [get_bd_intf_pins ip_1_floating_point/M_AXIS_RESULT]
...
connect_bd_net [get_bd_pins ip_22_slice_and_concat/out0] [get_bd_pins ip_6_accumulator/Bypass]
...
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_14_axis_dwidth_converter/S_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_14_axis_dwidth_converter/S_AXIS declared=288 actual=ERR $__err" }
if {[catch {
...
if {[catch {
  ...
  set __s [expr {$__aw == 288 ? "OK" : "MISMATCH"}]
  puts "RANDSOC_WIDTH_CHECK ip_16_axis_dwidth_converter/M_AXIS declared=288 actual=$__aw $__s"
} __err]} { puts "RANDSOC_WIDTH_CHECK ip_16_axis_dwidth_converter/M_AXIS declared=288 actual=ERR $__err" }
