...
set_property -dict "CONFIG.C_ALL_OUTPUTS 1 CONFIG.C_DOUT_DEFAULT 0x1f CONFIG.C_GPIO_WIDTH 5 CONFIG.C_INTERRUPT_PRESENT 1 CONFIG.C_IS_DUAL 0 " [get_bd_cells ip_0_gpio/gpio_0]
...
connect_bd_net [get_bd_pins ip_6_slice_and_concat/in_3] [get_bd_pins ip_1_xadc_wiz/temp_out]
...
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_0] [get_bd_pins ip_1_xadc_wiz/ot_out]
connect_bd_net [get_bd_pins ip_8_slice_and_concat/in_1] [get_bd_pins ip_1_xadc_wiz/alarm_out]
